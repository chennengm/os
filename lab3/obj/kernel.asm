...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	368040ef          	jal	ra,ffffffffc02043b2 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	39258593          	addi	a1,a1,914 # ffffffffc02043e0 <etext+0x4>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3aa50513          	addi	a0,a0,938 # ffffffffc0204400 <etext+0x24>
...
ffffffffc020006e:	614030ef          	jal	ra,ffffffffc0203682 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	653030ef          	jal	ra,ffffffffc0203f00 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	61d030ef          	jal	ra,ffffffffc0203f00 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	30450513          	addi	a0,a0,772 # ffffffffc0204408 <etext+0x2c>
void print_kerninfo(void) {
...
ffffffffc020011e:	30e50513          	addi	a0,a0,782 # ffffffffc0204428 <etext+0x4c>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2b658593          	addi	a1,a1,694 # ffffffffc02043dc <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	31a50513          	addi	a0,a0,794 # ffffffffc0204448 <etext+0x6c>
...
ffffffffc0200146:	32650513          	addi	a0,a0,806 # ffffffffc0204468 <etext+0x8c>
...
ffffffffc020015a:	33250513          	addi	a0,a0,818 # ffffffffc0204488 <etext+0xac>
...
ffffffffc0200188:	32450513          	addi	a0,a0,804 # ffffffffc02044a8 <etext+0xcc>
}
...
ffffffffc0200196:	34660613          	addi	a2,a2,838 # ffffffffc02044d8 <etext+0xfc>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	35250513          	addi	a0,a0,850 # ffffffffc02044f0 <etext+0x114>
void print_stackframe(void) {
...
ffffffffc02001b2:	35a60613          	addi	a2,a2,858 # ffffffffc0204508 <etext+0x12c>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	37258593          	addi	a1,a1,882 # ffffffffc0204528 <etext+0x14c>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	37250513          	addi	a0,a0,882 # ffffffffc0204530 <etext+0x154>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	37460613          	addi	a2,a2,884 # ffffffffc0204540 <etext+0x164>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	39458593          	addi	a1,a1,916 # ffffffffc0204568 <etext+0x18c>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	35450513          	addi	a0,a0,852 # ffffffffc0204530 <etext+0x154>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	39060613          	addi	a2,a2,912 # ffffffffc0204578 <etext+0x19c>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3a858593          	addi	a1,a1,936 # ffffffffc0204598 <etext+0x1bc>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	33850513          	addi	a0,a0,824 # ffffffffc0204530 <etext+0x154>
...
ffffffffc0200236:	37650513          	addi	a0,a0,886 # ffffffffc02045a8 <etext+0x1cc>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	37c50513          	addi	a0,a0,892 # ffffffffc02045d0 <etext+0x1f4>
...
ffffffffc020027e:	37e48493          	addi	s1,s1,894 # ffffffffc02045f8 <etext+0x21c>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	37cb0b13          	addi	s6,s6,892 # ffffffffc0204600 <etext+0x224>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	29ca0a13          	addi	s4,s4,668 # ffffffffc0204528 <etext+0x14c>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7eb030ef          	jal	ra,ffffffffc0204282 <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0c2040ef          	jal	ra,ffffffffc020437e <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0ae040ef          	jal	ra,ffffffffc020437e <strcmp>
...
ffffffffc020030e:	08e040ef          	jal	ra,ffffffffc020439c <strchr>
...
ffffffffc020034c:	050040ef          	jal	ra,ffffffffc020439c <strchr>
...
ffffffffc020036a:	2ba50513          	addi	a0,a0,698 # ffffffffc0204620 <etext+0x244>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	70d030ef          	jal	ra,ffffffffc02043c4 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6e9030ef          	jal	ra,ffffffffc02043c4 <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7120306f          	j	ffffffffc0203c5a <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0200b6e:	67e5b583          	ld	a1,1662(a1) # ffffffffc02061e8 <error_string+0x38>
ffffffffc0200b72:	02b70733          	mul	a4,a4,a1
ffffffffc0200b76:	00005617          	auipc	a2,0x5
ffffffffc0200b7a:	67a63603          	ld	a2,1658(a2) # ffffffffc02061f0 <nbase>
...
ffffffffc0201722:	acab3b03          	ld	s6,-1334(s6) # ffffffffc02061e8 <error_string+0x38>
...
ffffffffc0201760:	453020ef          	jal	ra,ffffffffc02043b2 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02017d0:	a1cb3b03          	ld	s6,-1508(s6) # ffffffffc02061e8 <error_string+0x38>
...
ffffffffc0201802:	3b1020ef          	jal	ra,ffffffffc02043b2 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc02019f8:	7f443403          	ld	s0,2036(s0) # ffffffffc02061e8 <error_string+0x38>
...
ffffffffc0201dfe:	3eecbc83          	ld	s9,1006(s9) # ffffffffc02061e8 <error_string+0x38>
...
ffffffffc0201f60:	40c020ef          	jal	ra,ffffffffc020436c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	412020ef          	jal	ra,ffffffffc020437e <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	390020ef          	jal	ra,ffffffffc0204336 <strlen>
...
ffffffffc02027a4:	a486b683          	ld	a3,-1464(a3) # ffffffffc02061e8 <error_string+0x38>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3f2010ef          	jal	ra,ffffffffc0203d28 <swapfs_init>
...
ffffffffc02029ec:	2db000ef          	jal	ra,ffffffffc02034c6 <mm_create>
...
ffffffffc0202a20:	2ef000ef          	jal	ra,ffffffffc020350e <vma_create>
...
ffffffffc0202a2c:	351000ef          	jal	ra,ffffffffc020357c <insert_vma_struct>
...
ffffffffc0202ba0:	654c0c13          	addi	s8,s8,1620 # ffffffffc02061f0 <nbase>
...
ffffffffc0202c36:	217000ef          	jal	ra,ffffffffc020364c <mm_destroy>
...
ffffffffc0203040:	5bb000ef          	jal	ra,ffffffffc0203dfa <swapfs_write>
...
ffffffffc02030de:	483000ef          	jal	ra,ffffffffc0203d60 <swapfs_read>
...
ffffffffc02033b0:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc02033b2:	cb95                	beqz	a5,ffffffffc02033e6 <_clock_swap_out_victim+0x3a>
     assert(in_tick==0);
ffffffffc02033b4:	ea29                	bnez	a2,ffffffffc0203406 <_clock_swap_out_victim+0x5a>
    return listelm->prev;
ffffffffc02033b6:	639c                	ld	a5,0(a5)
        if((*ptr_page)->visited==0)
ffffffffc02033b8:	fe07b703          	ld	a4,-32(a5)
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc02033bc:	fd078693          	addi	a3,a5,-48
ffffffffc02033c0:	e194                	sd	a3,0(a1)
        if((*ptr_page)->visited==0)
ffffffffc02033c2:	cb11                	beqz	a4,ffffffffc02033d6 <_clock_swap_out_victim+0x2a>
            (*ptr_page)->visited = 0;
ffffffffc02033c4:	fe07b023          	sd	zero,-32(a5)
ffffffffc02033c8:	639c                	ld	a5,0(a5)
        if((*ptr_page)->visited==0)
ffffffffc02033ca:	fe07b703          	ld	a4,-32(a5)
ffffffffc02033ce:	fb7d                	bnez	a4,ffffffffc02033c4 <_clock_swap_out_victim+0x18>
        *ptr_page = le2page(entry, pra_page_link);
ffffffffc02033d0:	fd078713          	addi	a4,a5,-48
ffffffffc02033d4:	e198                	sd	a4,0(a1)
    __list_del(listelm->prev, listelm->next);
...
ffffffffc02033ea:	7ba68693          	addi	a3,a3,1978 # ffffffffc0205ba0 <default_pmm_manager+0xa80>
ffffffffc02033ee:	00002617          	auipc	a2,0x2
ffffffffc02033f2:	98260613          	addi	a2,a2,-1662 # ffffffffc0204d70 <commands+0x738>
ffffffffc02033f6:	04d00593          	li	a1,77
ffffffffc02033fa:	00002517          	auipc	a0,0x2
ffffffffc02033fe:	74650513          	addi	a0,a0,1862 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203402:	f73fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203406:	00002697          	auipc	a3,0x2
ffffffffc020340a:	7aa68693          	addi	a3,a3,1962 # ffffffffc0205bb0 <default_pmm_manager+0xa90>
ffffffffc020340e:	00002617          	auipc	a2,0x2
ffffffffc0203412:	96260613          	addi	a2,a2,-1694 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203416:	04e00593          	li	a1,78
ffffffffc020341a:	00002517          	auipc	a0,0x2
ffffffffc020341e:	72650513          	addi	a0,a0,1830 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203422:	f53fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203426 <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203426:	0000e717          	auipc	a4,0xe
ffffffffc020342a:	13270713          	addi	a4,a4,306 # ffffffffc0211558 <curr_ptr>
ffffffffc020342e:	631c                	ld	a5,0(a4)
{
ffffffffc0203430:	1141                	addi	sp,sp,-16
ffffffffc0203432:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203434:	c79d                	beqz	a5,ffffffffc0203462 <_clock_map_swappable+0x3c>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203436:	751c                	ld	a5,40(a0)
    assert(entry != NULL && head != NULL);
ffffffffc0203438:	c7a9                	beqz	a5,ffffffffc0203482 <_clock_map_swappable+0x5c>
    __list_add(elm, listelm, listelm->next);
ffffffffc020343a:	6794                	ld	a3,8(a5)
ffffffffc020343c:	03060593          	addi	a1,a2,48
    cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc0203440:	00002517          	auipc	a0,0x2
ffffffffc0203444:	7c850513          	addi	a0,a0,1992 # ffffffffc0205c08 <default_pmm_manager+0xae8>
    prev->next = next->prev = elm;
ffffffffc0203448:	e28c                	sd	a1,0(a3)
ffffffffc020344a:	e78c                	sd	a1,8(a5)
    elm->prev = prev;
ffffffffc020344c:	fa1c                	sd	a5,48(a2)
    page->visited = 1; //已被访问
ffffffffc020344e:	4785                	li	a5,1
    elm->next = next;
ffffffffc0203450:	fe14                	sd	a3,56(a2)
ffffffffc0203452:	ea1c                	sd	a5,16(a2)
    curr_ptr = entry;
ffffffffc0203454:	e30c                	sd	a1,0(a4)
    cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc0203456:	c65fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc020345a:	60a2                	ld	ra,8(sp)
ffffffffc020345c:	4501                	li	a0,0
ffffffffc020345e:	0141                	addi	sp,sp,16
ffffffffc0203460:	8082                	ret
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203462:	00002697          	auipc	a3,0x2
ffffffffc0203466:	75e68693          	addi	a3,a3,1886 # ffffffffc0205bc0 <default_pmm_manager+0xaa0>
ffffffffc020346a:	00002617          	auipc	a2,0x2
ffffffffc020346e:	90660613          	addi	a2,a2,-1786 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203472:	03700593          	li	a1,55
ffffffffc0203476:	00002517          	auipc	a0,0x2
ffffffffc020347a:	6ca50513          	addi	a0,a0,1738 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc020347e:	ef7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(entry != NULL && head != NULL);
ffffffffc0203482:	00002697          	auipc	a3,0x2
ffffffffc0203486:	76668693          	addi	a3,a3,1894 # ffffffffc0205be8 <default_pmm_manager+0xac8>
ffffffffc020348a:	00002617          	auipc	a2,0x2
ffffffffc020348e:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203492:	03e00593          	li	a1,62
ffffffffc0203496:	00002517          	auipc	a0,0x2
ffffffffc020349a:	6aa50513          	addi	a0,a0,1706 # ffffffffc0205b40 <default_pmm_manager+0xa20>
...
ffffffffc02034a8:	78c68693          	addi	a3,a3,1932 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc02034ac:	00002617          	auipc	a2,0x2
ffffffffc02034b0:	8c460613          	addi	a2,a2,-1852 # ffffffffc0204d70 <commands+0x738>
ffffffffc02034b4:	07d00593          	li	a1,125
ffffffffc02034b8:	00002517          	auipc	a0,0x2
ffffffffc02034bc:	79850513          	addi	a0,a0,1944 # ffffffffc0205c50 <default_pmm_manager+0xb30>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
mm_create(void) {
ffffffffc02034cc:	e022                	sd	s0,0(sp)
ffffffffc02034ce:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034d0:	aa8ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034d4:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034d6:	c105                	beqz	a0,ffffffffc02034f6 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034d8:	e408                	sd	a0,8(s0)
ffffffffc02034da:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034dc:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034e0:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034e4:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034e8:	0000e797          	auipc	a5,0xe
ffffffffc02034ec:	0687a783          	lw	a5,104(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034f0:	eb81                	bnez	a5,ffffffffc0203500 <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034f2:	02053423          	sd	zero,40(a0)
}
ffffffffc02034f6:	60a2                	ld	ra,8(sp)
ffffffffc02034f8:	8522                	mv	a0,s0
ffffffffc02034fa:	6402                	ld	s0,0(sp)
ffffffffc02034fc:	0141                	addi	sp,sp,16
ffffffffc02034fe:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203500:	a85ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc020350e <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020350e:	1101                	addi	sp,sp,-32
ffffffffc0203510:	e04a                	sd	s2,0(sp)
ffffffffc0203512:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203514:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203518:	e822                	sd	s0,16(sp)
ffffffffc020351a:	e426                	sd	s1,8(sp)
ffffffffc020351c:	ec06                	sd	ra,24(sp)
ffffffffc020351e:	84ae                	mv	s1,a1
ffffffffc0203520:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203522:	a56ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc0203526:	c509                	beqz	a0,ffffffffc0203530 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203528:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020352c:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020352e:	ed00                	sd	s0,24(a0)
}
ffffffffc0203530:	60e2                	ld	ra,24(sp)
ffffffffc0203532:	6442                	ld	s0,16(sp)
ffffffffc0203534:	64a2                	ld	s1,8(sp)
ffffffffc0203536:	6902                	ld	s2,0(sp)
ffffffffc0203538:	6105                	addi	sp,sp,32
ffffffffc020353a:	8082                	ret

ffffffffc020353c <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc020353c:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc020353e:	c505                	beqz	a0,ffffffffc0203566 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc0203540:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203542:	c501                	beqz	a0,ffffffffc020354a <find_vma+0xe>
ffffffffc0203544:	651c                	ld	a5,8(a0)
ffffffffc0203546:	02f5f263          	bgeu	a1,a5,ffffffffc020356a <find_vma+0x2e>
    return listelm->next;
ffffffffc020354a:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc020354c:	00f68d63          	beq	a3,a5,ffffffffc0203566 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203550:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203554:	00e5e663          	bltu	a1,a4,ffffffffc0203560 <find_vma+0x24>
ffffffffc0203558:	ff07b703          	ld	a4,-16(a5)
ffffffffc020355c:	00e5ec63          	bltu	a1,a4,ffffffffc0203574 <find_vma+0x38>
ffffffffc0203560:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203562:	fef697e3          	bne	a3,a5,ffffffffc0203550 <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203566:	4501                	li	a0,0
}
ffffffffc0203568:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020356a:	691c                	ld	a5,16(a0)
ffffffffc020356c:	fcf5ffe3          	bgeu	a1,a5,ffffffffc020354a <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc0203570:	ea88                	sd	a0,16(a3)
ffffffffc0203572:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203574:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203578:	ea88                	sd	a0,16(a3)
ffffffffc020357a:	8082                	ret

ffffffffc020357c <insert_vma_struct>:
...
ffffffffc020357c:	6590                	ld	a2,8(a1)
ffffffffc020357e:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203582:	1141                	addi	sp,sp,-16
ffffffffc0203584:	e406                	sd	ra,8(sp)
ffffffffc0203586:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203588:	01066763          	bltu	a2,a6,ffffffffc0203596 <insert_vma_struct+0x1a>
ffffffffc020358c:	a085                	j	ffffffffc02035ec <insert_vma_struct+0x70>
...
ffffffffc020358e:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203592:	04e66863          	bltu	a2,a4,ffffffffc02035e2 <insert_vma_struct+0x66>
ffffffffc0203596:	86be                	mv	a3,a5
ffffffffc0203598:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020359a:	fef51ae3          	bne	a0,a5,ffffffffc020358e <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc020359e:	02a68463          	beq	a3,a0,ffffffffc02035c6 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035a2:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035a6:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035aa:	08e8f163          	bgeu	a7,a4,ffffffffc020362c <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035ae:	04e66f63          	bltu	a2,a4,ffffffffc020360c <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035b2:	00f50a63          	beq	a0,a5,ffffffffc02035c6 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035b6:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035ba:	05076963          	bltu	a4,a6,ffffffffc020360c <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02035be:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035c2:	02c77363          	bgeu	a4,a2,ffffffffc02035e8 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035c6:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035c8:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035ca:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035ce:	e390                	sd	a2,0(a5)
ffffffffc02035d0:	e690                	sd	a2,8(a3)
}
ffffffffc02035d2:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035d4:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035d6:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035d8:	0017079b          	addiw	a5,a4,1
ffffffffc02035dc:	d11c                	sw	a5,32(a0)
}
ffffffffc02035de:	0141                	addi	sp,sp,16
ffffffffc02035e0:	8082                	ret
    if (le_prev != list) {
ffffffffc02035e2:	fca690e3          	bne	a3,a0,ffffffffc02035a2 <insert_vma_struct+0x26>
ffffffffc02035e6:	bfd1                	j	ffffffffc02035ba <insert_vma_struct+0x3e>
ffffffffc02035e8:	ebbff0ef          	jal	ra,ffffffffc02034a2 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035ec:	00002697          	auipc	a3,0x2
ffffffffc02035f0:	67468693          	addi	a3,a3,1652 # ffffffffc0205c60 <default_pmm_manager+0xb40>
ffffffffc02035f4:	00001617          	auipc	a2,0x1
ffffffffc02035f8:	77c60613          	addi	a2,a2,1916 # ffffffffc0204d70 <commands+0x738>
ffffffffc02035fc:	08400593          	li	a1,132
ffffffffc0203600:	00002517          	auipc	a0,0x2
ffffffffc0203604:	65050513          	addi	a0,a0,1616 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203608:	d6dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020360c:	00002697          	auipc	a3,0x2
ffffffffc0203610:	69468693          	addi	a3,a3,1684 # ffffffffc0205ca0 <default_pmm_manager+0xb80>
ffffffffc0203614:	00001617          	auipc	a2,0x1
ffffffffc0203618:	75c60613          	addi	a2,a2,1884 # ffffffffc0204d70 <commands+0x738>
ffffffffc020361c:	07c00593          	li	a1,124
ffffffffc0203620:	00002517          	auipc	a0,0x2
ffffffffc0203624:	63050513          	addi	a0,a0,1584 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203628:	d4dfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020362c:	00002697          	auipc	a3,0x2
ffffffffc0203630:	65468693          	addi	a3,a3,1620 # ffffffffc0205c80 <default_pmm_manager+0xb60>
ffffffffc0203634:	00001617          	auipc	a2,0x1
ffffffffc0203638:	73c60613          	addi	a2,a2,1852 # ffffffffc0204d70 <commands+0x738>
ffffffffc020363c:	07b00593          	li	a1,123
ffffffffc0203640:	00002517          	auipc	a0,0x2
ffffffffc0203644:	61050513          	addi	a0,a0,1552 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203648:	d2dfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020364c <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc020364c:	1141                	addi	sp,sp,-16
ffffffffc020364e:	e022                	sd	s0,0(sp)
ffffffffc0203650:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203652:	6508                	ld	a0,8(a0)
ffffffffc0203654:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203656:	00a40e63          	beq	s0,a0,ffffffffc0203672 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc020365a:	6118                	ld	a4,0(a0)
ffffffffc020365c:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020365e:	03000593          	li	a1,48
ffffffffc0203662:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203664:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203666:	e398                	sd	a4,0(a5)
ffffffffc0203668:	9caff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020366c:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020366e:	fea416e3          	bne	s0,a0,ffffffffc020365a <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203672:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203674:	6402                	ld	s0,0(sp)
...
ffffffffc020367c:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020367e:	9b4ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203682 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203682:	715d                	addi	sp,sp,-80
ffffffffc0203684:	e486                	sd	ra,72(sp)
ffffffffc0203686:	f44e                	sd	s3,40(sp)
ffffffffc0203688:	f052                	sd	s4,32(sp)
ffffffffc020368a:	e0a2                	sd	s0,64(sp)
ffffffffc020368c:	fc26                	sd	s1,56(sp)
ffffffffc020368e:	f84a                	sd	s2,48(sp)
ffffffffc0203690:	ec56                	sd	s5,24(sp)
ffffffffc0203692:	e85a                	sd	s6,16(sp)
ffffffffc0203694:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203696:	ffdfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020369a:	89aa                	mv	s3,a0
...
ffffffffc02036a0:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02036a2:	03000513          	li	a0,48
ffffffffc02036a6:	8d2ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036aa:	56050863          	beqz	a0,ffffffffc0203c1a <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc02036ae:	e508                	sd	a0,8(a0)
ffffffffc02036b0:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02036b2:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02036b6:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02036ba:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036be:	0000e797          	auipc	a5,0xe
ffffffffc02036c2:	e927a783          	lw	a5,-366(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02036c6:	84aa                	mv	s1,a0
ffffffffc02036c8:	e7b9                	bnez	a5,ffffffffc0203716 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036ca:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036ce:	03200413          	li	s0,50
ffffffffc02036d2:	a811                	j	ffffffffc02036e6 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036d4:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036d6:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036d8:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036dc:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036de:	8526                	mv	a0,s1
ffffffffc02036e0:	e9dff0ef          	jal	ra,ffffffffc020357c <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036e4:	cc05                	beqz	s0,ffffffffc020371c <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036e6:	03000513          	li	a0,48
ffffffffc02036ea:	88eff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036ee:	85aa                	mv	a1,a0
ffffffffc02036f0:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036f4:	f165                	bnez	a0,ffffffffc02036d4 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036f6:	00002697          	auipc	a3,0x2
ffffffffc02036fa:	15a68693          	addi	a3,a3,346 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc02036fe:	00001617          	auipc	a2,0x1
ffffffffc0203702:	67260613          	addi	a2,a2,1650 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203706:	0ce00593          	li	a1,206
ffffffffc020370a:	00002517          	auipc	a0,0x2
ffffffffc020370e:	54650513          	addi	a0,a0,1350 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203712:	c63fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203716:	86fff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc020371a:	bf55                	j	ffffffffc02036ce <vmm_init+0x4c>
ffffffffc020371c:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203720:	1f900913          	li	s2,505
ffffffffc0203724:	a819                	j	ffffffffc020373a <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203726:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203728:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020372a:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020372e:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203730:	8526                	mv	a0,s1
ffffffffc0203732:	e4bff0ef          	jal	ra,ffffffffc020357c <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203736:	03240a63          	beq	s0,s2,ffffffffc020376a <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020373a:	03000513          	li	a0,48
ffffffffc020373e:	83aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203742:	85aa                	mv	a1,a0
ffffffffc0203744:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203748:	fd79                	bnez	a0,ffffffffc0203726 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc020374a:	00002697          	auipc	a3,0x2
ffffffffc020374e:	10668693          	addi	a3,a3,262 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203752:	00001617          	auipc	a2,0x1
ffffffffc0203756:	61e60613          	addi	a2,a2,1566 # ffffffffc0204d70 <commands+0x738>
ffffffffc020375a:	0d400593          	li	a1,212
ffffffffc020375e:	00002517          	auipc	a0,0x2
ffffffffc0203762:	4f250513          	addi	a0,a0,1266 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203766:	c0ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc020376a:	649c                	ld	a5,8(s1)
ffffffffc020376c:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020376e:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203772:	2ef48463          	beq	s1,a5,ffffffffc0203a5a <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203776:	fe87b603          	ld	a2,-24(a5)
ffffffffc020377a:	ffe70693          	addi	a3,a4,-2
ffffffffc020377e:	26d61e63          	bne	a2,a3,ffffffffc02039fa <vmm_init+0x378>
ffffffffc0203782:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203786:	26e69a63          	bne	a3,a4,ffffffffc02039fa <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc020378a:	0715                	addi	a4,a4,5
ffffffffc020378c:	679c                	ld	a5,8(a5)
ffffffffc020378e:	feb712e3          	bne	a4,a1,ffffffffc0203772 <vmm_init+0xf0>
ffffffffc0203792:	4b1d                	li	s6,7
ffffffffc0203794:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203796:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc020379a:	85a2                	mv	a1,s0
ffffffffc020379c:	8526                	mv	a0,s1
ffffffffc020379e:	d9fff0ef          	jal	ra,ffffffffc020353c <find_vma>
ffffffffc02037a2:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037a4:	2c050b63          	beqz	a0,ffffffffc0203a7a <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037a8:	00140593          	addi	a1,s0,1
ffffffffc02037ac:	8526                	mv	a0,s1
ffffffffc02037ae:	d8fff0ef          	jal	ra,ffffffffc020353c <find_vma>
ffffffffc02037b2:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037b4:	2e050363          	beqz	a0,ffffffffc0203a9a <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037b8:	85da                	mv	a1,s6
ffffffffc02037ba:	8526                	mv	a0,s1
ffffffffc02037bc:	d81ff0ef          	jal	ra,ffffffffc020353c <find_vma>
        assert(vma3 == NULL);
ffffffffc02037c0:	2e051d63          	bnez	a0,ffffffffc0203aba <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037c4:	00340593          	addi	a1,s0,3
ffffffffc02037c8:	8526                	mv	a0,s1
ffffffffc02037ca:	d73ff0ef          	jal	ra,ffffffffc020353c <find_vma>
        assert(vma4 == NULL);
ffffffffc02037ce:	30051663          	bnez	a0,ffffffffc0203ada <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037d2:	00440593          	addi	a1,s0,4
ffffffffc02037d6:	8526                	mv	a0,s1
ffffffffc02037d8:	d65ff0ef          	jal	ra,ffffffffc020353c <find_vma>
        assert(vma5 == NULL);
ffffffffc02037dc:	30051f63          	bnez	a0,ffffffffc0203afa <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037e0:	00893783          	ld	a5,8(s2)
ffffffffc02037e4:	24879b63          	bne	a5,s0,ffffffffc0203a3a <vmm_init+0x3b8>
ffffffffc02037e8:	01093783          	ld	a5,16(s2)
ffffffffc02037ec:	25679763          	bne	a5,s6,ffffffffc0203a3a <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037f0:	008ab783          	ld	a5,8(s5)
ffffffffc02037f4:	22879363          	bne	a5,s0,ffffffffc0203a1a <vmm_init+0x398>
ffffffffc02037f8:	010ab783          	ld	a5,16(s5)
ffffffffc02037fc:	21679f63          	bne	a5,s6,ffffffffc0203a1a <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203800:	0415                	addi	s0,s0,5
ffffffffc0203802:	0b15                	addi	s6,s6,5
ffffffffc0203804:	f9741be3          	bne	s0,s7,ffffffffc020379a <vmm_init+0x118>
ffffffffc0203808:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc020380a:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020380c:	85a2                	mv	a1,s0
ffffffffc020380e:	8526                	mv	a0,s1
ffffffffc0203810:	d2dff0ef          	jal	ra,ffffffffc020353c <find_vma>
ffffffffc0203814:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203818:	c90d                	beqz	a0,ffffffffc020384a <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc020381a:	6914                	ld	a3,16(a0)
ffffffffc020381c:	6510                	ld	a2,8(a0)
ffffffffc020381e:	00002517          	auipc	a0,0x2
ffffffffc0203822:	5a250513          	addi	a0,a0,1442 # ffffffffc0205dc0 <default_pmm_manager+0xca0>
ffffffffc0203826:	895fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020382a:	00002697          	auipc	a3,0x2
ffffffffc020382e:	5be68693          	addi	a3,a3,1470 # ffffffffc0205de8 <default_pmm_manager+0xcc8>
ffffffffc0203832:	00001617          	auipc	a2,0x1
ffffffffc0203836:	53e60613          	addi	a2,a2,1342 # ffffffffc0204d70 <commands+0x738>
ffffffffc020383a:	0f600593          	li	a1,246
ffffffffc020383e:	00002517          	auipc	a0,0x2
ffffffffc0203842:	41250513          	addi	a0,a0,1042 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203846:	b2ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc020384a:	147d                	addi	s0,s0,-1
ffffffffc020384c:	fd2410e3          	bne	s0,s2,ffffffffc020380c <vmm_init+0x18a>
ffffffffc0203850:	a811                	j	ffffffffc0203864 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
...
ffffffffc0203860:	fd3fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203864:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203866:	fea496e3          	bne	s1,a0,ffffffffc0203852 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020386a:	03000593          	li	a1,48
ffffffffc020386e:	8526                	mv	a0,s1
ffffffffc0203870:	fc3fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }
...
ffffffffc0203878:	3caa1163          	bne	s4,a0,ffffffffc0203c3a <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020387c:	00002517          	auipc	a0,0x2
ffffffffc0203880:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205e28 <default_pmm_manager+0xd08>
ffffffffc0203884:	837fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203888:	e0bfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020388c:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020388e:	03000513          	li	a0,48
ffffffffc0203892:	ee7fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203896:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203898:	2a050163          	beqz	a0,ffffffffc0203b3a <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020389c:	0000e797          	auipc	a5,0xe
ffffffffc02038a0:	cb47a783          	lw	a5,-844(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02038a4:	e508                	sd	a0,8(a0)
ffffffffc02038a6:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02038a8:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02038ac:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038b0:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038b4:	14079063          	bnez	a5,ffffffffc02039f4 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038b8:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038bc:	0000e917          	auipc	s2,0xe
ffffffffc02038c0:	c5c93903          	ld	s2,-932(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038c4:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038c8:	0000e717          	auipc	a4,0xe
ffffffffc02038cc:	c8873c23          	sd	s0,-872(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038d0:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038d4:	24079363          	bnez	a5,ffffffffc0203b1a <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038d8:	03000513          	li	a0,48
ffffffffc02038dc:	e9dfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038e0:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038e2:	28050063          	beqz	a0,ffffffffc0203b62 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038e6:	002007b7          	lui	a5,0x200
ffffffffc02038ea:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038ee:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02038f0:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038f2:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038f6:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038f8:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038fc:	c81ff0ef          	jal	ra,ffffffffc020357c <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc0203900:	10000593          	li	a1,256
ffffffffc0203904:	8522                	mv	a0,s0
ffffffffc0203906:	c37ff0ef          	jal	ra,ffffffffc020353c <find_vma>
ffffffffc020390a:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc020390e:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203912:	26aa1863          	bne	s4,a0,ffffffffc0203b82 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203916:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc020391a:	0785                	addi	a5,a5,1
ffffffffc020391c:	fee79de3          	bne	a5,a4,ffffffffc0203916 <vmm_init+0x294>
        sum += i;
ffffffffc0203920:	6705                	lui	a4,0x1
ffffffffc0203922:	10000793          	li	a5,256
ffffffffc0203926:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc020392a:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc020392e:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203932:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203934:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203936:	fec79ce3          	bne	a5,a2,ffffffffc020392e <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc020393a:	26071463          	bnez	a4,ffffffffc0203ba2 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc020393e:	4581                	li	a1,0
ffffffffc0203940:	854a                	mv	a0,s2
ffffffffc0203942:	fdbfd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203946:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc020394a:	0000e717          	auipc	a4,0xe
ffffffffc020394e:	bd673703          	ld	a4,-1066(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203952:	078a                	slli	a5,a5,0x2
ffffffffc0203954:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203956:	26e7f663          	bgeu	a5,a4,ffffffffc0203bc2 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc020395a:	00003717          	auipc	a4,0x3
ffffffffc020395e:	89673703          	ld	a4,-1898(a4) # ffffffffc02061f0 <nbase>
ffffffffc0203962:	8f99                	sub	a5,a5,a4
ffffffffc0203964:	00379713          	slli	a4,a5,0x3
ffffffffc0203968:	97ba                	add	a5,a5,a4
ffffffffc020396a:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc020396c:	0000e517          	auipc	a0,0xe
ffffffffc0203970:	bbc53503          	ld	a0,-1092(a0) # ffffffffc0211528 <pages>
ffffffffc0203974:	953e                	add	a0,a0,a5
ffffffffc0203976:	4585                	li	a1,1
ffffffffc0203978:	cdbfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc020397c:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc020397e:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203982:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203986:	00a40e63          	beq	s0,a0,ffffffffc02039a2 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc020398a:	6118                	ld	a4,0(a0)
ffffffffc020398c:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020398e:	03000593          	li	a1,48
ffffffffc0203992:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203994:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203996:	e398                	sd	a4,0(a5)
ffffffffc0203998:	e9bfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020399c:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020399e:	fea416e3          	bne	s0,a0,ffffffffc020398a <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02039a2:	03000593          	li	a1,48
ffffffffc02039a6:	8522                	mv	a0,s0
ffffffffc02039a8:	e8bfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc02039ac:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039ae:	0000e797          	auipc	a5,0xe
ffffffffc02039b2:	ba07b923          	sd	zero,-1102(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039b6:	cddfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02039ba:	22a49063          	bne	s1,a0,ffffffffc0203bda <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039be:	00002517          	auipc	a0,0x2
ffffffffc02039c2:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205e78 <default_pmm_manager+0xd58>
ffffffffc02039c6:	ef4fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039ca:	cc9fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc02039ce:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039d0:	22a99563          	bne	s3,a0,ffffffffc0203bfa <vmm_init+0x578>
}
ffffffffc02039d4:	6406                	ld	s0,64(sp)
ffffffffc02039d6:	60a6                	ld	ra,72(sp)
ffffffffc02039d8:	74e2                	ld	s1,56(sp)
ffffffffc02039da:	7942                	ld	s2,48(sp)
ffffffffc02039dc:	79a2                	ld	s3,40(sp)
ffffffffc02039de:	7a02                	ld	s4,32(sp)
ffffffffc02039e0:	6ae2                	ld	s5,24(sp)
ffffffffc02039e2:	6b42                	ld	s6,16(sp)
ffffffffc02039e4:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039e6:	00002517          	auipc	a0,0x2
ffffffffc02039ea:	4b250513          	addi	a0,a0,1202 # ffffffffc0205e98 <default_pmm_manager+0xd78>
}
ffffffffc02039ee:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039f0:	ecafc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039f4:	d90ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039f8:	b5d1                	j	ffffffffc02038bc <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039fa:	00002697          	auipc	a3,0x2
ffffffffc02039fe:	2de68693          	addi	a3,a3,734 # ffffffffc0205cd8 <default_pmm_manager+0xbb8>
ffffffffc0203a02:	00001617          	auipc	a2,0x1
ffffffffc0203a06:	36e60613          	addi	a2,a2,878 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a0a:	0dd00593          	li	a1,221
ffffffffc0203a0e:	00002517          	auipc	a0,0x2
ffffffffc0203a12:	24250513          	addi	a0,a0,578 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203a16:	95ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a1a:	00002697          	auipc	a3,0x2
ffffffffc0203a1e:	37668693          	addi	a3,a3,886 # ffffffffc0205d90 <default_pmm_manager+0xc70>
ffffffffc0203a22:	00001617          	auipc	a2,0x1
ffffffffc0203a26:	34e60613          	addi	a2,a2,846 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a2a:	0ee00593          	li	a1,238
ffffffffc0203a2e:	00002517          	auipc	a0,0x2
ffffffffc0203a32:	22250513          	addi	a0,a0,546 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203a36:	93ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a3a:	00002697          	auipc	a3,0x2
ffffffffc0203a3e:	32668693          	addi	a3,a3,806 # ffffffffc0205d60 <default_pmm_manager+0xc40>
ffffffffc0203a42:	00001617          	auipc	a2,0x1
ffffffffc0203a46:	32e60613          	addi	a2,a2,814 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a4a:	0ed00593          	li	a1,237
ffffffffc0203a4e:	00002517          	auipc	a0,0x2
ffffffffc0203a52:	20250513          	addi	a0,a0,514 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203a56:	91ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a5a:	00002697          	auipc	a3,0x2
ffffffffc0203a5e:	26668693          	addi	a3,a3,614 # ffffffffc0205cc0 <default_pmm_manager+0xba0>
ffffffffc0203a62:	00001617          	auipc	a2,0x1
ffffffffc0203a66:	30e60613          	addi	a2,a2,782 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a6a:	0db00593          	li	a1,219
ffffffffc0203a6e:	00002517          	auipc	a0,0x2
ffffffffc0203a72:	1e250513          	addi	a0,a0,482 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203a76:	8fffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a7a:	00002697          	auipc	a3,0x2
ffffffffc0203a7e:	29668693          	addi	a3,a3,662 # ffffffffc0205d10 <default_pmm_manager+0xbf0>
ffffffffc0203a82:	00001617          	auipc	a2,0x1
ffffffffc0203a86:	2ee60613          	addi	a2,a2,750 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a8a:	0e300593          	li	a1,227
ffffffffc0203a8e:	00002517          	auipc	a0,0x2
ffffffffc0203a92:	1c250513          	addi	a0,a0,450 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203a96:	8dffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a9a:	00002697          	auipc	a3,0x2
ffffffffc0203a9e:	28668693          	addi	a3,a3,646 # ffffffffc0205d20 <default_pmm_manager+0xc00>
ffffffffc0203aa2:	00001617          	auipc	a2,0x1
ffffffffc0203aa6:	2ce60613          	addi	a2,a2,718 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203aaa:	0e500593          	li	a1,229
ffffffffc0203aae:	00002517          	auipc	a0,0x2
ffffffffc0203ab2:	1a250513          	addi	a0,a0,418 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203ab6:	8bffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203aba:	00002697          	auipc	a3,0x2
ffffffffc0203abe:	27668693          	addi	a3,a3,630 # ffffffffc0205d30 <default_pmm_manager+0xc10>
ffffffffc0203ac2:	00001617          	auipc	a2,0x1
ffffffffc0203ac6:	2ae60613          	addi	a2,a2,686 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203aca:	0e700593          	li	a1,231
ffffffffc0203ace:	00002517          	auipc	a0,0x2
ffffffffc0203ad2:	18250513          	addi	a0,a0,386 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203ad6:	89ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ada:	00002697          	auipc	a3,0x2
ffffffffc0203ade:	26668693          	addi	a3,a3,614 # ffffffffc0205d40 <default_pmm_manager+0xc20>
ffffffffc0203ae2:	00001617          	auipc	a2,0x1
ffffffffc0203ae6:	28e60613          	addi	a2,a2,654 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203aea:	0e900593          	li	a1,233
ffffffffc0203aee:	00002517          	auipc	a0,0x2
ffffffffc0203af2:	16250513          	addi	a0,a0,354 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203af6:	87ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203afa:	00002697          	auipc	a3,0x2
ffffffffc0203afe:	25668693          	addi	a3,a3,598 # ffffffffc0205d50 <default_pmm_manager+0xc30>
ffffffffc0203b02:	00001617          	auipc	a2,0x1
ffffffffc0203b06:	26e60613          	addi	a2,a2,622 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b0a:	0eb00593          	li	a1,235
ffffffffc0203b0e:	00002517          	auipc	a0,0x2
ffffffffc0203b12:	14250513          	addi	a0,a0,322 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203b16:	85ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b1a:	00002697          	auipc	a3,0x2
ffffffffc0203b1e:	d2668693          	addi	a3,a3,-730 # ffffffffc0205840 <default_pmm_manager+0x720>
ffffffffc0203b22:	00001617          	auipc	a2,0x1
ffffffffc0203b26:	24e60613          	addi	a2,a2,590 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b2a:	10d00593          	li	a1,269
ffffffffc0203b2e:	00002517          	auipc	a0,0x2
ffffffffc0203b32:	12250513          	addi	a0,a0,290 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203b36:	83ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b3a:	00002697          	auipc	a3,0x2
ffffffffc0203b3e:	37668693          	addi	a3,a3,886 # ffffffffc0205eb0 <default_pmm_manager+0xd90>
ffffffffc0203b42:	00001617          	auipc	a2,0x1
ffffffffc0203b46:	22e60613          	addi	a2,a2,558 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b4a:	10a00593          	li	a1,266
ffffffffc0203b4e:	00002517          	auipc	a0,0x2
ffffffffc0203b52:	10250513          	addi	a0,a0,258 # ffffffffc0205c50 <default_pmm_manager+0xb30>
    check_mm_struct = mm_create();
ffffffffc0203b56:	0000e797          	auipc	a5,0xe
ffffffffc0203b5a:	a007b523          	sd	zero,-1526(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b5e:	817fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b62:	00002697          	auipc	a3,0x2
ffffffffc0203b66:	cee68693          	addi	a3,a3,-786 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203b6a:	00001617          	auipc	a2,0x1
ffffffffc0203b6e:	20660613          	addi	a2,a2,518 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b72:	11100593          	li	a1,273
ffffffffc0203b76:	00002517          	auipc	a0,0x2
ffffffffc0203b7a:	0da50513          	addi	a0,a0,218 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203b7e:	ff6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b82:	00002697          	auipc	a3,0x2
ffffffffc0203b86:	2c668693          	addi	a3,a3,710 # ffffffffc0205e48 <default_pmm_manager+0xd28>
ffffffffc0203b8a:	00001617          	auipc	a2,0x1
ffffffffc0203b8e:	1e660613          	addi	a2,a2,486 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b92:	11600593          	li	a1,278
ffffffffc0203b96:	00002517          	auipc	a0,0x2
ffffffffc0203b9a:	0ba50513          	addi	a0,a0,186 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203b9e:	fd6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ba2:	00002697          	auipc	a3,0x2
ffffffffc0203ba6:	2c668693          	addi	a3,a3,710 # ffffffffc0205e68 <default_pmm_manager+0xd48>
ffffffffc0203baa:	00001617          	auipc	a2,0x1
ffffffffc0203bae:	1c660613          	addi	a2,a2,454 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203bb2:	12000593          	li	a1,288
ffffffffc0203bb6:	00002517          	auipc	a0,0x2
ffffffffc0203bba:	09a50513          	addi	a0,a0,154 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203bbe:	fb6fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bc2:	00001617          	auipc	a2,0x1
ffffffffc0203bc6:	59660613          	addi	a2,a2,1430 # ffffffffc0205158 <default_pmm_manager+0x38>
ffffffffc0203bca:	06500593          	li	a1,101
ffffffffc0203bce:	00001517          	auipc	a0,0x1
ffffffffc0203bd2:	5aa50513          	addi	a0,a0,1450 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203bd6:	f9efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bda:	00002697          	auipc	a3,0x2
ffffffffc0203bde:	22668693          	addi	a3,a3,550 # ffffffffc0205e00 <default_pmm_manager+0xce0>
ffffffffc0203be2:	00001617          	auipc	a2,0x1
ffffffffc0203be6:	18e60613          	addi	a2,a2,398 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203bea:	12e00593          	li	a1,302
ffffffffc0203bee:	00002517          	auipc	a0,0x2
ffffffffc0203bf2:	06250513          	addi	a0,a0,98 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203bf6:	f7efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bfa:	00002697          	auipc	a3,0x2
ffffffffc0203bfe:	20668693          	addi	a3,a3,518 # ffffffffc0205e00 <default_pmm_manager+0xce0>
ffffffffc0203c02:	00001617          	auipc	a2,0x1
ffffffffc0203c06:	16e60613          	addi	a2,a2,366 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c0a:	0bd00593          	li	a1,189
ffffffffc0203c0e:	00002517          	auipc	a0,0x2
ffffffffc0203c12:	04250513          	addi	a0,a0,66 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203c16:	f5efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c1a:	00002697          	auipc	a3,0x2
ffffffffc0203c1e:	bfe68693          	addi	a3,a3,-1026 # ffffffffc0205818 <default_pmm_manager+0x6f8>
ffffffffc0203c22:	00001617          	auipc	a2,0x1
ffffffffc0203c26:	14e60613          	addi	a2,a2,334 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c2a:	0c700593          	li	a1,199
ffffffffc0203c2e:	00002517          	auipc	a0,0x2
ffffffffc0203c32:	02250513          	addi	a0,a0,34 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203c36:	f3efc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c3a:	00002697          	auipc	a3,0x2
ffffffffc0203c3e:	1c668693          	addi	a3,a3,454 # ffffffffc0205e00 <default_pmm_manager+0xce0>
ffffffffc0203c42:	00001617          	auipc	a2,0x1
ffffffffc0203c46:	12e60613          	addi	a2,a2,302 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c4a:	0fb00593          	li	a1,251
ffffffffc0203c4e:	00002517          	auipc	a0,0x2
ffffffffc0203c52:	00250513          	addi	a0,a0,2 # ffffffffc0205c50 <default_pmm_manager+0xb30>
ffffffffc0203c56:	f1efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c5a <do_pgfault>:
...
ffffffffc0203c5a:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c5c:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c5e:	f022                	sd	s0,32(sp)
ffffffffc0203c60:	ec26                	sd	s1,24(sp)
ffffffffc0203c62:	f406                	sd	ra,40(sp)
ffffffffc0203c64:	e84a                	sd	s2,16(sp)
ffffffffc0203c66:	8432                	mv	s0,a2
ffffffffc0203c68:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c6a:	8d3ff0ef          	jal	ra,ffffffffc020353c <find_vma>

    pgfault_num++;
ffffffffc0203c6e:	0000e797          	auipc	a5,0xe
ffffffffc0203c72:	8fa7a783          	lw	a5,-1798(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c76:	2785                	addiw	a5,a5,1
ffffffffc0203c78:	0000e717          	auipc	a4,0xe
ffffffffc0203c7c:	8ef72823          	sw	a5,-1808(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c80:	c159                	beqz	a0,ffffffffc0203d06 <do_pgfault+0xac>
ffffffffc0203c82:	651c                	ld	a5,8(a0)
ffffffffc0203c84:	08f46163          	bltu	s0,a5,ffffffffc0203d06 <do_pgfault+0xac>
...
ffffffffc0203c88:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c8a:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c8c:	8b89                	andi	a5,a5,2
ffffffffc0203c8e:	ebb1                	bnez	a5,ffffffffc0203ce2 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c90:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c92:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c94:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c96:	85a2                	mv	a1,s0
ffffffffc0203c98:	4605                	li	a2,1
ffffffffc0203c9a:	a33fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203c9e:	610c                	ld	a1,0(a0)
ffffffffc0203ca0:	c1b9                	beqz	a1,ffffffffc0203ce6 <do_pgfault+0x8c>
...
ffffffffc0203ca6:	8ae7a783          	lw	a5,-1874(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203caa:	c7bd                	beqz	a5,ffffffffc0203d18 <do_pgfault+0xbe>
...
ffffffffc0203cae:	0030                	addi	a2,sp,8
ffffffffc0203cb0:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203cb2:	e402                	sd	zero,8(sp)
             swap_in(mm,addr,&page);
ffffffffc0203cb4:	bfcff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
             page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203cb8:	65a2                	ld	a1,8(sp)
ffffffffc0203cba:	6c88                	ld	a0,24(s1)
ffffffffc0203cbc:	86ca                	mv	a3,s2
ffffffffc0203cbe:	8622                	mv	a2,s0
ffffffffc0203cc0:	cf7fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
             swap_map_swappable(mm,addr,page,1);
ffffffffc0203cc4:	6622                	ld	a2,8(sp)
ffffffffc0203cc6:	4685                	li	a3,1
ffffffffc0203cc8:	85a2                	mv	a1,s0
ffffffffc0203cca:	8526                	mv	a0,s1
ffffffffc0203ccc:	ac4ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
		
            page->pra_vaddr = addr;
ffffffffc0203cd0:	67a2                	ld	a5,8(sp)
...
ffffffffc0203cd2:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203cd4:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
ffffffffc0203cd6:	70a2                	ld	ra,40(sp)
...
ffffffffc0203ce4:	b775                	j	ffffffffc0203c90 <do_pgfault+0x36>
...
ffffffffc0203cf2:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cf4:	f3ed                	bnez	a5,ffffffffc0203cd6 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cf6:	00002517          	auipc	a0,0x2
ffffffffc0203cfa:	20250513          	addi	a0,a0,514 # ffffffffc0205ef8 <default_pmm_manager+0xdd8>
ffffffffc0203cfe:	bbcfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d02:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d04:	bfc9                	j	ffffffffc0203cd6 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d06:	85a2                	mv	a1,s0
ffffffffc0203d08:	00002517          	auipc	a0,0x2
ffffffffc0203d0c:	1c050513          	addi	a0,a0,448 # ffffffffc0205ec8 <default_pmm_manager+0xda8>
ffffffffc0203d10:	baafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d14:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d16:	b7c1                	j	ffffffffc0203cd6 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d18:	00002517          	auipc	a0,0x2
ffffffffc0203d1c:	20850513          	addi	a0,a0,520 # ffffffffc0205f20 <default_pmm_manager+0xe00>
ffffffffc0203d20:	b9afc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d24:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d26:	bf45                	j	ffffffffc0203cd6 <do_pgfault+0x7c>

ffffffffc0203d28 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
swapfs_init(void) {
ffffffffc0203d2c:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d2e:	f66fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d32:	cd01                	beqz	a0,ffffffffc0203d4a <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE); //得到最大的可用交换页数
ffffffffc0203d34:	4505                	li	a0,1
ffffffffc0203d36:	f64fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d3a:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE); //得到最大的可用交换页数
ffffffffc0203d3c:	810d                	srli	a0,a0,0x3
ffffffffc0203d3e:	0000e797          	auipc	a5,0xe
ffffffffc0203d42:	80a7b123          	sd	a0,-2046(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d46:	0141                	addi	sp,sp,16
ffffffffc0203d48:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d4a:	00002617          	auipc	a2,0x2
ffffffffc0203d4e:	1fe60613          	addi	a2,a2,510 # ffffffffc0205f48 <default_pmm_manager+0xe28>
ffffffffc0203d52:	45b5                	li	a1,13
ffffffffc0203d54:	00002517          	auipc	a0,0x2
ffffffffc0203d58:	21450513          	addi	a0,a0,532 # ffffffffc0205f68 <default_pmm_manager+0xe48>
ffffffffc0203d5c:	e18fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d60 <swapfs_read>:
...
ffffffffc0203d64:	00855793          	srli	a5,a0,0x8
ffffffffc0203d68:	c3a5                	beqz	a5,ffffffffc0203dc8 <swapfs_read+0x68>
ffffffffc0203d6a:	0000d717          	auipc	a4,0xd
ffffffffc0203d6e:	7d673703          	ld	a4,2006(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d72:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dc8 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d76:	0000d617          	auipc	a2,0xd
ffffffffc0203d7a:	7b263603          	ld	a2,1970(a2) # ffffffffc0211528 <pages>
ffffffffc0203d7e:	8d91                	sub	a1,a1,a2
ffffffffc0203d80:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d84:	00002597          	auipc	a1,0x2
ffffffffc0203d88:	4645b583          	ld	a1,1124(a1) # ffffffffc02061e8 <error_string+0x38>
ffffffffc0203d8c:	02b60633          	mul	a2,a2,a1
ffffffffc0203d90:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d94:	00002797          	auipc	a5,0x2
ffffffffc0203d98:	45c7b783          	ld	a5,1116(a5) # ffffffffc02061f0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d9c:	0000d717          	auipc	a4,0xd
ffffffffc0203da0:	78473703          	ld	a4,1924(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203da4:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203da6:	00c61793          	slli	a5,a2,0xc
ffffffffc0203daa:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203dac:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dae:	02e7f963          	bgeu	a5,a4,ffffffffc0203de0 <swapfs_read+0x80>
}
ffffffffc0203db2:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203db4:	0000d797          	auipc	a5,0xd
ffffffffc0203db8:	7847b783          	ld	a5,1924(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203dbc:	46a1                	li	a3,8
ffffffffc0203dbe:	963e                	add	a2,a2,a5
ffffffffc0203dc0:	4505                	li	a0,1
}
ffffffffc0203dc2:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dc4:	edcfc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dc8:	86aa                	mv	a3,a0
ffffffffc0203dca:	00002617          	auipc	a2,0x2
ffffffffc0203dce:	1b660613          	addi	a2,a2,438 # ffffffffc0205f80 <default_pmm_manager+0xe60>
ffffffffc0203dd2:	45d1                	li	a1,20
ffffffffc0203dd4:	00002517          	auipc	a0,0x2
ffffffffc0203dd8:	19450513          	addi	a0,a0,404 # ffffffffc0205f68 <default_pmm_manager+0xe48>
ffffffffc0203ddc:	d98fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203de0:	86b2                	mv	a3,a2
ffffffffc0203de2:	06a00593          	li	a1,106
ffffffffc0203de6:	00001617          	auipc	a2,0x1
ffffffffc0203dea:	3ca60613          	addi	a2,a2,970 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0203dee:	00001517          	auipc	a0,0x1
ffffffffc0203df2:	38a50513          	addi	a0,a0,906 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203df6:	d7efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203dfa <swapfs_write>:
...
ffffffffc0203e02:	c3a5                	beqz	a5,ffffffffc0203e62 <swapfs_write+0x68>
ffffffffc0203e04:	0000d717          	auipc	a4,0xd
ffffffffc0203e08:	73c73703          	ld	a4,1852(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e0c:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e62 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203e22:	3ca5b583          	ld	a1,970(a1) # ffffffffc02061e8 <error_string+0x38>
ffffffffc0203e26:	02b60633          	mul	a2,a2,a1
ffffffffc0203e2a:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e2e:	00002797          	auipc	a5,0x2
ffffffffc0203e32:	3c27b783          	ld	a5,962(a5) # ffffffffc02061f0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e48:	02e7f963          	bgeu	a5,a4,ffffffffc0203e7a <swapfs_write+0x80>
}
...
ffffffffc0203e5c:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e5e:	e66fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e62:	86aa                	mv	a3,a0
ffffffffc0203e64:	00002617          	auipc	a2,0x2
ffffffffc0203e68:	11c60613          	addi	a2,a2,284 # ffffffffc0205f80 <default_pmm_manager+0xe60>
ffffffffc0203e6c:	45e5                	li	a1,25
ffffffffc0203e6e:	00002517          	auipc	a0,0x2
ffffffffc0203e72:	0fa50513          	addi	a0,a0,250 # ffffffffc0205f68 <default_pmm_manager+0xe48>
...
ffffffffc0203e84:	33060613          	addi	a2,a2,816 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0203e88:	00001517          	auipc	a0,0x1
ffffffffc0203e8c:	2f050513          	addi	a0,a0,752 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203e90:	ce4fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e94 <printnum>:
 * */
static void
...
ffffffffc0203e94:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e98:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e9a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e9e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203ea0:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea4:	f022                	sd	s0,32(sp)
ffffffffc0203ea6:	ec26                	sd	s1,24(sp)
ffffffffc0203ea8:	e84a                	sd	s2,16(sp)
ffffffffc0203eaa:	f406                	sd	ra,40(sp)
ffffffffc0203eac:	e44e                	sd	s3,8(sp)
ffffffffc0203eae:	84aa                	mv	s1,a0
ffffffffc0203eb0:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203eb2:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203eb6:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203eb8:	03067e63          	bgeu	a2,a6,ffffffffc0203ef4 <printnum+0x60>
ffffffffc0203ebc:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ebe:	00805763          	blez	s0,ffffffffc0203ecc <printnum+0x38>
ffffffffc0203ec2:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203ec4:	85ca                	mv	a1,s2
ffffffffc0203ec6:	854e                	mv	a0,s3
ffffffffc0203ec8:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203eca:	fc65                	bnez	s0,ffffffffc0203ec2 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ecc:	1a02                	slli	s4,s4,0x20
ffffffffc0203ece:	00002797          	auipc	a5,0x2
ffffffffc0203ed2:	0d278793          	addi	a5,a5,210 # ffffffffc0205fa0 <default_pmm_manager+0xe80>
ffffffffc0203ed6:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203eda:	9a3e                	add	s4,s4,a5
}
ffffffffc0203edc:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ede:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203ee2:	70a2                	ld	ra,40(sp)
ffffffffc0203ee4:	69a2                	ld	s3,8(sp)
ffffffffc0203ee6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ee8:	85ca                	mv	a1,s2
ffffffffc0203eea:	87a6                	mv	a5,s1
}
ffffffffc0203eec:	6942                	ld	s2,16(sp)
ffffffffc0203eee:	64e2                	ld	s1,24(sp)
ffffffffc0203ef0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ef2:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203ef4:	03065633          	divu	a2,a2,a6
ffffffffc0203ef8:	8722                	mv	a4,s0
ffffffffc0203efa:	f9bff0ef          	jal	ra,ffffffffc0203e94 <printnum>
ffffffffc0203efe:	b7f9                	j	ffffffffc0203ecc <printnum+0x38>

ffffffffc0203f00 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f00:	7119                	addi	sp,sp,-128
ffffffffc0203f02:	f4a6                	sd	s1,104(sp)
...
ffffffffc0203f10:	f06a                	sd	s10,32(sp)
ffffffffc0203f12:	fc86                	sd	ra,120(sp)
ffffffffc0203f14:	f8a2                	sd	s0,112(sp)
ffffffffc0203f16:	f862                	sd	s8,48(sp)
ffffffffc0203f18:	f466                	sd	s9,40(sp)
ffffffffc0203f1a:	ec6e                	sd	s11,24(sp)
ffffffffc0203f1c:	892a                	mv	s2,a0
ffffffffc0203f1e:	84ae                	mv	s1,a1
ffffffffc0203f20:	8d32                	mv	s10,a2
ffffffffc0203f22:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f24:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f28:	5b7d                	li	s6,-1
ffffffffc0203f2a:	00002a97          	auipc	s5,0x2
ffffffffc0203f2e:	0aaa8a93          	addi	s5,s5,170 # ffffffffc0205fd4 <default_pmm_manager+0xeb4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f32:	00002b97          	auipc	s7,0x2
ffffffffc0203f36:	27eb8b93          	addi	s7,s7,638 # ffffffffc02061b0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f3a:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f3e:	001d0413          	addi	s0,s10,1
ffffffffc0203f42:	01350a63          	beq	a0,s3,ffffffffc0203f56 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f46:	c121                	beqz	a0,ffffffffc0203f86 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0203f52:	ff351ae3          	bne	a0,s3,ffffffffc0203f46 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f56:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f5a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f5e:	4c81                	li	s9,0
ffffffffc0203f60:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f62:	5c7d                	li	s8,-1
ffffffffc0203f64:	5dfd                	li	s11,-1
ffffffffc0203f66:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f6a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f6c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f70:	0ff5f593          	andi	a1,a1,255
ffffffffc0203f74:	00140d13          	addi	s10,s0,1
ffffffffc0203f78:	04b56263          	bltu	a0,a1,ffffffffc0203fbc <vprintfmt+0xbc>
ffffffffc0203f7c:	058a                	slli	a1,a1,0x2
ffffffffc0203f7e:	95d6                	add	a1,a1,s5
ffffffffc0203f80:	4194                	lw	a3,0(a1)
ffffffffc0203f82:	96d6                	add	a3,a3,s5
...
ffffffffc0203fa2:	8082                	ret
            padc = '0';
ffffffffc0203fa4:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203fa6:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203faa:	846a                	mv	s0,s10
ffffffffc0203fac:	00140d13          	addi	s10,s0,1
ffffffffc0203fb0:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fb4:	0ff5f593          	andi	a1,a1,255
ffffffffc0203fb8:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f7c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203fbc:	85a6                	mv	a1,s1
ffffffffc0203fbe:	02500513          	li	a0,37
ffffffffc0203fc2:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fc4:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fc8:	8d22                	mv	s10,s0
ffffffffc0203fca:	f73788e3          	beq	a5,s3,ffffffffc0203f3a <vprintfmt+0x3a>
ffffffffc0203fce:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fd2:	1d7d                	addi	s10,s10,-1
ffffffffc0203fd4:	ff379de3          	bne	a5,s3,ffffffffc0203fce <vprintfmt+0xce>
ffffffffc0203fd8:	b78d                	j	ffffffffc0203f3a <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fda:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc0203fe4:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fe8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fec:	02d86463          	bltu	a6,a3,ffffffffc0204014 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203ff0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203ff4:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203ff8:	0186873b          	addw	a4,a3,s8
ffffffffc0203ffc:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204000:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204002:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204006:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204008:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020400c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204010:	fed870e3          	bgeu	a6,a3,ffffffffc0203ff0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204014:	f40ddce3          	bgez	s11,ffffffffc0203f6c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204018:	8de2                	mv	s11,s8
ffffffffc020401a:	5c7d                	li	s8,-1
ffffffffc020401c:	bf81                	j	ffffffffc0203f6c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc020401e:	fffdc693          	not	a3,s11
ffffffffc0204022:	96fd                	srai	a3,a3,0x3f
ffffffffc0204024:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204028:	00144603          	lbu	a2,1(s0)
ffffffffc020402c:	2d81                	sext.w	s11,s11
ffffffffc020402e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204030:	bf35                	j	ffffffffc0203f6c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204032:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204036:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc020403a:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020403c:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc020403e:	bfd9                	j	ffffffffc0204014 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204040:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204042:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204046:	01174463          	blt	a4,a7,ffffffffc020404e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020404a:	1a088e63          	beqz	a7,ffffffffc0204206 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020404e:	000a3603          	ld	a2,0(s4)
ffffffffc0204052:	46c1                	li	a3,16
ffffffffc0204054:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204056:	2781                	sext.w	a5,a5
ffffffffc0204058:	876e                	mv	a4,s11
ffffffffc020405a:	85a6                	mv	a1,s1
ffffffffc020405c:	854a                	mv	a0,s2
ffffffffc020405e:	e37ff0ef          	jal	ra,ffffffffc0203e94 <printnum>
            break;
ffffffffc0204062:	bde1                	j	ffffffffc0203f3a <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204064:	000a2503          	lw	a0,0(s4)
ffffffffc0204068:	85a6                	mv	a1,s1
ffffffffc020406a:	0a21                	addi	s4,s4,8
ffffffffc020406c:	9902                	jalr	s2
            break;
ffffffffc020406e:	b5f1                	j	ffffffffc0203f3a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204070:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204072:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204076:	01174463          	blt	a4,a7,ffffffffc020407e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020407a:	18088163          	beqz	a7,ffffffffc02041fc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020407e:	000a3603          	ld	a2,0(s4)
ffffffffc0204082:	46a9                	li	a3,10
ffffffffc0204084:	8a2e                	mv	s4,a1
ffffffffc0204086:	bfc1                	j	ffffffffc0204056 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204088:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020408c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020408e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204090:	bdf1                	j	ffffffffc0203f6c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204092:	85a6                	mv	a1,s1
ffffffffc0204094:	02500513          	li	a0,37
ffffffffc0204098:	9902                	jalr	s2
            break;
ffffffffc020409a:	b545                	j	ffffffffc0203f3a <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020409c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040a0:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040a4:	b5e1                	j	ffffffffc0203f6c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040a6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040a8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040ac:	01174463          	blt	a4,a7,ffffffffc02040b4 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040b0:	14088163          	beqz	a7,ffffffffc02041f2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040b4:	000a3603          	ld	a2,0(s4)
ffffffffc02040b8:	46a1                	li	a3,8
ffffffffc02040ba:	8a2e                	mv	s4,a1
ffffffffc02040bc:	bf69                	j	ffffffffc0204056 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040be:	03000513          	li	a0,48
ffffffffc02040c2:	85a6                	mv	a1,s1
ffffffffc02040c4:	e03e                	sd	a5,0(sp)
ffffffffc02040c6:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040c8:	85a6                	mv	a1,s1
ffffffffc02040ca:	07800513          	li	a0,120
ffffffffc02040ce:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040d0:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040d2:	6782                	ld	a5,0(sp)
ffffffffc02040d4:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040d6:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040da:	bfb5                	j	ffffffffc0204056 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040dc:	000a3403          	ld	s0,0(s4)
ffffffffc02040e0:	008a0713          	addi	a4,s4,8
ffffffffc02040e4:	e03a                	sd	a4,0(sp)
ffffffffc02040e6:	14040263          	beqz	s0,ffffffffc020422a <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040ea:	0fb05763          	blez	s11,ffffffffc02041d8 <vprintfmt+0x2d8>
ffffffffc02040ee:	02d00693          	li	a3,45
ffffffffc02040f2:	0cd79163          	bne	a5,a3,ffffffffc02041b4 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040f6:	00044783          	lbu	a5,0(s0)
ffffffffc02040fa:	0007851b          	sext.w	a0,a5
ffffffffc02040fe:	cf85                	beqz	a5,ffffffffc0204136 <vprintfmt+0x236>
ffffffffc0204100:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204104:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204108:	000c4563          	bltz	s8,ffffffffc0204112 <vprintfmt+0x212>
ffffffffc020410c:	3c7d                	addiw	s8,s8,-1
ffffffffc020410e:	036c0263          	beq	s8,s6,ffffffffc0204132 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204112:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204114:	0e0c8e63          	beqz	s9,ffffffffc0204210 <vprintfmt+0x310>
ffffffffc0204118:	3781                	addiw	a5,a5,-32
ffffffffc020411a:	0ef47b63          	bgeu	s0,a5,ffffffffc0204210 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc020411e:	03f00513          	li	a0,63
ffffffffc0204122:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204124:	000a4783          	lbu	a5,0(s4)
ffffffffc0204128:	3dfd                	addiw	s11,s11,-1
ffffffffc020412a:	0a05                	addi	s4,s4,1
ffffffffc020412c:	0007851b          	sext.w	a0,a5
ffffffffc0204130:	ffe1                	bnez	a5,ffffffffc0204108 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204132:	01b05963          	blez	s11,ffffffffc0204144 <vprintfmt+0x244>
ffffffffc0204136:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204138:	85a6                	mv	a1,s1
ffffffffc020413a:	02000513          	li	a0,32
ffffffffc020413e:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204140:	fe0d9be3          	bnez	s11,ffffffffc0204136 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204144:	6a02                	ld	s4,0(sp)
ffffffffc0204146:	bbd5                	j	ffffffffc0203f3a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204148:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020414a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020414e:	01174463          	blt	a4,a7,ffffffffc0204156 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204152:	08088d63          	beqz	a7,ffffffffc02041ec <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204156:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020415a:	0a044d63          	bltz	s0,ffffffffc0204214 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020415e:	8622                	mv	a2,s0
ffffffffc0204160:	8a66                	mv	s4,s9
ffffffffc0204162:	46a9                	li	a3,10
ffffffffc0204164:	bdcd                	j	ffffffffc0204056 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204166:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020416a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020416c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020416e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204172:	8fb5                	xor	a5,a5,a3
ffffffffc0204174:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204178:	02d74163          	blt	a4,a3,ffffffffc020419a <vprintfmt+0x29a>
ffffffffc020417c:	00369793          	slli	a5,a3,0x3
ffffffffc0204180:	97de                	add	a5,a5,s7
ffffffffc0204182:	639c                	ld	a5,0(a5)
ffffffffc0204184:	cb99                	beqz	a5,ffffffffc020419a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204186:	86be                	mv	a3,a5
ffffffffc0204188:	00002617          	auipc	a2,0x2
ffffffffc020418c:	e4860613          	addi	a2,a2,-440 # ffffffffc0205fd0 <default_pmm_manager+0xeb0>
ffffffffc0204190:	85a6                	mv	a1,s1
ffffffffc0204192:	854a                	mv	a0,s2
ffffffffc0204194:	0ce000ef          	jal	ra,ffffffffc0204262 <printfmt>
ffffffffc0204198:	b34d                	j	ffffffffc0203f3a <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020419a:	00002617          	auipc	a2,0x2
ffffffffc020419e:	e2660613          	addi	a2,a2,-474 # ffffffffc0205fc0 <default_pmm_manager+0xea0>
ffffffffc02041a2:	85a6                	mv	a1,s1
ffffffffc02041a4:	854a                	mv	a0,s2
ffffffffc02041a6:	0bc000ef          	jal	ra,ffffffffc0204262 <printfmt>
ffffffffc02041aa:	bb41                	j	ffffffffc0203f3a <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041ac:	00002417          	auipc	s0,0x2
ffffffffc02041b0:	e0c40413          	addi	s0,s0,-500 # ffffffffc0205fb8 <default_pmm_manager+0xe98>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041b4:	85e2                	mv	a1,s8
ffffffffc02041b6:	8522                	mv	a0,s0
ffffffffc02041b8:	e43e                	sd	a5,8(sp)
ffffffffc02041ba:	196000ef          	jal	ra,ffffffffc0204350 <strnlen>
ffffffffc02041be:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041c2:	01b05b63          	blez	s11,ffffffffc02041d8 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041c6:	67a2                	ld	a5,8(sp)
ffffffffc02041c8:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041cc:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02041ce:	85a6                	mv	a1,s1
ffffffffc02041d0:	8552                	mv	a0,s4
ffffffffc02041d2:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041d4:	fe0d9ce3          	bnez	s11,ffffffffc02041cc <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041d8:	00044783          	lbu	a5,0(s0)
ffffffffc02041dc:	00140a13          	addi	s4,s0,1
ffffffffc02041e0:	0007851b          	sext.w	a0,a5
ffffffffc02041e4:	d3a5                	beqz	a5,ffffffffc0204144 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041e6:	05e00413          	li	s0,94
ffffffffc02041ea:	bf39                	j	ffffffffc0204108 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041ec:	000a2403          	lw	s0,0(s4)
ffffffffc02041f0:	b7ad                	j	ffffffffc020415a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041f2:	000a6603          	lwu	a2,0(s4)
ffffffffc02041f6:	46a1                	li	a3,8
ffffffffc02041f8:	8a2e                	mv	s4,a1
ffffffffc02041fa:	bdb1                	j	ffffffffc0204056 <vprintfmt+0x156>
ffffffffc02041fc:	000a6603          	lwu	a2,0(s4)
ffffffffc0204200:	46a9                	li	a3,10
ffffffffc0204202:	8a2e                	mv	s4,a1
ffffffffc0204204:	bd89                	j	ffffffffc0204056 <vprintfmt+0x156>
ffffffffc0204206:	000a6603          	lwu	a2,0(s4)
ffffffffc020420a:	46c1                	li	a3,16
ffffffffc020420c:	8a2e                	mv	s4,a1
ffffffffc020420e:	b5a1                	j	ffffffffc0204056 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204210:	9902                	jalr	s2
ffffffffc0204212:	bf09                	j	ffffffffc0204124 <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc020421c:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020421e:	6782                	ld	a5,0(sp)
ffffffffc0204220:	8a66                	mv	s4,s9
ffffffffc0204222:	40800633          	neg	a2,s0
ffffffffc0204226:	46a9                	li	a3,10
ffffffffc0204228:	b53d                	j	ffffffffc0204056 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc020422a:	03b05163          	blez	s11,ffffffffc020424c <vprintfmt+0x34c>
ffffffffc020422e:	02d00693          	li	a3,45
ffffffffc0204232:	f6d79de3          	bne	a5,a3,ffffffffc02041ac <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204236:	00002417          	auipc	s0,0x2
ffffffffc020423a:	d8240413          	addi	s0,s0,-638 # ffffffffc0205fb8 <default_pmm_manager+0xe98>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020423e:	02800793          	li	a5,40
ffffffffc0204242:	02800513          	li	a0,40
ffffffffc0204246:	00140a13          	addi	s4,s0,1
ffffffffc020424a:	bd6d                	j	ffffffffc0204104 <vprintfmt+0x204>
ffffffffc020424c:	00002a17          	auipc	s4,0x2
ffffffffc0204250:	d6da0a13          	addi	s4,s4,-659 # ffffffffc0205fb9 <default_pmm_manager+0xe99>
ffffffffc0204254:	02800513          	li	a0,40
ffffffffc0204258:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020425c:	05e00413          	li	s0,94
ffffffffc0204260:	b565                	j	ffffffffc0204108 <vprintfmt+0x208>
...
ffffffffc0204276:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204278:	c89ff0ef          	jal	ra,ffffffffc0203f00 <vprintfmt>
}
...
ffffffffc0204286:	e0a6                	sd	s1,64(sp)
ffffffffc0204288:	fc4a                	sd	s2,56(sp)
ffffffffc020428a:	f84e                	sd	s3,48(sp)
ffffffffc020428c:	f452                	sd	s4,40(sp)
ffffffffc020428e:	f056                	sd	s5,32(sp)
ffffffffc0204290:	ec5a                	sd	s6,24(sp)
ffffffffc0204292:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204294:	c901                	beqz	a0,ffffffffc02042a4 <readline+0x22>
ffffffffc0204296:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204298:	00002517          	auipc	a0,0x2
ffffffffc020429c:	d3850513          	addi	a0,a0,-712 # ffffffffc0205fd0 <default_pmm_manager+0xeb0>
ffffffffc02042a0:	e1bfb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
...
ffffffffc02042b2:	e4ab8b93          	addi	s7,s7,-438 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042b6:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042ba:	e39fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042be:	00054a63          	bltz	a0,ffffffffc02042d2 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042c2:	00a95a63          	bge	s2,a0,ffffffffc02042d6 <readline+0x54>
ffffffffc02042c6:	029a5263          	bge	s4,s1,ffffffffc02042ea <readline+0x68>
        c = getchar();
ffffffffc02042ca:	e29fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042ce:	fe055ae3          	bgez	a0,ffffffffc02042c2 <readline+0x40>
            return NULL;
ffffffffc02042d2:	4501                	li	a0,0
ffffffffc02042d4:	a091                	j	ffffffffc0204318 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042d6:	03351463          	bne	a0,s3,ffffffffc02042fe <readline+0x7c>
ffffffffc02042da:	e8a9                	bnez	s1,ffffffffc020432c <readline+0xaa>
        c = getchar();
ffffffffc02042dc:	e17fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042e0:	fe0549e3          	bltz	a0,ffffffffc02042d2 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042e4:	fea959e3          	bge	s2,a0,ffffffffc02042d6 <readline+0x54>
ffffffffc02042e8:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042ea:	e42a                	sd	a0,8(sp)
ffffffffc02042ec:	e05fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042f0:	6522                	ld	a0,8(sp)
ffffffffc02042f2:	009b87b3          	add	a5,s7,s1
ffffffffc02042f6:	2485                	addiw	s1,s1,1
ffffffffc02042f8:	00a78023          	sb	a0,0(a5)
ffffffffc02042fc:	bf7d                	j	ffffffffc02042ba <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02042fe:	01550463          	beq	a0,s5,ffffffffc0204306 <readline+0x84>
ffffffffc0204302:	fb651ce3          	bne	a0,s6,ffffffffc02042ba <readline+0x38>
            cputchar(c);
ffffffffc0204306:	debfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc020430a:	0000d517          	auipc	a0,0xd
ffffffffc020430e:	dee50513          	addi	a0,a0,-530 # ffffffffc02110f8 <buf>
ffffffffc0204312:	94aa                	add	s1,s1,a0
ffffffffc0204314:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204318:	60a6                	ld	ra,72(sp)
ffffffffc020431a:	6486                	ld	s1,64(sp)
ffffffffc020431c:	7962                	ld	s2,56(sp)
ffffffffc020431e:	79c2                	ld	s3,48(sp)
ffffffffc0204320:	7a22                	ld	s4,40(sp)
ffffffffc0204322:	7a82                	ld	s5,32(sp)
ffffffffc0204324:	6b62                	ld	s6,24(sp)
ffffffffc0204326:	6bc2                	ld	s7,16(sp)
ffffffffc0204328:	6161                	addi	sp,sp,80
ffffffffc020432a:	8082                	ret
            cputchar(c);
ffffffffc020432c:	4521                	li	a0,8
ffffffffc020432e:	dc3fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204332:	34fd                	addiw	s1,s1,-1
ffffffffc0204334:	b759                	j	ffffffffc02042ba <readline+0x38>

ffffffffc0204336 <strlen>:
...
strlen(const char *s) {
ffffffffc020433a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020433c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020433e:	cb81                	beqz	a5,ffffffffc020434e <strlen+0x18>
        cnt ++;
ffffffffc0204340:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204342:	00a707b3          	add	a5,a4,a0
ffffffffc0204346:	0007c783          	lbu	a5,0(a5)
ffffffffc020434a:	fbfd                	bnez	a5,ffffffffc0204340 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204350:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204352:	e589                	bnez	a1,ffffffffc020435c <strnlen+0xc>
ffffffffc0204354:	a811                	j	ffffffffc0204368 <strnlen+0x18>
        cnt ++;
ffffffffc0204356:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204358:	00f58863          	beq	a1,a5,ffffffffc0204368 <strnlen+0x18>
ffffffffc020435c:	00f50733          	add	a4,a0,a5
ffffffffc0204360:	00074703          	lbu	a4,0(a4)
ffffffffc0204364:	fb6d                	bnez	a4,ffffffffc0204356 <strnlen+0x6>
ffffffffc0204366:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204368:	852e                	mv	a0,a1
ffffffffc020436a:	8082                	ret

ffffffffc020436c <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc020436c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020436e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204372:	0785                	addi	a5,a5,1
ffffffffc0204374:	0585                	addi	a1,a1,1
ffffffffc0204376:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020437a:	fb75                	bnez	a4,ffffffffc020436e <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020437e:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204382:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204386:	cb89                	beqz	a5,ffffffffc0204398 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204388:	0505                	addi	a0,a0,1
ffffffffc020438a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020438c:	fee789e3          	beq	a5,a4,ffffffffc020437e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204390:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204394:	9d19                	subw	a0,a0,a4
ffffffffc0204396:	8082                	ret
ffffffffc0204398:	4501                	li	a0,0
ffffffffc020439a:	bfed                	j	ffffffffc0204394 <strcmp+0x16>

ffffffffc020439c <strchr>:
...
ffffffffc02043a0:	c799                	beqz	a5,ffffffffc02043ae <strchr+0x12>
        if (*s == c) {
ffffffffc02043a2:	00f58763          	beq	a1,a5,ffffffffc02043b0 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043a6:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043aa:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043ac:	fbfd                	bnez	a5,ffffffffc02043a2 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043b2:	ca01                	beqz	a2,ffffffffc02043c2 <memset+0x10>
ffffffffc02043b4:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043b6:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043b8:	0785                	addi	a5,a5,1
ffffffffc02043ba:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043be:	fec79de3          	bne	a5,a2,ffffffffc02043b8 <memset+0x6>
    }
    return s;
...
ffffffffc02043c4 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043c4:	ca19                	beqz	a2,ffffffffc02043da <memcpy+0x16>
ffffffffc02043c6:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043c8:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043ca:	0005c703          	lbu	a4,0(a1)
ffffffffc02043ce:	0585                	addi	a1,a1,1
ffffffffc02043d0:	0785                	addi	a5,a5,1
ffffffffc02043d2:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043d6:	fec59ae3          	bne	a1,a2,ffffffffc02043ca <memcpy+0x6>
    }
    return dst;
