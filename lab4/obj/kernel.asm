...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	649040ef          	jal	ra,ffffffffc0204e92 <memset>
...
ffffffffc02000ac:	e6050513          	addi	a0,a0,-416 # ffffffffc0204f08 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	121040ef          	jal	ra,ffffffffc0204a94 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0eb040ef          	jal	ra,ffffffffc0204a94 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d4650513          	addi	a0,a0,-698 # ffffffffc0204f10 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d5050513          	addi	a0,a0,-688 # ffffffffc0204f30 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	cf458593          	addi	a1,a1,-780 # ffffffffc0204ee0 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204f50 <etext+0x70>
...
ffffffffc020020c:	d6850513          	addi	a0,a0,-664 # ffffffffc0204f70 <etext+0x90>
...
ffffffffc0200220:	d7450513          	addi	a0,a0,-652 # ffffffffc0204f90 <etext+0xb0>
...
ffffffffc020024e:	d6650513          	addi	a0,a0,-666 # ffffffffc0204fb0 <etext+0xd0>
}
...
ffffffffc020025c:	d8860613          	addi	a2,a2,-632 # ffffffffc0204fe0 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d9450513          	addi	a0,a0,-620 # ffffffffc0204ff8 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	d9c60613          	addi	a2,a2,-612 # ffffffffc0205010 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	db458593          	addi	a1,a1,-588 # ffffffffc0205030 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	db450513          	addi	a0,a0,-588 # ffffffffc0205038 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	db660613          	addi	a2,a2,-586 # ffffffffc0205048 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dd658593          	addi	a1,a1,-554 # ffffffffc0205070 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d9650513          	addi	a0,a0,-618 # ffffffffc0205038 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dd260613          	addi	a2,a2,-558 # ffffffffc0205080 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dea58593          	addi	a1,a1,-534 # ffffffffc02050a0 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d7a50513          	addi	a0,a0,-646 # ffffffffc0205038 <etext+0x158>
...
ffffffffc02002fc:	db850513          	addi	a0,a0,-584 # ffffffffc02050b0 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	dbe50513          	addi	a0,a0,-578 # ffffffffc02050d8 <etext+0x1f8>
...
ffffffffc0200340:	e0cc0c13          	addi	s8,s8,-500 # ffffffffc0205148 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	dbc90913          	addi	s2,s2,-580 # ffffffffc0205100 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	dbc48493          	addi	s1,s1,-580 # ffffffffc0205108 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	dbab0b13          	addi	s6,s6,-582 # ffffffffc0205110 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cd2a0a13          	addi	s4,s4,-814 # ffffffffc0205030 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	dc8d0d13          	addi	s10,s10,-568 # ffffffffc0205148 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2d1040ef          	jal	ra,ffffffffc0204e5e <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2bd040ef          	jal	ra,ffffffffc0204e5e <strcmp>
...
ffffffffc02003e0:	29d040ef          	jal	ra,ffffffffc0204e7c <strchr>
...
ffffffffc020041e:	25f040ef          	jal	ra,ffffffffc0204e7c <strchr>
...
ffffffffc020043c:	cf850513          	addi	a0,a0,-776 # ffffffffc0205130 <etext+0x250>
...
ffffffffc0200478:	d1c50513          	addi	a0,a0,-740 # ffffffffc0205190 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	c7650513          	addi	a0,a0,-906 # ffffffffc0206100 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	ce850513          	addi	a0,a0,-792 # ffffffffc02051b0 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	119040ef          	jal	ra,ffffffffc0204ea4 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0f5040ef          	jal	ra,ffffffffc0204ea4 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	bd650513          	addi	a0,a0,-1066 # ffffffffc02051d0 <commands+0x88>
...
ffffffffc0200626:	bce60613          	addi	a2,a2,-1074 # ffffffffc02051f0 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	bda50513          	addi	a0,a0,-1062 # ffffffffc0205208 <commands+0xc0>
...
ffffffffc0200660:	bc450513          	addi	a0,a0,-1084 # ffffffffc0205220 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	bcc50513          	addi	a0,a0,-1076 # ffffffffc0205238 <commands+0xf0>
...
ffffffffc020067e:	bd650513          	addi	a0,a0,-1066 # ffffffffc0205250 <commands+0x108>
...
ffffffffc020068c:	be050513          	addi	a0,a0,-1056 # ffffffffc0205268 <commands+0x120>
...
ffffffffc020069a:	bea50513          	addi	a0,a0,-1046 # ffffffffc0205280 <commands+0x138>
...
ffffffffc02006a8:	bf450513          	addi	a0,a0,-1036 # ffffffffc0205298 <commands+0x150>
...
ffffffffc02006b6:	bfe50513          	addi	a0,a0,-1026 # ffffffffc02052b0 <commands+0x168>
...
ffffffffc02006c4:	c0850513          	addi	a0,a0,-1016 # ffffffffc02052c8 <commands+0x180>
...
ffffffffc02006d2:	c1250513          	addi	a0,a0,-1006 # ffffffffc02052e0 <commands+0x198>
...
ffffffffc02006e0:	c1c50513          	addi	a0,a0,-996 # ffffffffc02052f8 <commands+0x1b0>
...
ffffffffc02006ee:	c2650513          	addi	a0,a0,-986 # ffffffffc0205310 <commands+0x1c8>
...
ffffffffc02006fc:	c3050513          	addi	a0,a0,-976 # ffffffffc0205328 <commands+0x1e0>
...
ffffffffc020070a:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205340 <commands+0x1f8>
...
ffffffffc0200718:	c4450513          	addi	a0,a0,-956 # ffffffffc0205358 <commands+0x210>
...
ffffffffc0200726:	c4e50513          	addi	a0,a0,-946 # ffffffffc0205370 <commands+0x228>
...
ffffffffc0200734:	c5850513          	addi	a0,a0,-936 # ffffffffc0205388 <commands+0x240>
...
ffffffffc0200742:	c6250513          	addi	a0,a0,-926 # ffffffffc02053a0 <commands+0x258>
...
ffffffffc0200750:	c6c50513          	addi	a0,a0,-916 # ffffffffc02053b8 <commands+0x270>
...
ffffffffc020075e:	c7650513          	addi	a0,a0,-906 # ffffffffc02053d0 <commands+0x288>
...
ffffffffc020076c:	c8050513          	addi	a0,a0,-896 # ffffffffc02053e8 <commands+0x2a0>
...
ffffffffc020077a:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205400 <commands+0x2b8>
...
ffffffffc0200788:	c9450513          	addi	a0,a0,-876 # ffffffffc0205418 <commands+0x2d0>
...
ffffffffc0200796:	c9e50513          	addi	a0,a0,-866 # ffffffffc0205430 <commands+0x2e8>
...
ffffffffc02007a4:	ca850513          	addi	a0,a0,-856 # ffffffffc0205448 <commands+0x300>
...
ffffffffc02007b2:	cb250513          	addi	a0,a0,-846 # ffffffffc0205460 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	cbc50513          	addi	a0,a0,-836 # ffffffffc0205478 <commands+0x330>
...
ffffffffc02007ce:	cc650513          	addi	a0,a0,-826 # ffffffffc0205490 <commands+0x348>
...
ffffffffc02007dc:	cd050513          	addi	a0,a0,-816 # ffffffffc02054a8 <commands+0x360>
...
ffffffffc02007ea:	cda50513          	addi	a0,a0,-806 # ffffffffc02054c0 <commands+0x378>
...
ffffffffc02007f8:	ce450513          	addi	a0,a0,-796 # ffffffffc02054d8 <commands+0x390>
...
ffffffffc0200806:	cee50513          	addi	a0,a0,-786 # ffffffffc02054f0 <commands+0x3a8>
...
ffffffffc0200818:	cf450513          	addi	a0,a0,-780 # ffffffffc0205508 <commands+0x3c0>
}
...
ffffffffc020082c:	cf850513          	addi	a0,a0,-776 # ffffffffc0205520 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	cf850513          	addi	a0,a0,-776 # ffffffffc0205538 <commands+0x3f0>
...
ffffffffc0200854:	d0050513          	addi	a0,a0,-768 # ffffffffc0205550 <commands+0x408>
...
ffffffffc0200864:	d0850513          	addi	a0,a0,-760 # ffffffffc0205568 <commands+0x420>
...
ffffffffc0200878:	d0c50513          	addi	a0,a0,-756 # ffffffffc0205580 <commands+0x438>
}
...
ffffffffc0200894:	db870713          	addi	a4,a4,-584 # ffffffffc0205648 <commands+0x500>
...
ffffffffc02008a6:	d5650513          	addi	a0,a0,-682 # ffffffffc02055f8 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	d2a50513          	addi	a0,a0,-726 # ffffffffc02055d8 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	cde50513          	addi	a0,a0,-802 # ffffffffc0205598 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	cf250513          	addi	a0,a0,-782 # ffffffffc02055b8 <commands+0x470>
...
ffffffffc02008fc:	d3050513          	addi	a0,a0,-720 # ffffffffc0205628 <commands+0x4e0>
...
ffffffffc0200910:	d0c50513          	addi	a0,a0,-756 # ffffffffc0205618 <commands+0x4d0>
}
...
ffffffffc0200932:	f0270713          	addi	a4,a4,-254 # ffffffffc0205830 <commands+0x6e8>
...
ffffffffc0200944:	ed850513          	addi	a0,a0,-296 # ffffffffc0205818 <commands+0x6d0>
...
ffffffffc0200966:	d1650513          	addi	a0,a0,-746 # ffffffffc0205678 <commands+0x530>
}
...
ffffffffc02009c0:	d5c60613          	addi	a2,a2,-676 # ffffffffc0205718 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	84050513          	addi	a0,a0,-1984 # ffffffffc0205208 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	d6450513          	addi	a0,a0,-668 # ffffffffc0205738 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	d7250513          	addi	a0,a0,-654 # ffffffffc0205750 <commands+0x608>
...
ffffffffc0200a6a:	cb260613          	addi	a2,a2,-846 # ffffffffc0205718 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	79650513          	addi	a0,a0,1942 # ffffffffc0205208 <commands+0xc0>
...
ffffffffc0200a96:	c8660613          	addi	a2,a2,-890 # ffffffffc0205718 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	76a50513          	addi	a0,a0,1898 # ffffffffc0205208 <commands+0xc0>
...
ffffffffc0200e74:	a0068693          	addi	a3,a3,-1536 # ffffffffc0205870 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a0860613          	addi	a2,a2,-1528 # ffffffffc0205880 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a1450513          	addi	a0,a0,-1516 # ffffffffc0205898 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	aa068693          	addi	a3,a3,-1376 # ffffffffc0205930 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	9e860613          	addi	a2,a2,-1560 # ffffffffc0205880 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	9f450513          	addi	a0,a0,-1548 # ffffffffc0205898 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	aa868693          	addi	a3,a3,-1368 # ffffffffc0205958 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	9c860613          	addi	a2,a2,-1592 # ffffffffc0205880 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	9d450513          	addi	a0,a0,-1580 # ffffffffc0205898 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	ac868693          	addi	a3,a3,-1336 # ffffffffc0205998 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	9a860613          	addi	a2,a2,-1624 # ffffffffc0205880 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	9b450513          	addi	a0,a0,-1612 # ffffffffc0205898 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	b3068693          	addi	a3,a3,-1232 # ffffffffc0205a20 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	98860613          	addi	a2,a2,-1656 # ffffffffc0205880 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	99450513          	addi	a0,a0,-1644 # ffffffffc0205898 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	9c068693          	addi	a3,a3,-1600 # ffffffffc02058d0 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	96860613          	addi	a2,a2,-1688 # ffffffffc0205880 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	97450513          	addi	a0,a0,-1676 # ffffffffc0205898 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	ae068693          	addi	a3,a3,-1312 # ffffffffc0205a10 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	94860613          	addi	a2,a2,-1720 # ffffffffc0205880 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	95450513          	addi	a0,a0,-1708 # ffffffffc0205898 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	aa868693          	addi	a3,a3,-1368 # ffffffffc02059f8 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	92860613          	addi	a2,a2,-1752 # ffffffffc0205880 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	93450513          	addi	a0,a0,-1740 # ffffffffc0205898 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a6868693          	addi	a3,a3,-1432 # ffffffffc02059d8 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	90860613          	addi	a2,a2,-1784 # ffffffffc0205880 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	91450513          	addi	a0,a0,-1772 # ffffffffc0205898 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	ad868693          	addi	a3,a3,-1320 # ffffffffc0205a68 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0205880 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	8f450513          	addi	a0,a0,-1804 # ffffffffc0205898 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	aa868693          	addi	a3,a3,-1368 # ffffffffc0205a58 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	8c860613          	addi	a2,a2,-1848 # ffffffffc0205880 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	8d450513          	addi	a0,a0,-1836 # ffffffffc0205898 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	a2868693          	addi	a3,a3,-1496 # ffffffffc02059f8 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	8a860613          	addi	a2,a2,-1880 # ffffffffc0205880 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	8b450513          	addi	a0,a0,-1868 # ffffffffc0205898 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	a4868693          	addi	a3,a3,-1464 # ffffffffc0205a38 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	88860613          	addi	a2,a2,-1912 # ffffffffc0205880 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	89450513          	addi	a0,a0,-1900 # ffffffffc0205898 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	8c068693          	addi	a3,a3,-1856 # ffffffffc02058d0 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	86860613          	addi	a2,a2,-1944 # ffffffffc0205880 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	87450513          	addi	a0,a0,-1932 # ffffffffc0205898 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	9c868693          	addi	a3,a3,-1592 # ffffffffc02059f8 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	84860613          	addi	a2,a2,-1976 # ffffffffc0205880 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	85450513          	addi	a0,a0,-1964 # ffffffffc0205898 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205910 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	82860613          	addi	a2,a2,-2008 # ffffffffc0205880 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	83450513          	addi	a0,a0,-1996 # ffffffffc0205898 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	88068693          	addi	a3,a3,-1920 # ffffffffc02058f0 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	80860613          	addi	a2,a2,-2040 # ffffffffc0205880 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	81450513          	addi	a0,a0,-2028 # ffffffffc0205898 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	88068693          	addi	a3,a3,-1920 # ffffffffc0205910 <commands+0x7c8>
ffffffffc0201098:	00004617          	auipc	a2,0x4
ffffffffc020109c:	7e860613          	addi	a2,a2,2024 # ffffffffc0205880 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00004517          	auipc	a0,0x4
ffffffffc02010a8:	7f450513          	addi	a0,a0,2036 # ffffffffc0205898 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b0868693          	addi	a3,a3,-1272 # ffffffffc0205bb8 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	7c860613          	addi	a2,a2,1992 # ffffffffc0205880 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00004517          	auipc	a0,0x4
ffffffffc02010c8:	7d450513          	addi	a0,a0,2004 # ffffffffc0205898 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	98868693          	addi	a3,a3,-1656 # ffffffffc0205a58 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	7a860613          	addi	a2,a2,1960 # ffffffffc0205880 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	7b450513          	addi	a0,a0,1972 # ffffffffc0205898 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	90868693          	addi	a3,a3,-1784 # ffffffffc02059f8 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	78860613          	addi	a2,a2,1928 # ffffffffc0205880 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	79450513          	addi	a0,a0,1940 # ffffffffc0205898 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	8a868693          	addi	a3,a3,-1880 # ffffffffc02059b8 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	76860613          	addi	a2,a2,1896 # ffffffffc0205880 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	77450513          	addi	a0,a0,1908 # ffffffffc0205898 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	a4868693          	addi	a3,a3,-1464 # ffffffffc0205b78 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	74860613          	addi	a2,a2,1864 # ffffffffc0205880 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	75450513          	addi	a0,a0,1876 # ffffffffc0205898 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a0868693          	addi	a3,a3,-1528 # ffffffffc0205b58 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	72860613          	addi	a2,a2,1832 # ffffffffc0205880 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	73450513          	addi	a0,a0,1844 # ffffffffc0205898 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	9c068693          	addi	a3,a3,-1600 # ffffffffc0205b30 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	70860613          	addi	a2,a2,1800 # ffffffffc0205880 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	71450513          	addi	a0,a0,1812 # ffffffffc0205898 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	97868693          	addi	a3,a3,-1672 # ffffffffc0205b08 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	6e860613          	addi	a2,a2,1768 # ffffffffc0205880 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	6f450513          	addi	a0,a0,1780 # ffffffffc0205898 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	94868693          	addi	a3,a3,-1720 # ffffffffc0205af8 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	6c860613          	addi	a2,a2,1736 # ffffffffc0205880 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	6d450513          	addi	a0,a0,1748 # ffffffffc0205898 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	82868693          	addi	a3,a3,-2008 # ffffffffc02059f8 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	6a860613          	addi	a2,a2,1704 # ffffffffc0205880 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	6b450513          	addi	a0,a0,1716 # ffffffffc0205898 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	8e868693          	addi	a3,a3,-1816 # ffffffffc0205ad8 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	68860613          	addi	a2,a2,1672 # ffffffffc0205880 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	69450513          	addi	a0,a0,1684 # ffffffffc0205898 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	89868693          	addi	a3,a3,-1896 # ffffffffc0205aa8 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	66860613          	addi	a2,a2,1640 # ffffffffc0205880 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	67450513          	addi	a0,a0,1652 # ffffffffc0205898 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	86068693          	addi	a3,a3,-1952 # ffffffffc0205a90 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	64860613          	addi	a2,a2,1608 # ffffffffc0205880 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	65450513          	addi	a0,a0,1620 # ffffffffc0205898 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	7a868693          	addi	a3,a3,1960 # ffffffffc02059f8 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	62860613          	addi	a2,a2,1576 # ffffffffc0205880 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	63450513          	addi	a0,a0,1588 # ffffffffc0205898 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	80868693          	addi	a3,a3,-2040 # ffffffffc0205a78 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	60860613          	addi	a2,a2,1544 # ffffffffc0205880 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	61450513          	addi	a0,a0,1556 # ffffffffc0205898 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	90868693          	addi	a3,a3,-1784 # ffffffffc0205b98 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	5e860613          	addi	a2,a2,1512 # ffffffffc0205880 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	5f450513          	addi	a0,a0,1524 # ffffffffc0205898 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	91868693          	addi	a3,a3,-1768 # ffffffffc0205bc8 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	5c860613          	addi	a2,a2,1480 # ffffffffc0205880 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	5d450513          	addi	a0,a0,1492 # ffffffffc0205898 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	5e068693          	addi	a3,a3,1504 # ffffffffc02058b0 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	5a860613          	addi	a2,a2,1448 # ffffffffc0205880 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	5b450513          	addi	a0,a0,1460 # ffffffffc0205898 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	60068693          	addi	a3,a3,1536 # ffffffffc02058f0 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	58860613          	addi	a2,a2,1416 # ffffffffc0205880 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	59450513          	addi	a0,a0,1428 # ffffffffc0205898 <commands+0x750>
...
ffffffffc0201440:	7a468693          	addi	a3,a3,1956 # ffffffffc0205be0 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	43c60613          	addi	a2,a2,1084 # ffffffffc0205880 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	44850513          	addi	a0,a0,1096 # ffffffffc0205898 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	77c68693          	addi	a3,a3,1916 # ffffffffc0205bd8 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	41c60613          	addi	a2,a2,1052 # ffffffffc0205880 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	42850513          	addi	a0,a0,1064 # ffffffffc0205898 <commands+0x750>
...
ffffffffc0201512:	6ca68693          	addi	a3,a3,1738 # ffffffffc0205bd8 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	36a60613          	addi	a2,a2,874 # ffffffffc0205880 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	37650513          	addi	a0,a0,886 # ffffffffc0205898 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	62868693          	addi	a3,a3,1576 # ffffffffc0205c08 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	29860613          	addi	a2,a2,664 # ffffffffc0205880 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	2a450513          	addi	a0,a0,676 # ffffffffc0205898 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	5d868693          	addi	a3,a3,1496 # ffffffffc0205bd8 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	27860613          	addi	a2,a2,632 # ffffffffc0205880 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	28450513          	addi	a0,a0,644 # ffffffffc0205898 <commands+0x750>
...
ffffffffc0201724:	54860613          	addi	a2,a2,1352 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	56450513          	addi	a0,a0,1380 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc0201812:	49268693          	addi	a3,a3,1170 # ffffffffc0205ca0 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	06a60613          	addi	a2,a2,106 # ffffffffc0205880 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	49e50513          	addi	a0,a0,1182 # ffffffffc0205cc0 <default_pmm_manager+0x90>
...
ffffffffc0201834:	4a850513          	addi	a0,a0,1192 # ffffffffc0205cd8 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	4b050513          	addi	a0,a0,1200 # ffffffffc0205cf0 <default_pmm_manager+0xc0>
}
...
ffffffffc02019c6:	37660613          	addi	a2,a2,886 # ffffffffc0205d38 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	2c250513          	addi	a0,a0,706 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	33460613          	addi	a2,a2,820 # ffffffffc0205d10 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	2a850513          	addi	a0,a0,680 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	34260613          	addi	a2,a2,834 # ffffffffc0205d38 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	28e50513          	addi	a0,a0,654 # ffffffffc0205c90 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	34660613          	addi	a2,a2,838 # ffffffffc0205d58 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	27250513          	addi	a0,a0,626 # ffffffffc0205c90 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	2d4030ef          	jal	ra,ffffffffc0204e92 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	242030ef          	jal	ra,ffffffffc0204e92 <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	fc260613          	addi	a2,a2,-62 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	0ce50513          	addi	a0,a0,206 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	faa60613          	addi	a2,a2,-86 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	0b650513          	addi	a0,a0,182 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	f9060613          	addi	a2,a2,-112 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	09c50513          	addi	a0,a0,156 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	f7660613          	addi	a2,a2,-138 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	08250513          	addi	a0,a0,130 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	d4078793          	addi	a5,a5,-704 # ffffffffc0205c30 <default_pmm_manager>
...
ffffffffc0201f02:	e9250513          	addi	a0,a0,-366 # ffffffffc0205d90 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	e5c50513          	addi	a0,a0,-420 # ffffffffc0205da8 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	e5450513          	addi	a0,a0,-428 # ffffffffc0205dc0 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e1450513          	addi	a0,a0,-492 # ffffffffc0205de8 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e1050513          	addi	a0,a0,-496 # ffffffffc0205e00 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	e5850513          	addi	a0,a0,-424 # ffffffffc02060e8 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	eda58593          	addi	a1,a1,-294 # ffffffffc0206220 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	2fb020ef          	jal	ra,ffffffffc0204e4c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	301020ef          	jal	ra,ffffffffc0204e5e <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	283020ef          	jal	ra,ffffffffc0204e16 <strlen>
...
ffffffffc0202458:	e4450513          	addi	a0,a0,-444 # ffffffffc0206298 <default_pmm_manager+0x668>
...
ffffffffc0202572:	bda68693          	addi	a3,a3,-1062 # ffffffffc0206148 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	30a60613          	addi	a2,a2,778 # ffffffffc0205880 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00003517          	auipc	a0,0x3
ffffffffc0202586:	7fe50513          	addi	a0,a0,2046 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	b7a68693          	addi	a3,a3,-1158 # ffffffffc0206108 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	2ea60613          	addi	a2,a2,746 # ffffffffc0205880 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00003517          	auipc	a0,0x3
ffffffffc02025a6:	7de50513          	addi	a0,a0,2014 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	6b860613          	addi	a2,a2,1720 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	7c450513          	addi	a0,a0,1988 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	74460613          	addi	a2,a2,1860 # ffffffffc0205d10 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	7a850513          	addi	a0,a0,1960 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	72c60613          	addi	a2,a2,1836 # ffffffffc0205d10 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	79050513          	addi	a0,a0,1936 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	84468693          	addi	a3,a3,-1980 # ffffffffc0205e40 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	27c60613          	addi	a2,a2,636 # ffffffffc0205880 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	77050513          	addi	a0,a0,1904 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	80468693          	addi	a3,a3,-2044 # ffffffffc0205e20 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	25c60613          	addi	a2,a2,604 # ffffffffc0205880 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	75050513          	addi	a0,a0,1872 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0202644:	89068693          	addi	a3,a3,-1904 # ffffffffc0205ed0 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	23860613          	addi	a2,a2,568 # ffffffffc0205880 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	72c50513          	addi	a0,a0,1836 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	84068693          	addi	a3,a3,-1984 # ffffffffc0205ea0 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	21860613          	addi	a2,a2,536 # ffffffffc0205880 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	70c50513          	addi	a0,a0,1804 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00003697          	auipc	a3,0x3
ffffffffc0202684:	7f868693          	addi	a3,a3,2040 # ffffffffc0205e78 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	1f860613          	addi	a2,a2,504 # ffffffffc0205880 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	6ec50513          	addi	a0,a0,1772 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	8b868693          	addi	a3,a3,-1864 # ffffffffc0205f58 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	1d860613          	addi	a2,a2,472 # ffffffffc0205880 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	6cc50513          	addi	a0,a0,1740 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	93868693          	addi	a3,a3,-1736 # ffffffffc0205ff8 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	1b860613          	addi	a2,a2,440 # ffffffffc0205880 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	85068693          	addi	a3,a3,-1968 # ffffffffc0205f30 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	19860613          	addi	a2,a2,408 # ffffffffc0205880 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	68c50513          	addi	a0,a0,1676 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0202706:	56660613          	addi	a2,a2,1382 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	67250513          	addi	a0,a0,1650 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	87668693          	addi	a3,a3,-1930 # ffffffffc0205f90 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	15e60613          	addi	a2,a2,350 # ffffffffc0205880 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	65250513          	addi	a0,a0,1618 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	91e68693          	addi	a3,a3,-1762 # ffffffffc0206058 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	13e60613          	addi	a2,a2,318 # ffffffffc0205880 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	63250513          	addi	a0,a0,1586 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	8e668693          	addi	a3,a3,-1818 # ffffffffc0206040 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	11e60613          	addi	a2,a2,286 # ffffffffc0205880 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	61250513          	addi	a0,a0,1554 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	89668693          	addi	a3,a3,-1898 # ffffffffc0206010 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	0fe60613          	addi	a2,a2,254 # ffffffffc0205880 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	5f250513          	addi	a0,a0,1522 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a2e68693          	addi	a3,a3,-1490 # ffffffffc02061c8 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	0de60613          	addi	a2,a2,222 # ffffffffc0205880 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	5d250513          	addi	a0,a0,1490 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	82668693          	addi	a3,a3,-2010 # ffffffffc0205fe0 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	0be60613          	addi	a2,a2,190 # ffffffffc0205880 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	5b250513          	addi	a0,a0,1458 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00003697          	auipc	a3,0x3
ffffffffc02027de:	7f668693          	addi	a3,a3,2038 # ffffffffc0205fd0 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	09e60613          	addi	a2,a2,158 # ffffffffc0205880 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	59250513          	addi	a0,a0,1426 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	8ce68693          	addi	a3,a3,-1842 # ffffffffc02060c8 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	07e60613          	addi	a2,a2,126 # ffffffffc0205880 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	57250513          	addi	a0,a0,1394 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	7a668693          	addi	a3,a3,1958 # ffffffffc0205fc0 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	05e60613          	addi	a2,a2,94 # ffffffffc0205880 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	55250513          	addi	a0,a0,1362 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	6de68693          	addi	a3,a3,1758 # ffffffffc0205f18 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	03e60613          	addi	a2,a2,62 # ffffffffc0205880 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	53250513          	addi	a0,a0,1330 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	81668693          	addi	a3,a3,-2026 # ffffffffc0206070 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	01e60613          	addi	a2,a2,30 # ffffffffc0205880 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	51250513          	addi	a0,a0,1298 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	68668693          	addi	a3,a3,1670 # ffffffffc0205f00 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	ffe60613          	addi	a2,a2,-2 # ffffffffc0205880 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	4f250513          	addi	a0,a0,1266 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	3ce60613          	addi	a2,a2,974 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	3ea50513          	addi	a0,a0,1002 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00003697          	auipc	a3,0x3
ffffffffc02028b6:	7ee68693          	addi	a3,a3,2030 # ffffffffc02060a0 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	fc660613          	addi	a2,a2,-58 # ffffffffc0205880 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	78668693          	addi	a3,a3,1926 # ffffffffc0206058 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	fa660613          	addi	a2,a2,-90 # ffffffffc0205880 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	49a50513          	addi	a0,a0,1178 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	79668693          	addi	a3,a3,1942 # ffffffffc0206088 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	f8660613          	addi	a2,a2,-122 # ffffffffc0205880 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	47a50513          	addi	a0,a0,1146 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	74668693          	addi	a3,a3,1862 # ffffffffc0206058 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	f6660613          	addi	a2,a2,-154 # ffffffffc0205880 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	45a50513          	addi	a0,a0,1114 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	87e68693          	addi	a3,a3,-1922 # ffffffffc02061b0 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	f4660613          	addi	a2,a2,-186 # ffffffffc0205880 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	43a50513          	addi	a0,a0,1082 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	82668693          	addi	a3,a3,-2010 # ffffffffc0206178 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f2660613          	addi	a2,a2,-218 # ffffffffc0205880 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	41a50513          	addi	a0,a0,1050 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00003697          	auipc	a3,0x3
ffffffffc0202976:	7ee68693          	addi	a3,a3,2030 # ffffffffc0206160 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f0660613          	addi	a2,a2,-250 # ffffffffc0205880 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	3fa50513          	addi	a0,a0,1018 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	73668693          	addi	a3,a3,1846 # ffffffffc02060c8 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	ee660613          	addi	a2,a2,-282 # ffffffffc0205880 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	3da50513          	addi	a0,a0,986 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	54e68693          	addi	a3,a3,1358 # ffffffffc0205f00 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	ec660613          	addi	a2,a2,-314 # ffffffffc0205880 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	3ba50513          	addi	a0,a0,954 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	29660613          	addi	a2,a2,662 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	3a250513          	addi	a0,a0,930 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	52e68693          	addi	a3,a3,1326 # ffffffffc0205f18 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	e8e60613          	addi	a2,a2,-370 # ffffffffc0205880 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	38250513          	addi	a0,a0,898 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	58668693          	addi	a3,a3,1414 # ffffffffc0205f90 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e6e60613          	addi	a2,a2,-402 # ffffffffc0205880 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	36250513          	addi	a0,a0,866 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	84668693          	addi	a3,a3,-1978 # ffffffffc0206270 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	e4e60613          	addi	a2,a2,-434 # ffffffffc0205880 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	34250513          	addi	a0,a0,834 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00003697          	auipc	a3,0x3
ffffffffc0202a4e:	7ee68693          	addi	a3,a3,2030 # ffffffffc0206238 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e2e60613          	addi	a2,a2,-466 # ffffffffc0205880 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	32250513          	addi	a0,a0,802 # ffffffffc0205d80 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	79e68693          	addi	a3,a3,1950 # ffffffffc0206208 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e0e60613          	addi	a2,a2,-498 # ffffffffc0205880 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	30250513          	addi	a0,a0,770 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	7c868693          	addi	a3,a3,1992 # ffffffffc02062b8 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	d8860613          	addi	a2,a2,-632 # ffffffffc0205880 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	27c50513          	addi	a0,a0,636 # ffffffffc0205d80 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	1ee60613          	addi	a2,a2,494 # ffffffffc0205d38 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	13a50513          	addi	a0,a0,314 # ffffffffc0205c90 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	72650513          	addi	a0,a0,1830 # ffffffffc0206300 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	6ec50513          	addi	a0,a0,1772 # ffffffffc0206318 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	70850513          	addi	a0,a0,1800 # ffffffffc0206388 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	73c50513          	addi	a0,a0,1852 # ffffffffc02063d8 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	75050513          	addi	a0,a0,1872 # ffffffffc0206460 <default_pmm_manager+0x830>
...
ffffffffc0202e58:	6b450513          	addi	a0,a0,1716 # ffffffffc0206508 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	63050513          	addi	a0,a0,1584 # ffffffffc0206558 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	93668693          	addi	a3,a3,-1738 # ffffffffc0205870 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	93e60613          	addi	a2,a2,-1730 # ffffffffc0205880 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	3a250513          	addi	a0,a0,930 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	dda60613          	addi	a2,a2,-550 # ffffffffc0205d38 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d2650513          	addi	a0,a0,-730 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	56a68693          	addi	a3,a3,1386 # ffffffffc02064e0 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	90260613          	addi	a2,a2,-1790 # ffffffffc0205880 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	36650513          	addi	a0,a0,870 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	46a68693          	addi	a3,a3,1130 # ffffffffc0206400 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	8e260613          	addi	a2,a2,-1822 # ffffffffc0205880 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	34650513          	addi	a0,a0,838 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	31a60613          	addi	a2,a2,794 # ffffffffc02062d0 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	32e50513          	addi	a0,a0,814 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	4fa68693          	addi	a3,a3,1274 # ffffffffc02064c8 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	8aa60613          	addi	a2,a2,-1878 # ffffffffc0205880 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	30e50513          	addi	a0,a0,782 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d6a60613          	addi	a2,a2,-662 # ffffffffc0205d58 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	c9650513          	addi	a0,a0,-874 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	41268693          	addi	a3,a3,1042 # ffffffffc0206418 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	87260613          	addi	a2,a2,-1934 # ffffffffc0205880 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	2d650513          	addi	a0,a0,726 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	32a68693          	addi	a3,a3,810 # ffffffffc0206350 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	85260613          	addi	a2,a2,-1966 # ffffffffc0205880 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	2b650513          	addi	a0,a0,694 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	86a68693          	addi	a3,a3,-1942 # ffffffffc02058b0 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	83260613          	addi	a2,a2,-1998 # ffffffffc0205880 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	29650513          	addi	a0,a0,662 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	9f268693          	addi	a3,a3,-1550 # ffffffffc0205a58 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	81260613          	addi	a2,a2,-2030 # ffffffffc0205880 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	27650513          	addi	a0,a0,630 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	2e268693          	addi	a3,a3,738 # ffffffffc0206368 <default_pmm_manager+0x738>
ffffffffc020308e:	00002617          	auipc	a2,0x2
ffffffffc0203092:	7f260613          	addi	a2,a2,2034 # ffffffffc0205880 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	25650513          	addi	a0,a0,598 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	29a68693          	addi	a3,a3,666 # ffffffffc0206340 <default_pmm_manager+0x710>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	7d260613          	addi	a2,a2,2002 # ffffffffc0205880 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	23650513          	addi	a0,a0,566 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	48268693          	addi	a3,a3,1154 # ffffffffc0206548 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	7b260613          	addi	a2,a2,1970 # ffffffffc0205880 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	21650513          	addi	a0,a0,534 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	b8260613          	addi	a2,a2,-1150 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	b9e50513          	addi	a0,a0,-1122 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	43a68693          	addi	a3,a3,1082 # ffffffffc0206538 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	77a60613          	addi	a2,a2,1914 # ffffffffc0205880 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	1de50513          	addi	a0,a0,478 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	36a68693          	addi	a3,a3,874 # ffffffffc0206488 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	75a60613          	addi	a2,a2,1882 # ffffffffc0205880 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	1be50513          	addi	a0,a0,446 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	2fa68693          	addi	a3,a3,762 # ffffffffc0206438 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	73a60613          	addi	a2,a2,1850 # ffffffffc0205880 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	19e50513          	addi	a0,a0,414 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	26268693          	addi	a3,a3,610 # ffffffffc02063c0 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	71a60613          	addi	a2,a2,1818 # ffffffffc0205880 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	17e50513          	addi	a0,a0,382 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	3b268693          	addi	a3,a3,946 # ffffffffc0206530 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	6fa60613          	addi	a2,a2,1786 # ffffffffc0205880 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	15e50513          	addi	a0,a0,350 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	1da68693          	addi	a3,a3,474 # ffffffffc0206378 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	6da60613          	addi	a2,a2,1754 # ffffffffc0205880 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	13e50513          	addi	a0,a0,318 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	2fa68693          	addi	a3,a3,762 # ffffffffc02064b8 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	6ba60613          	addi	a2,a2,1722 # ffffffffc0205880 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	11e50513          	addi	a0,a0,286 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	2da68693          	addi	a3,a3,730 # ffffffffc02064b8 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	69a60613          	addi	a2,a2,1690 # ffffffffc0205880 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	0fe50513          	addi	a0,a0,254 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	29a68693          	addi	a3,a3,666 # ffffffffc0206498 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	67a60613          	addi	a2,a2,1658 # ffffffffc0205880 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	0de50513          	addi	a0,a0,222 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	27a68693          	addi	a3,a3,634 # ffffffffc0206498 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	65a60613          	addi	a2,a2,1626 # ffffffffc0205880 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	0be50513          	addi	a0,a0,190 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	26a68693          	addi	a3,a3,618 # ffffffffc02064a8 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	63a60613          	addi	a2,a2,1594 # ffffffffc0205880 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	09e50513          	addi	a0,a0,158 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	24a68693          	addi	a3,a3,586 # ffffffffc02064a8 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	61a60613          	addi	a2,a2,1562 # ffffffffc0205880 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	07e50513          	addi	a0,a0,126 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	20a68693          	addi	a3,a3,522 # ffffffffc0206488 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	5fa60613          	addi	a2,a2,1530 # ffffffffc0205880 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	05e50513          	addi	a0,a0,94 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	2fab0b13          	addi	s6,s6,762 # ffffffffc02065d8 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	2dab8b93          	addi	s7,s7,730 # ffffffffc02065c0 <default_pmm_manager+0x990>
...
ffffffffc020339c:	1e050513          	addi	a0,a0,480 # ffffffffc0206578 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	1fe68693          	addi	a3,a3,510 # ffffffffc02065a8 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	4ce60613          	addi	a2,a2,1230 # ffffffffc0205880 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	f3250513          	addi	a0,a0,-206 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	22650513          	addi	a0,a0,550 # ffffffffc0206628 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	1f468693          	addi	a3,a3,500 # ffffffffc0206618 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	45460613          	addi	a2,a2,1108 # ffffffffc0205880 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	eb850513          	addi	a0,a0,-328 # ffffffffc02062f0 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	20050513          	addi	a0,a0,512 # ffffffffc0206668 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	20a50513          	addi	a0,a0,522 # ffffffffc02066a8 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	20e50513          	addi	a0,a0,526 # ffffffffc02066d0 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	21850513          	addi	a0,a0,536 # ffffffffc02066f8 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	22450513          	addi	a0,a0,548 # ffffffffc0206720 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	1de50513          	addi	a0,a0,478 # ffffffffc02066f8 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	17650513          	addi	a0,a0,374 # ffffffffc02066a8 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	1ac50513          	addi	a0,a0,428 # ffffffffc02066f8 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	10250513          	addi	a0,a0,258 # ffffffffc0206668 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	15050513          	addi	a0,a0,336 # ffffffffc02066d0 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	18650513          	addi	a0,a0,390 # ffffffffc0206720 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	0f050513          	addi	a0,a0,240 # ffffffffc02066a8 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	ec268693          	addi	a3,a3,-318 # ffffffffc02064b8 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	28260613          	addi	a2,a2,642 # ffffffffc0205880 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	08650513          	addi	a0,a0,134 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	1ba68693          	addi	a3,a3,442 # ffffffffc02067d0 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	26260613          	addi	a2,a2,610 # ffffffffc0205880 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	06650513          	addi	a0,a0,102 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	17268693          	addi	a3,a3,370 # ffffffffc02067a8 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	24260613          	addi	a2,a2,578 # ffffffffc0205880 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	04650513          	addi	a0,a0,70 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	14268693          	addi	a3,a3,322 # ffffffffc0206798 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	22260613          	addi	a2,a2,546 # ffffffffc0205880 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	02650513          	addi	a0,a0,38 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	11268693          	addi	a3,a3,274 # ffffffffc0206788 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	20260613          	addi	a2,a2,514 # ffffffffc0205880 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	00650513          	addi	a0,a0,6 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	0e268693          	addi	a3,a3,226 # ffffffffc0206778 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	1e260613          	addi	a2,a2,482 # ffffffffc0205880 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	fe650513          	addi	a0,a0,-26 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	0b268693          	addi	a3,a3,178 # ffffffffc0206768 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	1c260613          	addi	a2,a2,450 # ffffffffc0205880 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	fc650513          	addi	a0,a0,-58 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	08268693          	addi	a3,a3,130 # ffffffffc0206758 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	1a260613          	addi	a2,a2,418 # ffffffffc0205880 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	fa650513          	addi	a0,a0,-90 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	05268693          	addi	a3,a3,82 # ffffffffc0206748 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	18260613          	addi	a2,a2,386 # ffffffffc0205880 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	f8650513          	addi	a0,a0,-122 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	03268693          	addi	a3,a3,50 # ffffffffc0206748 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	16260613          	addi	a2,a2,354 # ffffffffc0205880 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	f6650513          	addi	a0,a0,-154 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	d8268693          	addi	a3,a3,-638 # ffffffffc02064b8 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	14260613          	addi	a2,a2,322 # ffffffffc0205880 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	f4650513          	addi	a0,a0,-186 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	d6268693          	addi	a3,a3,-670 # ffffffffc02064b8 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	12260613          	addi	a2,a2,290 # ffffffffc0205880 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f2650513          	addi	a0,a0,-218 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	d4268693          	addi	a3,a3,-702 # ffffffffc02064b8 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	10260613          	addi	a2,a2,258 # ffffffffc0205880 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f0650513          	addi	a0,a0,-250 # ffffffffc0206690 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	02868693          	addi	a3,a3,40 # ffffffffc02067e0 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	0c060613          	addi	a2,a2,192 # ffffffffc0205880 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	ec450513          	addi	a0,a0,-316 # ffffffffc0206690 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	01868693          	addi	a3,a3,24 # ffffffffc02067f0 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	0a060613          	addi	a2,a2,160 # ffffffffc0205880 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	ea450513          	addi	a0,a0,-348 # ffffffffc0206690 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	ff068693          	addi	a3,a3,-16 # ffffffffc0206800 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	06860613          	addi	a2,a2,104 # ffffffffc0205880 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	e6c50513          	addi	a0,a0,-404 # ffffffffc0206690 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	00468693          	addi	a3,a3,4 # ffffffffc0206838 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	04460613          	addi	a2,a2,68 # ffffffffc0205880 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	01050513          	addi	a0,a0,16 # ffffffffc0206858 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	eec68693          	addi	a3,a3,-276 # ffffffffc0206868 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	efc60613          	addi	a2,a2,-260 # ffffffffc0205880 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	ec850513          	addi	a0,a0,-312 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f0c68693          	addi	a3,a3,-244 # ffffffffc02068a8 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	edc60613          	addi	a2,a2,-292 # ffffffffc0205880 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	ea850513          	addi	a0,a0,-344 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	ecc68693          	addi	a3,a3,-308 # ffffffffc0206888 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	ebc60613          	addi	a2,a2,-324 # ffffffffc0205880 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	e8850513          	addi	a0,a0,-376 # ffffffffc0206858 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	90a68693          	addi	a3,a3,-1782 # ffffffffc0206378 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e0a60613          	addi	a2,a2,-502 # ffffffffc0205880 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	dd650513          	addi	a0,a0,-554 # ffffffffc0206858 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	8b668693          	addi	a3,a3,-1866 # ffffffffc0206378 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	db660613          	addi	a2,a2,-586 # ffffffffc0205880 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	d8250513          	addi	a0,a0,-638 # ffffffffc0206858 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	e3250513          	addi	a0,a0,-462 # ffffffffc02069c8 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	e4e68693          	addi	a3,a3,-434 # ffffffffc02069f0 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	cd660613          	addi	a2,a2,-810 # ffffffffc0205880 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	ca250513          	addi	a0,a0,-862 # ffffffffc0206858 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e2450513          	addi	a0,a0,-476 # ffffffffc0206a08 <default_pmm_manager+0xdd8>
...
ffffffffc0203d7c:	d0850513          	addi	a0,a0,-760 # ffffffffc0206a80 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d0e50513          	addi	a0,a0,-754 # ffffffffc0206aa0 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b3a68693          	addi	a3,a3,-1222 # ffffffffc02068e0 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	ad260613          	addi	a2,a2,-1326 # ffffffffc0205880 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	ba268693          	addi	a3,a3,-1118 # ffffffffc0206968 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	ab260613          	addi	a2,a2,-1358 # ffffffffc0205880 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	a7e50513          	addi	a0,a0,-1410 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	bb268693          	addi	a3,a3,-1102 # ffffffffc0206998 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	a9260613          	addi	a2,a2,-1390 # ffffffffc0205880 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	a5e50513          	addi	a0,a0,-1442 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	ac268693          	addi	a3,a3,-1342 # ffffffffc02068c8 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	a7260613          	addi	a2,a2,-1422 # ffffffffc0205880 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a3e50513          	addi	a0,a0,-1474 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b2268693          	addi	a3,a3,-1246 # ffffffffc0206948 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	a5260613          	addi	a2,a2,-1454 # ffffffffc0205880 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a1e50513          	addi	a0,a0,-1506 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b1268693          	addi	a3,a3,-1262 # ffffffffc0206958 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	a3260613          	addi	a2,a2,-1486 # ffffffffc0205880 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	9fe50513          	addi	a0,a0,-1538 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	ab268693          	addi	a3,a3,-1358 # ffffffffc0206918 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a1260613          	addi	a2,a2,-1518 # ffffffffc0205880 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	9de50513          	addi	a0,a0,-1570 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	aa268693          	addi	a3,a3,-1374 # ffffffffc0206928 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	9f260613          	addi	a2,a2,-1550 # ffffffffc0205880 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	9be50513          	addi	a0,a0,-1602 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	a9268693          	addi	a3,a3,-1390 # ffffffffc0206938 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	9d260613          	addi	a2,a2,-1582 # ffffffffc0205880 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	99e50513          	addi	a0,a0,-1634 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	bf268693          	addi	a3,a3,-1038 # ffffffffc0206ab8 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	9b260613          	addi	a2,a2,-1614 # ffffffffc0205880 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	97e50513          	addi	a0,a0,-1666 # ffffffffc0206858 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	48a68693          	addi	a3,a3,1162 # ffffffffc0206378 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	98a60613          	addi	a2,a2,-1654 # ffffffffc0205880 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	95650513          	addi	a0,a0,-1706 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b1a68693          	addi	a3,a3,-1254 # ffffffffc0206a28 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	96a60613          	addi	a2,a2,-1686 # ffffffffc0205880 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	93650513          	addi	a0,a0,-1738 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b1a68693          	addi	a3,a3,-1254 # ffffffffc0206a48 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	94a60613          	addi	a2,a2,-1718 # ffffffffc0205880 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	91650513          	addi	a0,a0,-1770 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	dea60613          	addi	a2,a2,-534 # ffffffffc0205d38 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	d3650513          	addi	a0,a0,-714 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	d0260613          	addi	a2,a2,-766 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d1e50513          	addi	a0,a0,-738 # ffffffffc0205c90 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	ada68693          	addi	a3,a3,-1318 # ffffffffc0206a58 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	8fa60613          	addi	a2,a2,-1798 # ffffffffc0205880 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	8c650513          	addi	a0,a0,-1850 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	3ca68693          	addi	a3,a3,970 # ffffffffc0206368 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	8da60613          	addi	a2,a2,-1830 # ffffffffc0205880 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	8a650513          	addi	a0,a0,-1882 # ffffffffc0206858 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	38268693          	addi	a3,a3,898 # ffffffffc0206340 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	8ba60613          	addi	a2,a2,-1862 # ffffffffc0205880 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	88650513          	addi	a0,a0,-1914 # ffffffffc0206858 <default_pmm_manager+0xc28>
...
ffffffffc0204028:	c5a5                	beqz	a1,ffffffffc0204090 <do_pgfault+0xb2>
        ...
        */
        if (swap_init_ok) {
ffffffffc020402a:	00011797          	auipc	a5,0x11
ffffffffc020402e:	56e7a783          	lw	a5,1390(a5) # ffffffffc0215598 <swap_init_ok>
...
ffffffffc0204078:	ad450513          	addi	a0,a0,-1324 # ffffffffc0206b48 <default_pmm_manager+0xf18>
...
ffffffffc02040a2:	a8250513          	addi	a0,a0,-1406 # ffffffffc0206b20 <default_pmm_manager+0xef0>
...
ffffffffc02040b4:	a2050513          	addi	a0,a0,-1504 # ffffffffc0206ad0 <default_pmm_manager+0xea0>
...
ffffffffc02040c4:	a9850513          	addi	a0,a0,-1384 # ffffffffc0206b58 <default_pmm_manager+0xf28>
...
ffffffffc02040d4:	a3050513          	addi	a0,a0,-1488 # ffffffffc0206b00 <default_pmm_manager+0xed0>
...
ffffffffc02040f6:	00011797          	auipc	a5,0x11
ffffffffc02040fa:	48a7b923          	sd	a0,1170(a5) # ffffffffc0215588 <max_swap_offset>
}
ffffffffc02040fe:	0141                	addi	sp,sp,16
ffffffffc0204100:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204102:	00003617          	auipc	a2,0x3
ffffffffc0204106:	a7e60613          	addi	a2,a2,-1410 # ffffffffc0206b80 <default_pmm_manager+0xf50>
ffffffffc020410a:	45b5                	li	a1,13
ffffffffc020410c:	00003517          	auipc	a0,0x3
ffffffffc0204110:	a9450513          	addi	a0,a0,-1388 # ffffffffc0206ba0 <default_pmm_manager+0xf70>
...
ffffffffc0204126:	46673703          	ld	a4,1126(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc020412a:	04e7f563          	bgeu	a5,a4,ffffffffc0204174 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc020412e:	00011617          	auipc	a2,0x11
ffffffffc0204132:	44263603          	ld	a2,1090(a2) # ffffffffc0215570 <pages>
ffffffffc0204136:	8d91                	sub	a1,a1,a2
ffffffffc0204138:	4065d613          	srai	a2,a1,0x6
ffffffffc020413c:	00003717          	auipc	a4,0x3
ffffffffc0204140:	e9473703          	ld	a4,-364(a4) # ffffffffc0206fd0 <nbase>
ffffffffc0204144:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204146:	00c61713          	slli	a4,a2,0xc
ffffffffc020414a:	8331                	srli	a4,a4,0xc
ffffffffc020414c:	00011697          	auipc	a3,0x11
ffffffffc0204150:	41c6b683          	ld	a3,1052(a3) # ffffffffc0215568 <npage>
...
ffffffffc020415e:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204160:	00011797          	auipc	a5,0x11
ffffffffc0204164:	4207b783          	ld	a5,1056(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc0204196:	ad660613          	addi	a2,a2,-1322 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc020419a:	00002517          	auipc	a0,0x2
ffffffffc020419e:	af650513          	addi	a0,a0,-1290 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc02041b0:	00011717          	auipc	a4,0x11
ffffffffc02041b4:	3d873703          	ld	a4,984(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc02041b8:	04e7f563          	bgeu	a5,a4,ffffffffc0204202 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041bc:	00011617          	auipc	a2,0x11
ffffffffc02041c0:	3b463603          	ld	a2,948(a2) # ffffffffc0215570 <pages>
ffffffffc02041c4:	8d91                	sub	a1,a1,a2
ffffffffc02041c6:	4065d613          	srai	a2,a1,0x6
ffffffffc02041ca:	00003717          	auipc	a4,0x3
ffffffffc02041ce:	e0673703          	ld	a4,-506(a4) # ffffffffc0206fd0 <nbase>
ffffffffc02041d2:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041d4:	00c61713          	slli	a4,a2,0xc
ffffffffc02041d8:	8331                	srli	a4,a4,0xc
ffffffffc02041da:	00011697          	auipc	a3,0x11
ffffffffc02041de:	38e6b683          	ld	a3,910(a3) # ffffffffc0215568 <npage>
...
ffffffffc02041ec:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041ee:	00011797          	auipc	a5,0x11
ffffffffc02041f2:	3927b783          	ld	a5,914(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc0204208:	9b460613          	addi	a2,a2,-1612 # ffffffffc0206bb8 <default_pmm_manager+0xf88>
ffffffffc020420c:	45e5                	li	a1,25
ffffffffc020420e:	00003517          	auipc	a0,0x3
ffffffffc0204212:	99250513          	addi	a0,a0,-1646 # ffffffffc0206ba0 <default_pmm_manager+0xf70>
...
ffffffffc0204224:	a4860613          	addi	a2,a2,-1464 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc0204228:	00002517          	auipc	a0,0x2
ffffffffc020422c:	a6850513          	addi	a0,a0,-1432 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc0204272:	421000ef          	jal	ra,ffffffffc0204e92 <memset>
        proc->tf = NULL; //中断帧指针未分配
        proc->cr3 = boot_cr3;//内核线程的cr3为boot_cr3，即页目录为内核页目录表
ffffffffc0204276:	00011797          	auipc	a5,0x11
ffffffffc020427a:	2e27b783          	ld	a5,738(a5) # ffffffffc0215558 <boot_cr3>
        proc->tf = NULL; //中断帧指针未分配
...
ffffffffc0204288:	4641                	li	a2,16
ffffffffc020428a:	4581                	li	a1,0
ffffffffc020428c:	0b440513          	addi	a0,s0,180
ffffffffc0204290:	403000ef          	jal	ra,ffffffffc0204e92 <memset>
    }
    return proc;
}
...
ffffffffc02042a2:	3127b783          	ld	a5,786(a5) # ffffffffc02155b0 <current>
...
ffffffffc02042b0:	00011497          	auipc	s1,0x11
ffffffffc02042b4:	26848493          	addi	s1,s1,616 # ffffffffc0215518 <name.2>
init_main(void *arg) {
ffffffffc02042b8:	f022                	sd	s0,32(sp)
ffffffffc02042ba:	e84a                	sd	s2,16(sp)
ffffffffc02042bc:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042be:	00011917          	auipc	s2,0x11
ffffffffc02042c2:	2f293903          	ld	s2,754(s2) # ffffffffc02155b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc02042fa:	90a50513          	addi	a0,a0,-1782 # ffffffffc0206c00 <default_pmm_manager+0xfd0>
ffffffffc02042fe:	e83fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204302:	00003517          	auipc	a0,0x3
ffffffffc0204306:	90e50513          	addi	a0,a0,-1778 # ffffffffc0206c10 <default_pmm_manager+0xfe0>
...
ffffffffc0204320:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204322:	00011497          	auipc	s1,0x11
ffffffffc0204326:	28e48493          	addi	s1,s1,654 # ffffffffc02155b0 <current>
proc_run(struct proc_struct *proc) {
ffffffffc020432a:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc020432c:	0004b903          	ld	s2,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc0204330:	f406                	sd	ra,40(sp)
ffffffffc0204332:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204334:	02a90963          	beq	s2,a0,ffffffffc0204366 <proc_run+0x48>
        current = proc;
...
ffffffffc020433e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204340:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204342:	ef9d                	bnez	a5,ffffffffc0204380 <proc_run+0x62>
            lcr3(current->cr3);
ffffffffc0204344:	755c                	ld	a5,168(a0)
...
ffffffffc0204346:	80000737          	lui	a4,0x80000
            current = proc;
ffffffffc020434a:	e088                	sd	a0,0(s1)
...
ffffffffc020435a:	03090513          	addi	a0,s2,48
ffffffffc020435e:	584000ef          	jal	ra,ffffffffc02048e2 <switch_to>
    if (flag) {
...
ffffffffc020438a:	bf6d                	j	ffffffffc0204344 <proc_run+0x26>
...
ffffffffc0204390:	00011497          	auipc	s1,0x11
ffffffffc0204394:	23848493          	addi	s1,s1,568 # ffffffffc02155c8 <nr_process>
...
ffffffffc02043b8:	00011a17          	auipc	s4,0x11
ffffffffc02043bc:	1f8a0a13          	addi	s4,s4,504 # ffffffffc02155b0 <current>
...
ffffffffc02043ce:	1e050763          	beqz	a0,ffffffffc02045bc <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043d2:	00011697          	auipc	a3,0x11
ffffffffc02043d6:	19e6b683          	ld	a3,414(a3) # ffffffffc0215570 <pages>
ffffffffc02043da:	40d506b3          	sub	a3,a0,a3
ffffffffc02043de:	8699                	srai	a3,a3,0x6
ffffffffc02043e0:	00003517          	auipc	a0,0x3
ffffffffc02043e4:	bf053503          	ld	a0,-1040(a0) # ffffffffc0206fd0 <nbase>
ffffffffc02043e8:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043ea:	00c69793          	slli	a5,a3,0xc
ffffffffc02043ee:	83b1                	srli	a5,a5,0xc
ffffffffc02043f0:	00011717          	auipc	a4,0x11
ffffffffc02043f4:	17873703          	ld	a4,376(a4) # ffffffffc0215568 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc0204406:	17e73703          	ld	a4,382(a4) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc020446e:	12079663          	bnez	a5,ffffffffc020459a <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204472:	00006817          	auipc	a6,0x6
ffffffffc0204476:	be680813          	addi	a6,a6,-1050 # ffffffffc020a058 <last_pid.1>
...
ffffffffc020448c:	00006317          	auipc	t1,0x6
ffffffffc0204490:	bd030313          	addi	t1,t1,-1072 # ffffffffc020a05c <next_safe.0>
ffffffffc0204494:	00032783          	lw	a5,0(t1)
ffffffffc0204498:	00011417          	auipc	s0,0x11
ffffffffc020449c:	09040413          	addi	s0,s0,144 # ffffffffc0215528 <proc_list>
...
ffffffffc02044ac:	566000ef          	jal	ra,ffffffffc0204a12 <hash32>
ffffffffc02044b0:	02051793          	slli	a5,a0,0x20
ffffffffc02044b4:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044b8:	0000d797          	auipc	a5,0xd
ffffffffc02044bc:	06078793          	addi	a5,a5,96 # ffffffffc0211518 <hash_list>
...
ffffffffc02044f2:	45a000ef          	jal	ra,ffffffffc020494c <wakeup_proc>
    ret = proc->pid;
...
ffffffffc0204512:	00006317          	auipc	t1,0x6
ffffffffc0204516:	b4a30313          	addi	t1,t1,-1206 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc020451a:	00011417          	auipc	s0,0x11
ffffffffc020451e:	00e40413          	addi	s0,s0,14 # ffffffffc0215528 <proc_list>
...
ffffffffc02045d8:	65c68693          	addi	a3,a3,1628 # ffffffffc0206c30 <default_pmm_manager+0x1000>
ffffffffc02045dc:	00001617          	auipc	a2,0x1
ffffffffc02045e0:	2a460613          	addi	a2,a2,676 # ffffffffc0205880 <commands+0x738>
ffffffffc02045e4:	11f00593          	li	a1,287
ffffffffc02045e8:	00002517          	auipc	a0,0x2
ffffffffc02045ec:	66050513          	addi	a0,a0,1632 # ffffffffc0206c48 <default_pmm_manager+0x1018>
ffffffffc02045f0:	e57fb0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02045f4:	00001617          	auipc	a2,0x1
ffffffffc02045f8:	67460613          	addi	a2,a2,1652 # ffffffffc0205c68 <default_pmm_manager+0x38>
ffffffffc02045fc:	06900593          	li	a1,105
ffffffffc0204600:	00001517          	auipc	a0,0x1
ffffffffc0204604:	69050513          	addi	a0,a0,1680 # ffffffffc0205c90 <default_pmm_manager+0x60>
...
ffffffffc0204622:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));//所有字段初始化为 0
ffffffffc0204624:	06f000ef          	jal	ra,ffffffffc0204e92 <memset>
...
ffffffffc0204662:	60260613          	addi	a2,a2,1538 # ffffffffc0206c60 <default_pmm_manager+0x1030>
ffffffffc0204666:	19200593          	li	a1,402
ffffffffc020466a:	00002517          	auipc	a0,0x2
ffffffffc020466e:	5de50513          	addi	a0,a0,1502 # ffffffffc0206c48 <default_pmm_manager+0x1018>
do_exit(int error_code) {
...
ffffffffc020467a:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc020467c:	00011797          	auipc	a5,0x11
ffffffffc0204680:	eac78793          	addi	a5,a5,-340 # ffffffffc0215528 <proc_list>
...
ffffffffc020468c:	0000d497          	auipc	s1,0xd
ffffffffc0204690:	e8c48493          	addi	s1,s1,-372 # ffffffffc0211518 <hash_list>
...
ffffffffc020469c:	e8070713          	addi	a4,a4,-384 # ffffffffc0215518 <name.2>
...
ffffffffc02046b0:	00011917          	auipc	s2,0x11
ffffffffc02046b4:	f0890913          	addi	s2,s2,-248 # ffffffffc02155b8 <idleproc>
...
ffffffffc02046ce:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context)); // 将其清零
ffffffffc02046d0:	7c2000ef          	jal	ra,ffffffffc0204e92 <memset>
    // 比较 context 内容是否一致
...
ffffffffc02046e2:	7da000ef          	jal	ra,ffffffffc0204ebc <memcmp>
...
ffffffffc02046f2:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046f4:	79e000ef          	jal	ra,ffffffffc0204e92 <memset>
    // 比较 name 内容是否一致
...
ffffffffc0204704:	7b8000ef          	jal	ra,ffffffffc0204ebc <memcmp>
    // 检查 idleproc 的所有字段是否按照期望初始化
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204708:	00093783          	ld	a5,0(s2)
ffffffffc020470c:	00011717          	auipc	a4,0x11
ffffffffc0204710:	e4c73703          	ld	a4,-436(a4) # ffffffffc0215558 <boot_cr3>
...
ffffffffc020471e:	00003717          	auipc	a4,0x3
ffffffffc0204722:	8e270713          	addi	a4,a4,-1822 # ffffffffc0207000 <bootstack>
...
ffffffffc0204736:	75c000ef          	jal	ra,ffffffffc0204e92 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020473a:	463d                	li	a2,15
ffffffffc020473c:	00002597          	auipc	a1,0x2
ffffffffc0204740:	56c58593          	addi	a1,a1,1388 # ffffffffc0206ca8 <default_pmm_manager+0x1078>
ffffffffc0204744:	8522                	mv	a0,s0
ffffffffc0204746:	75e000ef          	jal	ra,ffffffffc0204ea4 <memcpy>
    set_proc_name(idleproc, "idle");// 设置进程名称为 "idle"
    nr_process ++;// 增加全局进程计数
ffffffffc020474a:	00011717          	auipc	a4,0x11
ffffffffc020474e:	e7e70713          	addi	a4,a4,-386 # ffffffffc02155c8 <nr_process>
...
ffffffffc0204760:	55458593          	addi	a1,a1,1364 # ffffffffc0206cb0 <default_pmm_manager+0x1080>
...
ffffffffc020476c:	c31c                	sw	a5,0(a4)
    current = idleproc; // 设置当前进程为 idleproc
ffffffffc020476e:	00011797          	auipc	a5,0x11
ffffffffc0204772:	e4d7b123          	sd	a3,-446(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
...
ffffffffc0204790:	282000ef          	jal	ra,ffffffffc0204a12 <hash32>
...
ffffffffc02047ba:	00011417          	auipc	s0,0x11
ffffffffc02047be:	e0640413          	addi	s0,s0,-506 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047c2:	8526                	mv	a0,s1
    initproc = find_proc(pid); // 根据 pid 查找新创建的 initproc
ffffffffc02047c4:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047c6:	6cc000ef          	jal	ra,ffffffffc0204e92 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047ca:	463d                	li	a2,15
ffffffffc02047cc:	00002597          	auipc	a1,0x2
ffffffffc02047d0:	51458593          	addi	a1,a1,1300 # ffffffffc0206ce0 <default_pmm_manager+0x10b0>
ffffffffc02047d4:	8526                	mv	a0,s1
ffffffffc02047d6:	6ce000ef          	jal	ra,ffffffffc0204ea4 <memcpy>
...
ffffffffc0204842:	45250513          	addi	a0,a0,1106 # ffffffffc0206c90 <default_pmm_manager+0x1060>
...
ffffffffc020485a:	42260613          	addi	a2,a2,1058 # ffffffffc0206c78 <default_pmm_manager+0x1048>
ffffffffc020485e:	1ab00593          	li	a1,427
ffffffffc0204862:	00002517          	auipc	a0,0x2
ffffffffc0204866:	3e650513          	addi	a0,a0,998 # ffffffffc0206c48 <default_pmm_manager+0x1018>
ffffffffc020486a:	bddfb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc020486e:	00002617          	auipc	a2,0x2
ffffffffc0204872:	45260613          	addi	a2,a2,1106 # ffffffffc0206cc0 <default_pmm_manager+0x1090>
ffffffffc0204876:	1cf00593          	li	a1,463
ffffffffc020487a:	00002517          	auipc	a0,0x2
ffffffffc020487e:	3ce50513          	addi	a0,a0,974 # ffffffffc0206c48 <default_pmm_manager+0x1018>
ffffffffc0204882:	bc5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204886:	00002697          	auipc	a3,0x2
ffffffffc020488a:	48a68693          	addi	a3,a3,1162 # ffffffffc0206d10 <default_pmm_manager+0x10e0>
ffffffffc020488e:	00001617          	auipc	a2,0x1
ffffffffc0204892:	ff260613          	addi	a2,a2,-14 # ffffffffc0205880 <commands+0x738>
ffffffffc0204896:	1d800593          	li	a1,472
ffffffffc020489a:	00002517          	auipc	a0,0x2
ffffffffc020489e:	3ae50513          	addi	a0,a0,942 # ffffffffc0206c48 <default_pmm_manager+0x1018>
ffffffffc02048a2:	ba5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048a6:	00002697          	auipc	a3,0x2
ffffffffc02048aa:	44268693          	addi	a3,a3,1090 # ffffffffc0206ce8 <default_pmm_manager+0x10b8>
ffffffffc02048ae:	00001617          	auipc	a2,0x1
ffffffffc02048b2:	fd260613          	addi	a2,a2,-46 # ffffffffc0205880 <commands+0x738>
ffffffffc02048b6:	1d600593          	li	a1,470
ffffffffc02048ba:	00002517          	auipc	a0,0x2
ffffffffc02048be:	38e50513          	addi	a0,a0,910 # ffffffffc0206c48 <default_pmm_manager+0x1018>
...
void
cpu_idle(void) {
ffffffffc02048c6:	1141                	addi	sp,sp,-16
ffffffffc02048c8:	e022                	sd	s0,0(sp)
ffffffffc02048ca:	e406                	sd	ra,8(sp)
ffffffffc02048cc:	00011417          	auipc	s0,0x11
ffffffffc02048d0:	ce440413          	addi	s0,s0,-796 # ffffffffc02155b0 <current>
    while (1) {//need_resched 为 true 时表示需要进行上下文切换
        if (current->need_resched) {
ffffffffc02048d4:	6018                	ld	a4,0(s0)
ffffffffc02048d6:	4f1c                	lw	a5,24(a4)
ffffffffc02048d8:	2781                	sext.w	a5,a5
ffffffffc02048da:	dff5                	beqz	a5,ffffffffc02048d6 <cpu_idle+0x10>
            //current,全局变量，指向当前正在运行的进程（此处为 idleproc）。
            //调度器
            schedule();
ffffffffc02048dc:	0a2000ef          	jal	ra,ffffffffc020497e <schedule>
ffffffffc02048e0:	bfd5                	j	ffffffffc02048d4 <cpu_idle+0xe>

ffffffffc02048e2 <switch_to>:
.text
...
ffffffffc02048e2:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc02048e6:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc02048ea:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc02048ec:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc02048ee:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc02048f2:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc02048f6:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc02048fa:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc02048fe:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204902:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204906:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020490a:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020490e:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204912:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204916:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc020491a:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020491e:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204920:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204922:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204926:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc020492a:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020492e:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204932:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204936:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc020493a:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc020493e:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204942:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204946:	0685bd83          	ld	s11,104(a1)
...
ffffffffc0204962:	3da68693          	addi	a3,a3,986 # ffffffffc0206d38 <default_pmm_manager+0x1108>
ffffffffc0204966:	00001617          	auipc	a2,0x1
ffffffffc020496a:	f1a60613          	addi	a2,a2,-230 # ffffffffc0205880 <commands+0x738>
ffffffffc020496e:	45a5                	li	a1,9
ffffffffc0204970:	00002517          	auipc	a0,0x2
ffffffffc0204974:	40850513          	addi	a0,a0,1032 # ffffffffc0206d78 <default_pmm_manager+0x1148>
wakeup_proc(struct proc_struct *proc) {
...
ffffffffc02049d6:	00a88463          	beq	a7,a0,ffffffffc02049de <schedule+0x60>
            proc_run(next);
ffffffffc02049da:	945ff0ef          	jal	ra,ffffffffc020431e <proc_run>
    if (flag) {
...
ffffffffc02049f8:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049fa:	bc3fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc0204a08:	b76d                	j	ffffffffc02049b2 <schedule+0x34>
        intr_disable();
ffffffffc0204a0a:	bb9fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a0e:	4405                	li	s0,1
ffffffffc0204a10:	bfbd                	j	ffffffffc020498e <schedule+0x10>

ffffffffc0204a12 <hash32>:
 *
...
ffffffffc0204a12:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a16:	2785                	addiw	a5,a5,1
ffffffffc0204a18:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a1c:	02000793          	li	a5,32
ffffffffc0204a20:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a22:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a26:	8082                	ret

ffffffffc0204a28 <printnum>:
 * */
static void
...
ffffffffc0204a28:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a2c:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a2e:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a32:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a34:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a38:	f022                	sd	s0,32(sp)
ffffffffc0204a3a:	ec26                	sd	s1,24(sp)
ffffffffc0204a3c:	e84a                	sd	s2,16(sp)
ffffffffc0204a3e:	f406                	sd	ra,40(sp)
ffffffffc0204a40:	e44e                	sd	s3,8(sp)
ffffffffc0204a42:	84aa                	mv	s1,a0
ffffffffc0204a44:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a46:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a4a:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a4c:	03067e63          	bgeu	a2,a6,ffffffffc0204a88 <printnum+0x60>
ffffffffc0204a50:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a52:	00805763          	blez	s0,ffffffffc0204a60 <printnum+0x38>
ffffffffc0204a56:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a58:	85ca                	mv	a1,s2
ffffffffc0204a5a:	854e                	mv	a0,s3
ffffffffc0204a5c:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a5e:	fc65                	bnez	s0,ffffffffc0204a56 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a60:	1a02                	slli	s4,s4,0x20
ffffffffc0204a62:	00002797          	auipc	a5,0x2
ffffffffc0204a66:	32e78793          	addi	a5,a5,814 # ffffffffc0206d90 <default_pmm_manager+0x1160>
ffffffffc0204a6a:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a6e:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a70:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a72:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a76:	70a2                	ld	ra,40(sp)
ffffffffc0204a78:	69a2                	ld	s3,8(sp)
ffffffffc0204a7a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a7c:	85ca                	mv	a1,s2
ffffffffc0204a7e:	87a6                	mv	a5,s1
}
ffffffffc0204a80:	6942                	ld	s2,16(sp)
ffffffffc0204a82:	64e2                	ld	s1,24(sp)
ffffffffc0204a84:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a86:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a88:	03065633          	divu	a2,a2,a6
ffffffffc0204a8c:	8722                	mv	a4,s0
ffffffffc0204a8e:	f9bff0ef          	jal	ra,ffffffffc0204a28 <printnum>
ffffffffc0204a92:	b7f9                	j	ffffffffc0204a60 <printnum+0x38>

ffffffffc0204a94 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a94:	7119                	addi	sp,sp,-128
ffffffffc0204a96:	f4a6                	sd	s1,104(sp)
ffffffffc0204a98:	f0ca                	sd	s2,96(sp)
ffffffffc0204a9a:	ecce                	sd	s3,88(sp)
...
ffffffffc0204aa4:	f06a                	sd	s10,32(sp)
ffffffffc0204aa6:	fc86                	sd	ra,120(sp)
ffffffffc0204aa8:	f8a2                	sd	s0,112(sp)
ffffffffc0204aaa:	f862                	sd	s8,48(sp)
ffffffffc0204aac:	f466                	sd	s9,40(sp)
ffffffffc0204aae:	ec6e                	sd	s11,24(sp)
ffffffffc0204ab0:	892a                	mv	s2,a0
ffffffffc0204ab2:	84ae                	mv	s1,a1
ffffffffc0204ab4:	8d32                	mv	s10,a2
ffffffffc0204ab6:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204ab8:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204abc:	5b7d                	li	s6,-1
ffffffffc0204abe:	00002a97          	auipc	s5,0x2
ffffffffc0204ac2:	2fea8a93          	addi	s5,s5,766 # ffffffffc0206dbc <default_pmm_manager+0x118c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204ac6:	00002b97          	auipc	s7,0x2
ffffffffc0204aca:	4d2b8b93          	addi	s7,s7,1234 # ffffffffc0206f98 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ace:	000d4503          	lbu	a0,0(s10)
ffffffffc0204ad2:	001d0413          	addi	s0,s10,1
ffffffffc0204ad6:	01350a63          	beq	a0,s3,ffffffffc0204aea <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204ada:	c121                	beqz	a0,ffffffffc0204b1a <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204adc:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ade:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204ae0:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ae2:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204ae6:	ff351ae3          	bne	a0,s3,ffffffffc0204ada <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aea:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204aee:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204af2:	4c81                	li	s9,0
ffffffffc0204af4:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204af6:	5c7d                	li	s8,-1
ffffffffc0204af8:	5dfd                	li	s11,-1
ffffffffc0204afa:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204afe:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b00:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b04:	0ff5f593          	andi	a1,a1,255
ffffffffc0204b08:	00140d13          	addi	s10,s0,1
ffffffffc0204b0c:	04b56263          	bltu	a0,a1,ffffffffc0204b50 <vprintfmt+0xbc>
ffffffffc0204b10:	058a                	slli	a1,a1,0x2
ffffffffc0204b12:	95d6                	add	a1,a1,s5
ffffffffc0204b14:	4194                	lw	a3,0(a1)
ffffffffc0204b16:	96d6                	add	a3,a3,s5
ffffffffc0204b18:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b1a:	70e6                	ld	ra,120(sp)
ffffffffc0204b1c:	7446                	ld	s0,112(sp)
ffffffffc0204b1e:	74a6                	ld	s1,104(sp)
ffffffffc0204b20:	7906                	ld	s2,96(sp)
ffffffffc0204b22:	69e6                	ld	s3,88(sp)
ffffffffc0204b24:	6a46                	ld	s4,80(sp)
ffffffffc0204b26:	6aa6                	ld	s5,72(sp)
ffffffffc0204b28:	6b06                	ld	s6,64(sp)
ffffffffc0204b2a:	7be2                	ld	s7,56(sp)
ffffffffc0204b2c:	7c42                	ld	s8,48(sp)
ffffffffc0204b2e:	7ca2                	ld	s9,40(sp)
ffffffffc0204b30:	7d02                	ld	s10,32(sp)
ffffffffc0204b32:	6de2                	ld	s11,24(sp)
ffffffffc0204b34:	6109                	addi	sp,sp,128
ffffffffc0204b36:	8082                	ret
            padc = '0';
ffffffffc0204b38:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b3a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b3e:	846a                	mv	s0,s10
ffffffffc0204b40:	00140d13          	addi	s10,s0,1
ffffffffc0204b44:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b48:	0ff5f593          	andi	a1,a1,255
ffffffffc0204b4c:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b10 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b50:	85a6                	mv	a1,s1
ffffffffc0204b52:	02500513          	li	a0,37
ffffffffc0204b56:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b58:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b5c:	8d22                	mv	s10,s0
ffffffffc0204b5e:	f73788e3          	beq	a5,s3,ffffffffc0204ace <vprintfmt+0x3a>
ffffffffc0204b62:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b66:	1d7d                	addi	s10,s10,-1
ffffffffc0204b68:	ff379de3          	bne	a5,s3,ffffffffc0204b62 <vprintfmt+0xce>
ffffffffc0204b6c:	b78d                	j	ffffffffc0204ace <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b6e:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b72:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b76:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b78:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b7c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b80:	02d86463          	bltu	a6,a3,ffffffffc0204ba8 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b84:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b88:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b8c:	0186873b          	addw	a4,a3,s8
ffffffffc0204b90:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b94:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b96:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b9a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b9c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204ba0:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204ba4:	fed870e3          	bgeu	a6,a3,ffffffffc0204b84 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204ba8:	f40ddce3          	bgez	s11,ffffffffc0204b00 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bac:	8de2                	mv	s11,s8
ffffffffc0204bae:	5c7d                	li	s8,-1
ffffffffc0204bb0:	bf81                	j	ffffffffc0204b00 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bb2:	fffdc693          	not	a3,s11
ffffffffc0204bb6:	96fd                	srai	a3,a3,0x3f
ffffffffc0204bb8:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bbc:	00144603          	lbu	a2,1(s0)
ffffffffc0204bc0:	2d81                	sext.w	s11,s11
ffffffffc0204bc2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bc4:	bf35                	j	ffffffffc0204b00 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bc6:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bca:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bce:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bd0:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204bd2:	bfd9                	j	ffffffffc0204ba8 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bd4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bd6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bda:	01174463          	blt	a4,a7,ffffffffc0204be2 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bde:	1a088e63          	beqz	a7,ffffffffc0204d9a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204be2:	000a3603          	ld	a2,0(s4)
ffffffffc0204be6:	46c1                	li	a3,16
ffffffffc0204be8:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204bea:	2781                	sext.w	a5,a5
ffffffffc0204bec:	876e                	mv	a4,s11
ffffffffc0204bee:	85a6                	mv	a1,s1
ffffffffc0204bf0:	854a                	mv	a0,s2
ffffffffc0204bf2:	e37ff0ef          	jal	ra,ffffffffc0204a28 <printnum>
            break;
ffffffffc0204bf6:	bde1                	j	ffffffffc0204ace <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204bf8:	000a2503          	lw	a0,0(s4)
ffffffffc0204bfc:	85a6                	mv	a1,s1
ffffffffc0204bfe:	0a21                	addi	s4,s4,8
ffffffffc0204c00:	9902                	jalr	s2
            break;
ffffffffc0204c02:	b5f1                	j	ffffffffc0204ace <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c04:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c06:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c0a:	01174463          	blt	a4,a7,ffffffffc0204c12 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c0e:	18088163          	beqz	a7,ffffffffc0204d90 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c12:	000a3603          	ld	a2,0(s4)
ffffffffc0204c16:	46a9                	li	a3,10
ffffffffc0204c18:	8a2e                	mv	s4,a1
ffffffffc0204c1a:	bfc1                	j	ffffffffc0204bea <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c1c:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c20:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c22:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c24:	bdf1                	j	ffffffffc0204b00 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c26:	85a6                	mv	a1,s1
ffffffffc0204c28:	02500513          	li	a0,37
ffffffffc0204c2c:	9902                	jalr	s2
            break;
ffffffffc0204c2e:	b545                	j	ffffffffc0204ace <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c30:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c34:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c36:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c38:	b5e1                	j	ffffffffc0204b00 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c3a:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c3c:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c40:	01174463          	blt	a4,a7,ffffffffc0204c48 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c44:	14088163          	beqz	a7,ffffffffc0204d86 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c48:	000a3603          	ld	a2,0(s4)
ffffffffc0204c4c:	46a1                	li	a3,8
ffffffffc0204c4e:	8a2e                	mv	s4,a1
ffffffffc0204c50:	bf69                	j	ffffffffc0204bea <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c52:	03000513          	li	a0,48
ffffffffc0204c56:	85a6                	mv	a1,s1
ffffffffc0204c58:	e03e                	sd	a5,0(sp)
ffffffffc0204c5a:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c5c:	85a6                	mv	a1,s1
ffffffffc0204c5e:	07800513          	li	a0,120
ffffffffc0204c62:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c64:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c66:	6782                	ld	a5,0(sp)
ffffffffc0204c68:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c6a:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c6e:	bfb5                	j	ffffffffc0204bea <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c70:	000a3403          	ld	s0,0(s4)
ffffffffc0204c74:	008a0713          	addi	a4,s4,8
ffffffffc0204c78:	e03a                	sd	a4,0(sp)
ffffffffc0204c7a:	14040263          	beqz	s0,ffffffffc0204dbe <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c7e:	0fb05763          	blez	s11,ffffffffc0204d6c <vprintfmt+0x2d8>
ffffffffc0204c82:	02d00693          	li	a3,45
ffffffffc0204c86:	0cd79163          	bne	a5,a3,ffffffffc0204d48 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c8a:	00044783          	lbu	a5,0(s0)
ffffffffc0204c8e:	0007851b          	sext.w	a0,a5
ffffffffc0204c92:	cf85                	beqz	a5,ffffffffc0204cca <vprintfmt+0x236>
ffffffffc0204c94:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c98:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c9c:	000c4563          	bltz	s8,ffffffffc0204ca6 <vprintfmt+0x212>
ffffffffc0204ca0:	3c7d                	addiw	s8,s8,-1
ffffffffc0204ca2:	036c0263          	beq	s8,s6,ffffffffc0204cc6 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204ca6:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204ca8:	0e0c8e63          	beqz	s9,ffffffffc0204da4 <vprintfmt+0x310>
ffffffffc0204cac:	3781                	addiw	a5,a5,-32
ffffffffc0204cae:	0ef47b63          	bgeu	s0,a5,ffffffffc0204da4 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cb2:	03f00513          	li	a0,63
ffffffffc0204cb6:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cb8:	000a4783          	lbu	a5,0(s4)
ffffffffc0204cbc:	3dfd                	addiw	s11,s11,-1
ffffffffc0204cbe:	0a05                	addi	s4,s4,1
ffffffffc0204cc0:	0007851b          	sext.w	a0,a5
ffffffffc0204cc4:	ffe1                	bnez	a5,ffffffffc0204c9c <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cc6:	01b05963          	blez	s11,ffffffffc0204cd8 <vprintfmt+0x244>
...
ffffffffc0204cd2:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cd4:	fe0d9be3          	bnez	s11,ffffffffc0204cca <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cd8:	6a02                	ld	s4,0(sp)
ffffffffc0204cda:	bbd5                	j	ffffffffc0204ace <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cdc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cde:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204ce2:	01174463          	blt	a4,a7,ffffffffc0204cea <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204ce6:	08088d63          	beqz	a7,ffffffffc0204d80 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204cea:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cee:	0a044d63          	bltz	s0,ffffffffc0204da8 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cf2:	8622                	mv	a2,s0
ffffffffc0204cf4:	8a66                	mv	s4,s9
ffffffffc0204cf6:	46a9                	li	a3,10
ffffffffc0204cf8:	bdcd                	j	ffffffffc0204bea <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204cfa:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cfe:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d00:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d02:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d06:	8fb5                	xor	a5,a5,a3
ffffffffc0204d08:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d0c:	02d74163          	blt	a4,a3,ffffffffc0204d2e <vprintfmt+0x29a>
ffffffffc0204d10:	00369793          	slli	a5,a3,0x3
ffffffffc0204d14:	97de                	add	a5,a5,s7
ffffffffc0204d16:	639c                	ld	a5,0(a5)
ffffffffc0204d18:	cb99                	beqz	a5,ffffffffc0204d2e <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d1a:	86be                	mv	a3,a5
ffffffffc0204d1c:	00000617          	auipc	a2,0x0
ffffffffc0204d20:	1ec60613          	addi	a2,a2,492 # ffffffffc0204f08 <etext+0x28>
ffffffffc0204d24:	85a6                	mv	a1,s1
ffffffffc0204d26:	854a                	mv	a0,s2
ffffffffc0204d28:	0ce000ef          	jal	ra,ffffffffc0204df6 <printfmt>
ffffffffc0204d2c:	b34d                	j	ffffffffc0204ace <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d2e:	00002617          	auipc	a2,0x2
ffffffffc0204d32:	08260613          	addi	a2,a2,130 # ffffffffc0206db0 <default_pmm_manager+0x1180>
ffffffffc0204d36:	85a6                	mv	a1,s1
ffffffffc0204d38:	854a                	mv	a0,s2
ffffffffc0204d3a:	0bc000ef          	jal	ra,ffffffffc0204df6 <printfmt>
ffffffffc0204d3e:	bb41                	j	ffffffffc0204ace <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d40:	00002417          	auipc	s0,0x2
ffffffffc0204d44:	06840413          	addi	s0,s0,104 # ffffffffc0206da8 <default_pmm_manager+0x1178>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d48:	85e2                	mv	a1,s8
ffffffffc0204d4a:	8522                	mv	a0,s0
ffffffffc0204d4c:	e43e                	sd	a5,8(sp)
ffffffffc0204d4e:	0e2000ef          	jal	ra,ffffffffc0204e30 <strnlen>
ffffffffc0204d52:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d56:	01b05b63          	blez	s11,ffffffffc0204d6c <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d5a:	67a2                	ld	a5,8(sp)
ffffffffc0204d5c:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d60:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d62:	85a6                	mv	a1,s1
ffffffffc0204d64:	8552                	mv	a0,s4
ffffffffc0204d66:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d68:	fe0d9ce3          	bnez	s11,ffffffffc0204d60 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d6c:	00044783          	lbu	a5,0(s0)
ffffffffc0204d70:	00140a13          	addi	s4,s0,1
ffffffffc0204d74:	0007851b          	sext.w	a0,a5
ffffffffc0204d78:	d3a5                	beqz	a5,ffffffffc0204cd8 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d7a:	05e00413          	li	s0,94
ffffffffc0204d7e:	bf39                	j	ffffffffc0204c9c <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d80:	000a2403          	lw	s0,0(s4)
ffffffffc0204d84:	b7ad                	j	ffffffffc0204cee <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d86:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d8a:	46a1                	li	a3,8
ffffffffc0204d8c:	8a2e                	mv	s4,a1
ffffffffc0204d8e:	bdb1                	j	ffffffffc0204bea <vprintfmt+0x156>
ffffffffc0204d90:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d94:	46a9                	li	a3,10
ffffffffc0204d96:	8a2e                	mv	s4,a1
ffffffffc0204d98:	bd89                	j	ffffffffc0204bea <vprintfmt+0x156>
ffffffffc0204d9a:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d9e:	46c1                	li	a3,16
ffffffffc0204da0:	8a2e                	mv	s4,a1
ffffffffc0204da2:	b5a1                	j	ffffffffc0204bea <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204da4:	9902                	jalr	s2
ffffffffc0204da6:	bf09                	j	ffffffffc0204cb8 <vprintfmt+0x224>
                putch('-', putdat);
...
ffffffffc0204db0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204db2:	6782                	ld	a5,0(sp)
ffffffffc0204db4:	8a66                	mv	s4,s9
ffffffffc0204db6:	40800633          	neg	a2,s0
ffffffffc0204dba:	46a9                	li	a3,10
ffffffffc0204dbc:	b53d                	j	ffffffffc0204bea <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204dbe:	03b05163          	blez	s11,ffffffffc0204de0 <vprintfmt+0x34c>
ffffffffc0204dc2:	02d00693          	li	a3,45
ffffffffc0204dc6:	f6d79de3          	bne	a5,a3,ffffffffc0204d40 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204dca:	00002417          	auipc	s0,0x2
ffffffffc0204dce:	fde40413          	addi	s0,s0,-34 # ffffffffc0206da8 <default_pmm_manager+0x1178>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dd2:	02800793          	li	a5,40
ffffffffc0204dd6:	02800513          	li	a0,40
ffffffffc0204dda:	00140a13          	addi	s4,s0,1
ffffffffc0204dde:	bd6d                	j	ffffffffc0204c98 <vprintfmt+0x204>
ffffffffc0204de0:	00002a17          	auipc	s4,0x2
ffffffffc0204de4:	fc9a0a13          	addi	s4,s4,-55 # ffffffffc0206da9 <default_pmm_manager+0x1179>
ffffffffc0204de8:	02800513          	li	a0,40
ffffffffc0204dec:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204df0:	05e00413          	li	s0,94
ffffffffc0204df4:	b565                	j	ffffffffc0204c9c <vprintfmt+0x208>
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204e16:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204e1a:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e1c:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e1e:	cb81                	beqz	a5,ffffffffc0204e2e <strlen+0x18>
        cnt ++;
ffffffffc0204e20:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e22:	00a707b3          	add	a5,a4,a0
ffffffffc0204e26:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e2a:	fbfd                	bnez	a5,ffffffffc0204e20 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e30:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e32:	e589                	bnez	a1,ffffffffc0204e3c <strnlen+0xc>
ffffffffc0204e34:	a811                	j	ffffffffc0204e48 <strnlen+0x18>
        cnt ++;
ffffffffc0204e36:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e38:	00f58863          	beq	a1,a5,ffffffffc0204e48 <strnlen+0x18>
ffffffffc0204e3c:	00f50733          	add	a4,a0,a5
ffffffffc0204e40:	00074703          	lbu	a4,0(a4)
ffffffffc0204e44:	fb6d                	bnez	a4,ffffffffc0204e36 <strnlen+0x6>
ffffffffc0204e46:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e48:	852e                	mv	a0,a1
ffffffffc0204e4a:	8082                	ret

ffffffffc0204e4c <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e4c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e4e:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e52:	0785                	addi	a5,a5,1
ffffffffc0204e54:	0585                	addi	a1,a1,1
ffffffffc0204e56:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e5a:	fb75                	bnez	a4,ffffffffc0204e4e <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e5e:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e62:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e66:	cb89                	beqz	a5,ffffffffc0204e78 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e68:	0505                	addi	a0,a0,1
ffffffffc0204e6a:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e6c:	fee789e3          	beq	a5,a4,ffffffffc0204e5e <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e70:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e74:	9d19                	subw	a0,a0,a4
ffffffffc0204e76:	8082                	ret
ffffffffc0204e78:	4501                	li	a0,0
ffffffffc0204e7a:	bfed                	j	ffffffffc0204e74 <strcmp+0x16>
...
ffffffffc0204e80:	c799                	beqz	a5,ffffffffc0204e8e <strchr+0x12>
        if (*s == c) {
ffffffffc0204e82:	00f58763          	beq	a1,a5,ffffffffc0204e90 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e86:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e8a:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e8c:	fbfd                	bnez	a5,ffffffffc0204e82 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e92:	ca01                	beqz	a2,ffffffffc0204ea2 <memset+0x10>
ffffffffc0204e94:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e96:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e98:	0785                	addi	a5,a5,1
ffffffffc0204e9a:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e9e:	fec79de3          	bne	a5,a2,ffffffffc0204e98 <memset+0x6>
    }
    return s;
...
ffffffffc0204ea4 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204ea4:	ca19                	beqz	a2,ffffffffc0204eba <memcpy+0x16>
ffffffffc0204ea6:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204ea8:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204eaa:	0005c703          	lbu	a4,0(a1)
ffffffffc0204eae:	0585                	addi	a1,a1,1
ffffffffc0204eb0:	0785                	addi	a5,a5,1
ffffffffc0204eb2:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204eb6:	fec59ae3          	bne	a1,a2,ffffffffc0204eaa <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204ebc:	c205                	beqz	a2,ffffffffc0204edc <memcmp+0x20>
ffffffffc0204ebe:	962e                	add	a2,a2,a1
ffffffffc0204ec0:	a019                	j	ffffffffc0204ec6 <memcmp+0xa>
ffffffffc0204ec2:	00c58d63          	beq	a1,a2,ffffffffc0204edc <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204eca:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204ece:	0505                	addi	a0,a0,1
ffffffffc0204ed0:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204ed2:	fee788e3          	beq	a5,a4,ffffffffc0204ec2 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204ed6:	40e7853b          	subw	a0,a5,a4
ffffffffc0204eda:	8082                	ret
    }
    return 0;
ffffffffc0204edc:	4501                	li	a0,0
}
