...
ffffffffc0200036:	20e50513          	addi	a0,a0,526 # ffffffffc02a7240 <buf>
ffffffffc020003a:	000b2617          	auipc	a2,0xb2
ffffffffc020003e:	76260613          	addi	a2,a2,1890 # ffffffffc02b279c <end>
kern_init(void) {
...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	574060ef          	jal	ra,ffffffffc02065be <memset>
...
ffffffffc020008e:	641050ef          	jal	ra,ffffffffc0205ece <cpu_idle>
...
ffffffffc02000ac:	56850513          	addi	a0,a0,1384 # ffffffffc0206610 <etext+0x28>
...
ffffffffc02000c2:	182b8b93          	addi	s7,s7,386 # ffffffffc02a7240 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020011e:	12650513          	addi	a0,a0,294 # ffffffffc02a7240 <buf>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	04c060ef          	jal	ra,ffffffffc02061c0 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	016060ef          	jal	ra,ffffffffc02061c0 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020020e:	40e50513          	addi	a0,a0,1038 # ffffffffc0206618 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc020028e:	42e50513          	addi	a0,a0,1070 # ffffffffc02066b8 <etext+0xd0>
}
...
ffffffffc020029c:	45060613          	addi	a2,a2,1104 # ffffffffc02066e8 <etext+0x100>
ffffffffc02002a0:	04d00593          	li	a1,77
ffffffffc02002a4:	00006517          	auipc	a0,0x6
ffffffffc02002a8:	45c50513          	addi	a0,a0,1116 # ffffffffc0206700 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc02002b8:	46460613          	addi	a2,a2,1124 # ffffffffc0206718 <etext+0x130>
ffffffffc02002bc:	00006597          	auipc	a1,0x6
ffffffffc02002c0:	47c58593          	addi	a1,a1,1148 # ffffffffc0206738 <etext+0x150>
ffffffffc02002c4:	00006517          	auipc	a0,0x6
ffffffffc02002c8:	47c50513          	addi	a0,a0,1148 # ffffffffc0206740 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002d6:	47e60613          	addi	a2,a2,1150 # ffffffffc0206750 <etext+0x168>
ffffffffc02002da:	00006597          	auipc	a1,0x6
ffffffffc02002de:	49e58593          	addi	a1,a1,1182 # ffffffffc0206778 <etext+0x190>
ffffffffc02002e2:	00006517          	auipc	a0,0x6
ffffffffc02002e6:	45e50513          	addi	a0,a0,1118 # ffffffffc0206740 <etext+0x158>
ffffffffc02002ea:	e97ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ee:	00006617          	auipc	a2,0x6
ffffffffc02002f2:	49a60613          	addi	a2,a2,1178 # ffffffffc0206788 <etext+0x1a0>
ffffffffc02002f6:	00006597          	auipc	a1,0x6
ffffffffc02002fa:	4b258593          	addi	a1,a1,1202 # ffffffffc02067a8 <etext+0x1c0>
ffffffffc02002fe:	00006517          	auipc	a0,0x6
ffffffffc0200302:	44250513          	addi	a0,a0,1090 # ffffffffc0206740 <etext+0x158>
...
ffffffffc020033c:	48050513          	addi	a0,a0,1152 # ffffffffc02067b8 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020035e:	48650513          	addi	a0,a0,1158 # ffffffffc02067e0 <etext+0x1f8>
...
ffffffffc020037c:	49090913          	addi	s2,s2,1168 # ffffffffc0206808 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200380:	00006497          	auipc	s1,0x6
ffffffffc0200384:	49048493          	addi	s1,s1,1168 # ffffffffc0206810 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200388:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020038a:	00006b17          	auipc	s6,0x6
ffffffffc020038e:	48eb0b13          	addi	s6,s6,1166 # ffffffffc0206818 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc0200392:	00006a17          	auipc	s4,0x6
ffffffffc0200396:	3a6a0a13          	addi	s4,s4,934 # ffffffffc0206738 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003c2:	1c8060ef          	jal	ra,ffffffffc020658a <strcmp>
...
ffffffffc02003d4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003d6:	1b4060ef          	jal	ra,ffffffffc020658a <strcmp>
...
ffffffffc0200414:	194060ef          	jal	ra,ffffffffc02065a8 <strchr>
...
ffffffffc0200452:	156060ef          	jal	ra,ffffffffc02065a8 <strchr>
...
ffffffffc0200470:	3cc50513          	addi	a0,a0,972 # ffffffffc0206838 <etext+0x250>
...
ffffffffc020047e:	28e30313          	addi	t1,t1,654 # ffffffffc02b2708 <is_panic>
...
ffffffffc0200530:	1ef73623          	sd	a5,492(a4) # ffffffffc02b2718 <timebase>
...
ffffffffc0200558:	1a07be23          	sd	zero,444(a5) # ffffffffc02b2710 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200566:	1b67b783          	ld	a5,438(a5) # ffffffffc02b2718 <timebase>
...
ffffffffc02005fc:	04878793          	addi	a5,a5,72 # ffffffffc02a7640 <ide>
    int iobase = secno * SECTSIZE;
...
ffffffffc020060e:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200610:	7c1050ef          	jal	ra,ffffffffc02065d0 <memcpy>
    return 0;
}
...
ffffffffc0200624:	02050513          	addi	a0,a0,32 # ffffffffc02a7640 <ide>
                   size_t nsecs) {
...
ffffffffc0200632:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200634:	79d050ef          	jal	ra,ffffffffc02065d0 <memcpy>
    return 0;
}
...
ffffffffc020089e:	ed648493          	addi	s1,s1,-298 # ffffffffc02b2770 <check_mm_struct>
...
ffffffffc02008e4:	ea073703          	ld	a4,-352(a4) # ffffffffc02b2780 <current>
ffffffffc02008e8:	000b2797          	auipc	a5,0xb2
ffffffffc02008ec:	ea07b783          	ld	a5,-352(a5) # ffffffffc02b2788 <idleproc>
...
ffffffffc0200920:	e647b783          	ld	a5,-412(a5) # ffffffffc02b2780 <current>
...
ffffffffc0200a0c:	d0868693          	addi	a3,a3,-760 # ffffffffc02b2710 <ticks>
...
ffffffffc0200a24:	d607b783          	ld	a5,-672(a5) # ffffffffc02b2780 <current>
...
ffffffffc0200a84:	6105                	addi	sp,sp,32
            syscall();
ffffffffc0200a86:	6380506f          	j	ffffffffc02060be <syscall>
...
ffffffffc0200b42:	10f43423          	sd	a5,264(s0)
                syscall();
ffffffffc0200b46:	578050ef          	jal	ra,ffffffffc02060be <syscall>
                kernel_execve_ret(tf,current->kstack+KSTACKSIZE);
ffffffffc0200b4a:	000b2797          	auipc	a5,0xb2
ffffffffc0200b4e:	c367b783          	ld	a5,-970(a5) # ffffffffc02b2780 <current>
...
ffffffffc0200b94:	0ce00593          	li	a1,206
...
ffffffffc0200bf0:	0d200593          	li	a1,210
...
ffffffffc0200c28:	b5c40413          	addi	s0,s0,-1188 # ffffffffc02b2780 <current>
...
ffffffffc0200c9a:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200c9c:	3360506f          	j	ffffffffc0205fd2 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200ca0:	555d                	li	a0,-9
ffffffffc0200ca2:	67a040ef          	jal	ra,ffffffffc020531c <do_exit>
            if (current->need_resched) {
...
ffffffffc0200e26:	81e78793          	addi	a5,a5,-2018 # ffffffffc02ae640 <free_area>
...
ffffffffc0200e38:	81c56503          	lwu	a0,-2020(a0) # ffffffffc02ae650 <free_area+0x10>
...
ffffffffc0200e46:	7fe40413          	addi	s0,s0,2046 # ffffffffc02ae640 <free_area>
...
ffffffffc0200f28:	7207a623          	sw	zero,1836(a5) # ffffffffc02ae650 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100a:	6407a523          	sw	zero,1610(a5) # ffffffffc02ae650 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc0201606:	03e68693          	addi	a3,a3,62 # ffffffffc02ae640 <free_area>
...
ffffffffc02016f0:	bfc68693          	addi	a3,a3,-1028 # ffffffffc02072e8 <commands+0xa98>
ffffffffc02016f4:	00005617          	auipc	a2,0x5
ffffffffc02016f8:	5ac60613          	addi	a2,a2,1452 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02016fc:	08300593          	li	a1,131
ffffffffc0201700:	00006517          	auipc	a0,0x6
ffffffffc0201704:	8a050513          	addi	a0,a0,-1888 # ffffffffc0206fa0 <commands+0x750>
ffffffffc0201708:	d73fe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc020170c:	00006697          	auipc	a3,0x6
ffffffffc0201710:	bd468693          	addi	a3,a3,-1068 # ffffffffc02072e0 <commands+0xa90>
ffffffffc0201714:	00005617          	auipc	a2,0x5
ffffffffc0201718:	58c60613          	addi	a2,a2,1420 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020171c:	08000593          	li	a1,128
ffffffffc0201720:	00006517          	auipc	a0,0x6
ffffffffc0201724:	88050513          	addi	a0,a0,-1920 # ffffffffc0206fa0 <commands+0x750>
...
ffffffffc0201732:	f1258593          	addi	a1,a1,-238 # ffffffffc02ae640 <free_area>
...
ffffffffc02017c2:	b2268693          	addi	a3,a3,-1246 # ffffffffc02072e0 <commands+0xa90>
ffffffffc02017c6:	00005617          	auipc	a2,0x5
ffffffffc02017ca:	4da60613          	addi	a2,a2,1242 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02017ce:	06200593          	li	a1,98
ffffffffc02017d2:	00005517          	auipc	a0,0x5
ffffffffc02017d6:	7ce50513          	addi	a0,a0,1998 # ffffffffc0206fa0 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020181e:	e2668693          	addi	a3,a3,-474 # ffffffffc02ae640 <free_area>
...
ffffffffc0201894:	a8068693          	addi	a3,a3,-1408 # ffffffffc0207310 <commands+0xac0>
ffffffffc0201898:	00005617          	auipc	a2,0x5
ffffffffc020189c:	40860613          	addi	a2,a2,1032 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02018a0:	04900593          	li	a1,73
ffffffffc02018a4:	00005517          	auipc	a0,0x5
ffffffffc02018a8:	6fc50513          	addi	a0,a0,1788 # ffffffffc0206fa0 <commands+0x750>
ffffffffc02018ac:	bcffe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(n > 0);
ffffffffc02018b0:	00006697          	auipc	a3,0x6
ffffffffc02018b4:	a3068693          	addi	a3,a3,-1488 # ffffffffc02072e0 <commands+0xa90>
ffffffffc02018b8:	00005617          	auipc	a2,0x5
ffffffffc02018bc:	3e860613          	addi	a2,a2,1000 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02018c0:	04600593          	li	a1,70
ffffffffc02018c4:	00005517          	auipc	a0,0x5
ffffffffc02018c8:	6dc50513          	addi	a0,a0,1756 # ffffffffc0206fa0 <commands+0x750>
...
ffffffffc02018ea:	94a60613          	addi	a2,a2,-1718 # ffffffffc02a7230 <slobfree>
...
ffffffffc0201998:	dac6b683          	ld	a3,-596(a3) # ffffffffc02b2740 <pages>
ffffffffc020199c:	8d15                	sub	a0,a0,a3
ffffffffc020199e:	8519                	srai	a0,a0,0x6
ffffffffc02019a0:	00007697          	auipc	a3,0x7
ffffffffc02019a4:	3406b683          	ld	a3,832(a3) # ffffffffc0208ce0 <nbase>
...
ffffffffc02019b4:	d8873703          	ld	a4,-632(a4) # ffffffffc02b2738 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc02019c2:	d926b683          	ld	a3,-622(a3) # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc02019d4:	9a060613          	addi	a2,a2,-1632 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc02019d8:	06900593          	li	a1,105
ffffffffc02019dc:	00006517          	auipc	a0,0x6
ffffffffc02019e0:	9bc50513          	addi	a0,a0,-1604 # ffffffffc0207398 <default_pmm_manager+0x60>
...
ffffffffc0201a10:	82490913          	addi	s2,s2,-2012 # ffffffffc02a7230 <slobfree>
...
ffffffffc0201ac2:	8ea68693          	addi	a3,a3,-1814 # ffffffffc02073a8 <default_pmm_manager+0x70>
ffffffffc0201ac6:	00005617          	auipc	a2,0x5
ffffffffc0201aca:	1da60613          	addi	a2,a2,474 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0201ace:	06400593          	li	a1,100
ffffffffc0201ad2:	00006517          	auipc	a0,0x6
ffffffffc0201ad6:	8f650513          	addi	a0,a0,-1802 # ffffffffc02073c8 <default_pmm_manager+0x90>
...
ffffffffc0201ae4:	90050513          	addi	a0,a0,-1792 # ffffffffc02073e0 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201af4:	90850513          	addi	a0,a0,-1784 # ffffffffc02073f8 <default_pmm_manager+0xc0>
}
...
ffffffffc0201b4e:	bd678793          	addi	a5,a5,-1066 # ffffffffc02b2720 <bigblocks>
...
ffffffffc0201b8a:	b9a78793          	addi	a5,a5,-1126 # ffffffffc02b2720 <bigblocks>
...
ffffffffc0201bd0:	b547b783          	ld	a5,-1196(a5) # ffffffffc02b2720 <bigblocks>
    return 0;
...
ffffffffc0201bdc:	b4868693          	addi	a3,a3,-1208 # ffffffffc02b2720 <bigblocks>
...
ffffffffc0201c60:	ac47b783          	ld	a5,-1340(a5) # ffffffffc02b2720 <bigblocks>
        return 1;
...
ffffffffc0201c7a:	7ca60613          	addi	a2,a2,1994 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0201c7e:	06200593          	li	a1,98
ffffffffc0201c82:	00005517          	auipc	a0,0x5
ffffffffc0201c86:	71650513          	addi	a0,a0,1814 # ffffffffc0207398 <default_pmm_manager+0x60>
...
ffffffffc0201c94:	78860613          	addi	a2,a2,1928 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc0201c98:	06e00593          	li	a1,110
ffffffffc0201c9c:	00005517          	auipc	a0,0x5
ffffffffc0201ca0:	6fc50513          	addi	a0,a0,1788 # ffffffffc0207398 <default_pmm_manager+0x60>
...
ffffffffc0201cae:	79660613          	addi	a2,a2,1942 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0201cb2:	06200593          	li	a1,98
ffffffffc0201cb6:	00005517          	auipc	a0,0x5
ffffffffc0201cba:	6e250513          	addi	a0,a0,1762 # ffffffffc0207398 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201cca:	79a60613          	addi	a2,a2,1946 # ffffffffc0207460 <default_pmm_manager+0x128>
ffffffffc0201cce:	07400593          	li	a1,116
ffffffffc0201cd2:	00005517          	auipc	a0,0x5
ffffffffc0201cd6:	6c650513          	addi	a0,a0,1734 # ffffffffc0207398 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201cf8:	a5490913          	addi	s2,s2,-1452 # ffffffffc02b2748 <pmm_manager>
        {
...
ffffffffc0201d02:	a6aa8a93          	addi	s5,s5,-1430 # ffffffffc02b2768 <swap_init_ok>
...
ffffffffc0201d0e:	a66b0b13          	addi	s6,s6,-1434 # ffffffffc02b2770 <check_mm_struct>
...
ffffffffc0201d7e:	9ce7b783          	ld	a5,-1586(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0201d9a:	9b27b783          	ld	a5,-1614(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0201dbe:	98e7b783          	ld	a5,-1650(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0201dd4:	9787b783          	ld	a5,-1672(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0201e1a:	922a0a13          	addi	s4,s4,-1758 # ffffffffc02b2738 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201e34:	910b0b13          	addi	s6,s6,-1776 # ffffffffc02b2740 <pages>
...
ffffffffc0201e44:	8f8a0a13          	addi	s4,s4,-1800 # ffffffffc02b2738 <npage>
...
ffffffffc0201e68:	8ec7b783          	ld	a5,-1812(a5) # ffffffffc02b2750 <va_pa_offset>
ffffffffc0201e6c:	6605                	lui	a2,0x1
ffffffffc0201e6e:	4581                	li	a1,0
ffffffffc0201e70:	953e                	add	a0,a0,a5
ffffffffc0201e72:	74c040ef          	jal	ra,ffffffffc02065be <memset>
    return page - pages + nbase;
...
ffffffffc0201ea0:	8b4a8a93          	addi	s5,s5,-1868 # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc0201ed2:	872b0b13          	addi	s6,s6,-1934 # ffffffffc02b2740 <pages>
...
ffffffffc0201f04:	6ba040ef          	jal	ra,ffffffffc02065be <memset>
    return page - pages + nbase;
...
ffffffffc0201f5e:	41660613          	addi	a2,a2,1046 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0201f62:	0e300593          	li	a1,227
ffffffffc0201f66:	00005517          	auipc	a0,0x5
ffffffffc0201f6a:	52250513          	addi	a0,a0,1314 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0201f6e:	d0cfe0ef          	jal	ra,ffffffffc020047a <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201f72:	00005617          	auipc	a2,0x5
ffffffffc0201f76:	3fe60613          	addi	a2,a2,1022 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0201f7a:	0ee00593          	li	a1,238
ffffffffc0201f7e:	00005517          	auipc	a0,0x5
ffffffffc0201f82:	50a50513          	addi	a0,a0,1290 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0201f90:	3e460613          	addi	a2,a2,996 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0201f94:	0eb00593          	li	a1,235
ffffffffc0201f98:	00005517          	auipc	a0,0x5
ffffffffc0201f9c:	4f050513          	addi	a0,a0,1264 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0201faa:	3ca60613          	addi	a2,a2,970 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0201fae:	0df00593          	li	a1,223
ffffffffc0201fb2:	00005517          	auipc	a0,0x5
ffffffffc0201fb6:	4d650513          	addi	a0,a0,1238 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0201fec:	75073703          	ld	a4,1872(a4) # ffffffffc02b2738 <npage>
...
ffffffffc0202004:	74053503          	ld	a0,1856(a0) # ffffffffc02b2740 <pages>
...
ffffffffc0202054:	6e8c8c93          	addi	s9,s9,1768 # ffffffffc02b2738 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0202058:	000b0c17          	auipc	s8,0xb0
ffffffffc020205c:	6e8c0c13          	addi	s8,s8,1768 # ffffffffc02b2740 <pages>
ffffffffc0202060:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc0202064:	000b0d17          	auipc	s10,0xb0
ffffffffc0202068:	6e4d0d13          	addi	s10,s10,1764 # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0202118:	38468693          	addi	a3,a3,900 # ffffffffc0207498 <default_pmm_manager+0x160>
ffffffffc020211c:	00005617          	auipc	a2,0x5
ffffffffc0202120:	b8460613          	addi	a2,a2,-1148 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202124:	10f00593          	li	a1,271
ffffffffc0202128:	00005517          	auipc	a0,0x5
ffffffffc020212c:	36050513          	addi	a0,a0,864 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202130:	b4afe0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0202134:	00005697          	auipc	a3,0x5
ffffffffc0202138:	39468693          	addi	a3,a3,916 # ffffffffc02074c8 <default_pmm_manager+0x190>
ffffffffc020213c:	00005617          	auipc	a2,0x5
ffffffffc0202140:	b6460613          	addi	a2,a2,-1180 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202144:	11000593          	li	a1,272
ffffffffc0202148:	00005517          	auipc	a0,0x5
ffffffffc020214c:	34050513          	addi	a0,a0,832 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc02021b2:	58ad0d13          	addi	s10,s10,1418 # ffffffffc02b2738 <npage>
    return KADDR(page2pa(page));
ffffffffc02021b6:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc02021ba:	000b0717          	auipc	a4,0xb0
ffffffffc02021be:	58670713          	addi	a4,a4,1414 # ffffffffc02b2740 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc02021c2:	000b0d97          	auipc	s11,0xb0
ffffffffc02021c6:	586d8d93          	addi	s11,s11,1414 # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0202222:	53280813          	addi	a6,a6,1330 # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc02022b6:	49e80813          	addi	a6,a6,1182 # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc02022c8:	47c70713          	addi	a4,a4,1148 # ffffffffc02b2740 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202300:	44470713          	addi	a4,a4,1092 # ffffffffc02b2740 <pages>
...
ffffffffc020234e:	3f670713          	addi	a4,a4,1014 # ffffffffc02b2740 <pages>
...
ffffffffc0202360:	3f480813          	addi	a6,a6,1012 # ffffffffc02b2750 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202384:	3c070713          	addi	a4,a4,960 # ffffffffc02b2740 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc0202392:	10a68693          	addi	a3,a3,266 # ffffffffc0207498 <default_pmm_manager+0x160>
ffffffffc0202396:	00005617          	auipc	a2,0x5
ffffffffc020239a:	90a60613          	addi	a2,a2,-1782 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020239e:	12000593          	li	a1,288
ffffffffc02023a2:	00005517          	auipc	a0,0x5
ffffffffc02023a6:	0e650513          	addi	a0,a0,230 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02023aa:	8d0fe0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02023ae:	00005617          	auipc	a2,0x5
ffffffffc02023b2:	fc260613          	addi	a2,a2,-62 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc02023b6:	06900593          	li	a1,105
ffffffffc02023ba:	00005517          	auipc	a0,0x5
ffffffffc02023be:	fde50513          	addi	a0,a0,-34 # ffffffffc0207398 <default_pmm_manager+0x60>
...
ffffffffc02023ce:	0fe68693          	addi	a3,a3,254 # ffffffffc02074c8 <default_pmm_manager+0x190>
ffffffffc02023d2:	00005617          	auipc	a2,0x5
ffffffffc02023d6:	8ce60613          	addi	a2,a2,-1842 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02023da:	12100593          	li	a1,289
ffffffffc02023de:	00005517          	auipc	a0,0x5
ffffffffc02023e2:	0aa50513          	addi	a0,a0,170 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0202418:	32473703          	ld	a4,804(a4) # ffffffffc02b2738 <npage>
...
ffffffffc020242c:	31853503          	ld	a0,792(a0) # ffffffffc02b2740 <pages>
...
ffffffffc020245a:	2f27b783          	ld	a5,754(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0202470:	2dc7b783          	ld	a5,732(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc02024bc:	28873703          	ld	a4,648(a4) # ffffffffc02b2740 <pages>
...
ffffffffc02024f6:	24673703          	ld	a4,582(a4) # ffffffffc02b2738 <npage>
ffffffffc02024fa:	06e7ff63          	bgeu	a5,a4,ffffffffc0202578 <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc02024fe:	000b0a97          	auipc	s5,0xb0
ffffffffc0202502:	242a8a93          	addi	s5,s5,578 # ffffffffc02b2740 <pages>
...
ffffffffc0202514:	01240c63          	beq	s0,s2,ffffffffc020252c <page_insert+0xa6>
    page->ref -= 1;
ffffffffc0202518:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fccd864>
...
ffffffffc020253c:	2107b783          	ld	a5,528(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc020255a:	1f27b783          	ld	a5,498(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc0202580:	dbc78793          	addi	a5,a5,-580 # ffffffffc0207338 <default_pmm_manager>
...
ffffffffc020258e:	f5650513          	addi	a0,a0,-170 # ffffffffc02074e0 <default_pmm_manager+0x1a8>
    pmm_manager = &default_pmm_manager;
ffffffffc0202592:	000b0b97          	auipc	s7,0xb0
ffffffffc0202596:	1b6b8b93          	addi	s7,s7,438 # ffffffffc02b2748 <pmm_manager>
void pmm_init(void) {
...
ffffffffc02025bc:	19898993          	addi	s3,s3,408 # ffffffffc02b2750 <va_pa_offset>
    npage = maxpa / PGSIZE;
ffffffffc02025c0:	000b0497          	auipc	s1,0xb0
ffffffffc02025c4:	17848493          	addi	s1,s1,376 # ffffffffc02b2738 <npage>
    pmm_manager->init();
ffffffffc02025c8:	679c                	ld	a5,8(a5)
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02025ca:	000b0b17          	auipc	s6,0xb0
ffffffffc02025ce:	176b0b13          	addi	s6,s6,374 # ffffffffc02b2740 <pages>
    pmm_manager->init();
...
ffffffffc02025dc:	f2050513          	addi	a0,a0,-224 # ffffffffc02074f8 <default_pmm_manager+0x1c0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc02025fc:	f1850513          	addi	a0,a0,-232 # ffffffffc0207510 <default_pmm_manager+0x1d8>
...
ffffffffc020260a:	19578793          	addi	a5,a5,405 # ffffffffc02b379b <end+0xfff>
...
ffffffffc0202664:	ed850513          	addi	a0,a0,-296 # ffffffffc0207538 <default_pmm_manager+0x200>
...
ffffffffc0202674:	0c090913          	addi	s2,s2,192 # ffffffffc02b2730 <boot_pgdir>
    pmm_manager->check();
ffffffffc0202678:	7b9c                	ld	a5,48(a5)
ffffffffc020267a:	9782                	jalr	a5
    cprintf("check_alloc_page() succeeded!\n");
ffffffffc020267c:	00005517          	auipc	a0,0x5
ffffffffc0202680:	ed450513          	addi	a0,a0,-300 # ffffffffc0207550 <default_pmm_manager+0x218>
...
ffffffffc02026a6:	08d7b323          	sd	a3,134(a5) # ffffffffc02b2728 <boot_cr3>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc02028fc:	0007b023          	sd	zero,0(a5) # fffffffffff80000 <end+0x3fccd864>
  asm volatile("sfence.vma");
...
ffffffffc0202920:	f1c50513          	addi	a0,a0,-228 # ffffffffc0207838 <default_pmm_manager+0x500>
...
ffffffffc02029a4:	62051d63          	bnez	a0,ffffffffc0202fde <pmm_init+0xa62>
    assert(page_ref(p) == 1);
ffffffffc02029a8:	000aa703          	lw	a4,0(s5) # fffffffffffff000 <end+0x3fd4c864>
...
ffffffffc02029d6:	f9e58593          	addi	a1,a1,-98 # ffffffffc0207970 <default_pmm_manager+0x638>
ffffffffc02029da:	10000513          	li	a0,256
ffffffffc02029de:	39b030ef          	jal	ra,ffffffffc0206578 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02029e2:	10040593          	addi	a1,s0,256
ffffffffc02029e6:	10000513          	li	a0,256
ffffffffc02029ea:	3a1030ef          	jal	ra,ffffffffc020658a <strcmp>
...
ffffffffc0202a1c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a20:	323030ef          	jal	ra,ffffffffc0206542 <strlen>
...
ffffffffc0202ae4:	f0850513          	addi	a0,a0,-248 # ffffffffc02079e8 <default_pmm_manager+0x6b0>
...
ffffffffc0202bfe:	c9e68693          	addi	a3,a3,-866 # ffffffffc0207898 <default_pmm_manager+0x560>
ffffffffc0202c02:	00004617          	auipc	a2,0x4
ffffffffc0202c06:	09e60613          	addi	a2,a2,158 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202c0a:	24200593          	li	a1,578
ffffffffc0202c0e:	00005517          	auipc	a0,0x5
ffffffffc0202c12:	87a50513          	addi	a0,a0,-1926 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202c16:	865fd0ef          	jal	ra,ffffffffc020047a <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202c1a:	00005697          	auipc	a3,0x5
ffffffffc0202c1e:	c3e68693          	addi	a3,a3,-962 # ffffffffc0207858 <default_pmm_manager+0x520>
ffffffffc0202c22:	00004617          	auipc	a2,0x4
ffffffffc0202c26:	07e60613          	addi	a2,a2,126 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202c2a:	24100593          	li	a1,577
ffffffffc0202c2e:	00005517          	auipc	a0,0x5
ffffffffc0202c32:	85a50513          	addi	a0,a0,-1958 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0202c40:	73460613          	addi	a2,a2,1844 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0202c44:	24100593          	li	a1,577
ffffffffc0202c48:	00005517          	auipc	a0,0x5
ffffffffc0202c4c:	84050513          	addi	a0,a0,-1984 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0202c5c:	7c060613          	addi	a2,a2,1984 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc0202c60:	07f00593          	li	a1,127
ffffffffc0202c64:	00005517          	auipc	a0,0x5
ffffffffc0202c68:	82450513          	addi	a0,a0,-2012 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202c6c:	80ffd0ef          	jal	ra,ffffffffc020047a <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202c70:	00004617          	auipc	a2,0x4
ffffffffc0202c74:	7a860613          	addi	a2,a2,1960 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc0202c78:	0c100593          	li	a1,193
ffffffffc0202c7c:	00005517          	auipc	a0,0x5
ffffffffc0202c80:	80c50513          	addi	a0,a0,-2036 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202c84:	ff6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc0202c88:	00005697          	auipc	a3,0x5
ffffffffc0202c8c:	90868693          	addi	a3,a3,-1784 # ffffffffc0207590 <default_pmm_manager+0x258>
ffffffffc0202c90:	00004617          	auipc	a2,0x4
ffffffffc0202c94:	01060613          	addi	a2,a2,16 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202c98:	20500593          	li	a1,517
ffffffffc0202c9c:	00004517          	auipc	a0,0x4
ffffffffc0202ca0:	7ec50513          	addi	a0,a0,2028 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202ca4:	fd6fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202ca8:	00005697          	auipc	a3,0x5
ffffffffc0202cac:	8c868693          	addi	a3,a3,-1848 # ffffffffc0207570 <default_pmm_manager+0x238>
ffffffffc0202cb0:	00004617          	auipc	a2,0x4
ffffffffc0202cb4:	ff060613          	addi	a2,a2,-16 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202cb8:	20400593          	li	a1,516
ffffffffc0202cbc:	00004517          	auipc	a0,0x4
ffffffffc0202cc0:	7cc50513          	addi	a0,a0,1996 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0202cd0:	95468693          	addi	a3,a3,-1708 # ffffffffc0207620 <default_pmm_manager+0x2e8>
ffffffffc0202cd4:	00004617          	auipc	a2,0x4
ffffffffc0202cd8:	fcc60613          	addi	a2,a2,-52 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202cdc:	20d00593          	li	a1,525
ffffffffc0202ce0:	00004517          	auipc	a0,0x4
ffffffffc0202ce4:	7a850513          	addi	a0,a0,1960 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202ce8:	f92fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202cec:	00005697          	auipc	a3,0x5
ffffffffc0202cf0:	90468693          	addi	a3,a3,-1788 # ffffffffc02075f0 <default_pmm_manager+0x2b8>
ffffffffc0202cf4:	00004617          	auipc	a2,0x4
ffffffffc0202cf8:	fac60613          	addi	a2,a2,-84 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202cfc:	20a00593          	li	a1,522
ffffffffc0202d00:	00004517          	auipc	a0,0x4
ffffffffc0202d04:	78850513          	addi	a0,a0,1928 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202d08:	f72fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202d0c:	00005697          	auipc	a3,0x5
ffffffffc0202d10:	8bc68693          	addi	a3,a3,-1860 # ffffffffc02075c8 <default_pmm_manager+0x290>
ffffffffc0202d14:	00004617          	auipc	a2,0x4
ffffffffc0202d18:	f8c60613          	addi	a2,a2,-116 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202d1c:	20600593          	li	a1,518
ffffffffc0202d20:	00004517          	auipc	a0,0x4
ffffffffc0202d24:	76850513          	addi	a0,a0,1896 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202d28:	f52fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202d2c:	00005697          	auipc	a3,0x5
ffffffffc0202d30:	97c68693          	addi	a3,a3,-1668 # ffffffffc02076a8 <default_pmm_manager+0x370>
ffffffffc0202d34:	00004617          	auipc	a2,0x4
ffffffffc0202d38:	f6c60613          	addi	a2,a2,-148 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202d3c:	21600593          	li	a1,534
ffffffffc0202d40:	00004517          	auipc	a0,0x4
ffffffffc0202d44:	74850513          	addi	a0,a0,1864 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202d48:	f32fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202d4c:	00005697          	auipc	a3,0x5
ffffffffc0202d50:	9fc68693          	addi	a3,a3,-1540 # ffffffffc0207748 <default_pmm_manager+0x410>
ffffffffc0202d54:	00004617          	auipc	a2,0x4
ffffffffc0202d58:	f4c60613          	addi	a2,a2,-180 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202d5c:	21b00593          	li	a1,539
ffffffffc0202d60:	00004517          	auipc	a0,0x4
ffffffffc0202d64:	72850513          	addi	a0,a0,1832 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202d68:	f12fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202d6c:	00005697          	auipc	a3,0x5
ffffffffc0202d70:	91468693          	addi	a3,a3,-1772 # ffffffffc0207680 <default_pmm_manager+0x348>
ffffffffc0202d74:	00004617          	auipc	a2,0x4
ffffffffc0202d78:	f2c60613          	addi	a2,a2,-212 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202d7c:	21300593          	li	a1,531
ffffffffc0202d80:	00004517          	auipc	a0,0x4
ffffffffc0202d84:	70850513          	addi	a0,a0,1800 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0202d92:	5e260613          	addi	a2,a2,1506 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0202d96:	21200593          	li	a1,530
ffffffffc0202d9a:	00004517          	auipc	a0,0x4
ffffffffc0202d9e:	6ee50513          	addi	a0,a0,1774 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202da2:	ed8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202da6:	00005697          	auipc	a3,0x5
ffffffffc0202daa:	93a68693          	addi	a3,a3,-1734 # ffffffffc02076e0 <default_pmm_manager+0x3a8>
ffffffffc0202dae:	00004617          	auipc	a2,0x4
ffffffffc0202db2:	ef260613          	addi	a2,a2,-270 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202db6:	22000593          	li	a1,544
ffffffffc0202dba:	00004517          	auipc	a0,0x4
ffffffffc0202dbe:	6ce50513          	addi	a0,a0,1742 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202dc2:	eb8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202dc6:	00005697          	auipc	a3,0x5
ffffffffc0202dca:	9e268693          	addi	a3,a3,-1566 # ffffffffc02077a8 <default_pmm_manager+0x470>
ffffffffc0202dce:	00004617          	auipc	a2,0x4
ffffffffc0202dd2:	ed260613          	addi	a2,a2,-302 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202dd6:	21f00593          	li	a1,543
ffffffffc0202dda:	00004517          	auipc	a0,0x4
ffffffffc0202dde:	6ae50513          	addi	a0,a0,1710 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202de2:	e98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202de6:	00005697          	auipc	a3,0x5
ffffffffc0202dea:	9aa68693          	addi	a3,a3,-1622 # ffffffffc0207790 <default_pmm_manager+0x458>
ffffffffc0202dee:	00004617          	auipc	a2,0x4
ffffffffc0202df2:	eb260613          	addi	a2,a2,-334 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202df6:	21e00593          	li	a1,542
ffffffffc0202dfa:	00004517          	auipc	a0,0x4
ffffffffc0202dfe:	68e50513          	addi	a0,a0,1678 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202e02:	e78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202e06:	00005697          	auipc	a3,0x5
ffffffffc0202e0a:	95a68693          	addi	a3,a3,-1702 # ffffffffc0207760 <default_pmm_manager+0x428>
ffffffffc0202e0e:	00004617          	auipc	a2,0x4
ffffffffc0202e12:	e9260613          	addi	a2,a2,-366 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202e16:	21d00593          	li	a1,541
ffffffffc0202e1a:	00004517          	auipc	a0,0x4
ffffffffc0202e1e:	66e50513          	addi	a0,a0,1646 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202e22:	e58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202e26:	00005697          	auipc	a3,0x5
ffffffffc0202e2a:	af268693          	addi	a3,a3,-1294 # ffffffffc0207918 <default_pmm_manager+0x5e0>
ffffffffc0202e2e:	00004617          	auipc	a2,0x4
ffffffffc0202e32:	e7260613          	addi	a2,a2,-398 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202e36:	24c00593          	li	a1,588
ffffffffc0202e3a:	00004517          	auipc	a0,0x4
ffffffffc0202e3e:	64e50513          	addi	a0,a0,1614 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202e42:	e38fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0202e46:	00005697          	auipc	a3,0x5
ffffffffc0202e4a:	8ea68693          	addi	a3,a3,-1814 # ffffffffc0207730 <default_pmm_manager+0x3f8>
ffffffffc0202e4e:	00004617          	auipc	a2,0x4
ffffffffc0202e52:	e5260613          	addi	a2,a2,-430 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202e56:	21a00593          	li	a1,538
ffffffffc0202e5a:	00004517          	auipc	a0,0x4
ffffffffc0202e5e:	62e50513          	addi	a0,a0,1582 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202e62:	e18fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202e66:	00005697          	auipc	a3,0x5
ffffffffc0202e6a:	8ba68693          	addi	a3,a3,-1862 # ffffffffc0207720 <default_pmm_manager+0x3e8>
ffffffffc0202e6e:	00004617          	auipc	a2,0x4
ffffffffc0202e72:	e3260613          	addi	a2,a2,-462 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202e76:	21900593          	li	a1,537
ffffffffc0202e7a:	00004517          	auipc	a0,0x4
ffffffffc0202e7e:	60e50513          	addi	a0,a0,1550 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202e82:	df8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202e86:	00005697          	auipc	a3,0x5
ffffffffc0202e8a:	99268693          	addi	a3,a3,-1646 # ffffffffc0207818 <default_pmm_manager+0x4e0>
ffffffffc0202e8e:	00004617          	auipc	a2,0x4
ffffffffc0202e92:	e1260613          	addi	a2,a2,-494 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202e96:	25d00593          	li	a1,605
ffffffffc0202e9a:	00004517          	auipc	a0,0x4
ffffffffc0202e9e:	5ee50513          	addi	a0,a0,1518 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202ea2:	dd8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ea6:	00005697          	auipc	a3,0x5
ffffffffc0202eaa:	86a68693          	addi	a3,a3,-1942 # ffffffffc0207710 <default_pmm_manager+0x3d8>
ffffffffc0202eae:	00004617          	auipc	a2,0x4
ffffffffc0202eb2:	df260613          	addi	a2,a2,-526 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202eb6:	21800593          	li	a1,536
ffffffffc0202eba:	00004517          	auipc	a0,0x4
ffffffffc0202ebe:	5ce50513          	addi	a0,a0,1486 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202ec2:	db8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202ec6:	00004697          	auipc	a3,0x4
ffffffffc0202eca:	7a268693          	addi	a3,a3,1954 # ffffffffc0207668 <default_pmm_manager+0x330>
ffffffffc0202ece:	00004617          	auipc	a2,0x4
ffffffffc0202ed2:	dd260613          	addi	a2,a2,-558 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202ed6:	22500593          	li	a1,549
ffffffffc0202eda:	00004517          	auipc	a0,0x4
ffffffffc0202ede:	5ae50513          	addi	a0,a0,1454 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202ee2:	d98fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202ee6:	00005697          	auipc	a3,0x5
ffffffffc0202eea:	8da68693          	addi	a3,a3,-1830 # ffffffffc02077c0 <default_pmm_manager+0x488>
ffffffffc0202eee:	00004617          	auipc	a2,0x4
ffffffffc0202ef2:	db260613          	addi	a2,a2,-590 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202ef6:	22200593          	li	a1,546
ffffffffc0202efa:	00004517          	auipc	a0,0x4
ffffffffc0202efe:	58e50513          	addi	a0,a0,1422 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202f02:	d78fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202f06:	00004697          	auipc	a3,0x4
ffffffffc0202f0a:	74a68693          	addi	a3,a3,1866 # ffffffffc0207650 <default_pmm_manager+0x318>
ffffffffc0202f0e:	00004617          	auipc	a2,0x4
ffffffffc0202f12:	d9260613          	addi	a2,a2,-622 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202f16:	22100593          	li	a1,545
ffffffffc0202f1a:	00004517          	auipc	a0,0x4
ffffffffc0202f1e:	56e50513          	addi	a0,a0,1390 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202f22:	d58fd0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202f26:	00004617          	auipc	a2,0x4
ffffffffc0202f2a:	44a60613          	addi	a2,a2,1098 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0202f2e:	06900593          	li	a1,105
ffffffffc0202f32:	00004517          	auipc	a0,0x4
ffffffffc0202f36:	46650513          	addi	a0,a0,1126 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0202f3a:	d40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc0202f3e:	00005697          	auipc	a3,0x5
ffffffffc0202f42:	8b268693          	addi	a3,a3,-1870 # ffffffffc02077f0 <default_pmm_manager+0x4b8>
ffffffffc0202f46:	00004617          	auipc	a2,0x4
ffffffffc0202f4a:	d5a60613          	addi	a2,a2,-678 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202f4e:	22c00593          	li	a1,556
ffffffffc0202f52:	00004517          	auipc	a0,0x4
ffffffffc0202f56:	53650513          	addi	a0,a0,1334 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202f5a:	d20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f5e:	00005697          	auipc	a3,0x5
ffffffffc0202f62:	84a68693          	addi	a3,a3,-1974 # ffffffffc02077a8 <default_pmm_manager+0x470>
ffffffffc0202f66:	00004617          	auipc	a2,0x4
ffffffffc0202f6a:	d3a60613          	addi	a2,a2,-710 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202f6e:	22a00593          	li	a1,554
ffffffffc0202f72:	00004517          	auipc	a0,0x4
ffffffffc0202f76:	51650513          	addi	a0,a0,1302 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202f7a:	d00fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202f7e:	00005697          	auipc	a3,0x5
ffffffffc0202f82:	85a68693          	addi	a3,a3,-1958 # ffffffffc02077d8 <default_pmm_manager+0x4a0>
ffffffffc0202f86:	00004617          	auipc	a2,0x4
ffffffffc0202f8a:	d1a60613          	addi	a2,a2,-742 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202f8e:	22900593          	li	a1,553
ffffffffc0202f92:	00004517          	auipc	a0,0x4
ffffffffc0202f96:	4f650513          	addi	a0,a0,1270 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202f9a:	ce0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202f9e:	00005697          	auipc	a3,0x5
ffffffffc0202fa2:	80a68693          	addi	a3,a3,-2038 # ffffffffc02077a8 <default_pmm_manager+0x470>
ffffffffc0202fa6:	00004617          	auipc	a2,0x4
ffffffffc0202faa:	cfa60613          	addi	a2,a2,-774 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202fae:	22600593          	li	a1,550
ffffffffc0202fb2:	00004517          	auipc	a0,0x4
ffffffffc0202fb6:	4d650513          	addi	a0,a0,1238 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202fba:	cc0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202fbe:	00005697          	auipc	a3,0x5
ffffffffc0202fc2:	94268693          	addi	a3,a3,-1726 # ffffffffc0207900 <default_pmm_manager+0x5c8>
ffffffffc0202fc6:	00004617          	auipc	a2,0x4
ffffffffc0202fca:	cda60613          	addi	a2,a2,-806 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202fce:	24b00593          	li	a1,587
ffffffffc0202fd2:	00004517          	auipc	a0,0x4
ffffffffc0202fd6:	4b650513          	addi	a0,a0,1206 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202fda:	ca0fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202fde:	00005697          	auipc	a3,0x5
ffffffffc0202fe2:	8ea68693          	addi	a3,a3,-1814 # ffffffffc02078c8 <default_pmm_manager+0x590>
ffffffffc0202fe6:	00004617          	auipc	a2,0x4
ffffffffc0202fea:	cba60613          	addi	a2,a2,-838 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0202fee:	24a00593          	li	a1,586
ffffffffc0202ff2:	00004517          	auipc	a0,0x4
ffffffffc0202ff6:	49650513          	addi	a0,a0,1174 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0202ffa:	c80fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202ffe:	00005697          	auipc	a3,0x5
ffffffffc0203002:	8b268693          	addi	a3,a3,-1870 # ffffffffc02078b0 <default_pmm_manager+0x578>
ffffffffc0203006:	00004617          	auipc	a2,0x4
ffffffffc020300a:	c9a60613          	addi	a2,a2,-870 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020300e:	24600593          	li	a1,582
ffffffffc0203012:	00004517          	auipc	a0,0x4
ffffffffc0203016:	47650513          	addi	a0,a0,1142 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc020301a:	c60fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020301e:	00004697          	auipc	a3,0x4
ffffffffc0203022:	7fa68693          	addi	a3,a3,2042 # ffffffffc0207818 <default_pmm_manager+0x4e0>
ffffffffc0203026:	00004617          	auipc	a2,0x4
ffffffffc020302a:	c7a60613          	addi	a2,a2,-902 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020302e:	23400593          	li	a1,564
ffffffffc0203032:	00004517          	auipc	a0,0x4
ffffffffc0203036:	45650513          	addi	a0,a0,1110 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc020303a:	c40fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020303e:	00004697          	auipc	a3,0x4
ffffffffc0203042:	61268693          	addi	a3,a3,1554 # ffffffffc0207650 <default_pmm_manager+0x318>
ffffffffc0203046:	00004617          	auipc	a2,0x4
ffffffffc020304a:	c5a60613          	addi	a2,a2,-934 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020304e:	20e00593          	li	a1,526
ffffffffc0203052:	00004517          	auipc	a0,0x4
ffffffffc0203056:	43650513          	addi	a0,a0,1078 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc020305a:	c20fd0ef          	jal	ra,ffffffffc020047a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc020305e:	00004617          	auipc	a2,0x4
ffffffffc0203062:	31260613          	addi	a2,a2,786 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0203066:	21100593          	li	a1,529
ffffffffc020306a:	00004517          	auipc	a0,0x4
ffffffffc020306e:	41e50513          	addi	a0,a0,1054 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0203072:	c08fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0203076:	00004697          	auipc	a3,0x4
ffffffffc020307a:	5f268693          	addi	a3,a3,1522 # ffffffffc0207668 <default_pmm_manager+0x330>
ffffffffc020307e:	00004617          	auipc	a2,0x4
ffffffffc0203082:	c2260613          	addi	a2,a2,-990 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203086:	20f00593          	li	a1,527
ffffffffc020308a:	00004517          	auipc	a0,0x4
ffffffffc020308e:	3fe50513          	addi	a0,a0,1022 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc0203092:	be8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0203096:	00004697          	auipc	a3,0x4
ffffffffc020309a:	64a68693          	addi	a3,a3,1610 # ffffffffc02076e0 <default_pmm_manager+0x3a8>
ffffffffc020309e:	00004617          	auipc	a2,0x4
ffffffffc02030a2:	c0260613          	addi	a2,a2,-1022 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02030a6:	21700593          	li	a1,535
ffffffffc02030aa:	00004517          	auipc	a0,0x4
ffffffffc02030ae:	3de50513          	addi	a0,a0,990 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02030b2:	bc8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc02030b6:	00005697          	auipc	a3,0x5
ffffffffc02030ba:	90a68693          	addi	a3,a3,-1782 # ffffffffc02079c0 <default_pmm_manager+0x688>
ffffffffc02030be:	00004617          	auipc	a2,0x4
ffffffffc02030c2:	be260613          	addi	a2,a2,-1054 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02030c6:	25400593          	li	a1,596
ffffffffc02030ca:	00004517          	auipc	a0,0x4
ffffffffc02030ce:	3be50513          	addi	a0,a0,958 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02030d2:	ba8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc02030d6:	00005697          	auipc	a3,0x5
ffffffffc02030da:	8b268693          	addi	a3,a3,-1870 # ffffffffc0207988 <default_pmm_manager+0x650>
ffffffffc02030de:	00004617          	auipc	a2,0x4
ffffffffc02030e2:	bc260613          	addi	a2,a2,-1086 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02030e6:	25100593          	li	a1,593
ffffffffc02030ea:	00004517          	auipc	a0,0x4
ffffffffc02030ee:	39e50513          	addi	a0,a0,926 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02030f2:	b88fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(page_ref(p) == 2);
ffffffffc02030f6:	00005697          	auipc	a3,0x5
ffffffffc02030fa:	86268693          	addi	a3,a3,-1950 # ffffffffc0207958 <default_pmm_manager+0x620>
ffffffffc02030fe:	00004617          	auipc	a2,0x4
ffffffffc0203102:	ba260613          	addi	a2,a2,-1118 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203106:	24d00593          	li	a1,589
ffffffffc020310a:	00004517          	auipc	a0,0x4
ffffffffc020310e:	37e50513          	addi	a0,a0,894 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0203160:	5dcc8c93          	addi	s9,s9,1500 # ffffffffc02b2738 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc0203164:	000afc17          	auipc	s8,0xaf
ffffffffc0203168:	5dcc0c13          	addi	s8,s8,1500 # ffffffffc02b2740 <pages>
    return page - pages + nbase;
...
ffffffffc0203216:	53e70713          	addi	a4,a4,1342 # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc0203232:	39e030ef          	jal	ra,ffffffffc02065d0 <memcpy>
...
ffffffffc0203248:	7e468693          	addi	a3,a3,2020 # ffffffffc0207a28 <default_pmm_manager+0x6f0>
ffffffffc020324c:	00004617          	auipc	a2,0x4
ffffffffc0203250:	a5460613          	addi	a2,a2,-1452 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203254:	1a600593          	li	a1,422
ffffffffc0203258:	00004517          	auipc	a0,0x4
ffffffffc020325c:	23050513          	addi	a0,a0,560 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc0203282:	0f260613          	addi	a2,a2,242 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0203286:	06900593          	li	a1,105
ffffffffc020328a:	00004517          	auipc	a0,0x4
ffffffffc020328e:	10e50513          	addi	a0,a0,270 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0203292:	9e8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(page != NULL);
ffffffffc0203296:	00004697          	auipc	a3,0x4
ffffffffc020329a:	77268693          	addi	a3,a3,1906 # ffffffffc0207a08 <default_pmm_manager+0x6d0>
ffffffffc020329e:	00004617          	auipc	a2,0x4
ffffffffc02032a2:	a0260613          	addi	a2,a2,-1534 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02032a6:	17e00593          	li	a1,382
ffffffffc02032aa:	00004517          	auipc	a0,0x4
ffffffffc02032ae:	1de50513          	addi	a0,a0,478 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02032b2:	9c8fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02032b6:	00004697          	auipc	a3,0x4
ffffffffc02032ba:	21268693          	addi	a3,a3,530 # ffffffffc02074c8 <default_pmm_manager+0x190>
ffffffffc02032be:	00004617          	auipc	a2,0x4
ffffffffc02032c2:	9e260613          	addi	a2,a2,-1566 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02032c6:	16500593          	li	a1,357
ffffffffc02032ca:	00004517          	auipc	a0,0x4
ffffffffc02032ce:	1be50513          	addi	a0,a0,446 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02032d2:	9a8fd0ef          	jal	ra,ffffffffc020047a <__panic>
            assert(npage != NULL);
ffffffffc02032d6:	00004697          	auipc	a3,0x4
ffffffffc02032da:	74268693          	addi	a3,a3,1858 # ffffffffc0207a18 <default_pmm_manager+0x6e0>
ffffffffc02032de:	00004617          	auipc	a2,0x4
ffffffffc02032e2:	9c260613          	addi	a2,a2,-1598 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02032e6:	17f00593          	li	a1,383
ffffffffc02032ea:	00004517          	auipc	a0,0x4
ffffffffc02032ee:	19e50513          	addi	a0,a0,414 # ffffffffc0207488 <default_pmm_manager+0x150>
ffffffffc02032f2:	988fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02032f6:	00004617          	auipc	a2,0x4
ffffffffc02032fa:	14a60613          	addi	a2,a2,330 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc02032fe:	06200593          	li	a1,98
ffffffffc0203302:	00004517          	auipc	a0,0x4
ffffffffc0203306:	09650513          	addi	a0,a0,150 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc020330a:	970fd0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc020330e:	00004617          	auipc	a2,0x4
ffffffffc0203312:	15260613          	addi	a2,a2,338 # ffffffffc0207460 <default_pmm_manager+0x128>
ffffffffc0203316:	07400593          	li	a1,116
ffffffffc020331a:	00004517          	auipc	a0,0x4
ffffffffc020331e:	07e50513          	addi	a0,a0,126 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0203322:	958fd0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0203326:	00004697          	auipc	a3,0x4
ffffffffc020332a:	17268693          	addi	a3,a3,370 # ffffffffc0207498 <default_pmm_manager+0x160>
ffffffffc020332e:	00004617          	auipc	a2,0x4
ffffffffc0203332:	97260613          	addi	a2,a2,-1678 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203336:	16400593          	li	a1,356
ffffffffc020333a:	00004517          	auipc	a0,0x4
ffffffffc020333e:	14e50513          	addi	a0,a0,334 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc020337a:	3f27a783          	lw	a5,1010(a5) # ffffffffc02b2768 <swap_init_ok>
ffffffffc020337e:	c385                	beqz	a5,ffffffffc020339e <pgdir_alloc_page+0x52>
            if (check_mm_struct != NULL) {
ffffffffc0203380:	000af517          	auipc	a0,0xaf
ffffffffc0203384:	3f053503          	ld	a0,1008(a0) # ffffffffc02b2770 <check_mm_struct>
...
ffffffffc02033ba:	3927b783          	ld	a5,914(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc02033d2:	37a7b783          	ld	a5,890(a5) # ffffffffc02b2748 <pmm_manager>
...
ffffffffc02033ea:	65268693          	addi	a3,a3,1618 # ffffffffc0207a38 <default_pmm_manager+0x700>
ffffffffc02033ee:	00004617          	auipc	a2,0x4
ffffffffc02033f2:	8b260613          	addi	a2,a2,-1870 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02033f6:	1e500593          	li	a1,485
ffffffffc02033fa:	00004517          	auipc	a0,0x4
ffffffffc02033fe:	08e50513          	addi	a0,a0,142 # ffffffffc0207488 <default_pmm_manager+0x150>
...
ffffffffc020340c:	03860613          	addi	a2,a2,56 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0203410:	06200593          	li	a1,98
ffffffffc0203414:	00004517          	auipc	a0,0x4
ffffffffc0203418:	f8450513          	addi	a0,a0,-124 # ffffffffc0207398 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc020343c:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc020343e:	750010ef          	jal	ra,ffffffffc0204b8e <swapfs_init>

     // Since the IDE is faked, it can only store 7 pages at most to pass the test
     if (!(7 <= max_swap_offset &&
ffffffffc0203442:	000af697          	auipc	a3,0xaf
ffffffffc0203446:	3166b683          	ld	a3,790(a3) # ffffffffc02b2758 <max_swap_offset>
...
ffffffffc020345c:	d9878793          	addi	a5,a5,-616 # ffffffffc02a71f0 <swap_manager_fifo>
     int r = sm->init();
ffffffffc0203460:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc0203462:	000afb97          	auipc	s7,0xaf
ffffffffc0203466:	2feb8b93          	addi	s7,s7,766 # ffffffffc02b2760 <sm>
...
ffffffffc020349c:	5e850513          	addi	a0,a0,1512 # ffffffffc0207a80 <default_pmm_manager+0x748>
    return listelm->next;
ffffffffc02034a0:	000ab417          	auipc	s0,0xab
ffffffffc02034a4:	1a040413          	addi	s0,s0,416 # ffffffffc02ae640 <free_area>
ffffffffc02034a8:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc02034aa:	4785                	li	a5,1
ffffffffc02034ac:	000af717          	auipc	a4,0xaf
ffffffffc02034b0:	2af72e23          	sw	a5,700(a4) # ffffffffc02b2768 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc02034ee:	5ae50513          	addi	a0,a0,1454 # ffffffffc0207a98 <default_pmm_manager+0x760>
...
ffffffffc0203504:	27078793          	addi	a5,a5,624 # ffffffffc02b2770 <check_mm_struct>
...
ffffffffc0203512:	22270713          	addi	a4,a4,546 # ffffffffc02b2730 <boot_pgdir>
...
ffffffffc0203542:	5ca50513          	addi	a0,a0,1482 # ffffffffc0207b08 <default_pmm_manager+0x7d0>
...
ffffffffc020355e:	5fe50513          	addi	a0,a0,1534 # ffffffffc0207b58 <default_pmm_manager+0x820>
ffffffffc0203562:	000ab497          	auipc	s1,0xab
ffffffffc0203566:	11648493          	addi	s1,s1,278 # ffffffffc02ae678 <check_rp>
ffffffffc020356a:	c17fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc020356e:	000ab997          	auipc	s3,0xab
ffffffffc0203572:	12a98993          	addi	s3,s3,298 # ffffffffc02ae698 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020357e:	00aa3023          	sd	a0,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8ba0>
...
ffffffffc020359a:	0e2a0a13          	addi	s4,s4,226 # ffffffffc02ae678 <check_rp>
    elm->prev = elm->next = elm;
...
ffffffffc02035b0:	0a07a223          	sw	zero,164(a5) # ffffffffc02ae650 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc02035d2:	61250513          	addi	a0,a0,1554 # ffffffffc0207be0 <default_pmm_manager+0x8a8>
...
ffffffffc02035e0:	1807ae23          	sw	zero,412(a5) # ffffffffc02b2778 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc02035e4:	4629                	li	a2,10
ffffffffc02035e6:	00c70023          	sb	a2,0(a4) # 1000 <_binary_obj___user_faultread_out_size-0x8ba0>
     assert(pgfault_num==1);
ffffffffc02035ea:	000af697          	auipc	a3,0xaf
ffffffffc02035ee:	18e6a683          	lw	a3,398(a3) # ffffffffc02b2778 <pgfault_num>
ffffffffc02035f2:	4585                	li	a1,1
ffffffffc02035f4:	000af797          	auipc	a5,0xaf
ffffffffc02035f8:	18478793          	addi	a5,a5,388 # ffffffffc02b2778 <pgfault_num>
...
ffffffffc0203610:	00c68023          	sb	a2,0(a3) # 2000 <_binary_obj___user_faultread_out_size-0x7ba0>
...
ffffffffc020362e:	00c68023          	sb	a2,0(a3) # 3000 <_binary_obj___user_faultread_out_size-0x6ba0>
...
ffffffffc020364c:	00c68023          	sb	a2,0(a3) # 4000 <_binary_obj___user_faultread_out_size-0x5ba0>
...
ffffffffc020366e:	02e78793          	addi	a5,a5,46 # ffffffffc02ae698 <swap_in_seq_no>
ffffffffc0203672:	000ab717          	auipc	a4,0xab
ffffffffc0203676:	04e70713          	addi	a4,a4,78 # ffffffffc02ae6c0 <swap_out_seq_no>
ffffffffc020367a:	000ab617          	auipc	a2,0xab
ffffffffc020367e:	04660613          	addi	a2,a2,70 # ffffffffc02ae6c0 <swap_out_seq_no>
...
ffffffffc0203694:	fc870713          	addi	a4,a4,-56 # ffffffffc02ae658 <check_ptep>
ffffffffc0203698:	000ab697          	auipc	a3,0xab
ffffffffc020369c:	fe068693          	addi	a3,a3,-32 # ffffffffc02ae678 <check_rp>
ffffffffc02036a0:	6585                	lui	a1,0x1
    if (PPN(pa) >= npage) {
ffffffffc02036a2:	000afc17          	auipc	s8,0xaf
ffffffffc02036a6:	096c0c13          	addi	s8,s8,150 # ffffffffc02b2738 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02036aa:	000afc97          	auipc	s9,0xaf
ffffffffc02036ae:	096c8c93          	addi	s9,s9,150 # ffffffffc02b2740 <pages>
...
ffffffffc02036ea:	5fa60613          	addi	a2,a2,1530 # ffffffffc0208ce0 <nbase>
...
ffffffffc0203716:	57650513          	addi	a0,a0,1398 # ffffffffc0207c88 <default_pmm_manager+0x950>
...
ffffffffc0203752:	fe278793          	addi	a5,a5,-30 # ffffffffc02b2730 <boot_pgdir>
ffffffffc0203756:	639c                	ld	a5,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0203758:	000c3703          	ld	a4,0(s8)
     check_mm_struct = NULL;
ffffffffc020375c:	000af697          	auipc	a3,0xaf
ffffffffc0203760:	0006ba23          	sd	zero,20(a3) # ffffffffc02b2770 <check_mm_struct>
    return pa2page(PDE_ADDR(pde));
...
ffffffffc020378c:	fc87b783          	ld	a5,-56(a5) # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc02037f6:	4e650513          	addi	a0,a0,1254 # ffffffffc0207cd8 <default_pmm_manager+0x9a0>
...
ffffffffc0203808:	78c68693          	addi	a3,a3,1932 # ffffffffc0206f90 <commands+0x740>
ffffffffc020380c:	00003617          	auipc	a2,0x3
ffffffffc0203810:	49460613          	addi	a2,a2,1172 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203814:	0bc00593          	li	a1,188
ffffffffc0203818:	00004517          	auipc	a0,0x4
ffffffffc020381c:	25850513          	addi	a0,a0,600 # ffffffffc0207a70 <default_pmm_manager+0x738>
...
ffffffffc020382c:	c1860613          	addi	a2,a2,-1000 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0203830:	06200593          	li	a1,98
ffffffffc0203834:	00004517          	auipc	a0,0x4
ffffffffc0203838:	b6450513          	addi	a0,a0,-1180 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc020383c:	c3ffc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0203840:	00004697          	auipc	a3,0x4
ffffffffc0203844:	42068693          	addi	a3,a3,1056 # ffffffffc0207c60 <default_pmm_manager+0x928>
ffffffffc0203848:	00003617          	auipc	a2,0x3
ffffffffc020384c:	45860613          	addi	a2,a2,1112 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203850:	0fc00593          	li	a1,252
ffffffffc0203854:	00004517          	auipc	a0,0x4
ffffffffc0203858:	21c50513          	addi	a0,a0,540 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020385c:	c1ffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0203860:	00004697          	auipc	a3,0x4
ffffffffc0203864:	32068693          	addi	a3,a3,800 # ffffffffc0207b80 <default_pmm_manager+0x848>
ffffffffc0203868:	00003617          	auipc	a2,0x3
ffffffffc020386c:	43860613          	addi	a2,a2,1080 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203870:	0dc00593          	li	a1,220
ffffffffc0203874:	00004517          	auipc	a0,0x4
ffffffffc0203878:	1fc50513          	addi	a0,a0,508 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020387c:	bfffc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0203880:	00004617          	auipc	a2,0x4
ffffffffc0203884:	1d060613          	addi	a2,a2,464 # ffffffffc0207a50 <default_pmm_manager+0x718>
ffffffffc0203888:	02800593          	li	a1,40
ffffffffc020388c:	00004517          	auipc	a0,0x4
ffffffffc0203890:	1e450513          	addi	a0,a0,484 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203894:	be7fc0ef          	jal	ra,ffffffffc020047a <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0203898:	00004697          	auipc	a3,0x4
ffffffffc020389c:	3b068693          	addi	a3,a3,944 # ffffffffc0207c48 <default_pmm_manager+0x910>
ffffffffc02038a0:	00003617          	auipc	a2,0x3
ffffffffc02038a4:	40060613          	addi	a2,a2,1024 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02038a8:	0fb00593          	li	a1,251
ffffffffc02038ac:	00004517          	auipc	a0,0x4
ffffffffc02038b0:	1c450513          	addi	a0,a0,452 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc02038b4:	bc7fc0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02038b8:	00004617          	auipc	a2,0x4
ffffffffc02038bc:	ba860613          	addi	a2,a2,-1112 # ffffffffc0207460 <default_pmm_manager+0x128>
ffffffffc02038c0:	07400593          	li	a1,116
ffffffffc02038c4:	00004517          	auipc	a0,0x4
ffffffffc02038c8:	ad450513          	addi	a0,a0,-1324 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc02038cc:	baffc0ef          	jal	ra,ffffffffc020047a <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc02038d0:	00004697          	auipc	a3,0x4
ffffffffc02038d4:	2c868693          	addi	a3,a3,712 # ffffffffc0207b98 <default_pmm_manager+0x860>
ffffffffc02038d8:	00003617          	auipc	a2,0x3
ffffffffc02038dc:	3c860613          	addi	a2,a2,968 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02038e0:	0dd00593          	li	a1,221
ffffffffc02038e4:	00004517          	auipc	a0,0x4
ffffffffc02038e8:	18c50513          	addi	a0,a0,396 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc02038ec:	b8ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(check_mm_struct == NULL);
ffffffffc02038f0:	00004697          	auipc	a3,0x4
ffffffffc02038f4:	1e068693          	addi	a3,a3,480 # ffffffffc0207ad0 <default_pmm_manager+0x798>
ffffffffc02038f8:	00003617          	auipc	a2,0x3
ffffffffc02038fc:	3a860613          	addi	a2,a2,936 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203900:	0c700593          	li	a1,199
ffffffffc0203904:	00004517          	auipc	a0,0x4
ffffffffc0203908:	16c50513          	addi	a0,a0,364 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020390c:	b6ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total == nr_free_pages());
ffffffffc0203910:	00003697          	auipc	a3,0x3
ffffffffc0203914:	6a868693          	addi	a3,a3,1704 # ffffffffc0206fb8 <commands+0x768>
ffffffffc0203918:	00003617          	auipc	a2,0x3
ffffffffc020391c:	38860613          	addi	a2,a2,904 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203920:	0bf00593          	li	a1,191
ffffffffc0203924:	00004517          	auipc	a0,0x4
ffffffffc0203928:	14c50513          	addi	a0,a0,332 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020392c:	b4ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert( nr_free == 0);         
ffffffffc0203930:	00004697          	auipc	a3,0x4
ffffffffc0203934:	83068693          	addi	a3,a3,-2000 # ffffffffc0207160 <commands+0x910>
ffffffffc0203938:	00003617          	auipc	a2,0x3
ffffffffc020393c:	36860613          	addi	a2,a2,872 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203940:	0f300593          	li	a1,243
ffffffffc0203944:	00004517          	auipc	a0,0x4
ffffffffc0203948:	12c50513          	addi	a0,a0,300 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020394c:	b2ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203950:	00004697          	auipc	a3,0x4
ffffffffc0203954:	19868693          	addi	a3,a3,408 # ffffffffc0207ae8 <default_pmm_manager+0x7b0>
ffffffffc0203958:	00003617          	auipc	a2,0x3
ffffffffc020395c:	34860613          	addi	a2,a2,840 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203960:	0cc00593          	li	a1,204
ffffffffc0203964:	00004517          	auipc	a0,0x4
ffffffffc0203968:	10c50513          	addi	a0,a0,268 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020396c:	b0ffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(mm != NULL);
ffffffffc0203970:	00004697          	auipc	a3,0x4
ffffffffc0203974:	15068693          	addi	a3,a3,336 # ffffffffc0207ac0 <default_pmm_manager+0x788>
ffffffffc0203978:	00003617          	auipc	a2,0x3
ffffffffc020397c:	32860613          	addi	a2,a2,808 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203980:	0c400593          	li	a1,196
ffffffffc0203984:	00004517          	auipc	a0,0x4
ffffffffc0203988:	0ec50513          	addi	a0,a0,236 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc020398c:	aeffc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(total==0);
ffffffffc0203990:	00004697          	auipc	a3,0x4
ffffffffc0203994:	33868693          	addi	a3,a3,824 # ffffffffc0207cc8 <default_pmm_manager+0x990>
ffffffffc0203998:	00003617          	auipc	a2,0x3
ffffffffc020399c:	30860613          	addi	a2,a2,776 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02039a0:	11e00593          	li	a1,286
ffffffffc02039a4:	00004517          	auipc	a0,0x4
ffffffffc02039a8:	0cc50513          	addi	a0,a0,204 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc02039ac:	acffc0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc02039b0:	00004617          	auipc	a2,0x4
ffffffffc02039b4:	9c060613          	addi	a2,a2,-1600 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc02039b8:	06900593          	li	a1,105
ffffffffc02039bc:	00004517          	auipc	a0,0x4
ffffffffc02039c0:	9dc50513          	addi	a0,a0,-1572 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc02039c4:	ab7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(count==0);
ffffffffc02039c8:	00004697          	auipc	a3,0x4
ffffffffc02039cc:	2f068693          	addi	a3,a3,752 # ffffffffc0207cb8 <default_pmm_manager+0x980>
ffffffffc02039d0:	00003617          	auipc	a2,0x3
ffffffffc02039d4:	2d060613          	addi	a2,a2,720 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02039d8:	11d00593          	li	a1,285
ffffffffc02039dc:	00004517          	auipc	a0,0x4
ffffffffc02039e0:	09450513          	addi	a0,a0,148 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc02039e4:	a97fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc02039e8:	00004697          	auipc	a3,0x4
ffffffffc02039ec:	22068693          	addi	a3,a3,544 # ffffffffc0207c08 <default_pmm_manager+0x8d0>
ffffffffc02039f0:	00003617          	auipc	a2,0x3
ffffffffc02039f4:	2b060613          	addi	a2,a2,688 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02039f8:	09500593          	li	a1,149
ffffffffc02039fc:	00004517          	auipc	a0,0x4
ffffffffc0203a00:	07450513          	addi	a0,a0,116 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203a04:	a77fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203a08:	00004697          	auipc	a3,0x4
ffffffffc0203a0c:	1b068693          	addi	a3,a3,432 # ffffffffc0207bb8 <default_pmm_manager+0x880>
ffffffffc0203a10:	00003617          	auipc	a2,0x3
ffffffffc0203a14:	29060613          	addi	a2,a2,656 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203a18:	0ea00593          	li	a1,234
ffffffffc0203a1c:	00004517          	auipc	a0,0x4
ffffffffc0203a20:	05450513          	addi	a0,a0,84 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203a24:	a57fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0203a28:	00004697          	auipc	a3,0x4
ffffffffc0203a2c:	11868693          	addi	a3,a3,280 # ffffffffc0207b40 <default_pmm_manager+0x808>
ffffffffc0203a30:	00003617          	auipc	a2,0x3
ffffffffc0203a34:	27060613          	addi	a2,a2,624 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203a38:	0d700593          	li	a1,215
ffffffffc0203a3c:	00004517          	auipc	a0,0x4
ffffffffc0203a40:	03450513          	addi	a0,a0,52 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203a44:	a37fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(ret==0);
ffffffffc0203a48:	00004697          	auipc	a3,0x4
ffffffffc0203a4c:	26868693          	addi	a3,a3,616 # ffffffffc0207cb0 <default_pmm_manager+0x978>
ffffffffc0203a50:	00003617          	auipc	a2,0x3
ffffffffc0203a54:	25060613          	addi	a2,a2,592 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203a58:	10200593          	li	a1,258
ffffffffc0203a5c:	00004517          	auipc	a0,0x4
ffffffffc0203a60:	01450513          	addi	a0,a0,20 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203a64:	a17fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(vma != NULL);
ffffffffc0203a68:	00004697          	auipc	a3,0x4
ffffffffc0203a6c:	09068693          	addi	a3,a3,144 # ffffffffc0207af8 <default_pmm_manager+0x7c0>
ffffffffc0203a70:	00003617          	auipc	a2,0x3
ffffffffc0203a74:	23060613          	addi	a2,a2,560 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203a78:	0cf00593          	li	a1,207
ffffffffc0203a7c:	00004517          	auipc	a0,0x4
ffffffffc0203a80:	ff450513          	addi	a0,a0,-12 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203a84:	9f7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203a88:	00004697          	auipc	a3,0x4
ffffffffc0203a8c:	1b068693          	addi	a3,a3,432 # ffffffffc0207c38 <default_pmm_manager+0x900>
ffffffffc0203a90:	00003617          	auipc	a2,0x3
ffffffffc0203a94:	21060613          	addi	a2,a2,528 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203a98:	09f00593          	li	a1,159
ffffffffc0203a9c:	00004517          	auipc	a0,0x4
ffffffffc0203aa0:	fd450513          	addi	a0,a0,-44 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203aa4:	9d7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==4);
ffffffffc0203aa8:	00004697          	auipc	a3,0x4
ffffffffc0203aac:	19068693          	addi	a3,a3,400 # ffffffffc0207c38 <default_pmm_manager+0x900>
ffffffffc0203ab0:	00003617          	auipc	a2,0x3
ffffffffc0203ab4:	1f060613          	addi	a2,a2,496 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203ab8:	0a100593          	li	a1,161
ffffffffc0203abc:	00004517          	auipc	a0,0x4
ffffffffc0203ac0:	fb450513          	addi	a0,a0,-76 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203ac4:	9b7fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ac8:	00004697          	auipc	a3,0x4
ffffffffc0203acc:	15068693          	addi	a3,a3,336 # ffffffffc0207c18 <default_pmm_manager+0x8e0>
ffffffffc0203ad0:	00003617          	auipc	a2,0x3
ffffffffc0203ad4:	1d060613          	addi	a2,a2,464 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203ad8:	09700593          	li	a1,151
ffffffffc0203adc:	00004517          	auipc	a0,0x4
ffffffffc0203ae0:	f9450513          	addi	a0,a0,-108 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203ae4:	997fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==2);
ffffffffc0203ae8:	00004697          	auipc	a3,0x4
ffffffffc0203aec:	13068693          	addi	a3,a3,304 # ffffffffc0207c18 <default_pmm_manager+0x8e0>
ffffffffc0203af0:	00003617          	auipc	a2,0x3
ffffffffc0203af4:	1b060613          	addi	a2,a2,432 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203af8:	09900593          	li	a1,153
ffffffffc0203afc:	00004517          	auipc	a0,0x4
ffffffffc0203b00:	f7450513          	addi	a0,a0,-140 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203b04:	977fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b08:	00004697          	auipc	a3,0x4
ffffffffc0203b0c:	12068693          	addi	a3,a3,288 # ffffffffc0207c28 <default_pmm_manager+0x8f0>
ffffffffc0203b10:	00003617          	auipc	a2,0x3
ffffffffc0203b14:	19060613          	addi	a2,a2,400 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203b18:	09b00593          	li	a1,155
ffffffffc0203b1c:	00004517          	auipc	a0,0x4
ffffffffc0203b20:	f5450513          	addi	a0,a0,-172 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203b24:	957fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==3);
ffffffffc0203b28:	00004697          	auipc	a3,0x4
ffffffffc0203b2c:	10068693          	addi	a3,a3,256 # ffffffffc0207c28 <default_pmm_manager+0x8f0>
ffffffffc0203b30:	00003617          	auipc	a2,0x3
ffffffffc0203b34:	17060613          	addi	a2,a2,368 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203b38:	09d00593          	li	a1,157
ffffffffc0203b3c:	00004517          	auipc	a0,0x4
ffffffffc0203b40:	f3450513          	addi	a0,a0,-204 # ffffffffc0207a70 <default_pmm_manager+0x738>
ffffffffc0203b44:	937fc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(pgfault_num==1);
ffffffffc0203b48:	00004697          	auipc	a3,0x4
ffffffffc0203b4c:	0c068693          	addi	a3,a3,192 # ffffffffc0207c08 <default_pmm_manager+0x8d0>
ffffffffc0203b50:	00003617          	auipc	a2,0x3
ffffffffc0203b54:	15060613          	addi	a2,a2,336 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203b58:	09300593          	li	a1,147
ffffffffc0203b5c:	00004517          	auipc	a0,0x4
ffffffffc0203b60:	f1450513          	addi	a0,a0,-236 # ffffffffc0207a70 <default_pmm_manager+0x738>
...
ffffffffc0203b6c:	bf87b783          	ld	a5,-1032(a5) # ffffffffc02b2760 <sm>
...
ffffffffc0203b78:	bec7b783          	ld	a5,-1044(a5) # ffffffffc02b2760 <sm>
...
ffffffffc0203ba4:	bc098993          	addi	s3,s3,-1088 # ffffffffc02b2760 <sm>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0203ba8:	00004b17          	auipc	s6,0x4
ffffffffc0203bac:	1b0b0b13          	addi	s6,s6,432 # ffffffffc0207d58 <default_pmm_manager+0xa20>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203bb0:	00004b97          	auipc	s7,0x4
ffffffffc0203bb4:	190b8b93          	addi	s7,s7,400 # ffffffffc0207d40 <default_pmm_manager+0xa08>
...
ffffffffc0203c24:	030010ef          	jal	ra,ffffffffc0204c54 <swapfs_write>
...
ffffffffc0203c66:	09650513          	addi	a0,a0,150 # ffffffffc0207cf8 <default_pmm_manager+0x9c0>
...
ffffffffc0203c78:	0b468693          	addi	a3,a3,180 # ffffffffc0207d28 <default_pmm_manager+0x9f0>
ffffffffc0203c7c:	00003617          	auipc	a2,0x3
ffffffffc0203c80:	02460613          	addi	a2,a2,36 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203c84:	06800593          	li	a1,104
ffffffffc0203c88:	00004517          	auipc	a0,0x4
ffffffffc0203c8c:	de850513          	addi	a0,a0,-536 # ffffffffc0207a70 <default_pmm_manager+0x738>
...
ffffffffc0203cc2:	705000ef          	jal	ra,ffffffffc0204bc6 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203cc6:	00093583          	ld	a1,0(s2)
ffffffffc0203cca:	8626                	mv	a2,s1
ffffffffc0203ccc:	00004517          	auipc	a0,0x4
ffffffffc0203cd0:	0dc50513          	addi	a0,a0,220 # ffffffffc0207da8 <default_pmm_manager+0xa70>
...
ffffffffc0203cf2:	0aa68693          	addi	a3,a3,170 # ffffffffc0207d98 <default_pmm_manager+0xa60>
ffffffffc0203cf6:	00003617          	auipc	a2,0x3
ffffffffc0203cfa:	faa60613          	addi	a2,a2,-86 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203cfe:	07e00593          	li	a1,126
ffffffffc0203d02:	00004517          	auipc	a0,0x4
ffffffffc0203d06:	d6e50513          	addi	a0,a0,-658 # ffffffffc0207a70 <default_pmm_manager+0x738>
...
ffffffffc0203d12:	9da78793          	addi	a5,a5,-1574 # ffffffffc02ae6e8 <pra_list_head>
 */
static int
...
ffffffffc0203d36:	0b650513          	addi	a0,a0,182 # ffffffffc0207de8 <default_pmm_manager+0xab0>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203d52:	c2efc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203d56:	01498023          	sb	s4,0(s3) # 3000 <_binary_obj___user_faultread_out_size-0x6ba0>
    assert(pgfault_num==4);
ffffffffc0203d5a:	000af917          	auipc	s2,0xaf
ffffffffc0203d5e:	a1e92903          	lw	s2,-1506(s2) # ffffffffc02b2778 <pgfault_num>
...
ffffffffc0203d6c:	0c050513          	addi	a0,a0,192 # ffffffffc0207e28 <default_pmm_manager+0xaf0>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203d7c:	a0040413          	addi	s0,s0,-1536 # ffffffffc02b2778 <pgfault_num>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203d80:	016a8023          	sb	s6,0(s5) # 1000 <_binary_obj___user_faultread_out_size-0x8ba0>
    assert(pgfault_num==4);
...
ffffffffc0203d90:	0c450513          	addi	a0,a0,196 # ffffffffc0207e50 <default_pmm_manager+0xb18>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc0203d98:	be8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc0203d9c:	018b8023          	sb	s8,0(s7) # 4000 <_binary_obj___user_faultread_out_size-0x5ba0>
    assert(pgfault_num==4);
...
ffffffffc0203dae:	0ce50513          	addi	a0,a0,206 # ffffffffc0207e78 <default_pmm_manager+0xb40>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203db6:	bcafc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203dba:	01ac8023          	sb	s10,0(s9) # 2000 <_binary_obj___user_faultread_out_size-0x7ba0>
    assert(pgfault_num==4);
...
ffffffffc0203dca:	0da50513          	addi	a0,a0,218 # ffffffffc0207ea0 <default_pmm_manager+0xb68>
...
ffffffffc0203dd6:	00e78023          	sb	a4,0(a5) # 5000 <_binary_obj___user_faultread_out_size-0x4ba0>
...
ffffffffc0203de8:	09450513          	addi	a0,a0,148 # ffffffffc0207e78 <default_pmm_manager+0xb40>
...
ffffffffc0203e00:	02c50513          	addi	a0,a0,44 # ffffffffc0207e28 <default_pmm_manager+0xaf0>
...
ffffffffc0203e1a:	06250513          	addi	a0,a0,98 # ffffffffc0207e78 <default_pmm_manager+0xb40>
...
ffffffffc0203e34:	fb850513          	addi	a0,a0,-72 # ffffffffc0207de8 <default_pmm_manager+0xab0>
...
ffffffffc0203e4e:	00650513          	addi	a0,a0,6 # ffffffffc0207e50 <default_pmm_manager+0xb18>
...
ffffffffc0203e68:	03c50513          	addi	a0,a0,60 # ffffffffc0207ea0 <default_pmm_manager+0xb68>
ffffffffc0203e6c:	b14fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc0203e70:	6795                	lui	a5,0x5
ffffffffc0203e72:	4739                	li	a4,14
ffffffffc0203e74:	00e78023          	sb	a4,0(a5) # 5000 <_binary_obj___user_faultread_out_size-0x4ba0>
...
ffffffffc0203e86:	fa650513          	addi	a0,a0,-90 # ffffffffc0207e28 <default_pmm_manager+0xaf0>
ffffffffc0203e8a:	af6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203e8e:	6785                	lui	a5,0x1
ffffffffc0203e90:	0007c783          	lbu	a5,0(a5) # 1000 <_binary_obj___user_faultread_out_size-0x8ba0>
...
ffffffffc0203ec4:	d7868693          	addi	a3,a3,-648 # ffffffffc0207c38 <default_pmm_manager+0x900>
ffffffffc0203ec8:	00003617          	auipc	a2,0x3
ffffffffc0203ecc:	dd860613          	addi	a2,a2,-552 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203ed0:	05100593          	li	a1,81
ffffffffc0203ed4:	00004517          	auipc	a0,0x4
ffffffffc0203ed8:	f3c50513          	addi	a0,a0,-196 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203edc:	d9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==11);
ffffffffc0203ee0:	00004697          	auipc	a3,0x4
ffffffffc0203ee4:	07068693          	addi	a3,a3,112 # ffffffffc0207f50 <default_pmm_manager+0xc18>
ffffffffc0203ee8:	00003617          	auipc	a2,0x3
ffffffffc0203eec:	db860613          	addi	a2,a2,-584 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203ef0:	07300593          	li	a1,115
ffffffffc0203ef4:	00004517          	auipc	a0,0x4
ffffffffc0203ef8:	f1c50513          	addi	a0,a0,-228 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203efc:	d7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203f00:	00004697          	auipc	a3,0x4
ffffffffc0203f04:	02868693          	addi	a3,a3,40 # ffffffffc0207f28 <default_pmm_manager+0xbf0>
ffffffffc0203f08:	00003617          	auipc	a2,0x3
ffffffffc0203f0c:	d9860613          	addi	a2,a2,-616 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203f10:	07100593          	li	a1,113
ffffffffc0203f14:	00004517          	auipc	a0,0x4
ffffffffc0203f18:	efc50513          	addi	a0,a0,-260 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203f1c:	d5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==10);
ffffffffc0203f20:	00004697          	auipc	a3,0x4
ffffffffc0203f24:	ff868693          	addi	a3,a3,-8 # ffffffffc0207f18 <default_pmm_manager+0xbe0>
ffffffffc0203f28:	00003617          	auipc	a2,0x3
ffffffffc0203f2c:	d7860613          	addi	a2,a2,-648 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203f30:	06f00593          	li	a1,111
ffffffffc0203f34:	00004517          	auipc	a0,0x4
ffffffffc0203f38:	edc50513          	addi	a0,a0,-292 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203f3c:	d3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==9);
ffffffffc0203f40:	00004697          	auipc	a3,0x4
ffffffffc0203f44:	fc868693          	addi	a3,a3,-56 # ffffffffc0207f08 <default_pmm_manager+0xbd0>
ffffffffc0203f48:	00003617          	auipc	a2,0x3
ffffffffc0203f4c:	d5860613          	addi	a2,a2,-680 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203f50:	06c00593          	li	a1,108
ffffffffc0203f54:	00004517          	auipc	a0,0x4
ffffffffc0203f58:	ebc50513          	addi	a0,a0,-324 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203f5c:	d1efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==8);
ffffffffc0203f60:	00004697          	auipc	a3,0x4
ffffffffc0203f64:	f9868693          	addi	a3,a3,-104 # ffffffffc0207ef8 <default_pmm_manager+0xbc0>
ffffffffc0203f68:	00003617          	auipc	a2,0x3
ffffffffc0203f6c:	d3860613          	addi	a2,a2,-712 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203f70:	06900593          	li	a1,105
ffffffffc0203f74:	00004517          	auipc	a0,0x4
ffffffffc0203f78:	e9c50513          	addi	a0,a0,-356 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203f7c:	cfefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==7);
ffffffffc0203f80:	00004697          	auipc	a3,0x4
ffffffffc0203f84:	f6868693          	addi	a3,a3,-152 # ffffffffc0207ee8 <default_pmm_manager+0xbb0>
ffffffffc0203f88:	00003617          	auipc	a2,0x3
ffffffffc0203f8c:	d1860613          	addi	a2,a2,-744 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203f90:	06600593          	li	a1,102
ffffffffc0203f94:	00004517          	auipc	a0,0x4
ffffffffc0203f98:	e7c50513          	addi	a0,a0,-388 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203f9c:	cdefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==6);
ffffffffc0203fa0:	00004697          	auipc	a3,0x4
ffffffffc0203fa4:	f3868693          	addi	a3,a3,-200 # ffffffffc0207ed8 <default_pmm_manager+0xba0>
ffffffffc0203fa8:	00003617          	auipc	a2,0x3
ffffffffc0203fac:	cf860613          	addi	a2,a2,-776 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203fb0:	06300593          	li	a1,99
ffffffffc0203fb4:	00004517          	auipc	a0,0x4
ffffffffc0203fb8:	e5c50513          	addi	a0,a0,-420 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203fbc:	cbefc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fc0:	00004697          	auipc	a3,0x4
ffffffffc0203fc4:	f0868693          	addi	a3,a3,-248 # ffffffffc0207ec8 <default_pmm_manager+0xb90>
ffffffffc0203fc8:	00003617          	auipc	a2,0x3
ffffffffc0203fcc:	cd860613          	addi	a2,a2,-808 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203fd0:	06000593          	li	a1,96
ffffffffc0203fd4:	00004517          	auipc	a0,0x4
ffffffffc0203fd8:	e3c50513          	addi	a0,a0,-452 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203fdc:	c9efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==5);
ffffffffc0203fe0:	00004697          	auipc	a3,0x4
ffffffffc0203fe4:	ee868693          	addi	a3,a3,-280 # ffffffffc0207ec8 <default_pmm_manager+0xb90>
ffffffffc0203fe8:	00003617          	auipc	a2,0x3
ffffffffc0203fec:	cb860613          	addi	a2,a2,-840 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0203ff0:	05d00593          	li	a1,93
ffffffffc0203ff4:	00004517          	auipc	a0,0x4
ffffffffc0203ff8:	e1c50513          	addi	a0,a0,-484 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc0203ffc:	c7efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204000:	00004697          	auipc	a3,0x4
ffffffffc0204004:	c3868693          	addi	a3,a3,-968 # ffffffffc0207c38 <default_pmm_manager+0x900>
ffffffffc0204008:	00003617          	auipc	a2,0x3
ffffffffc020400c:	c9860613          	addi	a2,a2,-872 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204010:	05a00593          	li	a1,90
ffffffffc0204014:	00004517          	auipc	a0,0x4
ffffffffc0204018:	dfc50513          	addi	a0,a0,-516 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc020401c:	c5efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204020:	00004697          	auipc	a3,0x4
ffffffffc0204024:	c1868693          	addi	a3,a3,-1000 # ffffffffc0207c38 <default_pmm_manager+0x900>
ffffffffc0204028:	00003617          	auipc	a2,0x3
ffffffffc020402c:	c7860613          	addi	a2,a2,-904 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204030:	05700593          	li	a1,87
ffffffffc0204034:	00004517          	auipc	a0,0x4
ffffffffc0204038:	ddc50513          	addi	a0,a0,-548 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc020403c:	c3efc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgfault_num==4);
ffffffffc0204040:	00004697          	auipc	a3,0x4
ffffffffc0204044:	bf868693          	addi	a3,a3,-1032 # ffffffffc0207c38 <default_pmm_manager+0x900>
ffffffffc0204048:	00003617          	auipc	a2,0x3
ffffffffc020404c:	c5860613          	addi	a2,a2,-936 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204050:	05400593          	li	a1,84
ffffffffc0204054:	00004517          	auipc	a0,0x4
ffffffffc0204058:	dbc50513          	addi	a0,a0,-580 # ffffffffc0207e10 <default_pmm_manager+0xad8>
...
ffffffffc0204086:	ede68693          	addi	a3,a3,-290 # ffffffffc0207f60 <default_pmm_manager+0xc28>
ffffffffc020408a:	00003617          	auipc	a2,0x3
ffffffffc020408e:	c1660613          	addi	a2,a2,-1002 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204092:	04100593          	li	a1,65
ffffffffc0204096:	00004517          	auipc	a0,0x4
ffffffffc020409a:	d7a50513          	addi	a0,a0,-646 # ffffffffc0207e10 <default_pmm_manager+0xad8>
ffffffffc020409e:	bdcfc0ef          	jal	ra,ffffffffc020047a <__panic>
     assert(in_tick==0);
ffffffffc02040a2:	00004697          	auipc	a3,0x4
ffffffffc02040a6:	ece68693          	addi	a3,a3,-306 # ffffffffc0207f70 <default_pmm_manager+0xc38>
ffffffffc02040aa:	00003617          	auipc	a2,0x3
ffffffffc02040ae:	bf660613          	addi	a2,a2,-1034 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02040b2:	04200593          	li	a1,66
ffffffffc02040b6:	00004517          	auipc	a0,0x4
ffffffffc02040ba:	d5a50513          	addi	a0,a0,-678 # ffffffffc0207e10 <default_pmm_manager+0xad8>
...
ffffffffc02040de:	ea668693          	addi	a3,a3,-346 # ffffffffc0207f80 <default_pmm_manager+0xc48>
ffffffffc02040e2:	00003617          	auipc	a2,0x3
ffffffffc02040e6:	bbe60613          	addi	a2,a2,-1090 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02040ea:	03200593          	li	a1,50
ffffffffc02040ee:	00004517          	auipc	a0,0x4
ffffffffc02040f2:	d2250513          	addi	a0,a0,-734 # ffffffffc0207e10 <default_pmm_manager+0xad8>
{
...
ffffffffc0204102:	eba68693          	addi	a3,a3,-326 # ffffffffc0207fb8 <default_pmm_manager+0xc80>
ffffffffc0204106:	00003617          	auipc	a2,0x3
ffffffffc020410a:	b9a60613          	addi	a2,a2,-1126 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020410e:	06d00593          	li	a1,109
ffffffffc0204112:	00004517          	auipc	a0,0x4
ffffffffc0204116:	ec650513          	addi	a0,a0,-314 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0204146:	6267a783          	lw	a5,1574(a5) # ffffffffc02b2768 <swap_init_ok>
...
ffffffffc02041d8:	0105b803          	ld	a6,16(a1) # 1010 <_binary_obj___user_faultread_out_size-0x8b90>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
...
ffffffffc020424a:	da268693          	addi	a3,a3,-606 # ffffffffc0207fe8 <default_pmm_manager+0xcb0>
ffffffffc020424e:	00003617          	auipc	a2,0x3
ffffffffc0204252:	a5260613          	addi	a2,a2,-1454 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204256:	07400593          	li	a1,116
ffffffffc020425a:	00004517          	auipc	a0,0x4
ffffffffc020425e:	d7e50513          	addi	a0,a0,-642 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204262:	a18fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0204266:	00004697          	auipc	a3,0x4
ffffffffc020426a:	dc268693          	addi	a3,a3,-574 # ffffffffc0208028 <default_pmm_manager+0xcf0>
ffffffffc020426e:	00003617          	auipc	a2,0x3
ffffffffc0204272:	a3260613          	addi	a2,a2,-1486 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204276:	06c00593          	li	a1,108
ffffffffc020427a:	00004517          	auipc	a0,0x4
ffffffffc020427e:	d5e50513          	addi	a0,a0,-674 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204282:	9f8fc0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0204286:	00004697          	auipc	a3,0x4
ffffffffc020428a:	d8268693          	addi	a3,a3,-638 # ffffffffc0208008 <default_pmm_manager+0xcd0>
ffffffffc020428e:	00003617          	auipc	a2,0x3
ffffffffc0204292:	a1260613          	addi	a2,a2,-1518 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204296:	06b00593          	li	a1,107
ffffffffc020429a:	00004517          	auipc	a0,0x4
ffffffffc020429e:	d3e50513          	addi	a0,a0,-706 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc02042dc:	d7068693          	addi	a3,a3,-656 # ffffffffc0208048 <default_pmm_manager+0xd10>
ffffffffc02042e0:	00003617          	auipc	a2,0x3
ffffffffc02042e4:	9c060613          	addi	a2,a2,-1600 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02042e8:	09400593          	li	a1,148
ffffffffc02042ec:	00004517          	auipc	a0,0x4
ffffffffc02042f0:	cec50513          	addi	a0,a0,-788 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc020438c:	73868693          	addi	a3,a3,1848 # ffffffffc0207ac0 <default_pmm_manager+0x788>
ffffffffc0204390:	00003617          	auipc	a2,0x3
ffffffffc0204394:	91060613          	addi	a2,a2,-1776 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204398:	0a700593          	li	a1,167
ffffffffc020439c:	00004517          	auipc	a0,0x4
ffffffffc02043a0:	c3c50513          	addi	a0,a0,-964 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc02043d6:	ff043683          	ld	a3,-16(s0) # ff0 <_binary_obj___user_faultread_out_size-0x8bb0>
...
ffffffffc0204426:	c3e68693          	addi	a3,a3,-962 # ffffffffc0208060 <default_pmm_manager+0xd28>
ffffffffc020442a:	00003617          	auipc	a2,0x3
ffffffffc020442e:	87660613          	addi	a2,a2,-1930 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204432:	0c000593          	li	a1,192
ffffffffc0204436:	00004517          	auipc	a0,0x4
ffffffffc020443a:	ba250513          	addi	a0,a0,-1118 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc020449c:	be868693          	addi	a3,a3,-1048 # ffffffffc0208080 <default_pmm_manager+0xd48>
ffffffffc02044a0:	00003617          	auipc	a2,0x3
ffffffffc02044a4:	80060613          	addi	a2,a2,-2048 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02044a8:	0d600593          	li	a1,214
ffffffffc02044ac:	00004517          	auipc	a0,0x4
ffffffffc02044b0:	b2c50513          	addi	a0,a0,-1236 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc02044fc:	60068693          	addi	a3,a3,1536 # ffffffffc0207af8 <default_pmm_manager+0x7c0>
ffffffffc0204500:	00002617          	auipc	a2,0x2
ffffffffc0204504:	7a060613          	addi	a2,a2,1952 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204508:	11300593          	li	a1,275
ffffffffc020450c:	00004517          	auipc	a0,0x4
ffffffffc0204510:	acc50513          	addi	a0,a0,-1332 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc020454a:	5b268693          	addi	a3,a3,1458 # ffffffffc0207af8 <default_pmm_manager+0x7c0>
ffffffffc020454e:	00002617          	auipc	a2,0x2
ffffffffc0204552:	75260613          	addi	a2,a2,1874 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204556:	11900593          	li	a1,281
ffffffffc020455a:	00004517          	auipc	a0,0x4
ffffffffc020455e:	a7e50513          	addi	a0,a0,-1410 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc0204572:	fe87b683          	ld	a3,-24(a5) # ffffffffffffefe8 <end+0x3fd4c84c>
...
ffffffffc020461e:	b8650513          	addi	a0,a0,-1146 # ffffffffc02081a0 <default_pmm_manager+0xe68>
ffffffffc0204622:	b5ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0204626:	00004697          	auipc	a3,0x4
ffffffffc020462a:	ba268693          	addi	a3,a3,-1118 # ffffffffc02081c8 <default_pmm_manager+0xe90>
ffffffffc020462e:	00002617          	auipc	a2,0x2
ffffffffc0204632:	67260613          	addi	a2,a2,1650 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204636:	13b00593          	li	a1,315
ffffffffc020463a:	00004517          	auipc	a0,0x4
ffffffffc020463e:	99e50513          	addi	a0,a0,-1634 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc0204656:	b8e50513          	addi	a0,a0,-1138 # ffffffffc02081e0 <default_pmm_manager+0xea8>
...
ffffffffc020466c:	10a7b423          	sd	a0,264(a5) # ffffffffc02b2770 <check_mm_struct>
...
ffffffffc020467a:	0ba4b483          	ld	s1,186(s1) # ffffffffc02b2730 <boot_pgdir>
    assert(pgdir[0] == 0);
...
ffffffffc02046d4:	35670713          	addi	a4,a4,854 # 1356 <_binary_obj___user_faultread_out_size-0x884a>
    }
    for (i = 0; i < 100; i ++) {
...
ffffffffc02046f2:	04aa8a93          	addi	s5,s5,74 # ffffffffc02b2738 <npage>
...
ffffffffc0204706:	5dea3a03          	ld	s4,1502(s4) # ffffffffc0208ce0 <nbase>
...
ffffffffc0204726:	02e9b983          	ld	s3,46(s3) # ffffffffc02b2750 <va_pa_offset>
...
ffffffffc0204748:	ffc98993          	addi	s3,s3,-4 # ffffffffc02b2740 <pages>
...
ffffffffc0204794:	fe07b023          	sd	zero,-32(a5) # ffffffffc02b2770 <check_mm_struct>
...
ffffffffc02047a4:	ad050513          	addi	a0,a0,-1328 # ffffffffc0208270 <default_pmm_manager+0xf38>
...
ffffffffc02047be:	ad650513          	addi	a0,a0,-1322 # ffffffffc0208290 <default_pmm_manager+0xf58>
}
...
ffffffffc02047cc:	8f068693          	addi	a3,a3,-1808 # ffffffffc02080b8 <default_pmm_manager+0xd80>
ffffffffc02047d0:	00002617          	auipc	a2,0x2
ffffffffc02047d4:	4d060613          	addi	a2,a2,1232 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02047d8:	12200593          	li	a1,290
ffffffffc02047dc:	00003517          	auipc	a0,0x3
ffffffffc02047e0:	7fc50513          	addi	a0,a0,2044 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc02047e4:	c97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02047e8:	00004697          	auipc	a3,0x4
ffffffffc02047ec:	95868693          	addi	a3,a3,-1704 # ffffffffc0208140 <default_pmm_manager+0xe08>
ffffffffc02047f0:	00002617          	auipc	a2,0x2
ffffffffc02047f4:	4b060613          	addi	a2,a2,1200 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02047f8:	13200593          	li	a1,306
ffffffffc02047fc:	00003517          	auipc	a0,0x3
ffffffffc0204800:	7dc50513          	addi	a0,a0,2012 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204804:	c77fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0204808:	00004697          	auipc	a3,0x4
ffffffffc020480c:	96868693          	addi	a3,a3,-1688 # ffffffffc0208170 <default_pmm_manager+0xe38>
ffffffffc0204810:	00002617          	auipc	a2,0x2
ffffffffc0204814:	49060613          	addi	a2,a2,1168 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204818:	13300593          	li	a1,307
ffffffffc020481c:	00003517          	auipc	a0,0x3
ffffffffc0204820:	7bc50513          	addi	a0,a0,1980 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204824:	c57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(vma != NULL);
ffffffffc0204828:	00003697          	auipc	a3,0x3
ffffffffc020482c:	2d068693          	addi	a3,a3,720 # ffffffffc0207af8 <default_pmm_manager+0x7c0>
ffffffffc0204830:	00002617          	auipc	a2,0x2
ffffffffc0204834:	47060613          	addi	a2,a2,1136 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204838:	15200593          	li	a1,338
ffffffffc020483c:	00003517          	auipc	a0,0x3
ffffffffc0204840:	79c50513          	addi	a0,a0,1948 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204844:	c37fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0204848:	00004697          	auipc	a3,0x4
ffffffffc020484c:	85868693          	addi	a3,a3,-1960 # ffffffffc02080a0 <default_pmm_manager+0xd68>
ffffffffc0204850:	00002617          	auipc	a2,0x2
ffffffffc0204854:	45060613          	addi	a2,a2,1104 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204858:	12000593          	li	a1,288
ffffffffc020485c:	00003517          	auipc	a0,0x3
ffffffffc0204860:	77c50513          	addi	a0,a0,1916 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204864:	c17fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma3 == NULL);
ffffffffc0204868:	00004697          	auipc	a3,0x4
ffffffffc020486c:	8a868693          	addi	a3,a3,-1880 # ffffffffc0208110 <default_pmm_manager+0xdd8>
ffffffffc0204870:	00002617          	auipc	a2,0x2
ffffffffc0204874:	43060613          	addi	a2,a2,1072 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204878:	12c00593          	li	a1,300
ffffffffc020487c:	00003517          	auipc	a0,0x3
ffffffffc0204880:	75c50513          	addi	a0,a0,1884 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204884:	bf7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma2 != NULL);
ffffffffc0204888:	00004697          	auipc	a3,0x4
ffffffffc020488c:	87868693          	addi	a3,a3,-1928 # ffffffffc0208100 <default_pmm_manager+0xdc8>
ffffffffc0204890:	00002617          	auipc	a2,0x2
ffffffffc0204894:	41060613          	addi	a2,a2,1040 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204898:	12a00593          	li	a1,298
ffffffffc020489c:	00003517          	auipc	a0,0x3
ffffffffc02048a0:	73c50513          	addi	a0,a0,1852 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc02048a4:	bd7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma1 != NULL);
ffffffffc02048a8:	00004697          	auipc	a3,0x4
ffffffffc02048ac:	84868693          	addi	a3,a3,-1976 # ffffffffc02080f0 <default_pmm_manager+0xdb8>
ffffffffc02048b0:	00002617          	auipc	a2,0x2
ffffffffc02048b4:	3f060613          	addi	a2,a2,1008 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02048b8:	12800593          	li	a1,296
ffffffffc02048bc:	00003517          	auipc	a0,0x3
ffffffffc02048c0:	71c50513          	addi	a0,a0,1820 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc02048c4:	bb7fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma5 == NULL);
ffffffffc02048c8:	00004697          	auipc	a3,0x4
ffffffffc02048cc:	86868693          	addi	a3,a3,-1944 # ffffffffc0208130 <default_pmm_manager+0xdf8>
ffffffffc02048d0:	00002617          	auipc	a2,0x2
ffffffffc02048d4:	3d060613          	addi	a2,a2,976 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02048d8:	13000593          	li	a1,304
ffffffffc02048dc:	00003517          	auipc	a0,0x3
ffffffffc02048e0:	6fc50513          	addi	a0,a0,1788 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc02048e4:	b97fb0ef          	jal	ra,ffffffffc020047a <__panic>
        assert(vma4 == NULL);
ffffffffc02048e8:	00004697          	auipc	a3,0x4
ffffffffc02048ec:	83868693          	addi	a3,a3,-1992 # ffffffffc0208120 <default_pmm_manager+0xde8>
ffffffffc02048f0:	00002617          	auipc	a2,0x2
ffffffffc02048f4:	3b060613          	addi	a2,a2,944 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02048f8:	12e00593          	li	a1,302
ffffffffc02048fc:	00003517          	auipc	a0,0x3
ffffffffc0204900:	6dc50513          	addi	a0,a0,1756 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204904:	b77fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0204908:	00004697          	auipc	a3,0x4
ffffffffc020490c:	8f868693          	addi	a3,a3,-1800 # ffffffffc0208200 <default_pmm_manager+0xec8>
ffffffffc0204910:	00002617          	auipc	a2,0x2
ffffffffc0204914:	39060613          	addi	a2,a2,912 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204918:	14b00593          	li	a1,331
ffffffffc020491c:	00003517          	auipc	a0,0x3
ffffffffc0204920:	6bc50513          	addi	a0,a0,1724 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204924:	b57fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(mm != NULL);
ffffffffc0204928:	00003697          	auipc	a3,0x3
ffffffffc020492c:	19868693          	addi	a3,a3,408 # ffffffffc0207ac0 <default_pmm_manager+0x788>
ffffffffc0204930:	00002617          	auipc	a2,0x2
ffffffffc0204934:	37060613          	addi	a2,a2,880 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204938:	10c00593          	li	a1,268
ffffffffc020493c:	00003517          	auipc	a0,0x3
ffffffffc0204940:	69c50513          	addi	a0,a0,1692 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204944:	b37fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0204948:	00004697          	auipc	a3,0x4
ffffffffc020494c:	90068693          	addi	a3,a3,-1792 # ffffffffc0208248 <default_pmm_manager+0xf10>
ffffffffc0204950:	00002617          	auipc	a2,0x2
ffffffffc0204954:	35060613          	addi	a2,a2,848 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204958:	17000593          	li	a1,368
ffffffffc020495c:	00003517          	auipc	a0,0x3
ffffffffc0204960:	67c50513          	addi	a0,a0,1660 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc0204964:	b17fb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0204968:	00003617          	auipc	a2,0x3
ffffffffc020496c:	a0860613          	addi	a2,a2,-1528 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0204970:	06900593          	li	a1,105
ffffffffc0204974:	00003517          	auipc	a0,0x3
ffffffffc0204978:	a2450513          	addi	a0,a0,-1500 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc020497c:	afffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir[0] == 0);
ffffffffc0204980:	00003697          	auipc	a3,0x3
ffffffffc0204984:	16868693          	addi	a3,a3,360 # ffffffffc0207ae8 <default_pmm_manager+0x7b0>
ffffffffc0204988:	00002617          	auipc	a2,0x2
ffffffffc020498c:	31860613          	addi	a2,a2,792 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0204990:	14f00593          	li	a1,335
ffffffffc0204994:	00003517          	auipc	a0,0x3
ffffffffc0204998:	64450513          	addi	a0,a0,1604 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc020499c:	adffb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc02049a0:	00004697          	auipc	a3,0x4
ffffffffc02049a4:	87868693          	addi	a3,a3,-1928 # ffffffffc0208218 <default_pmm_manager+0xee0>
ffffffffc02049a8:	00002617          	auipc	a2,0x2
ffffffffc02049ac:	2f860613          	addi	a2,a2,760 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02049b0:	15700593          	li	a1,343
ffffffffc02049b4:	00003517          	auipc	a0,0x3
ffffffffc02049b8:	62450513          	addi	a0,a0,1572 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
ffffffffc02049bc:	abffb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02049c0:	00003617          	auipc	a2,0x3
ffffffffc02049c4:	a8060613          	addi	a2,a2,-1408 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc02049c8:	06200593          	li	a1,98
ffffffffc02049cc:	00003517          	auipc	a0,0x3
ffffffffc02049d0:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc02049d4:	aa7fb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(sum == 0);
ffffffffc02049d8:	00004697          	auipc	a3,0x4
ffffffffc02049dc:	86068693          	addi	a3,a3,-1952 # ffffffffc0208238 <default_pmm_manager+0xf00>
ffffffffc02049e0:	00002617          	auipc	a2,0x2
ffffffffc02049e4:	2c060613          	addi	a2,a2,704 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02049e8:	16300593          	li	a1,355
ffffffffc02049ec:	00003517          	auipc	a0,0x3
ffffffffc02049f0:	5ec50513          	addi	a0,a0,1516 # ffffffffc0207fd8 <default_pmm_manager+0xca0>
...
ffffffffc0204a12:	d6a7a783          	lw	a5,-662(a5) # ffffffffc02b2778 <pgfault_num>
ffffffffc0204a16:	2785                	addiw	a5,a5,1
ffffffffc0204a18:	000ae717          	auipc	a4,0xae
ffffffffc0204a1c:	d6f72023          	sw	a5,-672(a4) # ffffffffc02b2778 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0204a20:	c545                	beqz	a0,ffffffffc0204ac8 <do_pgfault+0xd0>
ffffffffc0204a22:	651c                	ld	a5,8(a0)
ffffffffc0204a24:	0af46263          	bltu	s0,a5,ffffffffc0204ac8 <do_pgfault+0xd0>
...
ffffffffc0204a2e:	efb1                	bnez	a5,ffffffffc0204a8a <do_pgfault+0x92>
        perm |= READ_WRITE;
    }
...
ffffffffc0204a3e:	c555                	beqz	a0,ffffffffc0204aea <do_pgfault+0xf2>
...
ffffffffc0204a42:	c5a5                	beqz	a1,ffffffffc0204aaa <do_pgfault+0xb2>
...
ffffffffc0204a48:	d247a783          	lw	a5,-732(a5) # ffffffffc02b2768 <swap_init_ok>
ffffffffc0204a4c:	c7d9                	beqz	a5,ffffffffc0204ada <do_pgfault+0xe2>
            // page->pra_vaddr = addr;
...
ffffffffc0204a5c:	e90d                	bnez	a0,ffffffffc0204a8e <do_pgfault+0x96>
                cprintf("swap_in in do_pgfault failed\n");
                goto failed;
            }
            page_insert(mm->pgdir,page,addr,perm);//建立内存页 page 的物理地址和线性地址 addr 之间的映射
ffffffffc0204a5e:	65a2                	ld	a1,8(sp)
ffffffffc0204a60:	6c88                	ld	a0,24(s1)
ffffffffc0204a62:	86ce                	mv	a3,s3
ffffffffc0204a64:	8622                	mv	a2,s0
ffffffffc0204a66:	a21fd0ef          	jal	ra,ffffffffc0202486 <page_insert>
            swap_map_swappable(mm, addr, page, 1);//将页面标记为可交换
...
ffffffffc0204a7a:	70e2                	ld	ra,56(sp)
ffffffffc0204a7c:	7442                	ld	s0,48(sp)
ffffffffc0204a7e:	74a2                	ld	s1,40(sp)
ffffffffc0204a80:	69e2                	ld	s3,24(sp)
ffffffffc0204a82:	854a                	mv	a0,s2
ffffffffc0204a84:	7902                	ld	s2,32(sp)
ffffffffc0204a86:	6121                	addi	sp,sp,64
ffffffffc0204a88:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204a8a:	49dd                	li	s3,23
ffffffffc0204a8c:	b755                	j	ffffffffc0204a30 <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0204a8e:	00004517          	auipc	a0,0x4
ffffffffc0204a92:	89250513          	addi	a0,a0,-1902 # ffffffffc0208320 <default_pmm_manager+0xfe8>
ffffffffc0204a96:	eeafb0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0204a9a:	70e2                	ld	ra,56(sp)
ffffffffc0204a9c:	7442                	ld	s0,48(sp)
ffffffffc0204a9e:	74a2                	ld	s1,40(sp)
ffffffffc0204aa0:	69e2                	ld	s3,24(sp)
ffffffffc0204aa2:	854a                	mv	a0,s2
ffffffffc0204aa4:	7902                	ld	s2,32(sp)
ffffffffc0204aa6:	6121                	addi	sp,sp,64
ffffffffc0204aa8:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204aaa:	6c88                	ld	a0,24(s1)
ffffffffc0204aac:	864e                	mv	a2,s3
ffffffffc0204aae:	85a2                	mv	a1,s0
ffffffffc0204ab0:	89dfe0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
   ret = 0;
ffffffffc0204ab4:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0204ab6:	f171                	bnez	a0,ffffffffc0204a7a <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0204ab8:	00004517          	auipc	a0,0x4
ffffffffc0204abc:	84050513          	addi	a0,a0,-1984 # ffffffffc02082f8 <default_pmm_manager+0xfc0>
ffffffffc0204ac0:	ec0fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204ac4:	5971                	li	s2,-4
            goto failed;
ffffffffc0204ac6:	bf55                	j	ffffffffc0204a7a <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0204ac8:	85a2                	mv	a1,s0
ffffffffc0204aca:	00003517          	auipc	a0,0x3
ffffffffc0204ace:	7de50513          	addi	a0,a0,2014 # ffffffffc02082a8 <default_pmm_manager+0xf70>
ffffffffc0204ad2:	eaefb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc0204ad6:	5975                	li	s2,-3
        goto failed;
ffffffffc0204ad8:	b74d                	j	ffffffffc0204a7a <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0204ada:	00004517          	auipc	a0,0x4
ffffffffc0204ade:	86650513          	addi	a0,a0,-1946 # ffffffffc0208340 <default_pmm_manager+0x1008>
ffffffffc0204ae2:	e9efb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204ae6:	5971                	li	s2,-4
            goto failed;
ffffffffc0204ae8:	bf49                	j	ffffffffc0204a7a <do_pgfault+0x82>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc0204aea:	00003517          	auipc	a0,0x3
ffffffffc0204aee:	7ee50513          	addi	a0,a0,2030 # ffffffffc02082d8 <default_pmm_manager+0xfa0>
ffffffffc0204af2:	e8efb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc0204af6:	5971                	li	s2,-4
        goto failed;
ffffffffc0204af8:	b749                	j	ffffffffc0204a7a <do_pgfault+0x82>

ffffffffc0204afa <user_mem_check>:

bool
user_mem_check(struct mm_struct *mm, uintptr_t addr, size_t len, bool write) {
ffffffffc0204afa:	7179                	addi	sp,sp,-48
ffffffffc0204afc:	f022                	sd	s0,32(sp)
ffffffffc0204afe:	f406                	sd	ra,40(sp)
ffffffffc0204b00:	ec26                	sd	s1,24(sp)
ffffffffc0204b02:	e84a                	sd	s2,16(sp)
ffffffffc0204b04:	e44e                	sd	s3,8(sp)
ffffffffc0204b06:	e052                	sd	s4,0(sp)
ffffffffc0204b08:	842e                	mv	s0,a1
    //检查从addr开始长为len的一段内存能否被用户态程序访问
    if (mm != NULL) {
ffffffffc0204b0a:	c135                	beqz	a0,ffffffffc0204b6e <user_mem_check+0x74>
        if (!USER_ACCESS(addr, addr + len)) {
ffffffffc0204b0c:	002007b7          	lui	a5,0x200
ffffffffc0204b10:	04f5e663          	bltu	a1,a5,ffffffffc0204b5c <user_mem_check+0x62>
ffffffffc0204b14:	00c584b3          	add	s1,a1,a2
ffffffffc0204b18:	0495f263          	bgeu	a1,s1,ffffffffc0204b5c <user_mem_check+0x62>
ffffffffc0204b1c:	4785                	li	a5,1
ffffffffc0204b1e:	07fe                	slli	a5,a5,0x1f
ffffffffc0204b20:	0297ee63          	bltu	a5,s1,ffffffffc0204b5c <user_mem_check+0x62>
ffffffffc0204b24:	892a                	mv	s2,a0
ffffffffc0204b26:	89b6                	mv	s3,a3
            }
...
ffffffffc0204b28:	6a05                	lui	s4,0x1
ffffffffc0204b2a:	a821                	j	ffffffffc0204b42 <user_mem_check+0x48>
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ))) {
ffffffffc0204b2c:	0027f693          	andi	a3,a5,2
                if (start < vma->vm_start + PGSIZE) { //check stack start & size
ffffffffc0204b30:	9752                	add	a4,a4,s4
            if (write && (vma->vm_flags & VM_STACK)) {
ffffffffc0204b32:	8ba1                	andi	a5,a5,8
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ))) {
ffffffffc0204b34:	c685                	beqz	a3,ffffffffc0204b5c <user_mem_check+0x62>
            if (write && (vma->vm_flags & VM_STACK)) {
ffffffffc0204b36:	c399                	beqz	a5,ffffffffc0204b3c <user_mem_check+0x42>
                if (start < vma->vm_start + PGSIZE) { //check stack start & size
ffffffffc0204b38:	02e46263          	bltu	s0,a4,ffffffffc0204b5c <user_mem_check+0x62>
                    return 0;
                }
            }
            start = vma->vm_end;
ffffffffc0204b3c:	6900                	ld	s0,16(a0)
        while (start < end) {
ffffffffc0204b3e:	04947663          	bgeu	s0,s1,ffffffffc0204b8a <user_mem_check+0x90>
            if ((vma = find_vma(mm, start)) == NULL || start < vma->vm_start) {
ffffffffc0204b42:	85a2                	mv	a1,s0
ffffffffc0204b44:	854a                	mv	a0,s2
ffffffffc0204b46:	e50ff0ef          	jal	ra,ffffffffc0204196 <find_vma>
ffffffffc0204b4a:	c909                	beqz	a0,ffffffffc0204b5c <user_mem_check+0x62>
ffffffffc0204b4c:	6518                	ld	a4,8(a0)
ffffffffc0204b4e:	00e46763          	bltu	s0,a4,ffffffffc0204b5c <user_mem_check+0x62>
            if (!(vma->vm_flags & ((write) ? VM_WRITE : VM_READ))) {
ffffffffc0204b52:	4d1c                	lw	a5,24(a0)
ffffffffc0204b54:	fc099ce3          	bnez	s3,ffffffffc0204b2c <user_mem_check+0x32>
ffffffffc0204b58:	8b85                	andi	a5,a5,1
ffffffffc0204b5a:	f3ed                	bnez	a5,ffffffffc0204b3c <user_mem_check+0x42>
            return 0;
...
ffffffffc0204b5e:	70a2                	ld	ra,40(sp)
ffffffffc0204b60:	7402                	ld	s0,32(sp)
ffffffffc0204b62:	64e2                	ld	s1,24(sp)
ffffffffc0204b64:	6942                	ld	s2,16(sp)
ffffffffc0204b66:	69a2                	ld	s3,8(sp)
ffffffffc0204b68:	6a02                	ld	s4,0(sp)
ffffffffc0204b6a:	6145                	addi	sp,sp,48
ffffffffc0204b6c:	8082                	ret
    return KERN_ACCESS(addr, addr + len);
ffffffffc0204b6e:	c02007b7          	lui	a5,0xc0200
ffffffffc0204b72:	4501                	li	a0,0
ffffffffc0204b74:	fef5e5e3          	bltu	a1,a5,ffffffffc0204b5e <user_mem_check+0x64>
ffffffffc0204b78:	962e                	add	a2,a2,a1
ffffffffc0204b7a:	fec5f2e3          	bgeu	a1,a2,ffffffffc0204b5e <user_mem_check+0x64>
ffffffffc0204b7e:	c8000537          	lui	a0,0xc8000
ffffffffc0204b82:	0505                	addi	a0,a0,1
ffffffffc0204b84:	00a63533          	sltu	a0,a2,a0
ffffffffc0204b88:	bfd9                	j	ffffffffc0204b5e <user_mem_check+0x64>
        return 1;
ffffffffc0204b8a:	4505                	li	a0,1
ffffffffc0204b8c:	bfc9                	j	ffffffffc0204b5e <user_mem_check+0x64>

ffffffffc0204b8e <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0204b92:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0204b94:	a59fb0ef          	jal	ra,ffffffffc02005ec <ide_device_valid>
ffffffffc0204b98:	cd01                	beqz	a0,ffffffffc0204bb0 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204b9a:	4505                	li	a0,1
ffffffffc0204b9c:	a57fb0ef          	jal	ra,ffffffffc02005f2 <ide_device_size>
}
ffffffffc0204ba0:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204ba2:	810d                	srli	a0,a0,0x3
ffffffffc0204ba4:	000ae797          	auipc	a5,0xae
ffffffffc0204ba8:	baa7ba23          	sd	a0,-1100(a5) # ffffffffc02b2758 <max_swap_offset>
}
ffffffffc0204bac:	0141                	addi	sp,sp,16
ffffffffc0204bae:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204bb0:	00003617          	auipc	a2,0x3
ffffffffc0204bb4:	7b860613          	addi	a2,a2,1976 # ffffffffc0208368 <default_pmm_manager+0x1030>
ffffffffc0204bb8:	45b5                	li	a1,13
ffffffffc0204bba:	00003517          	auipc	a0,0x3
ffffffffc0204bbe:	7ce50513          	addi	a0,a0,1998 # ffffffffc0208388 <default_pmm_manager+0x1050>
ffffffffc0204bc2:	8b9fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204bc6 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0204bc6:	1141                	addi	sp,sp,-16
ffffffffc0204bc8:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204bca:	00855793          	srli	a5,a0,0x8
ffffffffc0204bce:	cbb1                	beqz	a5,ffffffffc0204c22 <swapfs_read+0x5c>
ffffffffc0204bd0:	000ae717          	auipc	a4,0xae
ffffffffc0204bd4:	b8873703          	ld	a4,-1144(a4) # ffffffffc02b2758 <max_swap_offset>
ffffffffc0204bd8:	04e7f563          	bgeu	a5,a4,ffffffffc0204c22 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204bdc:	000ae617          	auipc	a2,0xae
ffffffffc0204be0:	b6463603          	ld	a2,-1180(a2) # ffffffffc02b2740 <pages>
ffffffffc0204be4:	8d91                	sub	a1,a1,a2
ffffffffc0204be6:	4065d613          	srai	a2,a1,0x6
ffffffffc0204bea:	00004717          	auipc	a4,0x4
ffffffffc0204bee:	0f673703          	ld	a4,246(a4) # ffffffffc0208ce0 <nbase>
ffffffffc0204bf2:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204bf4:	00c61713          	slli	a4,a2,0xc
ffffffffc0204bf8:	8331                	srli	a4,a4,0xc
ffffffffc0204bfa:	000ae697          	auipc	a3,0xae
ffffffffc0204bfe:	b3e6b683          	ld	a3,-1218(a3) # ffffffffc02b2738 <npage>
ffffffffc0204c02:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204c06:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204c08:	02d77963          	bgeu	a4,a3,ffffffffc0204c3a <swapfs_read+0x74>
}
ffffffffc0204c0c:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c0e:	000ae797          	auipc	a5,0xae
ffffffffc0204c12:	b427b783          	ld	a5,-1214(a5) # ffffffffc02b2750 <va_pa_offset>
ffffffffc0204c16:	46a1                	li	a3,8
ffffffffc0204c18:	963e                	add	a2,a2,a5
ffffffffc0204c1a:	4505                	li	a0,1
}
ffffffffc0204c1c:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c1e:	9dbfb06f          	j	ffffffffc02005f8 <ide_read_secs>
ffffffffc0204c22:	86aa                	mv	a3,a0
ffffffffc0204c24:	00003617          	auipc	a2,0x3
ffffffffc0204c28:	77c60613          	addi	a2,a2,1916 # ffffffffc02083a0 <default_pmm_manager+0x1068>
ffffffffc0204c2c:	45d1                	li	a1,20
ffffffffc0204c2e:	00003517          	auipc	a0,0x3
ffffffffc0204c32:	75a50513          	addi	a0,a0,1882 # ffffffffc0208388 <default_pmm_manager+0x1050>
ffffffffc0204c36:	845fb0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0204c3a:	86b2                	mv	a3,a2
ffffffffc0204c3c:	06900593          	li	a1,105
ffffffffc0204c40:	00002617          	auipc	a2,0x2
ffffffffc0204c44:	73060613          	addi	a2,a2,1840 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0204c48:	00002517          	auipc	a0,0x2
ffffffffc0204c4c:	75050513          	addi	a0,a0,1872 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0204c50:	82bfb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204c54 <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc0204c54:	1141                	addi	sp,sp,-16
ffffffffc0204c56:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c58:	00855793          	srli	a5,a0,0x8
ffffffffc0204c5c:	cbb1                	beqz	a5,ffffffffc0204cb0 <swapfs_write+0x5c>
ffffffffc0204c5e:	000ae717          	auipc	a4,0xae
ffffffffc0204c62:	afa73703          	ld	a4,-1286(a4) # ffffffffc02b2758 <max_swap_offset>
ffffffffc0204c66:	04e7f563          	bgeu	a5,a4,ffffffffc0204cb0 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc0204c6a:	000ae617          	auipc	a2,0xae
ffffffffc0204c6e:	ad663603          	ld	a2,-1322(a2) # ffffffffc02b2740 <pages>
ffffffffc0204c72:	8d91                	sub	a1,a1,a2
ffffffffc0204c74:	4065d613          	srai	a2,a1,0x6
ffffffffc0204c78:	00004717          	auipc	a4,0x4
ffffffffc0204c7c:	06873703          	ld	a4,104(a4) # ffffffffc0208ce0 <nbase>
ffffffffc0204c80:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204c82:	00c61713          	slli	a4,a2,0xc
ffffffffc0204c86:	8331                	srli	a4,a4,0xc
ffffffffc0204c88:	000ae697          	auipc	a3,0xae
ffffffffc0204c8c:	ab06b683          	ld	a3,-1360(a3) # ffffffffc02b2738 <npage>
ffffffffc0204c90:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204c94:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc0204c96:	02d77963          	bgeu	a4,a3,ffffffffc0204cc8 <swapfs_write+0x74>
}
ffffffffc0204c9a:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204c9c:	000ae797          	auipc	a5,0xae
ffffffffc0204ca0:	ab47b783          	ld	a5,-1356(a5) # ffffffffc02b2750 <va_pa_offset>
ffffffffc0204ca4:	46a1                	li	a3,8
ffffffffc0204ca6:	963e                	add	a2,a2,a5
ffffffffc0204ca8:	4505                	li	a0,1
}
ffffffffc0204caa:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204cac:	971fb06f          	j	ffffffffc020061c <ide_write_secs>
ffffffffc0204cb0:	86aa                	mv	a3,a0
ffffffffc0204cb2:	00003617          	auipc	a2,0x3
ffffffffc0204cb6:	6ee60613          	addi	a2,a2,1774 # ffffffffc02083a0 <default_pmm_manager+0x1068>
ffffffffc0204cba:	45e5                	li	a1,25
ffffffffc0204cbc:	00003517          	auipc	a0,0x3
ffffffffc0204cc0:	6cc50513          	addi	a0,a0,1740 # ffffffffc0208388 <default_pmm_manager+0x1050>
ffffffffc0204cc4:	fb6fb0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0204cc8:	86b2                	mv	a3,a2
ffffffffc0204cca:	06900593          	li	a1,105
ffffffffc0204cce:	00002617          	auipc	a2,0x2
ffffffffc0204cd2:	6a260613          	addi	a2,a2,1698 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0204cd6:	00002517          	auipc	a0,0x2
ffffffffc0204cda:	6c250513          	addi	a0,a0,1730 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0204cde:	f9cfb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204ce2 <kernel_thread_entry>:
.text
.globl kernel_thread_entry
kernel_thread_entry:        # void kernel_thread(void)
	move a0, s1
ffffffffc0204ce2:	8526                	mv	a0,s1
	jalr s0
ffffffffc0204ce4:	9402                	jalr	s0

	jal do_exit
ffffffffc0204ce6:	636000ef          	jal	ra,ffffffffc020531c <do_exit>

ffffffffc0204cea <alloc_proc>:
...
alloc_proc(void) {
ffffffffc0204cea:	1141                	addi	sp,sp,-16
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204cec:	10800513          	li	a0,264
alloc_proc(void) {
ffffffffc0204cf0:	e022                	sd	s0,0(sp)
ffffffffc0204cf2:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204cf4:	e0ffc0ef          	jal	ra,ffffffffc0201b02 <kmalloc>
ffffffffc0204cf8:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc0204cfa:	cd21                	beqz	a0,ffffffffc0204d52 <alloc_proc+0x68>
...
ffffffffc0204d00:	e11c                	sd	a5,0(a0)
...
ffffffffc0204d02:	07000613          	li	a2,112
ffffffffc0204d06:	4581                	li	a1,0
    proc->runs = 0;  // 根据提示可知该成员变量表示进程的运行时间，初始化为0
ffffffffc0204d08:	00052423          	sw	zero,8(a0)
    proc->kstack = 0;  // 进程内核栈初始化为0【kstack记录了分配给该进程/线程的内核栈的位置】
ffffffffc0204d0c:	00053823          	sd	zero,16(a0)
    proc->need_resched = 0;  // 是否需要重新调度以释放 CPU？当然了，我们现在处于未初始化状态，不需要进行调度
ffffffffc0204d10:	00053c23          	sd	zero,24(a0)
    proc->parent = NULL;  // 父进程控制块指针，第0个进程控制块诶，它是始祖！
ffffffffc0204d14:	02053023          	sd	zero,32(a0)
    proc->mm = NULL;  // 进程的内存管理字段:参见lab3练习一分析；对于内核进程而言，不存在虚拟内存管理
ffffffffc0204d18:	02053423          	sd	zero,40(a0)
    memset(&(proc->context), 0, sizeof(struct context));  // 上下文，现在是源头，当然为空，发生切换时修改
ffffffffc0204d1c:	03050513          	addi	a0,a0,48
ffffffffc0204d20:	09f010ef          	jal	ra,ffffffffc02065be <memset>
...
ffffffffc0204d24:	000ae797          	auipc	a5,0xae
ffffffffc0204d28:	a047b783          	ld	a5,-1532(a5) # ffffffffc02b2728 <boot_cr3>
    proc->tf = NULL;  // 进程中断帧，初始化为空，发生中断时修改
ffffffffc0204d2c:	0a043023          	sd	zero,160(s0)
    proc->cr3 = boot_cr3;  // 页表基址初始化——在pmm_init中初始化页表基址，实际上是satp寄存器【X86历史残留，有点想改但是由于涉及文件相对较多，万一没修改完全就寄了，索性放弃】
ffffffffc0204d30:	f45c                	sd	a5,168(s0)
    proc->flags = 0;  // 进程标志位，初始化为空
ffffffffc0204d32:	0a042823          	sw	zero,176(s0)
    memset(proc->name, 0, PROC_NAME_LEN);  // 进程名初始化为空
ffffffffc0204d36:	463d                	li	a2,15
ffffffffc0204d38:	4581                	li	a1,0
ffffffffc0204d3a:	0b440513          	addi	a0,s0,180
ffffffffc0204d3e:	081010ef          	jal	ra,ffffffffc02065be <memset>
     /*
...
ffffffffc0204d42:	0e042623          	sw	zero,236(s0)
    proc->cptr = proc->optr = proc->yptr = NULL;  // 设置进程指针
ffffffffc0204d46:	0e043c23          	sd	zero,248(s0)
ffffffffc0204d4a:	10043023          	sd	zero,256(s0)
ffffffffc0204d4e:	0e043823          	sd	zero,240(s0)
    }
    return proc;
}
...
forkret(void) {
    forkrets(current->tf);
ffffffffc0204d5c:	000ae797          	auipc	a5,0xae
ffffffffc0204d60:	a247b783          	ld	a5,-1500(a5) # ffffffffc02b2780 <current>
ffffffffc0204d64:	73c8                	ld	a0,160(a5)
ffffffffc0204d66:	810fc06f          	j	ffffffffc0200d76 <forkrets>
...
ffffffffc0204d6a:	000ae797          	auipc	a5,0xae
ffffffffc0204d6e:	a167b783          	ld	a5,-1514(a5) # ffffffffc02b2780 <current>
ffffffffc0204d72:	43cc                	lw	a1,4(a5)
user_main(void *arg) {
ffffffffc0204d74:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d76:	00003617          	auipc	a2,0x3
ffffffffc0204d7a:	64a60613          	addi	a2,a2,1610 # ffffffffc02083c0 <default_pmm_manager+0x1088>
ffffffffc0204d7e:	00003517          	auipc	a0,0x3
ffffffffc0204d82:	65250513          	addi	a0,a0,1618 # ffffffffc02083d0 <default_pmm_manager+0x1098>
user_main(void *arg) {
ffffffffc0204d86:	fc06                	sd	ra,56(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d88:	bf8fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc0204d8c:	3fe06797          	auipc	a5,0x3fe06
ffffffffc0204d90:	bcc78793          	addi	a5,a5,-1076 # a958 <_binary_obj___user_forktest_out_size>
ffffffffc0204d94:	e43e                	sd	a5,8(sp)
ffffffffc0204d96:	00003517          	auipc	a0,0x3
ffffffffc0204d9a:	62a50513          	addi	a0,a0,1578 # ffffffffc02083c0 <default_pmm_manager+0x1088>
ffffffffc0204d9e:	00046797          	auipc	a5,0x46
ffffffffc0204da2:	92278793          	addi	a5,a5,-1758 # ffffffffc024a6c0 <_binary_obj___user_forktest_out_start>
ffffffffc0204da6:	f03e                	sd	a5,32(sp)
ffffffffc0204da8:	f42a                	sd	a0,40(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204daa:	e802                	sd	zero,16(sp)
ffffffffc0204dac:	796010ef          	jal	ra,ffffffffc0206542 <strlen>
ffffffffc0204db0:	ec2a                	sd	a0,24(sp)
    asm volatile(
ffffffffc0204db2:	4511                	li	a0,4
ffffffffc0204db4:	55a2                	lw	a1,40(sp)
ffffffffc0204db6:	4662                	lw	a2,24(sp)
ffffffffc0204db8:	5682                	lw	a3,32(sp)
ffffffffc0204dba:	4722                	lw	a4,8(sp)
ffffffffc0204dbc:	48a9                	li	a7,10
ffffffffc0204dbe:	9002                	ebreak
ffffffffc0204dc0:	c82a                	sw	a0,16(sp)
    cprintf("ret = %d\n", ret);
ffffffffc0204dc2:	65c2                	ld	a1,16(sp)
ffffffffc0204dc4:	00003517          	auipc	a0,0x3
ffffffffc0204dc8:	63450513          	addi	a0,a0,1588 # ffffffffc02083f8 <default_pmm_manager+0x10c0>
ffffffffc0204dcc:	bb4fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
#else
    KERNEL_EXECVE(exit);
#endif
    panic("user_main execve failed.\n");
ffffffffc0204dd0:	00003617          	auipc	a2,0x3
ffffffffc0204dd4:	63860613          	addi	a2,a2,1592 # ffffffffc0208408 <default_pmm_manager+0x10d0>
ffffffffc0204dd8:	38d00593          	li	a1,909
ffffffffc0204ddc:	00003517          	auipc	a0,0x3
ffffffffc0204de0:	64c50513          	addi	a0,a0,1612 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0204de4:	e96fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204de8 <put_pgdir>:
    return pa2page(PADDR(kva));
ffffffffc0204de8:	6d14                	ld	a3,24(a0)
put_pgdir(struct mm_struct *mm) {
ffffffffc0204dea:	1141                	addi	sp,sp,-16
ffffffffc0204dec:	e406                	sd	ra,8(sp)
ffffffffc0204dee:	c02007b7          	lui	a5,0xc0200
ffffffffc0204df2:	02f6ee63          	bltu	a3,a5,ffffffffc0204e2e <put_pgdir+0x46>
ffffffffc0204df6:	000ae517          	auipc	a0,0xae
ffffffffc0204dfa:	95a53503          	ld	a0,-1702(a0) # ffffffffc02b2750 <va_pa_offset>
ffffffffc0204dfe:	8e89                	sub	a3,a3,a0
    if (PPN(pa) >= npage) {
ffffffffc0204e00:	82b1                	srli	a3,a3,0xc
ffffffffc0204e02:	000ae797          	auipc	a5,0xae
ffffffffc0204e06:	9367b783          	ld	a5,-1738(a5) # ffffffffc02b2738 <npage>
ffffffffc0204e0a:	02f6fe63          	bgeu	a3,a5,ffffffffc0204e46 <put_pgdir+0x5e>
    return &pages[PPN(pa) - nbase];
ffffffffc0204e0e:	00004517          	auipc	a0,0x4
ffffffffc0204e12:	ed253503          	ld	a0,-302(a0) # ffffffffc0208ce0 <nbase>
}
ffffffffc0204e16:	60a2                	ld	ra,8(sp)
ffffffffc0204e18:	8e89                	sub	a3,a3,a0
ffffffffc0204e1a:	069a                	slli	a3,a3,0x6
    free_page(kva2page(mm->pgdir));
ffffffffc0204e1c:	000ae517          	auipc	a0,0xae
ffffffffc0204e20:	92453503          	ld	a0,-1756(a0) # ffffffffc02b2740 <pages>
ffffffffc0204e24:	4585                	li	a1,1
ffffffffc0204e26:	9536                	add	a0,a0,a3
}
ffffffffc0204e28:	0141                	addi	sp,sp,16
    free_page(kva2page(mm->pgdir));
ffffffffc0204e2a:	f49fc06f          	j	ffffffffc0201d72 <free_pages>
    return pa2page(PADDR(kva));
ffffffffc0204e2e:	00002617          	auipc	a2,0x2
ffffffffc0204e32:	5ea60613          	addi	a2,a2,1514 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc0204e36:	06e00593          	li	a1,110
ffffffffc0204e3a:	00002517          	auipc	a0,0x2
ffffffffc0204e3e:	55e50513          	addi	a0,a0,1374 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0204e42:	e38fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204e46:	00002617          	auipc	a2,0x2
ffffffffc0204e4a:	5fa60613          	addi	a2,a2,1530 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0204e4e:	06200593          	li	a1,98
ffffffffc0204e52:	00002517          	auipc	a0,0x2
ffffffffc0204e56:	54650513          	addi	a0,a0,1350 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0204e5a:	e20fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0204e5e <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204e5e:	7179                	addi	sp,sp,-48
ffffffffc0204e60:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204e62:	000ae917          	auipc	s2,0xae
ffffffffc0204e66:	91e90913          	addi	s2,s2,-1762 # ffffffffc02b2780 <current>
proc_run(struct proc_struct *proc) {
ffffffffc0204e6a:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204e6c:	00093483          	ld	s1,0(s2)
proc_run(struct proc_struct *proc) {
ffffffffc0204e70:	f406                	sd	ra,40(sp)
ffffffffc0204e72:	e84e                	sd	s3,16(sp)
    if (proc != current) {
ffffffffc0204e74:	02a48863          	beq	s1,a0,ffffffffc0204ea4 <proc_run+0x46>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e78:	100027f3          	csrr	a5,sstatus
ffffffffc0204e7c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204e7e:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204e80:	ef9d                	bnez	a5,ffffffffc0204ebe <proc_run+0x60>
...
ffffffffc0204e82:	755c                	ld	a5,168(a0)
ffffffffc0204e84:	577d                	li	a4,-1
ffffffffc0204e86:	177e                	slli	a4,a4,0x3f
ffffffffc0204e88:	83b1                	srli	a5,a5,0xc
            current = proc;
ffffffffc0204e8a:	00a93023          	sd	a0,0(s2)
ffffffffc0204e8e:	8fd9                	or	a5,a5,a4
ffffffffc0204e90:	18079073          	csrw	satp,a5
            switch_to(&(from->context), &(to->context));
ffffffffc0204e94:	03050593          	addi	a1,a0,48
ffffffffc0204e98:	03048513          	addi	a0,s1,48
ffffffffc0204e9c:	04c010ef          	jal	ra,ffffffffc0205ee8 <switch_to>
    if (flag) {
ffffffffc0204ea0:	00099863          	bnez	s3,ffffffffc0204eb0 <proc_run+0x52>
}
ffffffffc0204ea4:	70a2                	ld	ra,40(sp)
ffffffffc0204ea6:	7482                	ld	s1,32(sp)
ffffffffc0204ea8:	6962                	ld	s2,24(sp)
ffffffffc0204eaa:	69c2                	ld	s3,16(sp)
ffffffffc0204eac:	6145                	addi	sp,sp,48
...
ffffffffc0204eb8:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204eba:	f86fb06f          	j	ffffffffc0200640 <intr_enable>
ffffffffc0204ebe:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204ec0:	f86fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0204ec4:	6522                	ld	a0,8(sp)
ffffffffc0204ec6:	4985                	li	s3,1
ffffffffc0204ec8:	bf6d                	j	ffffffffc0204e82 <proc_run+0x24>

ffffffffc0204eca <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204eca:	7119                	addi	sp,sp,-128
ffffffffc0204ecc:	f0ca                	sd	s2,96(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204ece:	000ae917          	auipc	s2,0xae
ffffffffc0204ed2:	8ca90913          	addi	s2,s2,-1846 # ffffffffc02b2798 <nr_process>
ffffffffc0204ed6:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204eda:	fc86                	sd	ra,120(sp)
ffffffffc0204edc:	f8a2                	sd	s0,112(sp)
ffffffffc0204ede:	f4a6                	sd	s1,104(sp)
ffffffffc0204ee0:	ecce                	sd	s3,88(sp)
ffffffffc0204ee2:	e8d2                	sd	s4,80(sp)
ffffffffc0204ee4:	e4d6                	sd	s5,72(sp)
ffffffffc0204ee6:	e0da                	sd	s6,64(sp)
ffffffffc0204ee8:	fc5e                	sd	s7,56(sp)
ffffffffc0204eea:	f862                	sd	s8,48(sp)
ffffffffc0204eec:	f466                	sd	s9,40(sp)
ffffffffc0204eee:	f06a                	sd	s10,32(sp)
ffffffffc0204ef0:	ec6e                	sd	s11,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204ef2:	6785                	lui	a5,0x1
ffffffffc0204ef4:	32f75a63          	bge	a4,a5,ffffffffc0205228 <do_fork+0x35e>
ffffffffc0204ef8:	8a2a                	mv	s4,a0
ffffffffc0204efa:	89ae                	mv	s3,a1
ffffffffc0204efc:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0204efe:	dedff0ef          	jal	ra,ffffffffc0204cea <alloc_proc>
ffffffffc0204f02:	84aa                	mv	s1,a0
ffffffffc0204f04:	30050363          	beqz	a0,ffffffffc020520a <do_fork+0x340>
    proc->parent = current;  // 子进程的父进程是当前进程
ffffffffc0204f08:	000aec17          	auipc	s8,0xae
ffffffffc0204f0c:	878c0c13          	addi	s8,s8,-1928 # ffffffffc02b2780 <current>
ffffffffc0204f10:	000c3783          	ld	a5,0(s8)
    assert(current->wait_state == 0);  // 确保进程在等待
ffffffffc0204f14:	0ec7a703          	lw	a4,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8ab4>
    proc->parent = current;  // 子进程的父进程是当前进程
ffffffffc0204f18:	f11c                	sd	a5,32(a0)
    assert(current->wait_state == 0);  // 确保进程在等待
ffffffffc0204f1a:	36071c63          	bnez	a4,ffffffffc0205292 <do_fork+0x3c8>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204f1e:	4509                	li	a0,2
ffffffffc0204f20:	dc1fc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
    if (page != NULL) {
ffffffffc0204f24:	2e050063          	beqz	a0,ffffffffc0205204 <do_fork+0x33a>
    return page - pages + nbase;
ffffffffc0204f28:	000aea97          	auipc	s5,0xae
ffffffffc0204f2c:	818a8a93          	addi	s5,s5,-2024 # ffffffffc02b2740 <pages>
ffffffffc0204f30:	000ab683          	ld	a3,0(s5)
ffffffffc0204f34:	00004b17          	auipc	s6,0x4
ffffffffc0204f38:	dacb0b13          	addi	s6,s6,-596 # ffffffffc0208ce0 <nbase>
ffffffffc0204f3c:	000b3783          	ld	a5,0(s6)
ffffffffc0204f40:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204f44:	000adb97          	auipc	s7,0xad
ffffffffc0204f48:	7f4b8b93          	addi	s7,s7,2036 # ffffffffc02b2738 <npage>
    return page - pages + nbase;
ffffffffc0204f4c:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0204f4e:	5dfd                	li	s11,-1
ffffffffc0204f50:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0204f54:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204f56:	00cddd93          	srli	s11,s11,0xc
ffffffffc0204f5a:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0204f5e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204f60:	30e67163          	bgeu	a2,a4,ffffffffc0205262 <do_fork+0x398>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0204f64:	000c3603          	ld	a2,0(s8)
ffffffffc0204f68:	000adc17          	auipc	s8,0xad
ffffffffc0204f6c:	7e8c0c13          	addi	s8,s8,2024 # ffffffffc02b2750 <va_pa_offset>
ffffffffc0204f70:	000c3703          	ld	a4,0(s8)
ffffffffc0204f74:	02863d03          	ld	s10,40(a2)
ffffffffc0204f78:	e43e                	sd	a5,8(sp)
ffffffffc0204f7a:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204f7c:	e894                	sd	a3,16(s1)
    if (oldmm == NULL) {
ffffffffc0204f7e:	020d0863          	beqz	s10,ffffffffc0204fae <do_fork+0xe4>
    if (clone_flags & CLONE_VM) {
ffffffffc0204f82:	100a7a13          	andi	s4,s4,256
ffffffffc0204f86:	1c0a0163          	beqz	s4,ffffffffc0205148 <do_fork+0x27e>
}

static inline int
mm_count_inc(struct mm_struct *mm) {
    mm->mm_count += 1;
ffffffffc0204f8a:	030d2703          	lw	a4,48(s10)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204f8e:	018d3783          	ld	a5,24(s10)
ffffffffc0204f92:	c02006b7          	lui	a3,0xc0200
ffffffffc0204f96:	2705                	addiw	a4,a4,1
ffffffffc0204f98:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0204f9c:	03a4b423          	sd	s10,40(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204fa0:	30d7e963          	bltu	a5,a3,ffffffffc02052b2 <do_fork+0x3e8>
ffffffffc0204fa4:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fa8:	6894                	ld	a3,16(s1)
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc0204faa:	8f99                	sub	a5,a5,a4
ffffffffc0204fac:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fae:	6789                	lui	a5,0x2
ffffffffc0204fb0:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7cc0>
ffffffffc0204fb4:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204fb6:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0204fb8:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
...
ffffffffc0204fdc:	ff1612e3          	bne	a2,a7,ffffffffc0204fc0 <do_fork+0xf6>
    proc->tf->gpr.a0 = 0;
ffffffffc0204fe0:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x1e>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204fe4:	12098f63          	beqz	s3,ffffffffc0205122 <do_fork+0x258>
ffffffffc0204fe8:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204fec:	00000797          	auipc	a5,0x0
ffffffffc0204ff0:	d7078793          	addi	a5,a5,-656 # ffffffffc0204d5c <forkret>
ffffffffc0204ff4:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204ff6:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204ff8:	100027f3          	csrr	a5,sstatus
ffffffffc0204ffc:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204ffe:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205000:	14079063          	bnez	a5,ffffffffc0205140 <do_fork+0x276>
    if (++ last_pid >= MAX_PID) {
ffffffffc0205004:	000a2817          	auipc	a6,0xa2
ffffffffc0205008:	23480813          	addi	a6,a6,564 # ffffffffc02a7238 <last_pid.1>
ffffffffc020500c:	00082783          	lw	a5,0(a6)
ffffffffc0205010:	6709                	lui	a4,0x2
ffffffffc0205012:	0017851b          	addiw	a0,a5,1
ffffffffc0205016:	00a82023          	sw	a0,0(a6)
ffffffffc020501a:	08e55d63          	bge	a0,a4,ffffffffc02050b4 <do_fork+0x1ea>
    if (last_pid >= next_safe) {
ffffffffc020501e:	000a2317          	auipc	t1,0xa2
ffffffffc0205022:	21e30313          	addi	t1,t1,542 # ffffffffc02a723c <next_safe.0>
ffffffffc0205026:	00032783          	lw	a5,0(t1)
ffffffffc020502a:	000ad417          	auipc	s0,0xad
ffffffffc020502e:	6ce40413          	addi	s0,s0,1742 # ffffffffc02b26f8 <proc_list>
ffffffffc0205032:	08f55963          	bge	a0,a5,ffffffffc02050c4 <do_fork+0x1fa>
        proc->pid = get_pid();  // 获取当前pid
ffffffffc0205036:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205038:	45a9                	li	a1,10
ffffffffc020503a:	2501                	sext.w	a0,a0
ffffffffc020503c:	102010ef          	jal	ra,ffffffffc020613e <hash32>
ffffffffc0205040:	02051793          	slli	a5,a0,0x20
ffffffffc0205044:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205048:	000a9797          	auipc	a5,0xa9
ffffffffc020504c:	6b078793          	addi	a5,a5,1712 # ffffffffc02ae6f8 <hash_list>
ffffffffc0205050:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0205052:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {  // 年长的兄弟节点置为双亲节点的孩子节点，如果不为空，那么我们当前的进程就是年长兄弟的弟弟
ffffffffc0205054:	7094                	ld	a3,32(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205056:	0d848793          	addi	a5,s1,216
    prev->next = next->prev = elm;
ffffffffc020505a:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc020505c:	6410                	ld	a2,8(s0)
    prev->next = next->prev = elm;
ffffffffc020505e:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL) {  // 年长的兄弟节点置为双亲节点的孩子节点，如果不为空，那么我们当前的进程就是年长兄弟的弟弟
ffffffffc0205060:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));  // 将我们原先的列表添加挪到了这里
ffffffffc0205062:	0c848793          	addi	a5,s1,200
    elm->next = next;
ffffffffc0205066:	f0ec                	sd	a1,224(s1)
    elm->prev = prev;
ffffffffc0205068:	ece8                	sd	a0,216(s1)
    prev->next = next->prev = elm;
ffffffffc020506a:	e21c                	sd	a5,0(a2)
ffffffffc020506c:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc020506e:	e8f0                	sd	a2,208(s1)
    elm->prev = prev;
ffffffffc0205070:	e4e0                	sd	s0,200(s1)
    proc->yptr = NULL;  // 年轻的兄弟节点置为空
ffffffffc0205072:	0e04bc23          	sd	zero,248(s1)
    if ((proc->optr = proc->parent->cptr) != NULL) {  // 年长的兄弟节点置为双亲节点的孩子节点，如果不为空，那么我们当前的进程就是年长兄弟的弟弟
ffffffffc0205076:	10e4b023          	sd	a4,256(s1)
ffffffffc020507a:	c311                	beqz	a4,ffffffffc020507e <do_fork+0x1b4>
        proc->optr->yptr = proc;
ffffffffc020507c:	ff64                	sd	s1,248(a4)
    nr_process ++;  // 进程计数+1
ffffffffc020507e:	00092783          	lw	a5,0(s2)
    proc->parent->cptr = proc;  // 当前节点是双亲节点的孩子节点（用语言说出来好诡异啊）
ffffffffc0205082:	fae4                	sd	s1,240(a3)
    nr_process ++;  // 进程计数+1
ffffffffc0205084:	2785                	addiw	a5,a5,1
ffffffffc0205086:	00f92023          	sw	a5,0(s2)
    if (flag) {
ffffffffc020508a:	18099263          	bnez	s3,ffffffffc020520e <do_fork+0x344>
    wakeup_proc(proc);
ffffffffc020508e:	8526                	mv	a0,s1
ffffffffc0205090:	6c3000ef          	jal	ra,ffffffffc0205f52 <wakeup_proc>
    ret = proc->pid;
ffffffffc0205094:	40c8                	lw	a0,4(s1)
}
ffffffffc0205096:	70e6                	ld	ra,120(sp)
ffffffffc0205098:	7446                	ld	s0,112(sp)
ffffffffc020509a:	74a6                	ld	s1,104(sp)
ffffffffc020509c:	7906                	ld	s2,96(sp)
ffffffffc020509e:	69e6                	ld	s3,88(sp)
ffffffffc02050a0:	6a46                	ld	s4,80(sp)
ffffffffc02050a2:	6aa6                	ld	s5,72(sp)
ffffffffc02050a4:	6b06                	ld	s6,64(sp)
ffffffffc02050a6:	7be2                	ld	s7,56(sp)
ffffffffc02050a8:	7c42                	ld	s8,48(sp)
ffffffffc02050aa:	7ca2                	ld	s9,40(sp)
ffffffffc02050ac:	7d02                	ld	s10,32(sp)
ffffffffc02050ae:	6de2                	ld	s11,24(sp)
ffffffffc02050b0:	6109                	addi	sp,sp,128
ffffffffc02050b2:	8082                	ret
        last_pid = 1;
ffffffffc02050b4:	4785                	li	a5,1
ffffffffc02050b6:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02050ba:	4505                	li	a0,1
ffffffffc02050bc:	000a2317          	auipc	t1,0xa2
ffffffffc02050c0:	18030313          	addi	t1,t1,384 # ffffffffc02a723c <next_safe.0>
    return listelm->next;
ffffffffc02050c4:	000ad417          	auipc	s0,0xad
ffffffffc02050c8:	63440413          	addi	s0,s0,1588 # ffffffffc02b26f8 <proc_list>
ffffffffc02050cc:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02050d0:	6789                	lui	a5,0x2
ffffffffc02050d2:	00f32023          	sw	a5,0(t1)
ffffffffc02050d6:	86aa                	mv	a3,a0
ffffffffc02050d8:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02050da:	6e89                	lui	t4,0x2
ffffffffc02050dc:	148e0163          	beq	t3,s0,ffffffffc020521e <do_fork+0x354>
ffffffffc02050e0:	88ae                	mv	a7,a1
ffffffffc02050e2:	87f2                	mv	a5,t3
ffffffffc02050e4:	6609                	lui	a2,0x2
ffffffffc02050e6:	a811                	j	ffffffffc02050fa <do_fork+0x230>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc02050e8:	00e6d663          	bge	a3,a4,ffffffffc02050f4 <do_fork+0x22a>
ffffffffc02050ec:	00c75463          	bge	a4,a2,ffffffffc02050f4 <do_fork+0x22a>
ffffffffc02050f0:	863a                	mv	a2,a4
ffffffffc02050f2:	4885                	li	a7,1
ffffffffc02050f4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02050f6:	00878d63          	beq	a5,s0,ffffffffc0205110 <do_fork+0x246>
            if (proc->pid == last_pid) {
ffffffffc02050fa:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x7c64>
ffffffffc02050fe:	fed715e3          	bne	a4,a3,ffffffffc02050e8 <do_fork+0x21e>
                if (++ last_pid >= next_safe) {
ffffffffc0205102:	2685                	addiw	a3,a3,1
ffffffffc0205104:	10c6d863          	bge	a3,a2,ffffffffc0205214 <do_fork+0x34a>
ffffffffc0205108:	679c                	ld	a5,8(a5)
ffffffffc020510a:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020510c:	fe8797e3          	bne	a5,s0,ffffffffc02050fa <do_fork+0x230>
ffffffffc0205110:	c581                	beqz	a1,ffffffffc0205118 <do_fork+0x24e>
ffffffffc0205112:	00d82023          	sw	a3,0(a6)
ffffffffc0205116:	8536                	mv	a0,a3
ffffffffc0205118:	f0088fe3          	beqz	a7,ffffffffc0205036 <do_fork+0x16c>
ffffffffc020511c:	00c32023          	sw	a2,0(t1)
ffffffffc0205120:	bf19                	j	ffffffffc0205036 <do_fork+0x16c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0205122:	89b6                	mv	s3,a3
ffffffffc0205124:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0205128:	00000797          	auipc	a5,0x0
ffffffffc020512c:	c3478793          	addi	a5,a5,-972 # ffffffffc0204d5c <forkret>
ffffffffc0205130:	f89c                	sd	a5,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0205132:	fc94                	sd	a3,56(s1)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205134:	100027f3          	csrr	a5,sstatus
ffffffffc0205138:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020513a:	4981                	li	s3,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020513c:	ec0784e3          	beqz	a5,ffffffffc0205004 <do_fork+0x13a>
        intr_disable();
ffffffffc0205140:	d06fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc0205144:	4985                	li	s3,1
ffffffffc0205146:	bd7d                	j	ffffffffc0205004 <do_fork+0x13a>
    if ((mm = mm_create()) == NULL) {
ffffffffc0205148:	fd9fe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc020514c:	8caa                	mv	s9,a0
ffffffffc020514e:	c159                	beqz	a0,ffffffffc02051d4 <do_fork+0x30a>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205150:	4505                	li	a0,1
ffffffffc0205152:	b8ffc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0205156:	cd25                	beqz	a0,ffffffffc02051ce <do_fork+0x304>
    return page - pages + nbase;
ffffffffc0205158:	000ab683          	ld	a3,0(s5)
ffffffffc020515c:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc020515e:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0205162:	40d506b3          	sub	a3,a0,a3
ffffffffc0205166:	8699                	srai	a3,a3,0x6
ffffffffc0205168:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc020516a:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc020516e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205170:	0eedf963          	bgeu	s11,a4,ffffffffc0205262 <do_fork+0x398>
ffffffffc0205174:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205178:	6605                	lui	a2,0x1
ffffffffc020517a:	000ad597          	auipc	a1,0xad
ffffffffc020517e:	5b65b583          	ld	a1,1462(a1) # ffffffffc02b2730 <boot_pgdir>
ffffffffc0205182:	9a36                	add	s4,s4,a3
ffffffffc0205184:	8552                	mv	a0,s4
ffffffffc0205186:	44a010ef          	jal	ra,ffffffffc02065d0 <memcpy>
}
...
lock_mm(struct mm_struct *mm) {
    if (mm != NULL) {
        lock(&(mm->mm_lock));
ffffffffc020518a:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc020518e:	014cbc23          	sd	s4,24(s9)
...
ffffffffc0205194:	40fdb7af          	amoor.d	a5,a5,(s11)
...
lock(lock_t *lock) {
    while (!try_lock(lock)) {
ffffffffc0205198:	8b85                	andi	a5,a5,1
ffffffffc020519a:	4a05                	li	s4,1
ffffffffc020519c:	c799                	beqz	a5,ffffffffc02051aa <do_fork+0x2e0>
        schedule();
ffffffffc020519e:	635000ef          	jal	ra,ffffffffc0205fd2 <schedule>
ffffffffc02051a2:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock)) {
ffffffffc02051a6:	8b85                	andi	a5,a5,1
ffffffffc02051a8:	fbfd                	bnez	a5,ffffffffc020519e <do_fork+0x2d4>
        ret = dup_mmap(mm, oldmm);
ffffffffc02051aa:	85ea                	mv	a1,s10
ffffffffc02051ac:	8566                	mv	a0,s9
ffffffffc02051ae:	9faff0ef          	jal	ra,ffffffffc02043a8 <dup_mmap>
...
ffffffffc02051b2:	57f9                	li	a5,-2
ffffffffc02051b4:	60fdb7af          	amoand.d	a5,a5,(s11)
ffffffffc02051b8:	8b85                	andi	a5,a5,1
    }
}
...
ffffffffc02051ba:	cbc1                	beqz	a5,ffffffffc020524a <do_fork+0x380>
good_mm:
ffffffffc02051bc:	8d66                	mv	s10,s9
    if (ret != 0) {
ffffffffc02051be:	dc0506e3          	beqz	a0,ffffffffc0204f8a <do_fork+0xc0>
    exit_mmap(mm);
ffffffffc02051c2:	8566                	mv	a0,s9
ffffffffc02051c4:	a7eff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc02051c8:	8566                	mv	a0,s9
ffffffffc02051ca:	c1fff0ef          	jal	ra,ffffffffc0204de8 <put_pgdir>
    mm_destroy(mm);
...
ffffffffc02051da:	04f6ec63          	bltu	a3,a5,ffffffffc0205232 <do_fork+0x368>
...
ffffffffc02051ec:	08e7f763          	bgeu	a5,a4,ffffffffc020527a <do_fork+0x3b0>
    return &pages[PPN(pa) - nbase];
...
ffffffffc020520c:	b569                	j	ffffffffc0205096 <do_fork+0x1cc>
        intr_enable();
ffffffffc020520e:	c32fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205212:	bdb5                	j	ffffffffc020508e <do_fork+0x1c4>
                    if (last_pid >= MAX_PID) {
ffffffffc0205214:	01d6c363          	blt	a3,t4,ffffffffc020521a <do_fork+0x350>
                        last_pid = 1;
ffffffffc0205218:	4685                	li	a3,1
                    goto repeat;
ffffffffc020521a:	4585                	li	a1,1
ffffffffc020521c:	b5c1                	j	ffffffffc02050dc <do_fork+0x212>
ffffffffc020521e:	c599                	beqz	a1,ffffffffc020522c <do_fork+0x362>
ffffffffc0205220:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0205224:	8536                	mv	a0,a3
ffffffffc0205226:	bd01                	j	ffffffffc0205036 <do_fork+0x16c>
    int ret = -E_NO_FREE_PROC;
ffffffffc0205228:	556d                	li	a0,-5
ffffffffc020522a:	b5b5                	j	ffffffffc0205096 <do_fork+0x1cc>
    return last_pid;
ffffffffc020522c:	00082503          	lw	a0,0(a6)
ffffffffc0205230:	b519                	j	ffffffffc0205036 <do_fork+0x16c>
    return pa2page(PADDR(kva));
ffffffffc0205232:	00002617          	auipc	a2,0x2
ffffffffc0205236:	1e660613          	addi	a2,a2,486 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc020523a:	06e00593          	li	a1,110
ffffffffc020523e:	00002517          	auipc	a0,0x2
ffffffffc0205242:	15a50513          	addi	a0,a0,346 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0205246:	a34fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("Unlock failed.\n");
ffffffffc020524a:	00003617          	auipc	a2,0x3
ffffffffc020524e:	21660613          	addi	a2,a2,534 # ffffffffc0208460 <default_pmm_manager+0x1128>
ffffffffc0205252:	03100593          	li	a1,49
ffffffffc0205256:	00003517          	auipc	a0,0x3
ffffffffc020525a:	21a50513          	addi	a0,a0,538 # ffffffffc0208470 <default_pmm_manager+0x1138>
ffffffffc020525e:	a1cfb0ef          	jal	ra,ffffffffc020047a <__panic>
    return KADDR(page2pa(page));
ffffffffc0205262:	00002617          	auipc	a2,0x2
ffffffffc0205266:	10e60613          	addi	a2,a2,270 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc020526a:	06900593          	li	a1,105
ffffffffc020526e:	00002517          	auipc	a0,0x2
ffffffffc0205272:	12a50513          	addi	a0,a0,298 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0205276:	a04fb0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020527a:	00002617          	auipc	a2,0x2
ffffffffc020527e:	1c660613          	addi	a2,a2,454 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0205282:	06200593          	li	a1,98
ffffffffc0205286:	00002517          	auipc	a0,0x2
ffffffffc020528a:	11250513          	addi	a0,a0,274 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc020528e:	9ecfb0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(current->wait_state == 0);  // 确保进程在等待
ffffffffc0205292:	00003697          	auipc	a3,0x3
ffffffffc0205296:	1ae68693          	addi	a3,a3,430 # ffffffffc0208440 <default_pmm_manager+0x1108>
ffffffffc020529a:	00002617          	auipc	a2,0x2
ffffffffc020529e:	a0660613          	addi	a2,a2,-1530 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02052a2:	1a700593          	li	a1,423
ffffffffc02052a6:	00003517          	auipc	a0,0x3
ffffffffc02052aa:	18250513          	addi	a0,a0,386 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc02052ae:	9ccfb0ef          	jal	ra,ffffffffc020047a <__panic>
    proc->cr3 = PADDR(mm->pgdir);
ffffffffc02052b2:	86be                	mv	a3,a5
ffffffffc02052b4:	00002617          	auipc	a2,0x2
ffffffffc02052b8:	16460613          	addi	a2,a2,356 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc02052bc:	16700593          	li	a1,359
ffffffffc02052c0:	00003517          	auipc	a0,0x3
ffffffffc02052c4:	16850513          	addi	a0,a0,360 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc02052c8:	9b2fb0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc02052cc <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02052cc:	7129                	addi	sp,sp,-320
ffffffffc02052ce:	fa22                	sd	s0,304(sp)
ffffffffc02052d0:	f626                	sd	s1,296(sp)
ffffffffc02052d2:	f24a                	sd	s2,288(sp)
ffffffffc02052d4:	84ae                	mv	s1,a1
ffffffffc02052d6:	892a                	mv	s2,a0
ffffffffc02052d8:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052da:	4581                	li	a1,0
ffffffffc02052dc:	12000613          	li	a2,288
ffffffffc02052e0:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02052e2:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02052e4:	2da010ef          	jal	ra,ffffffffc02065be <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02052e8:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02052ea:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02052ec:	100027f3          	csrr	a5,sstatus
ffffffffc02052f0:	edd7f793          	andi	a5,a5,-291
ffffffffc02052f4:	1207e793          	ori	a5,a5,288
ffffffffc02052f8:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02052fa:	860a                	mv	a2,sp
ffffffffc02052fc:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0205300:	00000797          	auipc	a5,0x0
ffffffffc0205304:	9e278793          	addi	a5,a5,-1566 # ffffffffc0204ce2 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0205308:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020530a:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020530c:	bbfff0ef          	jal	ra,ffffffffc0204eca <do_fork>
}
ffffffffc0205310:	70f2                	ld	ra,312(sp)
ffffffffc0205312:	7452                	ld	s0,304(sp)
ffffffffc0205314:	74b2                	ld	s1,296(sp)
ffffffffc0205316:	7912                	ld	s2,288(sp)
ffffffffc0205318:	6131                	addi	sp,sp,320
ffffffffc020531a:	8082                	ret

ffffffffc020531c <do_exit>:
do_exit(int error_code) {
ffffffffc020531c:	7179                	addi	sp,sp,-48
ffffffffc020531e:	f022                	sd	s0,32(sp)
    if (current == idleproc) {
ffffffffc0205320:	000ad417          	auipc	s0,0xad
ffffffffc0205324:	46040413          	addi	s0,s0,1120 # ffffffffc02b2780 <current>
ffffffffc0205328:	601c                	ld	a5,0(s0)
do_exit(int error_code) {
ffffffffc020532a:	f406                	sd	ra,40(sp)
ffffffffc020532c:	ec26                	sd	s1,24(sp)
ffffffffc020532e:	e84a                	sd	s2,16(sp)
ffffffffc0205330:	e44e                	sd	s3,8(sp)
ffffffffc0205332:	e052                	sd	s4,0(sp)
    if (current == idleproc) {
ffffffffc0205334:	000ad717          	auipc	a4,0xad
ffffffffc0205338:	45473703          	ld	a4,1108(a4) # ffffffffc02b2788 <idleproc>
ffffffffc020533c:	0ce78c63          	beq	a5,a4,ffffffffc0205414 <do_exit+0xf8>
    if (current == initproc) {
ffffffffc0205340:	000ad497          	auipc	s1,0xad
ffffffffc0205344:	45048493          	addi	s1,s1,1104 # ffffffffc02b2790 <initproc>
ffffffffc0205348:	6098                	ld	a4,0(s1)
ffffffffc020534a:	0ee78b63          	beq	a5,a4,ffffffffc0205440 <do_exit+0x124>
    struct mm_struct *mm = current->mm;
ffffffffc020534e:	0287b983          	ld	s3,40(a5)
ffffffffc0205352:	892a                	mv	s2,a0
    if (mm != NULL) {
ffffffffc0205354:	02098663          	beqz	s3,ffffffffc0205380 <do_exit+0x64>
ffffffffc0205358:	000ad797          	auipc	a5,0xad
ffffffffc020535c:	3d07b783          	ld	a5,976(a5) # ffffffffc02b2728 <boot_cr3>
ffffffffc0205360:	577d                	li	a4,-1
ffffffffc0205362:	177e                	slli	a4,a4,0x3f
ffffffffc0205364:	83b1                	srli	a5,a5,0xc
ffffffffc0205366:	8fd9                	or	a5,a5,a4
ffffffffc0205368:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc020536c:	0309a783          	lw	a5,48(s3)
ffffffffc0205370:	fff7871b          	addiw	a4,a5,-1
ffffffffc0205374:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc0205378:	cb55                	beqz	a4,ffffffffc020542c <do_exit+0x110>
        current->mm = NULL;
ffffffffc020537a:	601c                	ld	a5,0(s0)
ffffffffc020537c:	0207b423          	sd	zero,40(a5)
    current->state = PROC_ZOMBIE;
ffffffffc0205380:	601c                	ld	a5,0(s0)
ffffffffc0205382:	470d                	li	a4,3
ffffffffc0205384:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0205386:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020538a:	100027f3          	csrr	a5,sstatus
ffffffffc020538e:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205390:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205392:	e3f9                	bnez	a5,ffffffffc0205458 <do_exit+0x13c>
        proc = current->parent;
ffffffffc0205394:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD) {
ffffffffc0205396:	800007b7          	lui	a5,0x80000
ffffffffc020539a:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc020539c:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD) {
ffffffffc020539e:	0ec52703          	lw	a4,236(a0)
ffffffffc02053a2:	0af70f63          	beq	a4,a5,ffffffffc0205460 <do_exit+0x144>
        while (current->cptr != NULL) {
ffffffffc02053a6:	6018                	ld	a4,0(s0)
ffffffffc02053a8:	7b7c                	ld	a5,240(a4)
ffffffffc02053aa:	c3a1                	beqz	a5,ffffffffc02053ea <do_exit+0xce>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053ac:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02053b0:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053b2:	0985                	addi	s3,s3,1
ffffffffc02053b4:	a021                	j	ffffffffc02053bc <do_exit+0xa0>
        while (current->cptr != NULL) {
ffffffffc02053b6:	6018                	ld	a4,0(s0)
ffffffffc02053b8:	7b7c                	ld	a5,240(a4)
ffffffffc02053ba:	cb85                	beqz	a5,ffffffffc02053ea <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc02053bc:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff4fe8>
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc02053c0:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc02053c2:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc02053c4:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc02053c6:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL) {
ffffffffc02053ca:	10e7b023          	sd	a4,256(a5)
ffffffffc02053ce:	c311                	beqz	a4,ffffffffc02053d2 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc02053d0:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02053d2:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc02053d4:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc02053d6:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02053d8:	fd271fe3          	bne	a4,s2,ffffffffc02053b6 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD) {
ffffffffc02053dc:	0ec52783          	lw	a5,236(a0)
ffffffffc02053e0:	fd379be3          	bne	a5,s3,ffffffffc02053b6 <do_exit+0x9a>
                    wakeup_proc(initproc);
ffffffffc02053e4:	36f000ef          	jal	ra,ffffffffc0205f52 <wakeup_proc>
ffffffffc02053e8:	b7f9                	j	ffffffffc02053b6 <do_exit+0x9a>
    if (flag) {
ffffffffc02053ea:	020a1263          	bnez	s4,ffffffffc020540e <do_exit+0xf2>
    schedule();
ffffffffc02053ee:	3e5000ef          	jal	ra,ffffffffc0205fd2 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc02053f2:	601c                	ld	a5,0(s0)
ffffffffc02053f4:	00003617          	auipc	a2,0x3
ffffffffc02053f8:	0b460613          	addi	a2,a2,180 # ffffffffc02084a8 <default_pmm_manager+0x1170>
ffffffffc02053fc:	22300593          	li	a1,547
ffffffffc0205400:	43d4                	lw	a3,4(a5)
ffffffffc0205402:	00003517          	auipc	a0,0x3
ffffffffc0205406:	02650513          	addi	a0,a0,38 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc020540a:	870fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_enable();
ffffffffc020540e:	a32fb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc0205412:	bff1                	j	ffffffffc02053ee <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc0205414:	00003617          	auipc	a2,0x3
ffffffffc0205418:	07460613          	addi	a2,a2,116 # ffffffffc0208488 <default_pmm_manager+0x1150>
ffffffffc020541c:	1f700593          	li	a1,503
ffffffffc0205420:	00003517          	auipc	a0,0x3
ffffffffc0205424:	00850513          	addi	a0,a0,8 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205428:	852fb0ef          	jal	ra,ffffffffc020047a <__panic>
            exit_mmap(mm);
ffffffffc020542c:	854e                	mv	a0,s3
ffffffffc020542e:	814ff0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);
ffffffffc0205432:	854e                	mv	a0,s3
ffffffffc0205434:	9b5ff0ef          	jal	ra,ffffffffc0204de8 <put_pgdir>
            mm_destroy(mm);
ffffffffc0205438:	854e                	mv	a0,s3
ffffffffc020543a:	e6dfe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc020543e:	bf35                	j	ffffffffc020537a <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc0205440:	00003617          	auipc	a2,0x3
ffffffffc0205444:	05860613          	addi	a2,a2,88 # ffffffffc0208498 <default_pmm_manager+0x1160>
ffffffffc0205448:	1fa00593          	li	a1,506
ffffffffc020544c:	00003517          	auipc	a0,0x3
ffffffffc0205450:	fdc50513          	addi	a0,a0,-36 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205454:	826fb0ef          	jal	ra,ffffffffc020047a <__panic>
        intr_disable();
ffffffffc0205458:	9eefb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc020545c:	4a05                	li	s4,1
ffffffffc020545e:	bf1d                	j	ffffffffc0205394 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc0205460:	2f3000ef          	jal	ra,ffffffffc0205f52 <wakeup_proc>
ffffffffc0205464:	b789                	j	ffffffffc02053a6 <do_exit+0x8a>

ffffffffc0205466 <do_wait.part.0>:
do_wait(int pid, int *code_store) {
ffffffffc0205466:	715d                	addi	sp,sp,-80
ffffffffc0205468:	f84a                	sd	s2,48(sp)
ffffffffc020546a:	f44e                	sd	s3,40(sp)
        current->wait_state = WT_CHILD;
ffffffffc020546c:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205470:	6989                	lui	s3,0x2
do_wait(int pid, int *code_store) {
ffffffffc0205472:	fc26                	sd	s1,56(sp)
ffffffffc0205474:	f052                	sd	s4,32(sp)
ffffffffc0205476:	ec56                	sd	s5,24(sp)
ffffffffc0205478:	e85a                	sd	s6,16(sp)
ffffffffc020547a:	e45e                	sd	s7,8(sp)
ffffffffc020547c:	e486                	sd	ra,72(sp)
ffffffffc020547e:	e0a2                	sd	s0,64(sp)
ffffffffc0205480:	84aa                	mv	s1,a0
ffffffffc0205482:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc0205484:	000adb97          	auipc	s7,0xad
ffffffffc0205488:	2fcb8b93          	addi	s7,s7,764 # ffffffffc02b2780 <current>
    if (0 < pid && pid < MAX_PID) {
ffffffffc020548c:	00050b1b          	sext.w	s6,a0
ffffffffc0205490:	fff50a9b          	addiw	s5,a0,-1
ffffffffc0205494:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc0205496:	0905                	addi	s2,s2,1
    if (pid != 0) {
ffffffffc0205498:	ccbd                	beqz	s1,ffffffffc0205516 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID) {
ffffffffc020549a:	0359e863          	bltu	s3,s5,ffffffffc02054ca <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020549e:	45a9                	li	a1,10
ffffffffc02054a0:	855a                	mv	a0,s6
ffffffffc02054a2:	49d000ef          	jal	ra,ffffffffc020613e <hash32>
ffffffffc02054a6:	02051793          	slli	a5,a0,0x20
ffffffffc02054aa:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02054ae:	000a9797          	auipc	a5,0xa9
ffffffffc02054b2:	24a78793          	addi	a5,a5,586 # ffffffffc02ae6f8 <hash_list>
ffffffffc02054b6:	953e                	add	a0,a0,a5
ffffffffc02054b8:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list) {
ffffffffc02054ba:	a029                	j	ffffffffc02054c4 <do_wait.part.0+0x5e>
            if (proc->pid == pid) {
ffffffffc02054bc:	f2c42783          	lw	a5,-212(s0)
ffffffffc02054c0:	02978163          	beq	a5,s1,ffffffffc02054e2 <do_wait.part.0+0x7c>
ffffffffc02054c4:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list) {
ffffffffc02054c6:	fe851be3          	bne	a0,s0,ffffffffc02054bc <do_wait.part.0+0x56>
    return -E_BAD_PROC;
ffffffffc02054ca:	5579                	li	a0,-2
}
ffffffffc02054cc:	60a6                	ld	ra,72(sp)
ffffffffc02054ce:	6406                	ld	s0,64(sp)
ffffffffc02054d0:	74e2                	ld	s1,56(sp)
ffffffffc02054d2:	7942                	ld	s2,48(sp)
ffffffffc02054d4:	79a2                	ld	s3,40(sp)
ffffffffc02054d6:	7a02                	ld	s4,32(sp)
ffffffffc02054d8:	6ae2                	ld	s5,24(sp)
ffffffffc02054da:	6b42                	ld	s6,16(sp)
ffffffffc02054dc:	6ba2                	ld	s7,8(sp)
ffffffffc02054de:	6161                	addi	sp,sp,80
ffffffffc02054e0:	8082                	ret
        if (proc != NULL && proc->parent == current) {
ffffffffc02054e2:	000bb683          	ld	a3,0(s7)
ffffffffc02054e6:	f4843783          	ld	a5,-184(s0)
ffffffffc02054ea:	fed790e3          	bne	a5,a3,ffffffffc02054ca <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc02054ee:	f2842703          	lw	a4,-216(s0)
ffffffffc02054f2:	478d                	li	a5,3
ffffffffc02054f4:	0ef70b63          	beq	a4,a5,ffffffffc02055ea <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc02054f8:	4785                	li	a5,1
ffffffffc02054fa:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc02054fc:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc0205500:	2d3000ef          	jal	ra,ffffffffc0205fd2 <schedule>
        if (current->flags & PF_EXITING) {
ffffffffc0205504:	000bb783          	ld	a5,0(s7)
ffffffffc0205508:	0b07a783          	lw	a5,176(a5)
ffffffffc020550c:	8b85                	andi	a5,a5,1
ffffffffc020550e:	d7c9                	beqz	a5,ffffffffc0205498 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc0205510:	555d                	li	a0,-9
ffffffffc0205512:	e0bff0ef          	jal	ra,ffffffffc020531c <do_exit>
        proc = current->cptr;
ffffffffc0205516:	000bb683          	ld	a3,0(s7)
ffffffffc020551a:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr) {
ffffffffc020551c:	d45d                	beqz	s0,ffffffffc02054ca <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc020551e:	470d                	li	a4,3
ffffffffc0205520:	a021                	j	ffffffffc0205528 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr) {
ffffffffc0205522:	10043403          	ld	s0,256(s0)
ffffffffc0205526:	d869                	beqz	s0,ffffffffc02054f8 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE) {
ffffffffc0205528:	401c                	lw	a5,0(s0)
ffffffffc020552a:	fee79ce3          	bne	a5,a4,ffffffffc0205522 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc) {
ffffffffc020552e:	000ad797          	auipc	a5,0xad
ffffffffc0205532:	25a7b783          	ld	a5,602(a5) # ffffffffc02b2788 <idleproc>
ffffffffc0205536:	0c878963          	beq	a5,s0,ffffffffc0205608 <do_wait.part.0+0x1a2>
ffffffffc020553a:	000ad797          	auipc	a5,0xad
ffffffffc020553e:	2567b783          	ld	a5,598(a5) # ffffffffc02b2790 <initproc>
ffffffffc0205542:	0cf40363          	beq	s0,a5,ffffffffc0205608 <do_wait.part.0+0x1a2>
    if (code_store != NULL) {
ffffffffc0205546:	000a0663          	beqz	s4,ffffffffc0205552 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc020554a:	0e842783          	lw	a5,232(s0)
ffffffffc020554e:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8ba0>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0205552:	100027f3          	csrr	a5,sstatus
ffffffffc0205556:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0205558:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020555a:	e7c1                	bnez	a5,ffffffffc02055e2 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc020555c:	6c70                	ld	a2,216(s0)
ffffffffc020555e:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL) {
ffffffffc0205560:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc0205564:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0205566:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205568:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc020556a:	6470                	ld	a2,200(s0)
ffffffffc020556c:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc020556e:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0205570:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL) {
ffffffffc0205572:	c319                	beqz	a4,ffffffffc0205578 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc0205574:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL) {
ffffffffc0205576:	7c7c                	ld	a5,248(s0)
ffffffffc0205578:	c3b5                	beqz	a5,ffffffffc02055dc <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc020557a:	10e7b023          	sd	a4,256(a5)
    nr_process --;
ffffffffc020557e:	000ad717          	auipc	a4,0xad
ffffffffc0205582:	21a70713          	addi	a4,a4,538 # ffffffffc02b2798 <nr_process>
ffffffffc0205586:	431c                	lw	a5,0(a4)
ffffffffc0205588:	37fd                	addiw	a5,a5,-1
ffffffffc020558a:	c31c                	sw	a5,0(a4)
    if (flag) {
ffffffffc020558c:	e5a9                	bnez	a1,ffffffffc02055d6 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020558e:	6814                	ld	a3,16(s0)
    return pa2page(PADDR(kva));
ffffffffc0205590:	c02007b7          	lui	a5,0xc0200
ffffffffc0205594:	04f6ee63          	bltu	a3,a5,ffffffffc02055f0 <do_wait.part.0+0x18a>
ffffffffc0205598:	000ad797          	auipc	a5,0xad
ffffffffc020559c:	1b87b783          	ld	a5,440(a5) # ffffffffc02b2750 <va_pa_offset>
ffffffffc02055a0:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02055a2:	82b1                	srli	a3,a3,0xc
ffffffffc02055a4:	000ad797          	auipc	a5,0xad
ffffffffc02055a8:	1947b783          	ld	a5,404(a5) # ffffffffc02b2738 <npage>
ffffffffc02055ac:	06f6fa63          	bgeu	a3,a5,ffffffffc0205620 <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc02055b0:	00003517          	auipc	a0,0x3
ffffffffc02055b4:	73053503          	ld	a0,1840(a0) # ffffffffc0208ce0 <nbase>
ffffffffc02055b8:	8e89                	sub	a3,a3,a0
ffffffffc02055ba:	069a                	slli	a3,a3,0x6
ffffffffc02055bc:	000ad517          	auipc	a0,0xad
ffffffffc02055c0:	18453503          	ld	a0,388(a0) # ffffffffc02b2740 <pages>
ffffffffc02055c4:	9536                	add	a0,a0,a3
ffffffffc02055c6:	4589                	li	a1,2
ffffffffc02055c8:	faafc0ef          	jal	ra,ffffffffc0201d72 <free_pages>
    kfree(proc);
ffffffffc02055cc:	8522                	mv	a0,s0
ffffffffc02055ce:	de4fc0ef          	jal	ra,ffffffffc0201bb2 <kfree>
    return 0;
ffffffffc02055d2:	4501                	li	a0,0
ffffffffc02055d4:	bde5                	j	ffffffffc02054cc <do_wait.part.0+0x66>
        intr_enable();
ffffffffc02055d6:	86afb0ef          	jal	ra,ffffffffc0200640 <intr_enable>
ffffffffc02055da:	bf55                	j	ffffffffc020558e <do_wait.part.0+0x128>
       proc->parent->cptr = proc->optr;
ffffffffc02055dc:	701c                	ld	a5,32(s0)
ffffffffc02055de:	fbf8                	sd	a4,240(a5)
ffffffffc02055e0:	bf79                	j	ffffffffc020557e <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02055e2:	864fb0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
ffffffffc02055e6:	4585                	li	a1,1
ffffffffc02055e8:	bf95                	j	ffffffffc020555c <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02055ea:	f2840413          	addi	s0,s0,-216
ffffffffc02055ee:	b781                	j	ffffffffc020552e <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02055f0:	00002617          	auipc	a2,0x2
ffffffffc02055f4:	e2860613          	addi	a2,a2,-472 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc02055f8:	06e00593          	li	a1,110
ffffffffc02055fc:	00002517          	auipc	a0,0x2
ffffffffc0205600:	d9c50513          	addi	a0,a0,-612 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0205604:	e77fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc0205608:	00003617          	auipc	a2,0x3
ffffffffc020560c:	ec060613          	addi	a2,a2,-320 # ffffffffc02084c8 <default_pmm_manager+0x1190>
ffffffffc0205610:	33b00593          	li	a1,827
ffffffffc0205614:	00003517          	auipc	a0,0x3
ffffffffc0205618:	e1450513          	addi	a0,a0,-492 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc020561c:	e5ffa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205620:	00002617          	auipc	a2,0x2
ffffffffc0205624:	e2060613          	addi	a2,a2,-480 # ffffffffc0207440 <default_pmm_manager+0x108>
ffffffffc0205628:	06200593          	li	a1,98
ffffffffc020562c:	00002517          	auipc	a0,0x2
ffffffffc0205630:	d6c50513          	addi	a0,a0,-660 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0205634:	e47fa0ef          	jal	ra,ffffffffc020047a <__panic>
...
ffffffffc020563a:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020563c:	f76fc0ef          	jal	ra,ffffffffc0201db2 <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc0205640:	cbefc0ef          	jal	ra,ffffffffc0201afe <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc0205644:	4601                	li	a2,0
ffffffffc0205646:	4581                	li	a1,0
ffffffffc0205648:	fffff517          	auipc	a0,0xfffff
ffffffffc020564c:	72250513          	addi	a0,a0,1826 # ffffffffc0204d6a <user_main>
ffffffffc0205650:	c7dff0ef          	jal	ra,ffffffffc02052cc <kernel_thread>
    if (pid <= 0) {
ffffffffc0205654:	00a04563          	bgtz	a0,ffffffffc020565e <init_main+0x26>
ffffffffc0205658:	a071                	j	ffffffffc02056e4 <init_main+0xac>
        panic("create user_main failed.\n");
    }

    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc020565a:	179000ef          	jal	ra,ffffffffc0205fd2 <schedule>
    if (code_store != NULL) {
ffffffffc020565e:	4581                	li	a1,0
ffffffffc0205660:	4501                	li	a0,0
ffffffffc0205662:	e05ff0ef          	jal	ra,ffffffffc0205466 <do_wait.part.0>
    while (do_wait(0, NULL) == 0) {
...
ffffffffc020566c:	ea050513          	addi	a0,a0,-352 # ffffffffc0208508 <default_pmm_manager+0x11d0>
ffffffffc0205670:	b11fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0205674:	000ad797          	auipc	a5,0xad
ffffffffc0205678:	11c7b783          	ld	a5,284(a5) # ffffffffc02b2790 <initproc>
ffffffffc020567c:	7bf8                	ld	a4,240(a5)
ffffffffc020567e:	e339                	bnez	a4,ffffffffc02056c4 <init_main+0x8c>
ffffffffc0205680:	7ff8                	ld	a4,248(a5)
ffffffffc0205682:	e329                	bnez	a4,ffffffffc02056c4 <init_main+0x8c>
ffffffffc0205684:	1007b703          	ld	a4,256(a5)
ffffffffc0205688:	ef15                	bnez	a4,ffffffffc02056c4 <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc020568a:	000ad697          	auipc	a3,0xad
ffffffffc020568e:	10e6a683          	lw	a3,270(a3) # ffffffffc02b2798 <nr_process>
ffffffffc0205692:	4709                	li	a4,2
ffffffffc0205694:	0ae69463          	bne	a3,a4,ffffffffc020573c <init_main+0x104>
    return listelm->next;
ffffffffc0205698:	000ad697          	auipc	a3,0xad
ffffffffc020569c:	06068693          	addi	a3,a3,96 # ffffffffc02b26f8 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02056a0:	6698                	ld	a4,8(a3)
ffffffffc02056a2:	0c878793          	addi	a5,a5,200
ffffffffc02056a6:	06f71b63          	bne	a4,a5,ffffffffc020571c <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056aa:	629c                	ld	a5,0(a3)
ffffffffc02056ac:	04f71863          	bne	a4,a5,ffffffffc02056fc <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc02056b0:	00003517          	auipc	a0,0x3
ffffffffc02056b4:	f4050513          	addi	a0,a0,-192 # ffffffffc02085f0 <default_pmm_manager+0x12b8>
ffffffffc02056b8:	ac9fa0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc02056bc:	60a2                	ld	ra,8(sp)
ffffffffc02056be:	4501                	li	a0,0
ffffffffc02056c0:	0141                	addi	sp,sp,16
ffffffffc02056c2:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02056c4:	00003697          	auipc	a3,0x3
ffffffffc02056c8:	e6c68693          	addi	a3,a3,-404 # ffffffffc0208530 <default_pmm_manager+0x11f8>
ffffffffc02056cc:	00001617          	auipc	a2,0x1
ffffffffc02056d0:	5d460613          	addi	a2,a2,1492 # ffffffffc0206ca0 <commands+0x450>
ffffffffc02056d4:	3a000593          	li	a1,928
ffffffffc02056d8:	00003517          	auipc	a0,0x3
ffffffffc02056dc:	d5050513          	addi	a0,a0,-688 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc02056e0:	d9bfa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("create user_main failed.\n");
ffffffffc02056e4:	00003617          	auipc	a2,0x3
ffffffffc02056e8:	e0460613          	addi	a2,a2,-508 # ffffffffc02084e8 <default_pmm_manager+0x11b0>
ffffffffc02056ec:	39800593          	li	a1,920
ffffffffc02056f0:	00003517          	auipc	a0,0x3
ffffffffc02056f4:	d3850513          	addi	a0,a0,-712 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc02056f8:	d83fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02056fc:	00003697          	auipc	a3,0x3
ffffffffc0205700:	ec468693          	addi	a3,a3,-316 # ffffffffc02085c0 <default_pmm_manager+0x1288>
ffffffffc0205704:	00001617          	auipc	a2,0x1
ffffffffc0205708:	59c60613          	addi	a2,a2,1436 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020570c:	3a300593          	li	a1,931
ffffffffc0205710:	00003517          	auipc	a0,0x3
ffffffffc0205714:	d1850513          	addi	a0,a0,-744 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205718:	d63fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020571c:	00003697          	auipc	a3,0x3
ffffffffc0205720:	e7468693          	addi	a3,a3,-396 # ffffffffc0208590 <default_pmm_manager+0x1258>
ffffffffc0205724:	00001617          	auipc	a2,0x1
ffffffffc0205728:	57c60613          	addi	a2,a2,1404 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020572c:	3a200593          	li	a1,930
ffffffffc0205730:	00003517          	auipc	a0,0x3
ffffffffc0205734:	cf850513          	addi	a0,a0,-776 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205738:	d43fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(nr_process == 2);
ffffffffc020573c:	00003697          	auipc	a3,0x3
ffffffffc0205740:	e4468693          	addi	a3,a3,-444 # ffffffffc0208580 <default_pmm_manager+0x1248>
ffffffffc0205744:	00001617          	auipc	a2,0x1
ffffffffc0205748:	55c60613          	addi	a2,a2,1372 # ffffffffc0206ca0 <commands+0x450>
ffffffffc020574c:	3a100593          	li	a1,929
ffffffffc0205750:	00003517          	auipc	a0,0x3
ffffffffc0205754:	cd850513          	addi	a0,a0,-808 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205758:	d23fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020575c <do_execve>:
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020575c:	7171                	addi	sp,sp,-176
ffffffffc020575e:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205760:	000add97          	auipc	s11,0xad
ffffffffc0205764:	020d8d93          	addi	s11,s11,32 # ffffffffc02b2780 <current>
ffffffffc0205768:	000db783          	ld	a5,0(s11)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc020576c:	e54e                	sd	s3,136(sp)
ffffffffc020576e:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc0205770:	0287b983          	ld	s3,40(a5)
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205774:	e94a                	sd	s2,144(sp)
ffffffffc0205776:	f4de                	sd	s7,104(sp)
ffffffffc0205778:	892a                	mv	s2,a0
ffffffffc020577a:	8bb2                	mv	s7,a2
ffffffffc020577c:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) { // 检查name的内存空间能否被访问
ffffffffc020577e:	862e                	mv	a2,a1
ffffffffc0205780:	4681                	li	a3,0
ffffffffc0205782:	85aa                	mv	a1,a0
ffffffffc0205784:	854e                	mv	a0,s3
do_execve(const char *name, size_t len, unsigned char *binary, size_t size) {
ffffffffc0205786:	f506                	sd	ra,168(sp)
ffffffffc0205788:	f122                	sd	s0,160(sp)
ffffffffc020578a:	e152                	sd	s4,128(sp)
ffffffffc020578c:	fcd6                	sd	s5,120(sp)
ffffffffc020578e:	f8da                	sd	s6,112(sp)
ffffffffc0205790:	f0e2                	sd	s8,96(sp)
ffffffffc0205792:	ece6                	sd	s9,88(sp)
ffffffffc0205794:	e8ea                	sd	s10,80(sp)
ffffffffc0205796:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0)) { // 检查name的内存空间能否被访问
ffffffffc0205798:	b62ff0ef          	jal	ra,ffffffffc0204afa <user_mem_check>
ffffffffc020579c:	40050863          	beqz	a0,ffffffffc0205bac <do_execve+0x450>
    memset(local_name, 0, sizeof(local_name));
ffffffffc02057a0:	4641                	li	a2,16
ffffffffc02057a2:	4581                	li	a1,0
ffffffffc02057a4:	1808                	addi	a0,sp,48
ffffffffc02057a6:	619000ef          	jal	ra,ffffffffc02065be <memset>
    memcpy(local_name, name, len);
ffffffffc02057aa:	47bd                	li	a5,15
ffffffffc02057ac:	8626                	mv	a2,s1
ffffffffc02057ae:	1e97e063          	bltu	a5,s1,ffffffffc020598e <do_execve+0x232>
ffffffffc02057b2:	85ca                	mv	a1,s2
ffffffffc02057b4:	1808                	addi	a0,sp,48
ffffffffc02057b6:	61b000ef          	jal	ra,ffffffffc02065d0 <memcpy>
    if (mm != NULL) {
ffffffffc02057ba:	1e098163          	beqz	s3,ffffffffc020599c <do_execve+0x240>
        cputs("mm != NULL"); 
ffffffffc02057be:	00002517          	auipc	a0,0x2
ffffffffc02057c2:	30250513          	addi	a0,a0,770 # ffffffffc0207ac0 <default_pmm_manager+0x788>
ffffffffc02057c6:	9f3fa0ef          	jal	ra,ffffffffc02001b8 <cputs>
ffffffffc02057ca:	000ad797          	auipc	a5,0xad
ffffffffc02057ce:	f5e7b783          	ld	a5,-162(a5) # ffffffffc02b2728 <boot_cr3>
ffffffffc02057d2:	577d                	li	a4,-1
ffffffffc02057d4:	177e                	slli	a4,a4,0x3f
ffffffffc02057d6:	83b1                	srli	a5,a5,0xc
ffffffffc02057d8:	8fd9                	or	a5,a5,a4
ffffffffc02057da:	18079073          	csrw	satp,a5
ffffffffc02057de:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7b70>
ffffffffc02057e2:	fff7871b          	addiw	a4,a5,-1
ffffffffc02057e6:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0) {
ffffffffc02057ea:	2c070263          	beqz	a4,ffffffffc0205aae <do_execve+0x352>
        current->mm = NULL;  // 将当前进程的内存管理结构置为 NULL
ffffffffc02057ee:	000db783          	ld	a5,0(s11)
ffffffffc02057f2:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL) {  // 创建内存管理结构
ffffffffc02057f6:	92bfe0ef          	jal	ra,ffffffffc0204120 <mm_create>
ffffffffc02057fa:	84aa                	mv	s1,a0
ffffffffc02057fc:	1c050b63          	beqz	a0,ffffffffc02059d2 <do_execve+0x276>
    if ((page = alloc_page()) == NULL) {
ffffffffc0205800:	4505                	li	a0,1
ffffffffc0205802:	cdefc0ef          	jal	ra,ffffffffc0201ce0 <alloc_pages>
ffffffffc0205806:	3a050763          	beqz	a0,ffffffffc0205bb4 <do_execve+0x458>
    return page - pages + nbase;
ffffffffc020580a:	000adc97          	auipc	s9,0xad
ffffffffc020580e:	f36c8c93          	addi	s9,s9,-202 # ffffffffc02b2740 <pages>
ffffffffc0205812:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc0205816:	000adc17          	auipc	s8,0xad
ffffffffc020581a:	f22c0c13          	addi	s8,s8,-222 # ffffffffc02b2738 <npage>
    return page - pages + nbase;
ffffffffc020581e:	00003717          	auipc	a4,0x3
ffffffffc0205822:	4c273703          	ld	a4,1218(a4) # ffffffffc0208ce0 <nbase>
ffffffffc0205826:	40d506b3          	sub	a3,a0,a3
ffffffffc020582a:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc020582c:	5afd                	li	s5,-1
ffffffffc020582e:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc0205832:	96ba                	add	a3,a3,a4
ffffffffc0205834:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205836:	00cad713          	srli	a4,s5,0xc
ffffffffc020583a:	ec3a                	sd	a4,24(sp)
ffffffffc020583c:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc020583e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205840:	36f77e63          	bgeu	a4,a5,ffffffffc0205bbc <do_execve+0x460>
ffffffffc0205844:	000adb17          	auipc	s6,0xad
ffffffffc0205848:	f0cb0b13          	addi	s6,s6,-244 # ffffffffc02b2750 <va_pa_offset>
ffffffffc020584c:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0205850:	6605                	lui	a2,0x1
ffffffffc0205852:	000ad597          	auipc	a1,0xad
ffffffffc0205856:	ede5b583          	ld	a1,-290(a1) # ffffffffc02b2730 <boot_pgdir>
ffffffffc020585a:	9936                	add	s2,s2,a3
ffffffffc020585c:	854a                	mv	a0,s2
ffffffffc020585e:	573000ef          	jal	ra,ffffffffc02065d0 <memcpy>
    if (elf->e_magic != ELF_MAGIC) {  // 判断读取的ELF文件是否合法
ffffffffc0205862:	7782                	ld	a5,32(sp)
ffffffffc0205864:	4398                	lw	a4,0(a5)
ffffffffc0205866:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc020586a:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC) {  // 判断读取的ELF文件是否合法
ffffffffc020586e:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9467>
ffffffffc0205872:	14f71663          	bne	a4,a5,ffffffffc02059be <do_execve+0x262>
    struct proghdr *ph_end = ph + elf->e_phnum;  // 程序段数目
ffffffffc0205876:	7682                	ld	a3,32(sp)
ffffffffc0205878:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);  // 获取段头部表的地址
ffffffffc020587c:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;  // 程序段数目
ffffffffc0205880:	00371793          	slli	a5,a4,0x3
ffffffffc0205884:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);  // 获取段头部表的地址
ffffffffc0205886:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;  // 程序段数目
ffffffffc0205888:	078e                	slli	a5,a5,0x3
ffffffffc020588a:	97ce                	add	a5,a5,s3
ffffffffc020588c:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph ++) {  // 遍历每一个程序段
ffffffffc020588e:	00f9fc63          	bgeu	s3,a5,ffffffffc02058a6 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD) {  // 判断当前段是否可以被加载
ffffffffc0205892:	0009a783          	lw	a5,0(s3)
ffffffffc0205896:	4705                	li	a4,1
ffffffffc0205898:	12e78f63          	beq	a5,a4,ffffffffc02059d6 <do_execve+0x27a>
    for (; ph < ph_end; ph ++) {  // 遍历每一个程序段
ffffffffc020589c:	77a2                	ld	a5,40(sp)
ffffffffc020589e:	03898993          	addi	s3,s3,56
ffffffffc02058a2:	fef9e8e3          	bltu	s3,a5,ffffffffc0205892 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0) {
ffffffffc02058a6:	4701                	li	a4,0
ffffffffc02058a8:	46ad                	li	a3,11
ffffffffc02058aa:	00100637          	lui	a2,0x100
ffffffffc02058ae:	7ff005b7          	lui	a1,0x7ff00
ffffffffc02058b2:	8526                	mv	a0,s1
ffffffffc02058b4:	a45fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc02058b8:	892a                	mv	s2,a0
ffffffffc02058ba:	1e051063          	bnez	a0,ffffffffc0205a9a <do_execve+0x33e>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc02058be:	6c88                	ld	a0,24(s1)
ffffffffc02058c0:	467d                	li	a2,31
ffffffffc02058c2:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc02058c6:	a87fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058ca:	38050163          	beqz	a0,ffffffffc0205c4c <do_execve+0x4f0>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc02058ce:	6c88                	ld	a0,24(s1)
ffffffffc02058d0:	467d                	li	a2,31
ffffffffc02058d2:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc02058d6:	a77fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058da:	34050963          	beqz	a0,ffffffffc0205c2c <do_execve+0x4d0>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc02058de:	6c88                	ld	a0,24(s1)
ffffffffc02058e0:	467d                	li	a2,31
ffffffffc02058e2:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02058e6:	a67fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058ea:	32050163          	beqz	a0,ffffffffc0205c0c <do_execve+0x4b0>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc02058ee:	6c88                	ld	a0,24(s1)
ffffffffc02058f0:	467d                	li	a2,31
ffffffffc02058f2:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc02058f6:	a57fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc02058fa:	2e050963          	beqz	a0,ffffffffc0205bec <do_execve+0x490>
    mm->mm_count += 1;
ffffffffc02058fe:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc0205900:	000db603          	ld	a2,0(s11)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205904:	6c94                	ld	a3,24(s1)
ffffffffc0205906:	2785                	addiw	a5,a5,1
ffffffffc0205908:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc020590a:	f604                	sd	s1,40(a2)
    current->cr3 = PADDR(mm->pgdir);
ffffffffc020590c:	c02007b7          	lui	a5,0xc0200
ffffffffc0205910:	2cf6e263          	bltu	a3,a5,ffffffffc0205bd4 <do_execve+0x478>
ffffffffc0205914:	000b3783          	ld	a5,0(s6)
ffffffffc0205918:	577d                	li	a4,-1
ffffffffc020591a:	177e                	slli	a4,a4,0x3f
ffffffffc020591c:	8e9d                	sub	a3,a3,a5
ffffffffc020591e:	00c6d793          	srli	a5,a3,0xc
ffffffffc0205922:	f654                	sd	a3,168(a2)
ffffffffc0205924:	8fd9                	or	a5,a5,a4
ffffffffc0205926:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc020592a:	7244                	ld	s1,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc020592c:	4581                	li	a1,0
ffffffffc020592e:	12000613          	li	a2,288
ffffffffc0205932:	8526                	mv	a0,s1
ffffffffc0205934:	48b000ef          	jal	ra,ffffffffc02065be <memset>
    tf->epc = elf->e_entry;  // 设置tf->epc为用户程序的入口地址
ffffffffc0205938:	7782                	ld	a5,32(sp)
ffffffffc020593a:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;  // 设置f->gpr.sp为用户栈的顶部地址
ffffffffc020593c:	4785                	li	a5,1
ffffffffc020593e:	07fe                	slli	a5,a5,0x1f
ffffffffc0205940:	e89c                	sd	a5,16(s1)
    tf->epc = elf->e_entry;  // 设置tf->epc为用户程序的入口地址
ffffffffc0205942:	10e4b423          	sd	a4,264(s1)
    tf->status = (read_csr(sstatus) & ~SSTATUS_SPP & ~SSTATUS_SPIE);  // 根据需要设置 tf->status 的值，清除 SSTATUS_SPP 和 SSTATUS_SPIE 位
ffffffffc0205946:	100027f3          	csrr	a5,sstatus
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020594a:	000db403          	ld	s0,0(s11)
    tf->status = (read_csr(sstatus) & ~SSTATUS_SPP & ~SSTATUS_SPIE);  // 根据需要设置 tf->status 的值，清除 SSTATUS_SPP 和 SSTATUS_SPIE 位
ffffffffc020594e:	edf7f793          	andi	a5,a5,-289
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205952:	4641                	li	a2,16
ffffffffc0205954:	0b440413          	addi	s0,s0,180
ffffffffc0205958:	4581                	li	a1,0
    tf->status = (read_csr(sstatus) & ~SSTATUS_SPP & ~SSTATUS_SPIE);  // 根据需要设置 tf->status 的值，清除 SSTATUS_SPP 和 SSTATUS_SPIE 位
ffffffffc020595a:	10f4b023          	sd	a5,256(s1)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020595e:	8522                	mv	a0,s0
ffffffffc0205960:	45f000ef          	jal	ra,ffffffffc02065be <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205964:	463d                	li	a2,15
ffffffffc0205966:	180c                	addi	a1,sp,48
ffffffffc0205968:	8522                	mv	a0,s0
ffffffffc020596a:	467000ef          	jal	ra,ffffffffc02065d0 <memcpy>
}
ffffffffc020596e:	70aa                	ld	ra,168(sp)
ffffffffc0205970:	740a                	ld	s0,160(sp)
ffffffffc0205972:	64ea                	ld	s1,152(sp)
ffffffffc0205974:	69aa                	ld	s3,136(sp)
ffffffffc0205976:	6a0a                	ld	s4,128(sp)
ffffffffc0205978:	7ae6                	ld	s5,120(sp)
ffffffffc020597a:	7b46                	ld	s6,112(sp)
ffffffffc020597c:	7ba6                	ld	s7,104(sp)
ffffffffc020597e:	7c06                	ld	s8,96(sp)
ffffffffc0205980:	6ce6                	ld	s9,88(sp)
ffffffffc0205982:	6d46                	ld	s10,80(sp)
ffffffffc0205984:	6da6                	ld	s11,72(sp)
ffffffffc0205986:	854a                	mv	a0,s2
ffffffffc0205988:	694a                	ld	s2,144(sp)
ffffffffc020598a:	614d                	addi	sp,sp,176
ffffffffc020598c:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc020598e:	463d                	li	a2,15
ffffffffc0205990:	85ca                	mv	a1,s2
ffffffffc0205992:	1808                	addi	a0,sp,48
ffffffffc0205994:	43d000ef          	jal	ra,ffffffffc02065d0 <memcpy>
    if (mm != NULL) {
ffffffffc0205998:	e20993e3          	bnez	s3,ffffffffc02057be <do_execve+0x62>
    if (current->mm != NULL) {
ffffffffc020599c:	000db783          	ld	a5,0(s11)
ffffffffc02059a0:	779c                	ld	a5,40(a5)
ffffffffc02059a2:	e4078ae3          	beqz	a5,ffffffffc02057f6 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc02059a6:	00003617          	auipc	a2,0x3
ffffffffc02059aa:	c6a60613          	addi	a2,a2,-918 # ffffffffc0208610 <default_pmm_manager+0x12d8>
ffffffffc02059ae:	23200593          	li	a1,562
ffffffffc02059b2:	00003517          	auipc	a0,0x3
ffffffffc02059b6:	a7650513          	addi	a0,a0,-1418 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc02059ba:	ac1fa0ef          	jal	ra,ffffffffc020047a <__panic>
    put_pgdir(mm);
ffffffffc02059be:	8526                	mv	a0,s1
ffffffffc02059c0:	c28ff0ef          	jal	ra,ffffffffc0204de8 <put_pgdir>
    mm_destroy(mm);
ffffffffc02059c4:	8526                	mv	a0,s1
ffffffffc02059c6:	8e1fe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
        ret = -E_INVAL_ELF;  // 错误码：ELF文件不合法
ffffffffc02059ca:	5961                	li	s2,-8
    do_exit(ret);  // 调用 do_exit 退出进程
ffffffffc02059cc:	854a                	mv	a0,s2
ffffffffc02059ce:	94fff0ef          	jal	ra,ffffffffc020531c <do_exit>
    int ret = -E_NO_MEM;  // 错误码：未分配内存
ffffffffc02059d2:	5971                	li	s2,-4
ffffffffc02059d4:	bfe5                	j	ffffffffc02059cc <do_execve+0x270>
        if (ph->p_filesz > ph->p_memsz) {  // 虚拟地址空间大小大于分配的物理地址空间，则ELF文件不合法
ffffffffc02059d6:	0289b603          	ld	a2,40(s3)
ffffffffc02059da:	0209b783          	ld	a5,32(s3)
ffffffffc02059de:	1cf66d63          	bltu	a2,a5,ffffffffc0205bb8 <do_execve+0x45c>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc02059e2:	0049a783          	lw	a5,4(s3)
ffffffffc02059e6:	0017f693          	andi	a3,a5,1
ffffffffc02059ea:	c291                	beqz	a3,ffffffffc02059ee <do_execve+0x292>
ffffffffc02059ec:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059ee:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059f2:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc02059f4:	e779                	bnez	a4,ffffffffc0205ac2 <do_execve+0x366>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc02059f6:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc02059f8:	c781                	beqz	a5,ffffffffc0205a00 <do_execve+0x2a4>
ffffffffc02059fa:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc02059fe:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a00:	0026f793          	andi	a5,a3,2
ffffffffc0205a04:	e3f1                	bnez	a5,ffffffffc0205ac8 <do_execve+0x36c>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205a06:	0046f793          	andi	a5,a3,4
ffffffffc0205a0a:	c399                	beqz	a5,ffffffffc0205a10 <do_execve+0x2b4>
ffffffffc0205a0c:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205a10:	0109b583          	ld	a1,16(s3)
ffffffffc0205a14:	4701                	li	a4,0
ffffffffc0205a16:	8526                	mv	a0,s1
ffffffffc0205a18:	8e1fe0ef          	jal	ra,ffffffffc02042f8 <mm_map>
ffffffffc0205a1c:	892a                	mv	s2,a0
ffffffffc0205a1e:	ed35                	bnez	a0,ffffffffc0205a9a <do_execve+0x33e>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a20:	0109bb83          	ld	s7,16(s3)
ffffffffc0205a24:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a26:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a2a:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a2e:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a32:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a34:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a36:	993e                	add	s2,s2,a5
        while (start < end) {
ffffffffc0205a38:	054be963          	bltu	s7,s4,ffffffffc0205a8a <do_execve+0x32e>
ffffffffc0205a3c:	aa95                	j	ffffffffc0205bb0 <do_execve+0x454>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205a3e:	6785                	lui	a5,0x1
ffffffffc0205a40:	415b8533          	sub	a0,s7,s5
ffffffffc0205a44:	9abe                	add	s5,s5,a5
ffffffffc0205a46:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205a4a:	015a7463          	bgeu	s4,s5,ffffffffc0205a52 <do_execve+0x2f6>
                size -= la - end;
ffffffffc0205a4e:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0205a52:	000cb683          	ld	a3,0(s9)
ffffffffc0205a56:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205a58:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205a5c:	40d406b3          	sub	a3,s0,a3
ffffffffc0205a60:	8699                	srai	a3,a3,0x6
ffffffffc0205a62:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205a64:	67e2                	ld	a5,24(sp)
ffffffffc0205a66:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205a6a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205a6c:	14b87863          	bgeu	a6,a1,ffffffffc0205bbc <do_execve+0x460>
ffffffffc0205a70:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a74:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0205a76:	9bb2                	add	s7,s7,a2
ffffffffc0205a78:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a7a:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205a7c:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205a7e:	353000ef          	jal	ra,ffffffffc02065d0 <memcpy>
            start += size, from += size;
ffffffffc0205a82:	6622                	ld	a2,8(sp)
ffffffffc0205a84:	9932                	add	s2,s2,a2
        while (start < end) {
ffffffffc0205a86:	054bf363          	bgeu	s7,s4,ffffffffc0205acc <do_execve+0x370>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205a8a:	6c88                	ld	a0,24(s1)
ffffffffc0205a8c:	866a                	mv	a2,s10
ffffffffc0205a8e:	85d6                	mv	a1,s5
ffffffffc0205a90:	8bdfd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205a94:	842a                	mv	s0,a0
ffffffffc0205a96:	f545                	bnez	a0,ffffffffc0205a3e <do_execve+0x2e2>
        ret = -E_NO_MEM;
ffffffffc0205a98:	5971                	li	s2,-4
    exit_mmap(mm);
ffffffffc0205a9a:	8526                	mv	a0,s1
ffffffffc0205a9c:	9a7fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
    put_pgdir(mm);
ffffffffc0205aa0:	8526                	mv	a0,s1
ffffffffc0205aa2:	b46ff0ef          	jal	ra,ffffffffc0204de8 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205aa6:	8526                	mv	a0,s1
ffffffffc0205aa8:	ffefe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
    return ret;
ffffffffc0205aac:	b705                	j	ffffffffc02059cc <do_execve+0x270>
            exit_mmap(mm);  // 退出内存映射
ffffffffc0205aae:	854e                	mv	a0,s3
ffffffffc0205ab0:	993fe0ef          	jal	ra,ffffffffc0204442 <exit_mmap>
            put_pgdir(mm);  // 释放页目录
ffffffffc0205ab4:	854e                	mv	a0,s3
ffffffffc0205ab6:	b32ff0ef          	jal	ra,ffffffffc0204de8 <put_pgdir>
            mm_destroy(mm);  // 销毁内存管理结构，释放当前进程占用的内存
ffffffffc0205aba:	854e                	mv	a0,s3
ffffffffc0205abc:	feafe0ef          	jal	ra,ffffffffc02042a6 <mm_destroy>
ffffffffc0205ac0:	b33d                	j	ffffffffc02057ee <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205ac2:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205ac6:	fb95                	bnez	a5,ffffffffc02059fa <do_execve+0x29e>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205ac8:	4d5d                	li	s10,23
ffffffffc0205aca:	bf35                	j	ffffffffc0205a06 <do_execve+0x2aa>
        end = ph->p_va + ph->p_memsz;
ffffffffc0205acc:	0109b683          	ld	a3,16(s3)
ffffffffc0205ad0:	0289b903          	ld	s2,40(s3)
ffffffffc0205ad4:	9936                	add	s2,s2,a3
        if (start < la) {
ffffffffc0205ad6:	075bfd63          	bgeu	s7,s5,ffffffffc0205b50 <do_execve+0x3f4>
            if (start == end) {
ffffffffc0205ada:	dd7901e3          	beq	s2,s7,ffffffffc020589c <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205ade:	6785                	lui	a5,0x1
ffffffffc0205ae0:	00fb8533          	add	a0,s7,a5
ffffffffc0205ae4:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc0205ae8:	41790a33          	sub	s4,s2,s7
            if (end < la) {
ffffffffc0205aec:	0b597d63          	bgeu	s2,s5,ffffffffc0205ba6 <do_execve+0x44a>
    return page - pages + nbase;
ffffffffc0205af0:	000cb683          	ld	a3,0(s9)
ffffffffc0205af4:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205af6:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0205afa:	40d406b3          	sub	a3,s0,a3
ffffffffc0205afe:	8699                	srai	a3,a3,0x6
ffffffffc0205b00:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b02:	67e2                	ld	a5,24(sp)
ffffffffc0205b04:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b08:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b0a:	0ac5f963          	bgeu	a1,a2,ffffffffc0205bbc <do_execve+0x460>
ffffffffc0205b0e:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b12:	8652                	mv	a2,s4
ffffffffc0205b14:	4581                	li	a1,0
ffffffffc0205b16:	96c2                	add	a3,a3,a6
ffffffffc0205b18:	9536                	add	a0,a0,a3
ffffffffc0205b1a:	2a5000ef          	jal	ra,ffffffffc02065be <memset>
            start += size;
ffffffffc0205b1e:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205b22:	03597463          	bgeu	s2,s5,ffffffffc0205b4a <do_execve+0x3ee>
ffffffffc0205b26:	d6e90be3          	beq	s2,a4,ffffffffc020589c <do_execve+0x140>
ffffffffc0205b2a:	00003697          	auipc	a3,0x3
ffffffffc0205b2e:	b0e68693          	addi	a3,a3,-1266 # ffffffffc0208638 <default_pmm_manager+0x1300>
ffffffffc0205b32:	00001617          	auipc	a2,0x1
ffffffffc0205b36:	16e60613          	addi	a2,a2,366 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205b3a:	29000593          	li	a1,656
ffffffffc0205b3e:	00003517          	auipc	a0,0x3
ffffffffc0205b42:	8ea50513          	addi	a0,a0,-1814 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205b46:	935fa0ef          	jal	ra,ffffffffc020047a <__panic>
ffffffffc0205b4a:	ff5710e3          	bne	a4,s5,ffffffffc0205b2a <do_execve+0x3ce>
ffffffffc0205b4e:	8bd6                	mv	s7,s5
        while (start < end) {
ffffffffc0205b50:	d52bf6e3          	bgeu	s7,s2,ffffffffc020589c <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205b54:	6c88                	ld	a0,24(s1)
ffffffffc0205b56:	866a                	mv	a2,s10
ffffffffc0205b58:	85d6                	mv	a1,s5
ffffffffc0205b5a:	ff2fd0ef          	jal	ra,ffffffffc020334c <pgdir_alloc_page>
ffffffffc0205b5e:	842a                	mv	s0,a0
ffffffffc0205b60:	dd05                	beqz	a0,ffffffffc0205a98 <do_execve+0x33c>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205b62:	6785                	lui	a5,0x1
ffffffffc0205b64:	415b8533          	sub	a0,s7,s5
ffffffffc0205b68:	9abe                	add	s5,s5,a5
ffffffffc0205b6a:	417a8633          	sub	a2,s5,s7
            if (end < la) {
ffffffffc0205b6e:	01597463          	bgeu	s2,s5,ffffffffc0205b76 <do_execve+0x41a>
                size -= la - end;
ffffffffc0205b72:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0205b76:	000cb683          	ld	a3,0(s9)
ffffffffc0205b7a:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0205b7c:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc0205b80:	40d406b3          	sub	a3,s0,a3
ffffffffc0205b84:	8699                	srai	a3,a3,0x6
ffffffffc0205b86:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0205b88:	67e2                	ld	a5,24(sp)
ffffffffc0205b8a:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b8e:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b90:	02b87663          	bgeu	a6,a1,ffffffffc0205bbc <do_execve+0x460>
ffffffffc0205b94:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b98:	4581                	li	a1,0
            start += size;
ffffffffc0205b9a:	9bb2                	add	s7,s7,a2
ffffffffc0205b9c:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b9e:	9536                	add	a0,a0,a3
ffffffffc0205ba0:	21f000ef          	jal	ra,ffffffffc02065be <memset>
ffffffffc0205ba4:	b775                	j	ffffffffc0205b50 <do_execve+0x3f4>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205ba6:	417a8a33          	sub	s4,s5,s7
ffffffffc0205baa:	b799                	j	ffffffffc0205af0 <do_execve+0x394>
        return -E_INVAL;
ffffffffc0205bac:	5975                	li	s2,-3
ffffffffc0205bae:	b3c1                	j	ffffffffc020596e <do_execve+0x212>
        while (start < end) {
ffffffffc0205bb0:	86de                	mv	a3,s7
ffffffffc0205bb2:	bf39                	j	ffffffffc0205ad0 <do_execve+0x374>
    int ret = -E_NO_MEM;  // 错误码：未分配内存
ffffffffc0205bb4:	5971                	li	s2,-4
ffffffffc0205bb6:	bdc5                	j	ffffffffc0205aa6 <do_execve+0x34a>
            ret = -E_INVAL_ELF;
ffffffffc0205bb8:	5961                	li	s2,-8
ffffffffc0205bba:	b5c5                	j	ffffffffc0205a9a <do_execve+0x33e>
ffffffffc0205bbc:	00001617          	auipc	a2,0x1
ffffffffc0205bc0:	7b460613          	addi	a2,a2,1972 # ffffffffc0207370 <default_pmm_manager+0x38>
ffffffffc0205bc4:	06900593          	li	a1,105
ffffffffc0205bc8:	00001517          	auipc	a0,0x1
ffffffffc0205bcc:	7d050513          	addi	a0,a0,2000 # ffffffffc0207398 <default_pmm_manager+0x60>
ffffffffc0205bd0:	8abfa0ef          	jal	ra,ffffffffc020047a <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205bd4:	00002617          	auipc	a2,0x2
ffffffffc0205bd8:	84460613          	addi	a2,a2,-1980 # ffffffffc0207418 <default_pmm_manager+0xe0>
ffffffffc0205bdc:	2ab00593          	li	a1,683
ffffffffc0205be0:	00003517          	auipc	a0,0x3
ffffffffc0205be4:	84850513          	addi	a0,a0,-1976 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205be8:	893fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205bec:	00003697          	auipc	a3,0x3
ffffffffc0205bf0:	b6468693          	addi	a3,a3,-1180 # ffffffffc0208750 <default_pmm_manager+0x1418>
ffffffffc0205bf4:	00001617          	auipc	a2,0x1
ffffffffc0205bf8:	0ac60613          	addi	a2,a2,172 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205bfc:	2a600593          	li	a1,678
ffffffffc0205c00:	00003517          	auipc	a0,0x3
ffffffffc0205c04:	82850513          	addi	a0,a0,-2008 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205c08:	873fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c0c:	00003697          	auipc	a3,0x3
ffffffffc0205c10:	afc68693          	addi	a3,a3,-1284 # ffffffffc0208708 <default_pmm_manager+0x13d0>
ffffffffc0205c14:	00001617          	auipc	a2,0x1
ffffffffc0205c18:	08c60613          	addi	a2,a2,140 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205c1c:	2a500593          	li	a1,677
ffffffffc0205c20:	00003517          	auipc	a0,0x3
ffffffffc0205c24:	80850513          	addi	a0,a0,-2040 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205c28:	853fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c2c:	00003697          	auipc	a3,0x3
ffffffffc0205c30:	a9468693          	addi	a3,a3,-1388 # ffffffffc02086c0 <default_pmm_manager+0x1388>
ffffffffc0205c34:	00001617          	auipc	a2,0x1
ffffffffc0205c38:	06c60613          	addi	a2,a2,108 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205c3c:	2a400593          	li	a1,676
ffffffffc0205c40:	00002517          	auipc	a0,0x2
ffffffffc0205c44:	7e850513          	addi	a0,a0,2024 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205c48:	833fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205c4c:	00003697          	auipc	a3,0x3
ffffffffc0205c50:	a2c68693          	addi	a3,a3,-1492 # ffffffffc0208678 <default_pmm_manager+0x1340>
ffffffffc0205c54:	00001617          	auipc	a2,0x1
ffffffffc0205c58:	04c60613          	addi	a2,a2,76 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205c5c:	2a300593          	li	a1,675
ffffffffc0205c60:	00002517          	auipc	a0,0x2
ffffffffc0205c64:	7c850513          	addi	a0,a0,1992 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205c68:	813fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205c6c <do_yield>:
    current->need_resched = 1;
ffffffffc0205c6c:	000ad797          	auipc	a5,0xad
ffffffffc0205c70:	b147b783          	ld	a5,-1260(a5) # ffffffffc02b2780 <current>
ffffffffc0205c74:	4705                	li	a4,1
ffffffffc0205c76:	ef98                	sd	a4,24(a5)
}
ffffffffc0205c78:	4501                	li	a0,0
ffffffffc0205c7a:	8082                	ret

ffffffffc0205c7c <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205c7c:	1101                	addi	sp,sp,-32
ffffffffc0205c7e:	e822                	sd	s0,16(sp)
ffffffffc0205c80:	e426                	sd	s1,8(sp)
ffffffffc0205c82:	ec06                	sd	ra,24(sp)
ffffffffc0205c84:	842e                	mv	s0,a1
ffffffffc0205c86:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205c88:	c999                	beqz	a1,ffffffffc0205c9e <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0205c8a:	000ad797          	auipc	a5,0xad
ffffffffc0205c8e:	af67b783          	ld	a5,-1290(a5) # ffffffffc02b2780 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205c92:	7788                	ld	a0,40(a5)
ffffffffc0205c94:	4685                	li	a3,1
ffffffffc0205c96:	4611                	li	a2,4
ffffffffc0205c98:	e63fe0ef          	jal	ra,ffffffffc0204afa <user_mem_check>
ffffffffc0205c9c:	c909                	beqz	a0,ffffffffc0205cae <do_wait+0x32>
ffffffffc0205c9e:	85a2                	mv	a1,s0
}
ffffffffc0205ca0:	6442                	ld	s0,16(sp)
ffffffffc0205ca2:	60e2                	ld	ra,24(sp)
ffffffffc0205ca4:	8526                	mv	a0,s1
ffffffffc0205ca6:	64a2                	ld	s1,8(sp)
ffffffffc0205ca8:	6105                	addi	sp,sp,32
ffffffffc0205caa:	fbcff06f          	j	ffffffffc0205466 <do_wait.part.0>
ffffffffc0205cae:	60e2                	ld	ra,24(sp)
ffffffffc0205cb0:	6442                	ld	s0,16(sp)
ffffffffc0205cb2:	64a2                	ld	s1,8(sp)
ffffffffc0205cb4:	5575                	li	a0,-3
ffffffffc0205cb6:	6105                	addi	sp,sp,32
ffffffffc0205cb8:	8082                	ret

ffffffffc0205cba <do_kill>:
do_kill(int pid) {
ffffffffc0205cba:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205cbc:	6789                	lui	a5,0x2
do_kill(int pid) {
ffffffffc0205cbe:	e406                	sd	ra,8(sp)
ffffffffc0205cc0:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID) {
ffffffffc0205cc2:	fff5071b          	addiw	a4,a0,-1
ffffffffc0205cc6:	17f9                	addi	a5,a5,-2
ffffffffc0205cc8:	02e7e963          	bltu	a5,a4,ffffffffc0205cfa <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205ccc:	842a                	mv	s0,a0
ffffffffc0205cce:	45a9                	li	a1,10
ffffffffc0205cd0:	2501                	sext.w	a0,a0
ffffffffc0205cd2:	46c000ef          	jal	ra,ffffffffc020613e <hash32>
ffffffffc0205cd6:	02051793          	slli	a5,a0,0x20
ffffffffc0205cda:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0205cde:	000a9797          	auipc	a5,0xa9
ffffffffc0205ce2:	a1a78793          	addi	a5,a5,-1510 # ffffffffc02ae6f8 <hash_list>
ffffffffc0205ce6:	953e                	add	a0,a0,a5
ffffffffc0205ce8:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list) {
ffffffffc0205cea:	a029                	j	ffffffffc0205cf4 <do_kill+0x3a>
            if (proc->pid == pid) {
ffffffffc0205cec:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0205cf0:	00870b63          	beq	a4,s0,ffffffffc0205d06 <do_kill+0x4c>
ffffffffc0205cf4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205cf6:	fef51be3          	bne	a0,a5,ffffffffc0205cec <do_kill+0x32>
    return -E_INVAL;
...
ffffffffc0205d06:	fd87a703          	lw	a4,-40(a5)
ffffffffc0205d0a:	00177693          	andi	a3,a4,1
ffffffffc0205d0e:	e295                	bnez	a3,ffffffffc0205d32 <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d10:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0205d12:	00176713          	ori	a4,a4,1
ffffffffc0205d16:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0205d1a:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d1c:	fe06d0e3          	bgez	a3,ffffffffc0205cfc <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0205d20:	f2878513          	addi	a0,a5,-216
ffffffffc0205d24:	22e000ef          	jal	ra,ffffffffc0205f52 <wakeup_proc>
}
...
ffffffffc0205d34:	b7e1                	j	ffffffffc0205cfc <do_kill+0x42>
...
ffffffffc0205d3e:	9be78793          	addi	a5,a5,-1602 # ffffffffc02b26f8 <proc_list>
...
ffffffffc0205d4c:	9b048493          	addi	s1,s1,-1616 # ffffffffc02ae6f8 <hash_list>
...
ffffffffc0205d58:	9a470713          	addi	a4,a4,-1628 # ffffffffc02b26f8 <proc_list>
...
ffffffffc0205d68:	f83fe0ef          	jal	ra,ffffffffc0204cea <alloc_proc>
ffffffffc0205d6c:	000ad917          	auipc	s2,0xad
ffffffffc0205d70:	a1c90913          	addi	s2,s2,-1508 # ffffffffc02b2788 <idleproc>
ffffffffc0205d74:	00a93023          	sd	a0,0(s2)
ffffffffc0205d78:	0e050f63          	beqz	a0,ffffffffc0205e76 <proc_init+0x140>
...
ffffffffc0205d98:	027000ef          	jal	ra,ffffffffc02065be <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205d9c:	463d                	li	a2,15
ffffffffc0205d9e:	00003597          	auipc	a1,0x3
ffffffffc0205da2:	a1258593          	addi	a1,a1,-1518 # ffffffffc02087b0 <default_pmm_manager+0x1478>
ffffffffc0205da6:	8522                	mv	a0,s0
ffffffffc0205da8:	029000ef          	jal	ra,ffffffffc02065d0 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0205dac:	000ad717          	auipc	a4,0xad
ffffffffc0205db0:	9ec70713          	addi	a4,a4,-1556 # ffffffffc02b2798 <nr_process>
...
ffffffffc0205dc4:	87850513          	addi	a0,a0,-1928 # ffffffffc0205638 <init_main>
    nr_process ++;
ffffffffc0205dc8:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0205dca:	000ad797          	auipc	a5,0xad
ffffffffc0205dce:	9ad7bb23          	sd	a3,-1610(a5) # ffffffffc02b2780 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205dd2:	cfaff0ef          	jal	ra,ffffffffc02052cc <kernel_thread>
ffffffffc0205dd6:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0205dd8:	08a05363          	blez	a0,ffffffffc0205e5e <proc_init+0x128>
    if (0 < pid && pid < MAX_PID) {
...
ffffffffc0205de6:	02e7e363          	bltu	a5,a4,ffffffffc0205e0c <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0205dea:	45a9                	li	a1,10
ffffffffc0205dec:	352000ef          	jal	ra,ffffffffc020613e <hash32>
ffffffffc0205df0:	02051793          	slli	a5,a0,0x20
ffffffffc0205df4:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0205df8:	96a6                	add	a3,a3,s1
ffffffffc0205dfa:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc0205dfc:	a029                	j	ffffffffc0205e06 <proc_init+0xd0>
            if (proc->pid == pid) {
ffffffffc0205dfe:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x7c74>
ffffffffc0205e02:	04870b63          	beq	a4,s0,ffffffffc0205e58 <proc_init+0x122>
    return listelm->next;
ffffffffc0205e06:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0205e08:	fef69be3          	bne	a3,a5,ffffffffc0205dfe <proc_init+0xc8>
    return NULL;
ffffffffc0205e0c:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e0e:	0b478493          	addi	s1,a5,180
ffffffffc0205e12:	4641                	li	a2,16
ffffffffc0205e14:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205e16:	000ad417          	auipc	s0,0xad
ffffffffc0205e1a:	97a40413          	addi	s0,s0,-1670 # ffffffffc02b2790 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e1e:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0205e20:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0205e22:	79c000ef          	jal	ra,ffffffffc02065be <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0205e26:	463d                	li	a2,15
ffffffffc0205e28:	00003597          	auipc	a1,0x3
ffffffffc0205e2c:	9b058593          	addi	a1,a1,-1616 # ffffffffc02087d8 <default_pmm_manager+0x14a0>
ffffffffc0205e30:	8526                	mv	a0,s1
ffffffffc0205e32:	79e000ef          	jal	ra,ffffffffc02065d0 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e36:	00093783          	ld	a5,0(s2)
ffffffffc0205e3a:	cbb5                	beqz	a5,ffffffffc0205eae <proc_init+0x178>
ffffffffc0205e3c:	43dc                	lw	a5,4(a5)
ffffffffc0205e3e:	eba5                	bnez	a5,ffffffffc0205eae <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e40:	601c                	ld	a5,0(s0)
ffffffffc0205e42:	c7b1                	beqz	a5,ffffffffc0205e8e <proc_init+0x158>
ffffffffc0205e44:	43d8                	lw	a4,4(a5)
ffffffffc0205e46:	4785                	li	a5,1
ffffffffc0205e48:	04f71363          	bne	a4,a5,ffffffffc0205e8e <proc_init+0x158>
}
ffffffffc0205e4c:	60e2                	ld	ra,24(sp)
ffffffffc0205e4e:	6442                	ld	s0,16(sp)
ffffffffc0205e50:	64a2                	ld	s1,8(sp)
ffffffffc0205e52:	6902                	ld	s2,0(sp)
ffffffffc0205e54:	6105                	addi	sp,sp,32
ffffffffc0205e56:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0205e58:	f2878793          	addi	a5,a5,-216
ffffffffc0205e5c:	bf4d                	j	ffffffffc0205e0e <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0205e5e:	00003617          	auipc	a2,0x3
ffffffffc0205e62:	95a60613          	addi	a2,a2,-1702 # ffffffffc02087b8 <default_pmm_manager+0x1480>
ffffffffc0205e66:	3c300593          	li	a1,963
ffffffffc0205e6a:	00002517          	auipc	a0,0x2
ffffffffc0205e6e:	5be50513          	addi	a0,a0,1470 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205e72:	e08fa0ef          	jal	ra,ffffffffc020047a <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0205e76:	00003617          	auipc	a2,0x3
ffffffffc0205e7a:	92260613          	addi	a2,a2,-1758 # ffffffffc0208798 <default_pmm_manager+0x1460>
ffffffffc0205e7e:	3b500593          	li	a1,949
ffffffffc0205e82:	00002517          	auipc	a0,0x2
ffffffffc0205e86:	5a650513          	addi	a0,a0,1446 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205e8a:	df0fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e8e:	00003697          	auipc	a3,0x3
ffffffffc0205e92:	97a68693          	addi	a3,a3,-1670 # ffffffffc0208808 <default_pmm_manager+0x14d0>
ffffffffc0205e96:	00001617          	auipc	a2,0x1
ffffffffc0205e9a:	e0a60613          	addi	a2,a2,-502 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205e9e:	3ca00593          	li	a1,970
ffffffffc0205ea2:	00002517          	auipc	a0,0x2
ffffffffc0205ea6:	58650513          	addi	a0,a0,1414 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205eaa:	dd0fa0ef          	jal	ra,ffffffffc020047a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205eae:	00003697          	auipc	a3,0x3
ffffffffc0205eb2:	93268693          	addi	a3,a3,-1742 # ffffffffc02087e0 <default_pmm_manager+0x14a8>
ffffffffc0205eb6:	00001617          	auipc	a2,0x1
ffffffffc0205eba:	dea60613          	addi	a2,a2,-534 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205ebe:	3c900593          	li	a1,969
ffffffffc0205ec2:	00002517          	auipc	a0,0x2
ffffffffc0205ec6:	56650513          	addi	a0,a0,1382 # ffffffffc0208428 <default_pmm_manager+0x10f0>
ffffffffc0205eca:	db0fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc0205ece <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205ece:	1141                	addi	sp,sp,-16
ffffffffc0205ed0:	e022                	sd	s0,0(sp)
ffffffffc0205ed2:	e406                	sd	ra,8(sp)
ffffffffc0205ed4:	000ad417          	auipc	s0,0xad
ffffffffc0205ed8:	8ac40413          	addi	s0,s0,-1876 # ffffffffc02b2780 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205edc:	6018                	ld	a4,0(s0)
ffffffffc0205ede:	6f1c                	ld	a5,24(a4)
ffffffffc0205ee0:	dffd                	beqz	a5,ffffffffc0205ede <cpu_idle+0x10>
            schedule();
ffffffffc0205ee2:	0f0000ef          	jal	ra,ffffffffc0205fd2 <schedule>
ffffffffc0205ee6:	bfdd                	j	ffffffffc0205edc <cpu_idle+0xe>

ffffffffc0205ee8 <switch_to>:
.text
...
ffffffffc0205ee8:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205eec:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205ef0:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205ef2:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205ef4:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205ef8:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205efc:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205f00:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205f04:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205f08:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205f0c:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205f10:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205f14:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205f18:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205f1c:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205f20:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205f24:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205f26:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205f28:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205f2c:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205f30:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205f34:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205f38:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205f3c:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205f40:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205f44:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205f48:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205f4c:	0685bd83          	ld	s11,104(a1)
...
ffffffffc0205f8c:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f8e:	eb2fa06f          	j	ffffffffc0200640 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f92:	00003617          	auipc	a2,0x3
ffffffffc0205f96:	8d660613          	addi	a2,a2,-1834 # ffffffffc0208868 <default_pmm_manager+0x1530>
ffffffffc0205f9a:	45c9                	li	a1,18
ffffffffc0205f9c:	00003517          	auipc	a0,0x3
ffffffffc0205fa0:	8b450513          	addi	a0,a0,-1868 # ffffffffc0208850 <default_pmm_manager+0x1518>
ffffffffc0205fa4:	d3efa0ef          	jal	ra,ffffffffc02004e2 <__warn>
ffffffffc0205fa8:	bfc9                	j	ffffffffc0205f7a <wakeup_proc+0x28>
        intr_disable();
ffffffffc0205faa:	e9cfa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        if (proc->state != PROC_RUNNABLE) {
...
ffffffffc0205fb8:	87c68693          	addi	a3,a3,-1924 # ffffffffc0208830 <default_pmm_manager+0x14f8>
ffffffffc0205fbc:	00001617          	auipc	a2,0x1
ffffffffc0205fc0:	ce460613          	addi	a2,a2,-796 # ffffffffc0206ca0 <commands+0x450>
ffffffffc0205fc4:	45a5                	li	a1,9
ffffffffc0205fc6:	00003517          	auipc	a0,0x3
ffffffffc0205fca:	88a50513          	addi	a0,a0,-1910 # ffffffffc0208850 <default_pmm_manager+0x1518>
...
ffffffffc0205fe2:	000ac897          	auipc	a7,0xac
ffffffffc0205fe6:	79e8b883          	ld	a7,1950(a7) # ffffffffc02b2780 <current>
ffffffffc0205fea:	0008bc23          	sd	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205fee:	000ac517          	auipc	a0,0xac
ffffffffc0205ff2:	79a53503          	ld	a0,1946(a0) # ffffffffc02b2788 <idleproc>
ffffffffc0205ff6:	04a88e63          	beq	a7,a0,ffffffffc0206052 <schedule+0x80>
ffffffffc0205ffa:	0c888693          	addi	a3,a7,200
ffffffffc0205ffe:	000ac617          	auipc	a2,0xac
ffffffffc0206002:	6fa60613          	addi	a2,a2,1786 # ffffffffc02b26f8 <proc_list>
        le = last;
...
ffffffffc020602a:	00a88463          	beq	a7,a0,ffffffffc0206032 <schedule+0x60>
            proc_run(next);
ffffffffc020602e:	e31fe0ef          	jal	ra,ffffffffc0204e5e <proc_run>
    if (flag) {
...
ffffffffc020604c:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020604e:	df2fa06f          	j	ffffffffc0200640 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206052:	000ac617          	auipc	a2,0xac
ffffffffc0206056:	6a660613          	addi	a2,a2,1702 # ffffffffc02b26f8 <proc_list>
ffffffffc020605a:	86b2                	mv	a3,a2
ffffffffc020605c:	b76d                	j	ffffffffc0206006 <schedule+0x34>
        intr_disable();
ffffffffc020605e:	de8fa0ef          	jal	ra,ffffffffc0200646 <intr_disable>
        return 1;
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0206066:	000ac797          	auipc	a5,0xac
ffffffffc020606a:	71a7b783          	ld	a5,1818(a5) # ffffffffc02b2780 <current>
}
...
ffffffffc020607a:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc020607c:	93afa0ef          	jal	ra,ffffffffc02001b6 <cputchar>
}
...
ffffffffc020608a:	c31ff06f          	j	ffffffffc0205cba <do_kill>

ffffffffc020608e <sys_yield>:
    return do_yield();
ffffffffc020608e:	bdfff06f          	j	ffffffffc0205c6c <do_yield>
...
ffffffffc020609a:	ec2ff06f          	j	ffffffffc020575c <do_execve>

ffffffffc020609e <sys_wait>:
    return do_wait(pid, store);
ffffffffc020609e:	650c                	ld	a1,8(a0)
ffffffffc02060a0:	4108                	lw	a0,0(a0)
ffffffffc02060a2:	bdbff06f          	j	ffffffffc0205c7c <do_wait>

ffffffffc02060a6 <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc02060a6:	000ac797          	auipc	a5,0xac
ffffffffc02060aa:	6da7b783          	ld	a5,1754(a5) # ffffffffc02b2780 <current>
ffffffffc02060ae:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc02060b0:	4501                	li	a0,0
ffffffffc02060b2:	6a0c                	ld	a1,16(a2)
ffffffffc02060b4:	e17fe06f          	j	ffffffffc0204eca <do_fork>

ffffffffc02060b8 <sys_exit>:
    return do_exit(error_code);
ffffffffc02060b8:	4108                	lw	a0,0(a0)
ffffffffc02060ba:	a62ff06f          	j	ffffffffc020531c <do_exit>
...
ffffffffc02060c0:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc02060c2:	000ac497          	auipc	s1,0xac
ffffffffc02060c6:	6be48493          	addi	s1,s1,1726 # ffffffffc02b2780 <current>
...
ffffffffc02060e6:	7ee78793          	addi	a5,a5,2030 # ffffffffc02088d0 <syscalls>
...
ffffffffc0206118:	f1cfa0ef          	jal	ra,ffffffffc0200834 <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc020611c:	609c                	ld	a5,0(s1)
ffffffffc020611e:	86ca                	mv	a3,s2
ffffffffc0206120:	00002617          	auipc	a2,0x2
ffffffffc0206124:	76860613          	addi	a2,a2,1896 # ffffffffc0208888 <default_pmm_manager+0x1550>
ffffffffc0206128:	43d8                	lw	a4,4(a5)
ffffffffc020612a:	06800593          	li	a1,104
ffffffffc020612e:	0b478793          	addi	a5,a5,180
ffffffffc0206132:	00002517          	auipc	a0,0x2
ffffffffc0206136:	78650513          	addi	a0,a0,1926 # ffffffffc02088b8 <default_pmm_manager+0x1580>
ffffffffc020613a:	b40fa0ef          	jal	ra,ffffffffc020047a <__panic>

ffffffffc020613e <hash32>:
 *
...
ffffffffc020613e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0206142:	2785                	addiw	a5,a5,1
ffffffffc0206144:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0206148:	02000793          	li	a5,32
ffffffffc020614c:	9f8d                	subw	a5,a5,a1
}
ffffffffc020614e:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc0206176:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0206178:	03067e63          	bgeu	a2,a6,ffffffffc02061b4 <printnum+0x60>
...
ffffffffc0206192:	84278793          	addi	a5,a5,-1982 # ffffffffc02089d0 <syscalls+0x100>
ffffffffc0206196:	020a5a13          	srli	s4,s4,0x20
...
ffffffffc02061c8:	e8d2                	sd	s4,80(sp)
ffffffffc02061ca:	e4d6                	sd	s5,72(sp)
ffffffffc02061cc:	e0da                	sd	s6,64(sp)
ffffffffc02061ce:	fc5e                	sd	s7,56(sp)
ffffffffc02061d0:	f06a                	sd	s10,32(sp)
ffffffffc02061d2:	fc86                	sd	ra,120(sp)
ffffffffc02061d4:	f8a2                	sd	s0,112(sp)
ffffffffc02061d6:	f862                	sd	s8,48(sp)
...
ffffffffc02061e2:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02061e4:	02500993          	li	s3,37
            putch(ch, putdat);
        }
...
ffffffffc02061ea:	00003a97          	auipc	s5,0x3
ffffffffc02061ee:	812a8a93          	addi	s5,s5,-2030 # ffffffffc02089fc <syscalls+0x12c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02061f2:	00003b97          	auipc	s7,0x3
ffffffffc02061f6:	a26b8b93          	addi	s7,s7,-1498 # ffffffffc0208c18 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061fa:	000d4503          	lbu	a0,0(s10)
ffffffffc02061fe:	001d0413          	addi	s0,s10,1
ffffffffc0206202:	01350a63          	beq	a0,s3,ffffffffc0206216 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0206206:	c121                	beqz	a0,ffffffffc0206246 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0206212:	ff351ae3          	bne	a0,s3,ffffffffc0206206 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206216:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc020621a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc020621e:	4c81                	li	s9,0
ffffffffc0206220:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0206222:	5c7d                	li	s8,-1
ffffffffc0206224:	5dfd                	li	s11,-1
ffffffffc0206226:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc020622a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020622c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206230:	0ff5f593          	andi	a1,a1,255
ffffffffc0206234:	00140d13          	addi	s10,s0,1
ffffffffc0206238:	04b56263          	bltu	a0,a1,ffffffffc020627c <vprintfmt+0xbc>
ffffffffc020623c:	058a                	slli	a1,a1,0x2
ffffffffc020623e:	95d6                	add	a1,a1,s5
ffffffffc0206240:	4194                	lw	a3,0(a1)
ffffffffc0206242:	96d6                	add	a3,a3,s5
...
ffffffffc020626c:	00140d13          	addi	s10,s0,1
ffffffffc0206270:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0206274:	0ff5f593          	andi	a1,a1,255
ffffffffc0206278:	fcb572e3          	bgeu	a0,a1,ffffffffc020623c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc020627c:	85a6                	mv	a1,s1
ffffffffc020627e:	02500513          	li	a0,37
ffffffffc0206282:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206284:	fff44783          	lbu	a5,-1(s0)
ffffffffc0206288:	8d22                	mv	s10,s0
ffffffffc020628a:	f73788e3          	beq	a5,s3,ffffffffc02061fa <vprintfmt+0x3a>
ffffffffc020628e:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0206292:	1d7d                	addi	s10,s10,-1
ffffffffc0206294:	ff379de3          	bne	a5,s3,ffffffffc020628e <vprintfmt+0xce>
ffffffffc0206298:	b78d                	j	ffffffffc02061fa <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc020629a:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
...
ffffffffc02062a8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02062ac:	02d86463          	bltu	a6,a3,ffffffffc02062d4 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc02062b0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc02062b4:	002c169b          	slliw	a3,s8,0x2
ffffffffc02062b8:	0186873b          	addw	a4,a3,s8
ffffffffc02062bc:	0017171b          	slliw	a4,a4,0x1
ffffffffc02062c0:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc02062c2:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc02062c6:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc02062c8:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc02062cc:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc02062d0:	fed870e3          	bgeu	a6,a3,ffffffffc02062b0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc02062d4:	f40ddce3          	bgez	s11,ffffffffc020622c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02062d8:	8de2                	mv	s11,s8
ffffffffc02062da:	5c7d                	li	s8,-1
ffffffffc02062dc:	bf81                	j	ffffffffc020622c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02062de:	fffdc693          	not	a3,s11
ffffffffc02062e2:	96fd                	srai	a3,a3,0x3f
ffffffffc02062e4:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062e8:	00144603          	lbu	a2,1(s0)
ffffffffc02062ec:	2d81                	sext.w	s11,s11
ffffffffc02062ee:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062f0:	bf35                	j	ffffffffc020622c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02062f2:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc02062fe:	bfd9                	j	ffffffffc02062d4 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0206300:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206302:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206306:	01174463          	blt	a4,a7,ffffffffc020630e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc020630a:	1a088e63          	beqz	a7,ffffffffc02064c6 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020630e:	000a3603          	ld	a2,0(s4)
ffffffffc0206312:	46c1                	li	a3,16
ffffffffc0206314:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0206316:	2781                	sext.w	a5,a5
ffffffffc0206318:	876e                	mv	a4,s11
ffffffffc020631a:	85a6                	mv	a1,s1
ffffffffc020631c:	854a                	mv	a0,s2
ffffffffc020631e:	e37ff0ef          	jal	ra,ffffffffc0206154 <printnum>
            break;
ffffffffc0206322:	bde1                	j	ffffffffc02061fa <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0206324:	000a2503          	lw	a0,0(s4)
ffffffffc0206328:	85a6                	mv	a1,s1
ffffffffc020632a:	0a21                	addi	s4,s4,8
ffffffffc020632c:	9902                	jalr	s2
            break;
ffffffffc020632e:	b5f1                	j	ffffffffc02061fa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0206330:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206332:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0206336:	01174463          	blt	a4,a7,ffffffffc020633e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc020633a:	18088163          	beqz	a7,ffffffffc02064bc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020633e:	000a3603          	ld	a2,0(s4)
ffffffffc0206342:	46a9                	li	a3,10
ffffffffc0206344:	8a2e                	mv	s4,a1
ffffffffc0206346:	bfc1                	j	ffffffffc0206316 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206348:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020634c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020634e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206350:	bdf1                	j	ffffffffc020622c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0206352:	85a6                	mv	a1,s1
ffffffffc0206354:	02500513          	li	a0,37
ffffffffc0206358:	9902                	jalr	s2
            break;
ffffffffc020635a:	b545                	j	ffffffffc02061fa <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020635c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0206360:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206362:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0206364:	b5e1                	j	ffffffffc020622c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0206366:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0206368:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020636c:	01174463          	blt	a4,a7,ffffffffc0206374 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0206370:	14088163          	beqz	a7,ffffffffc02064b2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0206374:	000a3603          	ld	a2,0(s4)
ffffffffc0206378:	46a1                	li	a3,8
ffffffffc020637a:	8a2e                	mv	s4,a1
ffffffffc020637c:	bf69                	j	ffffffffc0206316 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc020637e:	03000513          	li	a0,48
ffffffffc0206382:	85a6                	mv	a1,s1
ffffffffc0206384:	e03e                	sd	a5,0(sp)
ffffffffc0206386:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0206388:	85a6                	mv	a1,s1
ffffffffc020638a:	07800513          	li	a0,120
ffffffffc020638e:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206390:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0206392:	6782                	ld	a5,0(sp)
ffffffffc0206394:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206396:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc020639a:	bfb5                	j	ffffffffc0206316 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020639c:	000a3403          	ld	s0,0(s4)
ffffffffc02063a0:	008a0713          	addi	a4,s4,8
ffffffffc02063a4:	e03a                	sd	a4,0(sp)
ffffffffc02063a6:	14040263          	beqz	s0,ffffffffc02064ea <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02063aa:	0fb05763          	blez	s11,ffffffffc0206498 <vprintfmt+0x2d8>
ffffffffc02063ae:	02d00693          	li	a3,45
ffffffffc02063b2:	0cd79163          	bne	a5,a3,ffffffffc0206474 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063b6:	00044783          	lbu	a5,0(s0)
ffffffffc02063ba:	0007851b          	sext.w	a0,a5
ffffffffc02063be:	cf85                	beqz	a5,ffffffffc02063f6 <vprintfmt+0x236>
ffffffffc02063c0:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02063c4:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063c8:	000c4563          	bltz	s8,ffffffffc02063d2 <vprintfmt+0x212>
ffffffffc02063cc:	3c7d                	addiw	s8,s8,-1
ffffffffc02063ce:	036c0263          	beq	s8,s6,ffffffffc02063f2 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc02063d2:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02063d4:	0e0c8e63          	beqz	s9,ffffffffc02064d0 <vprintfmt+0x310>
ffffffffc02063d8:	3781                	addiw	a5,a5,-32
ffffffffc02063da:	0ef47b63          	bgeu	s0,a5,ffffffffc02064d0 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02063de:	03f00513          	li	a0,63
ffffffffc02063e2:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02063e4:	000a4783          	lbu	a5,0(s4)
ffffffffc02063e8:	3dfd                	addiw	s11,s11,-1
ffffffffc02063ea:	0a05                	addi	s4,s4,1
ffffffffc02063ec:	0007851b          	sext.w	a0,a5
ffffffffc02063f0:	ffe1                	bnez	a5,ffffffffc02063c8 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02063f2:	01b05963          	blez	s11,ffffffffc0206404 <vprintfmt+0x244>
ffffffffc02063f6:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02063f8:	85a6                	mv	a1,s1
ffffffffc02063fa:	02000513          	li	a0,32
ffffffffc02063fe:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0206400:	fe0d9be3          	bnez	s11,ffffffffc02063f6 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0206404:	6a02                	ld	s4,0(sp)
ffffffffc0206406:	bbd5                	j	ffffffffc02061fa <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0206408:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc020640a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020640e:	01174463          	blt	a4,a7,ffffffffc0206416 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0206412:	08088d63          	beqz	a7,ffffffffc02064ac <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0206416:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc020641a:	0a044d63          	bltz	s0,ffffffffc02064d4 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020641e:	8622                	mv	a2,s0
ffffffffc0206420:	8a66                	mv	s4,s9
ffffffffc0206422:	46a9                	li	a3,10
ffffffffc0206424:	bdcd                	j	ffffffffc0206316 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0206426:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020642a:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc020642c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020642e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0206432:	8fb5                	xor	a5,a5,a3
ffffffffc0206434:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0206438:	02d74163          	blt	a4,a3,ffffffffc020645a <vprintfmt+0x29a>
ffffffffc020643c:	00369793          	slli	a5,a3,0x3
ffffffffc0206440:	97de                	add	a5,a5,s7
ffffffffc0206442:	639c                	ld	a5,0(a5)
ffffffffc0206444:	cb99                	beqz	a5,ffffffffc020645a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0206446:	86be                	mv	a3,a5
ffffffffc0206448:	00000617          	auipc	a2,0x0
ffffffffc020644c:	1c860613          	addi	a2,a2,456 # ffffffffc0206610 <etext+0x28>
ffffffffc0206450:	85a6                	mv	a1,s1
ffffffffc0206452:	854a                	mv	a0,s2
ffffffffc0206454:	0ce000ef          	jal	ra,ffffffffc0206522 <printfmt>
ffffffffc0206458:	b34d                	j	ffffffffc02061fa <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020645a:	00002617          	auipc	a2,0x2
ffffffffc020645e:	59660613          	addi	a2,a2,1430 # ffffffffc02089f0 <syscalls+0x120>
ffffffffc0206462:	85a6                	mv	a1,s1
ffffffffc0206464:	854a                	mv	a0,s2
ffffffffc0206466:	0bc000ef          	jal	ra,ffffffffc0206522 <printfmt>
ffffffffc020646a:	bb41                	j	ffffffffc02061fa <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020646c:	00002417          	auipc	s0,0x2
ffffffffc0206470:	57c40413          	addi	s0,s0,1404 # ffffffffc02089e8 <syscalls+0x118>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206474:	85e2                	mv	a1,s8
ffffffffc0206476:	8522                	mv	a0,s0
ffffffffc0206478:	e43e                	sd	a5,8(sp)
ffffffffc020647a:	0e2000ef          	jal	ra,ffffffffc020655c <strnlen>
ffffffffc020647e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0206482:	01b05b63          	blez	s11,ffffffffc0206498 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0206486:	67a2                	ld	a5,8(sp)
ffffffffc0206488:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020648c:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc020648e:	85a6                	mv	a1,s1
ffffffffc0206490:	8552                	mv	a0,s4
ffffffffc0206492:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206494:	fe0d9ce3          	bnez	s11,ffffffffc020648c <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206498:	00044783          	lbu	a5,0(s0)
ffffffffc020649c:	00140a13          	addi	s4,s0,1
ffffffffc02064a0:	0007851b          	sext.w	a0,a5
ffffffffc02064a4:	d3a5                	beqz	a5,ffffffffc0206404 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02064a6:	05e00413          	li	s0,94
ffffffffc02064aa:	bf39                	j	ffffffffc02063c8 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02064ac:	000a2403          	lw	s0,0(s4)
ffffffffc02064b0:	b7ad                	j	ffffffffc020641a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02064b2:	000a6603          	lwu	a2,0(s4)
ffffffffc02064b6:	46a1                	li	a3,8
ffffffffc02064b8:	8a2e                	mv	s4,a1
ffffffffc02064ba:	bdb1                	j	ffffffffc0206316 <vprintfmt+0x156>
ffffffffc02064bc:	000a6603          	lwu	a2,0(s4)
ffffffffc02064c0:	46a9                	li	a3,10
ffffffffc02064c2:	8a2e                	mv	s4,a1
ffffffffc02064c4:	bd89                	j	ffffffffc0206316 <vprintfmt+0x156>
ffffffffc02064c6:	000a6603          	lwu	a2,0(s4)
ffffffffc02064ca:	46c1                	li	a3,16
ffffffffc02064cc:	8a2e                	mv	s4,a1
ffffffffc02064ce:	b5a1                	j	ffffffffc0206316 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc02064d0:	9902                	jalr	s2
ffffffffc02064d2:	bf09                	j	ffffffffc02063e4 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc02064d4:	85a6                	mv	a1,s1
ffffffffc02064d6:	02d00513          	li	a0,45
ffffffffc02064da:	e03e                	sd	a5,0(sp)
ffffffffc02064dc:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02064de:	6782                	ld	a5,0(sp)
ffffffffc02064e0:	8a66                	mv	s4,s9
ffffffffc02064e2:	40800633          	neg	a2,s0
ffffffffc02064e6:	46a9                	li	a3,10
ffffffffc02064e8:	b53d                	j	ffffffffc0206316 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02064ea:	03b05163          	blez	s11,ffffffffc020650c <vprintfmt+0x34c>
ffffffffc02064ee:	02d00693          	li	a3,45
ffffffffc02064f2:	f6d79de3          	bne	a5,a3,ffffffffc020646c <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02064f6:	00002417          	auipc	s0,0x2
ffffffffc02064fa:	4f240413          	addi	s0,s0,1266 # ffffffffc02089e8 <syscalls+0x118>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064fe:	02800793          	li	a5,40
ffffffffc0206502:	02800513          	li	a0,40
ffffffffc0206506:	00140a13          	addi	s4,s0,1
ffffffffc020650a:	bd6d                	j	ffffffffc02063c4 <vprintfmt+0x204>
ffffffffc020650c:	00002a17          	auipc	s4,0x2
ffffffffc0206510:	4dda0a13          	addi	s4,s4,1245 # ffffffffc02089e9 <syscalls+0x119>
ffffffffc0206514:	02800513          	li	a0,40
ffffffffc0206518:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020651c:	05e00413          	li	s0,94
ffffffffc0206520:	b565                	j	ffffffffc02063c8 <vprintfmt+0x208>

ffffffffc0206522 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206522:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0206524:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206528:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020652a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020652c:	ec06                	sd	ra,24(sp)
ffffffffc020652e:	f83a                	sd	a4,48(sp)
ffffffffc0206530:	fc3e                	sd	a5,56(sp)
ffffffffc0206532:	e0c2                	sd	a6,64(sp)
ffffffffc0206534:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0206536:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206538:	c89ff0ef          	jal	ra,ffffffffc02061c0 <vprintfmt>
}
ffffffffc020653c:	60e2                	ld	ra,24(sp)
ffffffffc020653e:	6161                	addi	sp,sp,80
ffffffffc0206540:	8082                	ret

ffffffffc0206542 <strlen>:
...
strlen(const char *s) {
ffffffffc0206546:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0206548:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020654a:	cb81                	beqz	a5,ffffffffc020655a <strlen+0x18>
        cnt ++;
ffffffffc020654c:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc020654e:	00a707b3          	add	a5,a4,a0
ffffffffc0206552:	0007c783          	lbu	a5,0(a5)
ffffffffc0206556:	fbfd                	bnez	a5,ffffffffc020654c <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc020655c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc020655e:	e589                	bnez	a1,ffffffffc0206568 <strnlen+0xc>
ffffffffc0206560:	a811                	j	ffffffffc0206574 <strnlen+0x18>
        cnt ++;
ffffffffc0206562:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206564:	00f58863          	beq	a1,a5,ffffffffc0206574 <strnlen+0x18>
ffffffffc0206568:	00f50733          	add	a4,a0,a5
ffffffffc020656c:	00074703          	lbu	a4,0(a4)
ffffffffc0206570:	fb6d                	bnez	a4,ffffffffc0206562 <strnlen+0x6>
ffffffffc0206572:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0206574:	852e                	mv	a0,a1
...
ffffffffc0206578:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020657a:	0005c703          	lbu	a4,0(a1)
...
ffffffffc020658e:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206592:	cb89                	beqz	a5,ffffffffc02065a4 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0206594:	0505                	addi	a0,a0,1
ffffffffc0206596:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0206598:	fee789e3          	beq	a5,a4,ffffffffc020658a <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020659c:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02065a0:	9d19                	subw	a0,a0,a4
ffffffffc02065a2:	8082                	ret
ffffffffc02065a4:	4501                	li	a0,0
ffffffffc02065a6:	bfed                	j	ffffffffc02065a0 <strcmp+0x16>

ffffffffc02065a8 <strchr>:
...
ffffffffc02065ac:	c799                	beqz	a5,ffffffffc02065ba <strchr+0x12>
        if (*s == c) {
ffffffffc02065ae:	00f58763          	beq	a1,a5,ffffffffc02065bc <strchr+0x14>
    while (*s != '\0') {
ffffffffc02065b2:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02065b6:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02065b8:	fbfd                	bnez	a5,ffffffffc02065ae <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02065be:	ca01                	beqz	a2,ffffffffc02065ce <memset+0x10>
ffffffffc02065c0:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02065c2:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02065c4:	0785                	addi	a5,a5,1
ffffffffc02065c6:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02065ca:	fec79de3          	bne	a5,a2,ffffffffc02065c4 <memset+0x6>
    }
    return s;
...
ffffffffc02065d0 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02065d0:	ca19                	beqz	a2,ffffffffc02065e6 <memcpy+0x16>
ffffffffc02065d2:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02065d4:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02065d6:	0005c703          	lbu	a4,0(a1)
ffffffffc02065da:	0585                	addi	a1,a1,1
ffffffffc02065dc:	0785                	addi	a5,a5,1
ffffffffc02065de:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02065e2:	fec59ae3          	bne	a1,a2,ffffffffc02065d6 <memcpy+0x6>
    }
    return dst;
